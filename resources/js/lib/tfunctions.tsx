...
export default function setupDiagnoze(toothNum, diagnoze, subdiagnoze, teethdiagnoze, dispatch, vinirColor, ceramicCrownColor, mceramicCrownColor, metalicCrownColor, zirconiaCrownColor) {
    ...
    if (diagnoze === 'change_color')
        ...
        teethdiagnoze[`tooth${toothNum}`].fissure = !teethdiagnoze[`tooth${toothNum}`].fissure;
    else if (diagnoze === 'caries')
        teethdiagnoze[`tooth${toothNum}`].caries = !teethdiagnoze[`tooth${toothNum}`].caries;
    else if (diagnoze === 'cervical_caries')
        teethdiagnoze[`tooth${toothNum}`].cervical_caries = !teethdiagnoze[`tooth${toothNum}`].cervical_caries;
    else if (diagnoze === 'wedge_shaped_defect')
        teethdiagnoze[`tooth${toothNum}`].wedge_shaped_defect = !teethdiagnoze[`tooth${toothNum}`].wedge_shaped_defect;
    else if (diagnoze === 'tartar')
        teethdiagnoze[`tooth${toothNum}`].tartar = !teethdiagnoze[`tooth${toothNum}`].tartar;
    else if (diagnoze === 'pulpit') {
        teethdiagnoze[`tooth${toothNum}`].pulpit = !teethdiagnoze[`tooth${toothNum}`].pulpit;
        teethdiagnoze[`tooth${toothNum}`].channel_class = teethdiagnoze[`tooth${toothNum}`].pulpit ? 'pulpit' : ''
    } else if (diagnoze === 'channel_not_sealed') {
        teethdiagnoze[`tooth${toothNum}`].channel_not_sealed = !teethdiagnoze[`tooth${toothNum}`].channel_not_sealed;
        teethdiagnoze[`tooth${toothNum}`].channel_class = teethdiagnoze[`tooth${toothNum}`].channel_not_sealed ? 'channel-not-sealed' : '';
    } else if (diagnoze === 'channel_top_sealed') {
        teethdiagnoze[`tooth${toothNum}`].channel_top_sealed = !teethdiagnoze[`tooth${toothNum}`].channel_top_sealed;
        teethdiagnoze[`tooth${toothNum}`].channel_class = teethdiagnoze[`tooth${toothNum}`].channel_top_sealed ? 'channel-top-sealed' : '';
    } else if (diagnoze === 'channel_part_sealed') {
        teethdiagnoze[`tooth${toothNum}`].channel_part_sealed = !teethdiagnoze[`tooth${toothNum}`].channel_part_sealed;
        teethdiagnoze[`tooth${toothNum}`].channel_class = teethdiagnoze[`tooth${toothNum}`].channel_part_sealed ? 'channel-part-sealed' : '';
        ...
        if (teethdiagnoze[`tooth${toothNum}`].periodontit_stage !== subdiagnoze) {
            ...
            teethdiagnoze[`tooth${toothNum}`].periodontit = !teethdiagnoze[`tooth${toothNum}`].periodontit;
        }
        teethdiagnoze[`tooth${toothNum}`].channel_class = teethdiagnoze[`tooth${toothNum}`].periodontit ? 'periodontit' : '';
        if (!teethdiagnoze[`tooth${toothNum}`].periodontit) dispatch(setSubDiagnosis(''));
        ...
        if (!teethdiagnoze[`tooth${toothNum}`].metalic_crown && teethdiagnoze[`tooth${toothNum}`].metalic_crown_color === "") {
            ...
            teethdiagnoze[`tooth${toothNum}`].mceramic_crown_color = metalicCrownColor;
        } else {
        ...
        teethdiagnoze[`tooth${toothNum}`].pin = !teethdiagnoze[`tooth${toothNum}`].pin;
    } else if (diagnoze === 'culttab') {
        teethdiagnoze[`tooth${toothNum}`].culttab = !teethdiagnoze[`tooth${toothNum}`].culttab;
    } else if (diagnoze === 'abutment') {
        teethdiagnoze[`tooth${toothNum}`].abutment = !teethdiagnoze[`tooth${toothNum}`].abutment;
    } else if (diagnoze === 'shaper') {
        teethdiagnoze[`tooth${toothNum}`].shaper = !teethdiagnoze[`tooth${toothNum}`].shaper;
    } else if (diagnoze === 'implant') {
        teethdiagnoze[`tooth${toothNum}`].implant = !teethdiagnoze[`tooth${toothNum}`].implant;
    } else if (diagnoze === 'apex') {
        teethdiagnoze[`tooth${toothNum}`].apex = !teethdiagnoze[`tooth${toothNum}`].apex;
    } else if (diagnoze === 'absent') {
        teethdiagnoze[`tooth${toothNum}`].absent = !teethdiagnoze[`tooth${toothNum}`].absent;
    } else if (diagnoze === 'cervical_caries') {
        teethdiagnoze[`tooth${toothNum}`].cervical_caries = !teethdiagnoze[`tooth${toothNum}`].cervical_caries;
    } else if (diagnoze === 'caries') {
        teethdiagnoze[`tooth${toothNum}`].caries = !teethdiagnoze[`tooth${toothNum}`].caries;
