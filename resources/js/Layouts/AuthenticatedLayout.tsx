        ...
        <div className="min-h-screen">
            {header && (
                <header className="bg-white shadow">
                    <div
                        className="flex shadow-md py-2 px-4 sm:px-10 top-header font-sans min-h-[60px] tracking-wide relative z-50 header-fixed">
                        <div className="relative flex w-full">
                            ...
                            <div className={`nav-content ${isNavCollapsed ? 'left-side-close' : 'left-side-open'}`}
                                 id="navbarsExample09">
