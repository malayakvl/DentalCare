...
import { setInvoiceTax, setShowTableError } from "../../../Redux/OutgoingInvoice";
...
export default function Form({
    ...
    const submit = e => {
        ...
        if (haveErrorInRow) {
            ...
            if (formData.id) {
                router.post(`/invoice-outgoing/update?id=${formData.id}`, {
                ...
                router.post('/invoice-outgoing/update', {
                    invoice_number: values.invoice_number,
                    invoice_date: values.invoice_date,
                    clinic_id: values.clinic_id,
                    store_id: values.store_id,
    ...
    return (
        <section className={className}>
            <header>
                <h2>
                    <Link className="icon-back" href={'/invoice-outgoing'}>&nbsp;</Link>
