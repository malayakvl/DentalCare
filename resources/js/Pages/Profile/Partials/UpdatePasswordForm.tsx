    ...
    return (
        <section className={className}>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="password" value={msg.get('profile.password.new')} />
                ...
                <div className="flex items-center gap-4">
                    <PrimaryButton disabled={processing}>{msg.get('profile.save')}</PrimaryButton>
