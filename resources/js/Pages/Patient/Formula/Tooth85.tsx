...
export default function Tooth85() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth85.caries_bottom = !teethDiagnozis.tooth85.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth85.caries_center = !teethDiagnozis.tooth85.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth85.caries_left = !teethDiagnozis.tooth85.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth85.caries_right = !teethDiagnozis.tooth85.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth85.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth85.seal_center_color = sealColor1;
                    teethDiagnozis.tooth85.seal_center = true;
                } else if (teethDiagnozis.tooth85.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth85.seal_center_color = sealColor2;
                    teethDiagnozis.tooth85.seal_center = true;
                } else if (teethDiagnozis.tooth85.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth85.seal_center_color = sealColor3;
                    teethDiagnozis.tooth85.seal_center = true;
                } else {
                    teethDiagnozis.tooth85.seal_center = !teethDiagnozis.tooth85.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth85.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth85.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth85.seal_bottom = true;
                } else if (teethDiagnozis.tooth85.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth85.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth85.seal_bottom = true;
                } else if (teethDiagnozis.tooth85.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth85.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth85.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth85.seal_bottom = !teethDiagnozis.tooth85.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth85.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth85.seal_left_color = sealColor1;
                    teethDiagnozis.tooth85.seal_left = true;
                } else if (teethDiagnozis.tooth85.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth85.seal_left_color = sealColor2;
                    teethDiagnozis.tooth85.seal_left = true;
                } else if (teethDiagnozis.tooth85.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth85.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth85.seal_right_color = sealColor1;
                    teethDiagnozis.tooth85.seal_right = true;
                } else if (teethDiagnozis.tooth85.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth85.seal_right_color = sealColor2;
                    teethDiagnozis.tooth85.seal_right = true;
                } else if (teethDiagnozis.tooth85.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth85.seal_right_color = sealColor3;
                    teethDiagnozis.tooth85.seal_right = true;
                } else {
                    teethDiagnozis.tooth85.seal_right = !teethDiagnozis.tooth85.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth85.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth85.seal_top_color = sealColor1;
                    teethDiagnozis.tooth85.seal_top = true;
                } else if (teethDiagnozis.tooth85.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth85.seal_top_color = sealColor2;
                    teethDiagnozis.tooth85.seal_top = true;
                } else if (teethDiagnozis.tooth85.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth85.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth85.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth85.wedge_shaped_defect_color = !teethDiagnozis.tooth85.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="85" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 673.1582 842.0025)" className={`st3 st4 st5 ${toothActive.tooth85.active ? 'num-active' : ''}`}>85</text>
            </g>
            <g id="TH-85" className={`f-tooth-init-milk ${(teethDiagnozis.tooth85.show && !teethDiagnozis.tooth85.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (teethType === 'child') {
                        document.getElementById('TH-85').style.opacity = 1
                    } else {
                        if (!teethDiagnozis.tooth55.show) {
                            document.getElementById('TH-85').style.visibility = 'inherit'
                            document.getElementById('TH-45').style.visibility = 'hidden'
                        } else {
                            document.getElementById('TH-45').style.visibility = 'inherit'
                            document.getElementById('TH-85').style.visibility = 'hidden'
                        }
                    }
                    (!toothActive && !allTeeth) && document.getElementById('85').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth85.show) {
                        document.getElementById('TH-85').style.opacity = 0
                    }
                    if (teethDiagnozis.tooth85.show && teethType === 'adult') {
                        document.getElementById('TH-45').style.visibility = 'hidden'
                        document.getElementById('TH-85').style.visibility = 'inherit'
                    }
                    ...
                    (!toothActive && !allTeeth) && document.getElementById('85').classList.remove('tooth-number-hover')
                }}
                onClick={() => {
                    ...
                    if (diagnozis) {
                        teethDiagnozis.tooth85.show = true;
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth85.change_color = !teethDiagnozis.tooth85.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth85.fissure = !teethDiagnozis.tooth85.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth85.caries = !teethDiagnozis.tooth85.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth85.cervical_caries = !teethDiagnozis.tooth85.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth85.wedge_shaped_defect = !teethDiagnozis.tooth85.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth85.tartar = !teethDiagnozis.tooth85.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth85.pulpit = !teethDiagnozis.tooth85.pulpit;
                            teethDiagnozis.tooth85.channel_class = teethDiagnozis.tooth85.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth85.channel_not_sealed = !teethDiagnozis.tooth85.channel_not_sealed;
                            teethDiagnozis.tooth85.channel_class = teethDiagnozis.tooth85.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth85.channel_top_sealed = !teethDiagnozis.tooth85.channel_top_sealed;
                            teethDiagnozis.tooth85.channel_class = teethDiagnozis.tooth85.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth85.channel_part_sealed = !teethDiagnozis.tooth85.channel_part_sealed;
                            teethDiagnozis.tooth85.channel_class = teethDiagnozis.tooth85.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth85.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth85.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth85.periodontit = true;
                            } else {
                                teethDiagnozis.tooth85.periodontit = !teethDiagnozis.tooth85.periodontit;
                            }
                            teethDiagnozis.tooth85.channel_class = teethDiagnozis.tooth85.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth85.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth85.seal = !teethDiagnozis.tooth85.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth85.seal_cervical && teethDiagnozis.tooth85.seal_cervical_color === "") {
                                teethDiagnozis.tooth85.seal_cervical = true;
                                teethDiagnozis.tooth85.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth85.seal_cervical && teethDiagnozis.tooth85.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth85.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth85.seal_cervical = false;
                                teethDiagnozis.tooth85.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth85.vinir && teethDiagnozis.tooth85.vinir_color === "") {
                                teethDiagnozis.tooth85.vinir = true;
                                teethDiagnozis.tooth85.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth85.vinir && teethDiagnozis.tooth85.vinir_color != vinirColor) {
                                teethDiagnozis.tooth85.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth85.vinir = false;
                                teethDiagnozis.tooth85.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth85.temporary_crown = !teethDiagnozis.tooth85.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth85.ceramic_crown && teethDiagnozis.tooth85.ceramic_crown_color === "") {
                                teethDiagnozis.tooth85.ceramic_crown = true;
                                teethDiagnozis.tooth85.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth85.ceramic_crown && teethDiagnozis.tooth85.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth85.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth85.ceramic_crown = false;
                                teethDiagnozis.tooth85.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth85.mceramic_crown && teethDiagnozis.tooth85.mceramic_crown_color === "") {
                                teethDiagnozis.tooth85.mceramic_crown = true;
                                teethDiagnozis.tooth85.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth85.mceramic_crown && teethDiagnozis.tooth85.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth85.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth85.mceramic_crown = false;
                                teethDiagnozis.tooth85.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth85.metalic_crown && teethDiagnozis.tooth85.metalic_crown_color === "") {
                                teethDiagnozis.tooth85.metalic_crown = true;
                                teethDiagnozis.tooth85.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth85.metalic_crown && teethDiagnozis.tooth85.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth85.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth85.metalic_crown = false;
                                teethDiagnozis.tooth85.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth85.zirconia_crown && teethDiagnozis.tooth85.zirconia_crown_color === "") {
                                teethDiagnozis.tooth85.zirconia_crown = true;
                                teethDiagnozis.tooth85.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth85.zirconia_crown && teethDiagnozis.tooth85.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth85.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth85.zirconia_crown = false;
                                teethDiagnozis.tooth85.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth85.pin = !teethDiagnozis.tooth85.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth85.culttab = !teethDiagnozis.tooth85.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth85.abutment = !teethDiagnozis.tooth85.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth85.shaper = !teethDiagnozis.tooth85.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth85.implant = !teethDiagnozis.tooth85.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth85.apex = !teethDiagnozis.tooth85.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth85.absent = !teethDiagnozis.tooth85.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth85.cervical_caries = !teethDiagnozis.tooth85.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth85.caries = !teethDiagnozis.tooth85.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth85.parodontit) {
                                if (teethDiagnozis.tooth85.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth85.parodontit = false;
                                    teethDiagnozis.tooth85.active = false;
                                } else {
                                    teethDiagnozis.tooth85.parodontit = true;
                                    teethDiagnozis.tooth85.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth85.parodontit = true;
                                teethDiagnozis.tooth85.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth85.active = true;
                            }
                        }
                    }
                    dispatch(setToothDiagnoze(teethDiagnozis))
            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 315, -10)'}}>
                    <g className="dentin">
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <path className="st46" d="M480.6,953.8c-0.7-8.8-2.6-17.4-6.4-25.4c-0.4-0.8-0.8-1.5-1.2-2.3
                            ...
                            c4.2-3.7,8-7.8,10.9-12.5c3.8-6.2,6-13.3,7.7-20.4C479.9,978.6,481.5,966.2,480.6,953.8z"></path>
                    </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_header_85_5" className="caries-filling" dataposition="85_5">
                            <path className="st7" 
                        ...
                        <g id="s_header_85_4" className="caries-filling" dataposition="85_4">
                            ...
                            />
                            <path className="st8 target" d="M437.3,988.7c2.3,2.4,6.3,6.9,10.9,14.3c4.3,6.9,8,15,10.3,20.6c4.2-3.7,8-7.8,10.9-12.5
                                c3.8-6.2,6-13.3,7.7-20.4c2.9-12.1,4.4-24.5,3.5-36.8c-0.7-8.8-2.6-17.4-6.4-25.4c-0.4-0.8-0.8-1.5-1.2-2.3
                                c-3,3.4-7.6,7.7-13.9,11.8c-7.5,4.9-14.2,8.5-18.7,10.7c5.8,7.6,6.6,18.5,3.8,27.3C442.9,979.9,440.5,984.4,437.3,988.7z"
                            />
                        </g>
                        <g id="s_header_85_3" className="caries-filling" dataposition="85_3">
                            ...
                            />
                            <path className="st8 target" d="M339.4,911.4c3.4,4.5,10.2,13.6,14.5,20.1c3.7,5.6,7.6,12.4,10.6,19c6.9-8.4,18.5-11.5,29.6-12
                                c3.4-0.1,6.9-0.3,10.4-0.5c9.7-0.4,19.3-0.3,28.3,4.1c3.2,1.6,5.8,3.8,7.7,6.4c4.5-2.2,11.2-5.8,18.7-10.7
                                c6.3-4.1,10.8-8.4,13.9-11.8c-4-7.5-9.7-14.1-17-18.7c-8.3-5.2-18.1-7.5-27.9-8.3c-5-0.4-10.1-0.5-15,0.9c-3.7,1.1-7.2,3-11,3.1
                                c-2.9,0-5.6-1-8.3-1.8c-5.4-1.6-10.9-2.5-16.5-3c-5.5-0.4-11-0.4-16.4,0.6c-6.3,1.2-12.2,3.8-17.1,7.9
                                C342.2,908.3,340.7,909.8,339.4,911.4z"
                        ...
                        <g id="s_header_85_2" className="caries-filling" dataposition="85_2">
                            ...
                            />
                            <path className="st8 target" d="M334,1006.8c0.5,1.3,1.1,2.5,1.8,3.8c8.2-12.9,19.7-19.6,26.7-22.7c-5.2-7.4-6.4-16.9-2.5-28.9
                                c1.1-3.3,2.6-6.1,4.6-8.5c-3-6.6-6.9-13.5-10.6-19c-4.2-6.4-11-15.5-14.5-20.1c-1.8,2.2-3.2,4.7-4.2,7.4c-1.7,4.3-2.2,9-2.6,13.5
                                c-0.8,8.5-1.3,16.9-2.3,25.4c-0.7,5.8-1.8,11.5-2,17.3C327.7,985.9,329.7,996.7,334,1006.8z"
                            />
                        </g>
                        <g id="s_header_85_1" className="caries-filling" dataposition="85_1">
                            ...
                            />
                            <path className="st8 target" d="M335.7,1010.5c2.9,5.7,6.6,11,11.6,15c4.2,3.5,9.1,6,14,8.2c7.1,3.3,14.4,6.2,22.1,7.4
                                c7.8,1.3,15.8,0.8,23.8,0.3c7-0.5,14-0.9,20.9-2.4c5.2-1.1,10.3-2.7,15-5c4.4-2.1,8.4-4.9,12.2-7.9c1.1-0.9,2.2-1.8,3.3-2.7
                                c-2.3-5.6-6-13.7-10.3-20.6c-4.6-7.4-8.6-11.9-10.9-14.3c-6.1,8.3-14.8,15.8-22.9,17c-12.3,1.9-31-1-43-9.2
                                c-3.7-2.5-6.7-5.4-9-8.6C355.4,990.9,344,997.6,335.7,1010.5z"
                            />
                    ...
                    <g className="crown"  style={{visibility: 'hidden', opacity: 0}}>
                        ...
                        />
                        <path className="st3 fissure" d="M454.1,963.8c-3.8,0.4-7.7,1-11.5,1.8c-2,0.4-4.1,0.8-5.9,0c-0.1,0-0.1-0.1-0.2-0.1
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 335, -35)'}}>
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st9" d="M460.5,1138.7c-0.3,8.3-3.4,29.5-5.4,37.5c-0.2,0.3-0.5,0.6-0.7,0.8
                        ...
                        <g className="hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st10" d="M454.5,1177.1c-9.2,11.2-14.9,17.1-20.7,30.4c-8.3,19.2-12.7,33.7-21.7,52.7
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="85_5">
                        ...
                        <g className="caries-filling" dataposition="85_4">
                        ...
                        <g className="caries-filling" dataposition="85_2">
                        ...
                        <g className="caries-filling" dataposition="85_1">
                        ...
                        <g className="with">
                            <path className="st54" areas="85_2 85_5" d="M358.5 1108L366.5 1071.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="85_1 85_2" d="M358.5 1108C355.5 1120 355.1 1129.3 327.5 1128.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="85_1 85_5" d="M358.5 1108C369.333 1118.5 403.4 1137.4 453 1129" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="85_1 85_4" d="M453 1129C451.5 1141.5 444.1 1147.8 460.5 1163" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="85_4 85_5" d="M453 1129C455.5 1119.5 457.9 1098.1 457.5 1086.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                        </g>
                    </g>
