        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth85Diagnozis.implant || tooth85Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth85Diagnozis.pin ? 1 : 0}}>
                        ...
                        <path className="st56 hIntact" d="M354.281 965.275C353.842 968.206 353.184 971.136 353.038 974.139C352.745 979.707 354.135 985.347 357.06 990.475C359.181 994.138 362.033 997.654 366.055 1000.22C368.907 1002.05 372.125 1003.29 375.489 1004.54C380.242 1006.22 385.142 1007.76 390.334 1008.5C395.599 1009.23 400.938 1009.01 406.203 1008.79C410.884 1008.57 415.564 1008.35 420.171 1007.69C423.608 1007.18 427.045 1006.37 430.19 1005.2C433.115 1004.1 435.748 1002.71 438.307 1001.24C441.964 999.046 445.255 996.555 447.668 993.479C450.227 990.329 451.617 986.666 452.641 983.003C454.469 976.85 455.493 970.477 454.762 964.103C454.25 959.635 452.933 955.166 450.374 951.064C447.595 946.669 443.5 942.859 438.088 940.222C432.53 937.512 425.948 936.266 419.367 935.827C416.003 935.607 412.566 935.534 409.348 936.193C406.861 936.706 404.594 937.658 401.962 937.732C400.06 937.732 398.232 937.219 396.404 936.779C392.82 935.9 389.091 935.387 385.361 935.168C381.705 934.948 377.975 934.875 374.392 935.387C370.223 935.973 366.274 937.292 362.983 939.343C360.424 941.028 358.449 943.006 357.279 945.423C356.182 947.621 355.89 950.038 355.597 952.383C355.232 956.558 354.939 960.88 354.281 965.275Z"
                            style={{visibility: 'inherit'}}
                        />
                        <circle className="st57" r="13" transform="matrix(-1 0 0 1 402.736 970)" style={{fill: 'black', opacity: tooth85Diagnozis.pin ? 1 : 0}} />
                    </g>
                    {/* CULTTAB */}
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth85Diagnozis.culttab && !tooth85Diagnozis.abutment && !tooth85Diagnozis.implant && !tooth85Diagnozis.apex && !tooth85Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth85.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth85Diagnozis.culttab && !tooth85Diagnozis.abutment && !tooth85Diagnozis.implant && !tooth85Diagnozis.shaper && !tooth85Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_85_4" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g id="s_header_85_3" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_85_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_left && !tooth85Diagnozis.seal_bottom) ||
                                        (!tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_left && !tooth85Diagnozis.seal_center) ||
                                        (!tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_right && !tooth85Diagnozis.seal_bottom) ||
                                        (!tooth85Diagnozis.seal_right && tooth85Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_center && !tooth85Diagnozis.seal_bottom) ||
                                        (!tooth85Diagnozis.seal_center && tooth85Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth85Diagnozis.temporary_crown || tooth85Diagnozis.ceramic_crown || tooth85Diagnozis.mceramic_crown || tooth85Diagnozis.metalic_crown || tooth85Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth85Diagnozis.temporary_crown || tooth85Diagnozis.ceramic_crown || tooth85Diagnozis.mceramic_crown || tooth85Diagnozis.metalic_crown || tooth85Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                        ...
                        />
                        <path className={`st3 fissure ${tooth85Diagnozis.fissure ? 'diagnoze' : tooth85Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth85Diagnozis.culttab && !tooth85Diagnozis.abutment && !tooth85Diagnozis.implant && !tooth85Diagnozis.apex && !tooth85Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth85Diagnozis.fissure ? 'diagnoze' : ''}`}
                            d="M454.1,963.8c-3.8,0.4-7.7,1-11.5,1.8c-2,0.4-4.1,0.8-5.9,0c-0.1,0-0.1-0.1-0.2-0.1
                            c0-0.1,0.1-0.2,0.1-0.3l-1-0.5c0,0.1,0,0.1-0.1,0.2c-0.4-0.3-0.8-0.6-1.1-1c-1-0.9-2.1-1.9-3.5-2.2c-2.3-0.5-4.1,0.8-5.8,2
                            l-0.4,0.3c-1.7,1.2-3.6,2.1-5.4,2.7c-4.2,1.5-8.7,1.3-12.7-0.5c0.3-2.1,0.2-4.2,0-6c-0.1-0.9-0.2-1.9-0.3-2.8
                            c-0.3-2.1-0.5-4.3-0.5-6.5c0-2.7,0.5-5.4,0.9-8c0.5-3.3,1.1-6.6,0.8-10c-0.4-5.3-2.7-10.3-6.4-14l-0.8,0.8
                ...
                >
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth85Diagnozis.channel_class} ${tooth85Diagnozis.channel_class} ${tooth85Diagnozis.pulpit ? 'pulpit' : ''} ${tooth85Diagnozis.periodontit ? 'periodontit' : ''}`} 
                        ...
                        <g>
                            <path className={`st22 target part ${tooth85Diagnozis.channel_class} ${tooth85Diagnozis.channel_class} ${tooth85Diagnozis.pulpit ? 'pulpit' : ''} ${tooth85Diagnozis.periodontit ? 'periodontit' : ''} top-sealed-part`} 
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth85Diagnozis.abutment || tooth85Diagnozis.implant || tooth85Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth85Diagnozis.culttab && !tooth85Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth85Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth85.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth85Diagnozis.culttab && !tooth85Diagnozis.abutment && !tooth85Diagnozis.implant && !tooth85Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_left && !tooth85Diagnozis.seal_top && !tooth85Diagnozis.seal_center) ||
                                        (tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_top && !tooth85Diagnozis.seal_center) ||
                                        (!tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_left && !tooth85Diagnozis.seal_bottom) ||
                                        (!tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_bottom && !tooth85Diagnozis.seal_center) ||
                                        (!tooth85Diagnozis.seal_left && tooth85Diagnozis.seal_bottom && tooth85Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_bottom && !tooth85Diagnozis.seal_center) ||
                                        (!tooth85Diagnozis.seal_bottom && tooth85Diagnozis.seal_center) ||
                                        (tooth85Diagnozis.seal_right && tooth85Diagnozis.seal_left && !tooth85Diagnozis.seal_center && !tooth85Diagnozis.seal_top) ||
                                        (!tooth85Diagnozis.seal_top && !tooth85Diagnozis.seal_bottom && tooth85Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth85Diagnozis.seal_right && !tooth85Diagnozis.seal_bottom) ||
                                        (!tooth85Diagnozis.seal_right && tooth85Diagnozis.seal_bottom && !tooth85Diagnozis.seal_center) ||
                                        (!tooth85Diagnozis.seal_right && tooth85Diagnozis.seal_bottom && tooth85Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
