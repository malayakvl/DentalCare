...
export default function Tooth85() {
    ...
    return (
        <>
            ...
            <g id="TH-85" className={`f-tooth-init-milk ${teethType} ${((teethDiagnozis.tooth85.show || allTeeth) && !teethDiagnozis.tooth85.absent)  ? 'f-tooth-active' : ''}`}
                onClick={() => {
            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 315, 50)'}}  
                    onMouseOver={() => {
                ...
                >
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth85Diagnozis.vinir_color}`}  
                ...
                <g className="common-view" 
                    ...
                    style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 340, 35)'}}
                >
                    {/* CHANGE COLOR */}
                    <g className="dentin">
