            ...
            <g  className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth24.active) {
                        ...
                        dispatch(setNewToothActive({tooth4: {active: true}}))
                    }
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            ...
                            if (teethDiagnozis.tooth24.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth24.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth24.periodontit = true;
                            } else {
            ...
            >
                ...
                <g id="T_24_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g style={{visibility: tooth24Diagnozis?.apex || tooth24Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth24Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth24Diagnozis?.apex ? 'apex' : ''}`}
                            ...
                            />
                            <path className={`st53 change-color ${tooth24Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth24Diagnozis?.apex ? 'apex' : ''}`}
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth24Diagnozis.implant || tooth24Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="shaper hEmpty hIntact hRoot" style={{visibility: 'hidden', opacity: 0}} >
                        <circle className="st44" r="22.435" transform="matrix(-1 0 0 1 1359.57 596.435)" />
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth24Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth24Diagnozis.abutment ? 1 : 0}}>
                        <path className="st47" d="M1394.66 600.4C1396.16 594.4 1396.16 588.5 1393.86 583C1391.46 577.4 1386.66 572.7 1381.46 568.9C1375.16 564.3 1367.86 560.7 1359.86 560.7C1351.26 560.8 1343.76 564.9 
                        ...
                        />
                        <path className="st47" d="M1383.56 599.898C1384.57 595.833 1384.57 591.836 1383.03 588.109C1381.42 584.315 1378.2 581.131 1374.72 578.556C1370.5 575.439 1365.6 573 1360.24 573C1354.48 
                        ...
                        />
                        <circle className="st45" r="13" transform="matrix(-1 0 0 1 1360.26 595)" />
                    </g>
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth24Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact" d="M1394.66 600.399C1396.16 594.399 1396.16 588.499 1393.86 582.999C1391.46 577.399 1386.66 572.699 1381.46 568.899C1375.16 564.299 
                        ...
                        <path className="st56 hIntact" d="M1383.56 599.897C1384.57 595.832 1384.57 591.835 1383.02 588.108C1381.42 584.314 1378.2 581.13 1374.72 578.555C1370.49 575.438 1365.6 572.999 1360.24 
                            ...
                            style={{visibility: 'hidden'}} />
                        <circle className="st57" r="12.25" transform="matrix(-1 0 0 1 1360.26 594.999)" style={{fill: 'black', opacity: tooth24Diagnozis.pin ? 1 : 0}} />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth24Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth24Diagnozis.culttab ? 0 : 1}}>
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth24Diagnozis.culttab && !tooth24Diagnozis.abutment && !tooth24Diagnozis.implant && !tooth24Diagnozis.apex && !tooth24Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth24Diagnozis.culttab && !tooth24Diagnozis.abutment && !tooth24Diagnozis.implant && !tooth24Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_24_4" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС BOTTOM*/}
                        <g id="s_header_24_3 hoho-bottom" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_24_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g className="with">
                            {/*Черточка право низ*/}
                            <path className="st54 lnrb" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth24Diagnozis.seal_bottom && !tooth24Diagnozis.seal_top && !tooth24Diagnozis.seal_center && !tooth24Diagnozis.seal_right) ||
                                        (tooth24Diagnozis.seal_right && !tooth24Diagnozis.seal_bottom && !tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_right && !tooth24Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                                d="M1374 620.5C1375.83 622.333 1380.9 626.7 1386.5 629.5" 
                            />
                            {/*Овал право*/}
                            <path className="st54 ovr" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth24Diagnozis.seal_right && tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_right && !tooth24Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            />
                            {/*Черточка верх право*/}
                            <path className="st54 lnrt" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                            ...
                            />
                            {/*Черточка верх лево*/}
                            <path className="st54 lnlt" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                            ...
                            />
                            {/*Овал черточка лево*/}
                            <path className="st54 ovl" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth24Diagnozis.seal_left && !tooth24Diagnozis.seal_center) ||
                                        (!tooth24Diagnozis.seal_left && tooth24Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            />
                            {/*Черточка низ лево*/}
                            <path className="st54 lnlb" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth24Diagnozis.seal_left && !tooth24Diagnozis.seal_bottom && !tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_bottom && !tooth24Diagnozis.seal_center && !tooth24Diagnozis.seal_left)
                                    ) ? 5 : 0
                                }} 
                                d="M1353 620L1343 636.5" 
                            />
                            {/*Овал черточка низ*/}
                            <path className="st54 ovb" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth24Diagnozis.seal_right && tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_bottom && !tooth24Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth24Diagnozis.temporary_crown || tooth24Diagnozis.ceramic_crown || tooth24Diagnozis.mceramic_crown || tooth24Diagnozis.metalic_crown || tooth24Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth24Diagnozis.temporary_crown || tooth24Diagnozis.ceramic_crown || tooth24Diagnozis.mceramic_crown || tooth24Diagnozis.metalic_crown || tooth24Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth24Diagnozis.fissure ? 'diagnoze' : tooth24Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    {/* FISSURES */}
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth24Diagnozis.culttab && !tooth24Diagnozis.abutment && !tooth24Diagnozis.implant && !tooth24Diagnozis.apex && !tooth24Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth24Diagnozis.fissure ? 'diagnoze' : ''}`}
                            d="M1380.2,607.3c-7.4-4.3-16.1-6.2-24.7-5.5c-5.1,0.4-10.1,1.8-14.7,4l-0.5-1c4.7-2.3,9.8-3.7,15.1-4.1
                            c8.8-0.7,17.8,1.3,25.4,5.7L1380.2,607.3z" 
                        />
                        <path className={`st3 fissure ${tooth24Diagnozis.fissure ? 'diagnoze' : ''}`}
                ...
                <g id="T_24" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g id="dentin_n_24" className="hImplant hEmpty" style={{visibility: !tooth24Diagnozis.implant && !tooth24Diagnozis.abutment && !tooth24Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_x5F_14_4_" className={`st10 change-color ${tooth24Diagnozis.change_color ? 'diagnoze' : ''}`}
                            ...
                            />
                            <path className={`st10 change-color ${tooth24Diagnozis.change_color ? 'diagnoze' : ''}`}
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth24Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact" d="M1394.37 436.199C1393.87 449.099 1390.47 461.699 1384.47 473.399L1359.47 470.499L1334.47 476.099C1331.17 465.499 1328.97 454.499 1327.97 443.399C1327.37 436.699 1327.27 429.899 
                            ...
                            style={{visibility: 'hidden'}} 
                        />
                        <path className="st57" d="M1375.27 291.8C1374.17 291.8 1373.27 292.6 1373.07 293.7L1346.47 473.5L1359.47 470.6H1359.57L1364.77 471.2L1373.87 342.9L1377.67 294.3C1377.67 
                    ...
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="1340.2" y1="364" x2="1388.4" y2="373.9" />
                        <line className="st19" x1="1342.1" y1="338.5" x2="1390.4" y2="348.4" />
                        <line className="st19" x1="1345.1" y1="313" x2="1393.3" y2="322.9" />
                        <line className="st19" x1="1347" y1="287.5" x2="1395.2" y2="297.4" />
                        <line className="st19" x1="1348.9" y1="262" x2="1397.2" y2="271.9" />
                    </g>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth24Diagnozis.culttab && !tooth24Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <path className={`st7 ${tooth24Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
                    ...
                    {/* TARTAR */}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth24.tartar ? 1 : 0}}>
                        <path className="st61 level2" d="M1318 444L1320 443L1321 441L1322 439.5L1323 438.5L1323.5 437L1324 435.5V434L1325 431.5V429L1326 426L1327 424.5L1327.5 421.5L1328.5 419.5L1330 417.5V415.5L1331.5 414.5L1333 412L1334.5 410.5L1336 408.5L1338 407.5L1339.5 406L1340.5 405L1342 403L1344 401.5L1345.5 400.5L1348 398.5L1351 397.5L1352.5 396H1354.5L1357.5 
                        ...
                        />
                        <path className="st61 level1" d="M1318 444L1320 443L1321 441L1322 439.5L1323 438.5L1323.5 437L1324 435.5V434L1325 431.5V429L1326 426L1327 424.5L1327.5 421.5L1328.5 419.5L1330 417.5V415.5L1331.5 414.5L1333 412L1334.5 410.5L1336 408.5L1338 407.5L1339.5 406L1340.5 405L1342 403L1344 401.5L1345.5 400.5L1348 398.5L1351 397.5L1352.5 396H1354.5L1357.5 394.5H1359L1362.5 396H1364.5H1366.5L1370 396.5L1373.5 397.5L1376 399.5L1378.5 
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth24Diagnozis.culttab && !tooth24Diagnozis.abutment && !tooth24Diagnozis.implant && !tooth24Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth24Diagnozis.seal_right && !tooth24Diagnozis.seal_top && !tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_right && tooth24Diagnozis.seal_top && !tooth24Diagnozis.seal_center) ||
                                        (!tooth24Diagnozis.seal_right && tooth24Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth24Diagnozis.seal_top && !tooth24Diagnozis.seal_center) ||
                                        (tooth24Diagnozis.seal_right && tooth24Diagnozis.seal_left && tooth24Diagnozis.seal_center && !tooth24Diagnozis.seal_top) ||
                                        (!tooth24Diagnozis.seal_top && !tooth24Diagnozis.seal_bottom && tooth24Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
