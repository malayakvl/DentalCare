...
export default function Tooth52() {
    ...
    const tooth18Diagnozis = teethDiagnozis.tooth52;
    ...
    return (
        <>
            <g id="52" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 889.209 716.1968)" className={`st3 st4 st5 ${toothActive.tooth52.active ? 'num-active' : ''}`}>52</text>
            </g>
            <g id="TH-52" className={`f-tooth-init-milk ${(teethDiagnozis.tooth52.show && !teethDiagnozis.tooth52.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
               onMouseOver={() => {
                   ...
                   (!toothActive && !allTeeth) && document.getElementById('52').classList.add('tooth-number-hover')
               }}
               onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth52.show) {
                        document.getElementById('TH-52').style.opacity = 0
                    }
                    if (teethDiagnozis.tooth52.show && teethType === 'adult') {
                   ...
                   (!toothActive && !allTeeth) && document.getElementById('52').classList.remove('tooth-number-hover')
               }}
               onClick={() => {
                   ...
                   // effects block
                    if (teethType === 'child' && teethDiagnozis.tooth12.show) {
                        ...
                        teethDiagnozis.tooth52.show = true;
                    } else if (teethType === 'child' && !teethDiagnozis.tooth12.show) {
                        teethDiagnozis.tooth12.show = false;
                        teethDiagnozis.tooth52.show = true;
                    } else {
            ...
            >
                ...
                <g className="top-view" transform="matrix(0.55 0 0 0.55 0 0)"
                   default-matrix="matrix(0.55, 0, 0, 0.55, 0, 0)" style={{visibility:"inherit", transform: 'matrix(0.55, 0, 0, 0.55, 16, 8)'}}>
                    <g className="dentin">
                    ...
                    C891.5,601.2,888,600,886.8,597.2z"></path>
                        </g>
                    ...
                    <g className="pin hEmpty hImplant" status="0" style={{visibility:"inherit", opacity: 0}}>
                        ...
                        <path className="st56 hIntact"
                              ...
                              style={{visibility:"hidden"}}></path>
                        <circle className="st57" id="Ellipse_49" cx="913" cy="600" r="12.25"></circle>
                    </g>
                    <g className="stump hEmpty hIntact hImplant" status="0" style={{opacity:0, visibility: "hidden"}}>
                        <path className="st47"
                              d="M882.489 594.821C880.282 588.167 885.858 582.381 892.945 580.211C898.987 578.331 905.841 578.331 912.696 578.187C919.55 578.042 926.405 577.608 932.562 578.91C939.185 580.212 945.226 584.406 944.994 591.205C944.877 594.821 942.554 597.858 939.998 600.317C937.093 603.065 933.724 605.38 931.052 608.562C927.683 612.757 925.824 618.108 922.339 622.158C920.364 624.473 918.04 626.208 915.252 626.787C911.185 627.655 907.119 625.775 903.982 622.882C900.032 619.121 897.941 613.624 895.153 608.996C893.991 606.971 892.597 604.946 890.854 603.355C887.95 600.606 883.883 598.871 882.489 594.821Z"></path>
                        <path className="st47"
                              d="M891.349 597.015C889.773 592.262 893.756 588.129 898.818 586.58C903.133 585.237 908.029 585.237 912.926 585.133C917.822 585.03 922.718 584.72 927.116 585.65C931.846 586.58 936.161 589.576 935.995 594.432C935.912 597.015 934.253 599.184 932.427 600.941C930.352 602.904 927.946 604.557 926.037 606.83C923.631 609.826 922.303 613.649 919.813 616.542C918.403 618.195 916.743 619.435 914.751 619.848C911.847 620.468 908.942 619.125 906.702 617.058C903.88 614.372 902.386 610.446 900.395 607.14C899.565 605.693 898.569 604.247 897.324 603.11C895.25 601.147 892.345 599.908 891.349 597.015Z"></path>
                ...
                c0.8-1.4,1.7-2.7,2.8-3.9c2.9-3.4,6.7-5.9,10-8.9c2.9-2.6,5.5-5.9,5.6-9.8C949.3,586.6,946.6,583,942.7,580.7z"></path>
                    </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility:"inherit"}}>
                        <g id="s_header_52_4" className="caries-filling" data-position="52_4">
                            <path className="st7" d="M878.6,594.7c1.5,4.4,6.2,6.3,9.5,9.4c1.9,1.7,3.5,3.9,4.8,6.1c0.9,1.5,1.7,3,2.6,4.5
                    c2.9-4.5,7-11.5,7.1-13.9c0-0.3,0-0.5-0.1-0.6c-1.1-1.7-12.9-13.2-18.5-18.5C879.5,584.7,876.8,589.5,878.6,594.7z"></path>
                            <path className="st8 target" d="M878.6,594.7c1.5,4.4,6.2,6.3,9.5,9.4c1.9,1.7,3.5,3.9,4.8,6.1c0.9,1.5,1.7,3,2.6,4.5
                    c2.9-4.5,7-11.5,7.1-13.9c0-0.3,0-0.5-0.1-0.6c-1.1-1.7-12.9-13.2-18.5-18.5C879.5,584.7,876.8,589.5,878.6,594.7z"
                                  style={{strokeWidth:0}}></path>
                        </g>
                        <g id="s_header_52_3" className="caries-filling" data-position="52_3">
                    ...
                    c-1.1-2.5-2.7-5.9-3.6-8c-0.5-1.2-1-2.5-1.2-3.8c-5.9-0.5-16.3-1.3-23.3-1.3C902.6,603.2,898.5,610.1,895.6,614.7z"></path>
                            <path className="st8 target" d="M895.6,614.7c2.1,3.8,4.3,7.7,7.5,10.7c3.5,3.3,8.1,5.3,12.7,4.4c3.1-0.6,5.9-2.5,8-5c2.9-3.2,4.7-7.2,7-10.9
                    c-1.1-2.5-2.7-5.9-3.6-8c-0.5-1.2-1-2.5-1.2-3.8c-5.9-0.5-16.3-1.3-23.3-1.3C902.6,603.2,898.5,610.1,895.6,614.7z"
                                  style={{strokeWidth:0}}></path>
                        </g>
                        <g id="s_header_52_2" className="caries-filling" data-position="52_2">
                    ...
                    c2.9-2.6,5.5-5.9,5.6-9.8c0.2-4.6-2.5-8.2-6.5-10.6c-4.3,3.6-13.8,11.5-15.5,14C925.7,596.9,925.5,599.5,926,602.1z"></path>
                            <path className="st8 target" d="M926,602.1c0.2,1.3,0.7,2.5,1.2,3.8c0.9,2.1,2.5,5.5,3.6,8c0.8-1.4,1.7-2.7,2.8-3.9c2.9-3.4,6.7-5.9,10-8.9
                    c2.9-2.6,5.5-5.9,5.6-9.8c0.2-4.6-2.5-8.2-6.5-10.6c-4.3,3.6-13.8,11.5-15.5,14C925.7,596.9,925.5,599.5,926,602.1z"
                                  style={{strokeWidth:0}}></path>
                        </g>
                        <g id="s_header_52_1" className="caries-filling" data-position="52_1">
                    ...
                    C888.1,579.4,885.9,580.4,884.1,581.6z"></path>
                            <path className="st8 target" d="M884.1,581.6c5.6,5.4,17.4,16.9,18.5,18.5c0.1,0.1,0.1,0.4,0.1,0.6c6.9,0,17.4,0.8,23.3,1.3
                    c-0.5-2.6-0.3-5.2,1.2-7.5c1.7-2.5,11.1-10.4,15.5-14c-2.2-1.4-4.9-2.3-7.6-2.9c-7-1.4-14.7-1.1-22.5-1c-7.7,0.1-15.4,0.1-22.2,2
                    C888.1,579.4,885.9,580.4,884.1,581.6z" style={{strokeWidth:0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="52_4 52_3"
                                  d="M903 601C902.667 602.5 901.3 606.4 898.5 610"></path>
                            <path className="st54" areas="52_1 52_4"
                                  d="M903 601C900.333 597.667 893.5 589.8 887.5 585"></path>
                            <path className="st54" areas="52_1 52_3" d="M903 601C907 600.5 917.1 600 925.5 602"></path>
                            <path className="st54" areas="52_1 52_2"
                                  d="M925.5 602C923.833 599.667 924.1 592.8 938.5 584"></path>
                            <path className="st54" areas="52_2 52_3" d="M925 602L928.5 608.5"></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility:"inherit"}}>
                        <g className="vinir" status="0" style={{opacity:0, visibility: "hidden"}}>
                            <path className="st55"
                                  d="M884.611 581.577C886.411 580.377 888.511 579.377 890.811 578.777C897.611 576.877 905.311 576.877 913.011 576.777C920.811 576.677 928.511 576.377 935.511 577.777C938.211 578.277 940.911 579.277 943.111 580.677C947.011 583.077 949.711 586.677 949.611 591.277C949.597 591.86 949.529 592.426 949.415 592.976C947.818 593.048 943.102 592.278 937.011 588.62C936.379 587.977 935.648 587.402 934.848 586.9C933.27 585.875 931.334 585.144 929.398 584.778C924.377 583.754 918.855 583.973 913.262 584.047C907.74 584.12 902.218 584.12 897.341 585.51C895.692 585.949 894.186 586.68 892.895 587.558C892.478 587.845 892.082 588.151 891.713 588.476C890.042 589.809 885.082 592.576 878.606 592.976C877.929 588.44 880.518 584.335 884.611 581.577Z"></path>
                        </g>
                    </g>
                    <g className="crown" status="0" style={{opacity:0, visibility: "hidden"}}>
                        <path className="st46 target" d="M942.7,580.7c-2.2-1.4-4.9-2.3-7.6-2.9c-7-1.4-14.7-1.1-22.5-1
                c-7.7,0.1-15.4,0.1-22.2,2c-2.3,0.6-4.4,1.6-6.2,2.8c-4.6,3.1-7.3,7.8-5.5,13c1.5,4.4,6.2,6.3,9.5,9.4c1.9,1.7,3.5,3.9,4.8,6.1
                c0.9,1.5,1.7,3,2.6,4.5c2.1,3.8,4.3,7.7,7.5,10.7c3.5,3.3,8.1,5.3,12.7,4.4c3.1-0.6,5.9-2.5,8-5c2.9-3.2,4.7-7.2,7-10.9
                c0.8-1.4,1.7-2.7,2.8-3.9c2.9-3.4,6.7-5.9,10-8.9c2.9-2.6,5.5-5.9,5.6-9.8C949.3,586.6,946.6,583,942.7,580.7z"></path>
                    </g>
                ...
                <g className="common-view" style={{visibility:"inherit", transform: 'matrix(0.55, 0, 0, 0.55, 24, 85)'}}>
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility:"inherit"}}>
                            <path className="st9" d="M938,483.1l-1.7,2.4l-2.1,1l-38.5,5.2l-1.9-1.4l-1.1-1.5
                ...
                c1.2,4.1,2.5,8.2,3.3,12.4c1,5,1.3,10.2,1.4,15.3C939.3,467.6,938.9,475.4,938,483.1z"></path>
                        ...
                        <g className="hImplant hEmpty" style={{visibility:"inherit"}}>
                            <path className="st10" d="M934.5,432.8c-2-3.1-4.3-6.1-6.9-8.7c-4.2-4.2-9.2-7.3-14.6-9.2
                ...
                C933.6,429.7,934.1,431.2,934.5,432.8z"></path>
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" data-position="52"
                ...
                c1.6,6.2,3.4,12.3,4.4,18.6C916.9,442.5,917.2,449.2,916.7,455.7z"></path>
                        ...
                        <g className="hEmpty hImplant pulpitis-pfilling" data-position="52"
                           style={{visibility:"inherit"}}>
            ...
            C939.9,467.8,939.5,475.6,938.6,483.3z"></path>
                ...
                c4.8-0.5,9.8,1.2,13.7,4.8c3.5,20.2,6.8,40.4,9.8,60.6C917.9,361.1,920.6,380,923.1,398.9z"></path>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility:"inherit"}}>
                        <g className="caries-filling" data-position="52_4">
                ...
                c1.7,1.6,3.7,2.9,5.8,3.8c3,0.4,6,0.7,9.1,0.8c-3.3-16.9-10.8-54.4-12.5-57c-1.6-2.4-9.8-9.4-14.3-13.1
                C876.7,448.8,876.9,455.4,877,462z" style={{strokeWidth:0}}></path>
                        </g>
                        <g className="caries-filling" data-position="52_2">
                ...
                c0.5-1.3,0.8-2.7,1-4.1c0.2-1.4,0.4-2.8,0.5-4.2c0.7-8.5,0-17-1.6-25.4c-1.3-6.9-3.2-13.6-5.8-20.1c-1.3-3.4-2.8-6.6-4.5-9.7
                c-2.9,5.1-7,12.6-7.7,15.5C928.1,455,933.8,490.4,936.7,508.2z" style={{strokeWidth:0}}></path>
                        </g>
                        <g className="caries-filling" data-position="52_1">
                ...
                c-4.2-4.2-9.2-7.3-14.6-9.2c-6.8-2.3-14.1-2.5-20.5,1c-6.7,3.6-11,10.5-13.3,18C878.5,436.7,877.9,439.5,877.6,442.4z"
                        ...
                        <g className="with">
                            <path className="st54" areas="52_4 52_1" d="M895.5 468L903.5 507"></path>
                            <path className="st54" areas="52_4 52_1" d="M895.5 468C893 456 890.8 451.6 882 446"></path>
                            <path className="st54" areas="52_2 52_1"
                                  d="M929.5 463.5C928 453.5 926 448.6 934 441"></path>
                            <path className="st54" areas="52_2 52_1" d="M929.5 463.5L935.5 502.5"></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility:"inherit"}}>
                        <g className="vinir" status="0" style={{opacity:0, visibility: "hidden"}}>
