...
export default function Tooth52() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth52.caries_bottom = !teethDiagnozis.tooth52.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth52.caries_center = !teethDiagnozis.tooth52.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth52.caries_left = !teethDiagnozis.tooth52.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth52.caries_right = !teethDiagnozis.tooth52.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth52.caries_top = !teethDiagnozis.tooth52.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth52.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth52.seal_center_color = sealColor1;
                    teethDiagnozis.tooth52.seal_center = true;
                } else if (teethDiagnozis.tooth52.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth52.seal_center_color = sealColor2;
                    teethDiagnozis.tooth52.seal_center = true;
                } else if (teethDiagnozis.tooth52.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth52.seal_center_color = sealColor3;
                    teethDiagnozis.tooth52.seal_center = true;
                } else {
                    teethDiagnozis.tooth52.seal_center = !teethDiagnozis.tooth52.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth52.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth52.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth52.seal_bottom = true;
                } else if (teethDiagnozis.tooth52.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth52.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth52.seal_bottom = true;
                } else if (teethDiagnozis.tooth52.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth52.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth52.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth52.seal_bottom = !teethDiagnozis.tooth52.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth52.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth52.seal_left_color = sealColor1;
                    teethDiagnozis.tooth52.seal_left = true;
                } else if (teethDiagnozis.tooth52.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth52.seal_left_color = sealColor2;
                    teethDiagnozis.tooth52.seal_left = true;
                } else if (teethDiagnozis.tooth52.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth52.seal_left_color = sealColor3;
                    teethDiagnozis.tooth52.seal_left = true;
                } else {
                    teethDiagnozis.tooth52.seal_left = !teethDiagnozis.tooth52.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth52.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth52.seal_right_color = sealColor1;
                    teethDiagnozis.tooth52.seal_right = true;
                } else if (teethDiagnozis.tooth52.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth52.seal_right_color = sealColor2;
                    teethDiagnozis.tooth52.seal_right = true;
                } else if (teethDiagnozis.tooth52.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth52.seal_right_color = sealColor3;
                    teethDiagnozis.tooth52.seal_right = true;
                } else {
                    teethDiagnozis.tooth52.seal_right = !teethDiagnozis.tooth52.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth52.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth52.seal_top_color = sealColor1;
                    teethDiagnozis.tooth52.seal_top = true;
                } else if (teethDiagnozis.tooth52.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth52.seal_top_color = sealColor2;
                    teethDiagnozis.tooth52.seal_top = true;
                } else if (teethDiagnozis.tooth52.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth52.seal_top_color = sealColor3;
                    teethDiagnozis.tooth52.seal_top = true;
                } else {
                    teethDiagnozis.tooth52.seal_top = !teethDiagnozis.tooth52.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth52.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth52.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth52.wedge_shaped_defect_color = !teethDiagnozis.tooth52.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && teethDiagnozis.tooth12.show) {
                document.getElementById('TH-52').classList.add('f-tooth-active');
                document.getElementById('TH-12').classList.remove('f-tooth-active');
            }
            if (teethType === 'adult' && teethDiagnozis.tooth52.show) {
                document.getElementById('TH-52').classList.remove('f-tooth-active');
                document.getElementById('TH-12').classList.add('f-tooth-active');
            }
        }
        ...
        <>
            ...
            <g id="TH-52" className={`f-tooth-init-milk ${(teethDiagnozis.tooth52.show && !teethDiagnozis.tooth52.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
                    ...
                    dispatch(setSelectedToothNumber(52));
            ...
            >
                <g className={`underlay ${selectedTooth === 52 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}
                    onMouseOver={() => {
                ...
                <g className="top-view" style={{visibility:"inherit", transform: 'matrix(0.55, 0, 0, 0.55, 16, 8)'}}
                    onMouseOver={() => {
                        showHideOverlay('over');
                    }}
                    onMouseLeave={() => {
                ...
                >
                    ...
                    <g className="dentin">
                        <g style={{visibility: !tooth52Diagnozis.culttab && !tooth52Diagnozis.implant && !tooth52Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 ${tooth52Diagnozis.apex ? 'apex' : ''}`} 
                                d="M886.8,597.2c-1.9-4.6,2.9-8.6,9-10.1c5.2-1.3,11.1-1.3,17-1.4c5.9-0.1,11.8-0.4,17.1,0.5
                        ...
                        <g style={{visibility: tooth52Diagnozis?.apex || tooth52Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth52Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth52Diagnozis?.apex ? 'apex' : ''}`}
                                d="M882.489 594.821C880.282 588.167 885.858 582.381 892.945 580.211C898.987 578.331 905.841 578.331 912.696 578.187C919.55 578.042 926.405 577.608 932.562 578.91C939.185 580.212 945.226 584.406 944.994 591.205C944.877 594.821 942.554 597.858 939.998 600.317C937.093 603.065 933.724 605.38 931.052 608.562C927.683 612.757 925.824 618.108 922.339 622.158C920.364 624.473 918.04 626.208 915.252 
                                626.787C911.185 627.655 907.119 625.775 903.982 622.882C900.032 619.121 897.941 613.624 895.153 608.996C893.991 606.971 892.597 604.946 890.854 603.355C887.95 600.606 883.883 598.871 882.489 594.821Z"
                            />
                        </g>
                    </g>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth52Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth52Diagnozis.abutment ? 1 : 0}}>
                        <path className="st47"
                        ...
                        <path className="st47"
                              d="M891.349 597.015C889.773 592.262 893.756 588.129 898.818 586.58C903.133 585.237 908.029 585.237 912.926 585.133C917.822 585.03 922.718 584.72 927.116 585.65C931.846 586.58 936.161 589.576 935.995 594.432C935.912 597.015 934.253 599.184 932.427 600.941C930.352 602.904 927.946 604.557 926.037 606.83C923.631 609.826 922.303 613.649 919.813 616.542C918.403 618.195 916.743 619.435 914.751 619.848C911.847 620.468 908.942 619.125 906.702 617.058C903.88 614.372 902.386 610.446 900.395 607.14C899.565 605.693 898.569 604.247 897.324 603.11C895.25 601.147 892.345 599.908 891.349 597.015Z"></path>
                        <circle className="st45" cx="913" cy="600" r="13"></circle>
                    </g>
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth52Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact"
                              d="M882.49 594.821C880.282 588.167 885.859 582.381 892.946 580.211C898.987 578.331 905.842 578.331 912.696 578.187C919.551 578.042 926.405 577.608 932.563 578.91C939.185 580.212 945.226 584.406 944.994 591.205C944.878 594.821 942.554 597.858 939.998 600.317C937.094 603.065 933.725 605.38 931.052 608.562C927.683 612.757 925.824 618.108 922.339 622.158C920.364 624.473 918.04 626.208 915.252 626.787C911.186 627.655 907.12 625.775 903.983 622.882C900.033 619.121 897.941 613.624 895.153 608.996C893.991 606.971 892.597 604.946 890.855 603.355C887.95 600.606 883.884 598.871 882.49 594.821Z"
                              style={{visibility:"hidden"}}></path>
                        <path className="st56 hIntact"
                              d="M891.35 597.015C889.773 592.262 893.756 588.129 898.819 586.58C903.134 585.237 908.03 585.237 912.926 585.133C917.822 585.03 922.718 584.72 927.116 585.65C931.847 586.58 936.162 589.576 935.996 594.432C935.913 597.015 934.253 599.184 932.428 600.941C930.353 602.904 927.946 604.557 926.038 606.83C923.631 609.826 922.303 613.649 919.814 616.542C918.403 618.195 916.743 619.435 914.752 619.848C911.847 620.468 908.943 619.125 906.702 617.058C903.881 614.372 902.387 610.446 900.395 607.14C899.565 605.693 898.57 604.247 897.325 603.11C895.25 601.147 892.346 599.908 891.35 597.015Z"
                              style={{visibility:"hidden"}}></path>
                        <circle className="st57" id="Ellipse_49" cx="913" cy="600" r="12.25" style={{fill: 'black', opacity: tooth52Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump" style={{visibility: !tooth52Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth52Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47"
                              d="M882.489 594.821C880.282 588.167 885.858 582.381 892.945 580.211C898.987 578.331 905.841 578.331 912.696 578.187C919.55 578.042 926.405 577.608 932.562 578.91C939.185 580.212 945.226 584.406 944.994 591.205C944.877 594.821 942.554 597.858 939.998 600.317C937.093 603.065 933.724 605.38 931.052 608.562C927.683 612.757 925.824 618.108 922.339 622.158C920.364 624.473 918.04 626.208 915.252 626.787C911.185 627.655 907.119 625.775 903.982 622.882C900.032 619.121 897.941 613.624 895.153 608.996C893.991 606.971 892.597 604.946 890.854 603.355C887.95 600.606 883.883 598.871 882.489 594.821Z"></path>
                        <path className="st47"
                              d="M891.349 597.015C889.773 592.262 893.756 588.129 898.818 586.58C903.133 585.237 908.029 585.237 912.926 585.133C917.822 585.03 922.718 584.72 927.116 585.65C931.846 586.58 936.161 589.576 935.995 594.432C935.912 597.015 934.253 599.184 932.427 600.941C930.352 602.904 927.946 604.557 926.037 606.83C923.631 609.826 922.303 613.649 919.813 616.542C918.403 618.195 916.743 619.435 914.751 619.848C911.847 620.468 908.942 619.125 906.702 617.058C903.88 614.372 902.386 610.446 900.395 607.14C899.565 605.693 898.569 604.247 897.324 603.11C895.25 601.147 892.345 599.908 891.349 597.015Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth52Diagnozis.culttab && !tooth52Diagnozis.abutment && !tooth52Diagnozis.implant && !tooth52Diagnozis.apex && !tooth52Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth52Diagnozis.culttab && !tooth52Diagnozis.abutment && !tooth52Diagnozis.implant && !tooth52Diagnozis.shaper && !tooth52Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth52.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth52.seal_bottom ? `seal-fill ${teethDiagnozis.tooth52.seal_bottom_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth52.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth52.seal_right ? `seal-fill ${teethDiagnozis.tooth52.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth52.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth52.seal_top ? `seal-fill ${teethDiagnozis.tooth52.seal_top_color}` : ''}
                                `}
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_bottom && !tooth52Diagnozis.seal_center) ||
                                        (tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_bottom && !tooth52Diagnozis.seal_center) ||
                                        (!tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_top) ||
                                        (!tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_top && !tooth52Diagnozis.seal_bottom) ||
                                        (!tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_top && tooth52Diagnozis.seal_bottom) ||
                                        (!tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_right && tooth52Diagnozis.seal_top && !tooth52Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_right && !tooth52Diagnozis.seal_top) ||
                                        (!tooth52Diagnozis.seal_right && tooth52Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_right && !tooth52Diagnozis.seal_bottom) ||
                                        (!tooth52Diagnozis.seal_right && tooth52Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility:"inherit"}}>
                        <g className="vinir" style={
                            {
                                visibility: tooth52Diagnozis.vinir ? 'inherit' : 'hidden',
                    ...
                    <g className="crown" style={{
                        visibility: (tooth52Diagnozis.temporary_crown || tooth52Diagnozis.ceramic_crown || tooth52Diagnozis.mceramic_crown || tooth52Diagnozis.metalic_crown || tooth52Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth52Diagnozis.temporary_crown || tooth52Diagnozis.ceramic_crown || tooth52Diagnozis.mceramic_crown || tooth52Diagnozis.metalic_crown || tooth52Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth52Diagnozis.ceramic_crown_color}
                                ${tooth52Diagnozis.mceramic_crown_color}
                                ${tooth52Diagnozis.metalic_crown_color}
                                ${tooth52Diagnozis.zirconia_crown_color}
                            `} 
                ...
                >
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g style={{visibility: !tooth52Diagnozis.implant && !tooth52Diagnozis.apex && !tooth52Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth52Diagnozis.change_color ? 'diagnoze' : ''}`}
                        ...
                        <g className="hImplant hEmpty" style={{visibility: !tooth52Diagnozis.implant && !tooth52Diagnozis.abutment && !tooth52Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth52Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth52Diagnozis.channel_class} ${tooth52Diagnozis.channel_class} ${tooth52Diagnozis.pulpit ? 'pulpit' : ''} ${tooth52Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="stump" style={{visibility: !tooth52Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth52Diagnozis.culttab ? 0 : 1}}>
                        ...
                        />
                        <path className="st15" 
                            d="M879,437.1c0.8,7.4,2,14.7,3.7,21.9c2.5,10.3,6,20.4,10.5,30.1l1.1,1.5l1.9,1.4l38.5-5.2l2.1-1l1.7-2.4
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth52Diagnozis.abutment || tooth52Diagnozis.implant || tooth52Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth52Diagnozis.culttab && !tooth52Diagnozis.abutment && !tooth52Diagnozis.implant && !tooth52Diagnozis.shaper && !tooth52Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                        <path className="st46" 
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth52Diagnozis.culttab && !tooth52Diagnozis.abutment && !tooth52Diagnozis.implant && !tooth52Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling" 
                            onClick={() => {
                                setColordedPart(diagnozis, 'left');
                            }}
                        >
                            ...
                            `}
                                ...
                                C876.7,448.8,876.9,455.4,877,462z"
                                style={{
                                    fill: teethDiagnozis.tooth52.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth52.seal_left ? teethDiagnozis.tooth52.seal_left_color : 'transparent',
                                }}
                            />
                        </g>
                        <g
                        ...
                        >
                            ...
                            `} 
                                ...
                                c-2.9,5.1-7,12.6-7.7,15.5C928.1,455,933.8,490.4,936.7,508.2z"
                                style={{
                                    fill: teethDiagnozis.tooth52.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth52.seal_right ? teethDiagnozis.tooth52.seal_right_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                c-4.2-4.2-9.2-7.3-14.6-9.2c-6.8-2.3-14.1-2.5-20.5,1c-6.7,3.6-11,10.5-13.3,18C878.5,436.7,877.9,439.5,877.6,442.4z"
                                style={{
                                    fill: teethDiagnozis.tooth52.caries_top ? '#606c80' : 
                                    teethDiagnozis.tooth52.seal_top ? teethDiagnozis.tooth52.seal_top_color : 'transparent',
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_left && !tooth52Diagnozis.seal_top && !tooth52Diagnozis.seal_center) ||
                                        (!tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth52Diagnozis.seal_right && !tooth52Diagnozis.seal_top) ||
                                        (!tooth52Diagnozis.seal_right && !tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_top && tooth52Diagnozis.seal_bottom) ||
                                        (tooth52Diagnozis.seal_right && tooth52Diagnozis.seal_left && tooth52Diagnozis.seal_center && !tooth52Diagnozis.seal_top) ||
                                        (!tooth52Diagnozis.seal_center && !tooth52Diagnozis.seal_bottom && tooth52Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g style={{visibility:"inherit"}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth52Diagnozis.vinir_color}`}
                                d="M946.9 466.1C945.6 459.2 943.7 452.5 941.1 446C939.8 442.6 938.3 439.4 936.6 436.3C934.1 431.8 931.2 427.7 927.6 424.2C923.4 420 918.4 416.9 913 415C906.2 412.7 898.9 412.5 892.5 416C885.8 419.6 881.5 426.5 879.2 434C878.4 436.8 877.8 439.6 877.4 442.5C876.6 449 876.8 455.5 876.9 462.1C877.1 472.3 877.2 482.6 880.5 492.3C881.4 495.1 882.6 497.9 884.1 500.5C885.4 503.4 887.2 505.9 889.4 508C891.1 509.6 893.1 510.9 895.2 511.8C898.2 512.2 901.2 512.5 904.3 
                                512.6C905.6 512.6 906.9 512.7 908.2 512.7C915 512.7 921.7 511.9 928.3 510.5C931.1 509.9 933.8 509.2 936.5 508.4C937.9 508 939.3 507.5 940.8 507L945 503.1C945.4 502.6 945.7 502.1 946 501.6C946.3 501.1 946.6 500.5 946.8 500C947.3 498.7 947.6 497.3 947.8 495.9C948 494.5 948.2 493.1 948.3 491.7C949.2 483 948.5 474.4 946.9 466.1Z"
                            />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
