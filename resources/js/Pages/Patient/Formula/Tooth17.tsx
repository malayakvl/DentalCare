                ...
                <g id="T_17_up" className="top-view" 
                    ...
                    <g className="dentin">
                        ...
                        <g className={`hIntact hImplant hEmpty`} style={{visibility: tooth17Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth17Diagnozis?.change_color ? 'diagnoze-opacity' : ''}`}
                            ...
                            />
                            <path className={`st53 change-color ${tooth17Diagnozis?.change_color ? 'diagnoze-opacity' : ''}`}
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth17Diagnozis.culttab && !tooth17Diagnozis.abutment && !tooth17Diagnozis.implant && !tooth17Diagnozis.shaper ) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g
                    ...
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth17Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact"
                              ...
                              390.199C459.4 389.799 459.3 389.499 459.1 389.199C458.9 388.899 458.7 388.499 458.6 388.199C458.4
                               ...
                               style={{visibility: tooth17Diagnozis.pin ? 'inherit' : 'hidden'}}
                            />
                        <path className="st57"
