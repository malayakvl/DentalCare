...
export default function Tooth31() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth31.caries_bottom = !teethDiagnozis.tooth31.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth31.caries_center = !teethDiagnozis.tooth31.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth31.caries_left = !teethDiagnozis.tooth31.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth31.caries_right = !teethDiagnozis.tooth31.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth31.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth31.seal_center_color = sealColor1;
                    teethDiagnozis.tooth31.seal_center = true;
                } else if (teethDiagnozis.tooth31.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth31.seal_center_color = sealColor2;
                    teethDiagnozis.tooth31.seal_center = true;
                } else if (teethDiagnozis.tooth31.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth31.seal_center_color = sealColor3;
                    teethDiagnozis.tooth31.seal_center = true;
                } else {
                    teethDiagnozis.tooth31.seal_center = !teethDiagnozis.tooth31.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth31.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth31.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth31.seal_bottom = true;
                } else if (teethDiagnozis.tooth31.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth31.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth31.seal_bottom = true;
                } else if (teethDiagnozis.tooth31.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth31.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth31.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth31.seal_bottom = !teethDiagnozis.tooth31.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth31.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth31.seal_left_color = sealColor1;
                    teethDiagnozis.tooth31.seal_left = true;
                } else if (teethDiagnozis.tooth31.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth31.seal_left_color = sealColor2;
                    teethDiagnozis.tooth31.seal_left = true;
                } else if (teethDiagnozis.tooth31.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth31.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth31.seal_right_color = sealColor1;
                    teethDiagnozis.tooth31.seal_right = true;
                } else if (teethDiagnozis.tooth31.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth31.seal_right_color = sealColor2;
                    teethDiagnozis.tooth31.seal_right = true;
                } else if (teethDiagnozis.tooth31.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth31.seal_right_color = sealColor3;
                    teethDiagnozis.tooth31.seal_right = true;
                } else {
                    teethDiagnozis.tooth31.seal_right = !teethDiagnozis.tooth31.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth31.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth31.seal_top_color = sealColor1;
                    teethDiagnozis.tooth31.seal_top = true;
                } else if (teethDiagnozis.tooth31.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth31.seal_top_color = sealColor2;
                    teethDiagnozis.tooth31.seal_top = true;
                } else if (teethDiagnozis.tooth31.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth31.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth31.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth31.wedge_shaped_defect_color = !teethDiagnozis.tooth31.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="31" className="df-tooth-text" style={{opacity: 1}}>
                <text transform="matrix(1 0 0 1 1061.5439 842.0025)" className={`st3 st4 st5 ${toothActive.tooth31.active ? 'num-active' : ''}`}>31</text>
            </g>
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth31.active) {
                        dispatch(setNewToothActive({tooth31: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth31.change_color = !teethDiagnozis.tooth31.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth31.fissure = !teethDiagnozis.tooth31.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth31.caries = !teethDiagnozis.tooth31.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth31.cervical_caries = !teethDiagnozis.tooth31.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth31.wedge_shaped_defect = !teethDiagnozis.tooth31.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth31.tartar = !teethDiagnozis.tooth31.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth31.pulpit = !teethDiagnozis.tooth31.pulpit;
                            teethDiagnozis.tooth31.channel_class = teethDiagnozis.tooth31.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth31.channel_not_sealed = !teethDiagnozis.tooth31.channel_not_sealed;
                            teethDiagnozis.tooth31.channel_class = teethDiagnozis.tooth31.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth31.channel_top_sealed = !teethDiagnozis.tooth31.channel_top_sealed;
                            teethDiagnozis.tooth31.channel_class = teethDiagnozis.tooth31.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth31.channel_part_sealed = !teethDiagnozis.tooth31.channel_part_sealed;
                            teethDiagnozis.tooth31.channel_class = teethDiagnozis.tooth31.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth31.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth31.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth31.periodontit = true;
                            } else {
                                teethDiagnozis.tooth31.periodontit = !teethDiagnozis.tooth31.periodontit;
                            }
                            teethDiagnozis.tooth31.channel_class = teethDiagnozis.tooth31.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth31.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth31.seal = !teethDiagnozis.tooth31.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth31.seal_cervical && teethDiagnozis.tooth31.seal_cervical_color === "") {
                                teethDiagnozis.tooth31.seal_cervical = true;
                                teethDiagnozis.tooth31.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth31.seal_cervical && teethDiagnozis.tooth31.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth31.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth31.seal_cervical = false;
                                teethDiagnozis.tooth31.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth31.vinir && teethDiagnozis.tooth31.vinir_color === "") {
                                teethDiagnozis.tooth31.vinir = true;
                                teethDiagnozis.tooth31.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth31.vinir && teethDiagnozis.tooth31.vinir_color != vinirColor) {
                                teethDiagnozis.tooth31.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth31.vinir = false;
                                teethDiagnozis.tooth31.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth31.temporary_crown = !teethDiagnozis.tooth31.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth31.ceramic_crown && teethDiagnozis.tooth31.ceramic_crown_color === "") {
                                teethDiagnozis.tooth31.ceramic_crown = true;
                                teethDiagnozis.tooth31.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth31.ceramic_crown && teethDiagnozis.tooth31.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth31.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth31.ceramic_crown = false;
                                teethDiagnozis.tooth31.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth31.mceramic_crown && teethDiagnozis.tooth31.mceramic_crown_color === "") {
                                teethDiagnozis.tooth31.mceramic_crown = true;
                                teethDiagnozis.tooth31.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth31.mceramic_crown && teethDiagnozis.tooth31.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth31.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth31.mceramic_crown = false;
                                teethDiagnozis.tooth31.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth31.metalic_crown && teethDiagnozis.tooth31.metalic_crown_color === "") {
                                teethDiagnozis.tooth31.metalic_crown = true;
                                teethDiagnozis.tooth31.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth31.metalic_crown && teethDiagnozis.tooth31.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth31.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth31.metalic_crown = false;
                                teethDiagnozis.tooth31.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth31.zirconia_crown && teethDiagnozis.tooth31.zirconia_crown_color === "") {
                                teethDiagnozis.tooth31.zirconia_crown = true;
                                teethDiagnozis.tooth31.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth31.zirconia_crown && teethDiagnozis.tooth31.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth31.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth31.zirconia_crown = false;
                                teethDiagnozis.tooth31.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth31.pin = !teethDiagnozis.tooth31.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth31.culttab = !teethDiagnozis.tooth31.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth31.abutment = !teethDiagnozis.tooth31.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth31.shaper = !teethDiagnozis.tooth31.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth31.implant = !teethDiagnozis.tooth31.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth31.apex = !teethDiagnozis.tooth31.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth31.absent = !teethDiagnozis.tooth31.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth31.cervical_caries = !teethDiagnozis.tooth31.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth31.caries = !teethDiagnozis.tooth31.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth31.parodontit) {
                                if (teethDiagnozis.tooth31.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth31.parodontit = false;
                                    teethDiagnozis.tooth31.active = false;
                                } else {
                                    teethDiagnozis.tooth31.parodontit = true;
                                    teethDiagnozis.tooth31.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth31.parodontit = true;
                                teethDiagnozis.tooth31.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth31.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_31_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g style={{visibility: !tooth31Diagnozis.culttab && !tooth31Diagnozis.implant && !tooth31Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className="st24" d="M1108.4,990.6c-1.4,2.6-4.3,4.2-7.3,5.4c-5.5,2.1-11.7,3-17.8,3c-5.2-0.1-10.3-0.8-15.1-2.5
                        ...
                        <g style={{visibility: tooth31Diagnozis?.apex || tooth31Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                        <path className={`st24 change-color ${tooth31Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth31Diagnozis?.apex ? 'apex' : ''}`}  
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth31Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth31Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth31.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth31Diagnozis.culttab && !tooth31Diagnozis.abutment && !tooth31Diagnozis.implant && !tooth31Diagnozis.shaper && !tooth31Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_31_4" 
                            onClick={() => {
                        ...
                        <g id="s_header_31_3" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_31_2" className="caries-filling" 
                            onClick={() => {
                                alert('center')
                        ...
                        {/*КАРИЕС TOP*/}
                        <g id="s_header_31_1" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth31.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth31.seal_top ? `seal-fill ${teethDiagnozis.tooth31.seal_top_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_center) ||
                                        (tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_center && !tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_right && tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_top && !tooth31Diagnozis.seal_center && tooth31Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_right && tooth31Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_center && tooth31Diagnozis.seal_top) ||
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_bottom && tooth31Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_bottom) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth31Diagnozis.temporary_crown || tooth31Diagnozis.ceramic_crown || tooth31Diagnozis.mceramic_crown || tooth31Diagnozis.metalic_crown || tooth31Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth31Diagnozis.temporary_crown || tooth31Diagnozis.ceramic_crown || tooth31Diagnozis.mceramic_crown || tooth31Diagnozis.metalic_crown || tooth31Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                ...
                <g id="T_31" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g id="dentin_n_31" style={{visibility: !tooth31Diagnozis.implant && !tooth31Diagnozis.abutment && !tooth31Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_31" className={`st10 change-color ${tooth31Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth31Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" d="M1069 1146.9L1078.1 1225.1L1085.9 1292.2L1088.2 1311.9C1088.3 1312.9 1089.2 1313.7 1090.2 1313.7C1091.3 1313.7 1092.3 1312.8 1092.2 1311.6L1091.6 1286.3L1090.1 1225.3L1088.2 1146.9H1069Z"
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth31Diagnozis.abutment || tooth31Diagnozis.implant || tooth31Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="1108" y1="1247.5" x2="1066.6" y2="1255" />
                        <line className="st19" x1="1108" y1="1271.5" x2="1068.6" y2="1278" />
                        <line className="st19" x1="1110" y1="1294.5" x2="1070.6" y2="1301" />
                        <line className="st19" x1="1111" y1="1317.5" x2="1071.6" y2="1324" />
                        <line className="st19" x1="1112" y1="1341.5" x2="1072.6" y2="1348" />
                    </g>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty" style={{visibility: !tooth31Diagnozis.culttab && !tooth31Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth31Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth31.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth31Diagnozis.culttab && !tooth31Diagnozis.abutment && !tooth31Diagnozis.implant && !tooth31Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            `} 
                                ...
                                C1115.9,1147.2,1115.3,1164.4,1113.2,1181.4z"
                                style={{
                                    fill: teethDiagnozis.tooth31.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth31.seal_right ? teethDiagnozis.tooth31.seal_right_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                c-0.4-2.1,0.6-4.2,2.5-5.2c0.8-0.4,1.6-0.6,2.5-0.5l9.4-0.1v44.8C1064.3,1180.9,1066,1195.2,1058.9,1201z"
                                style={{
                                    fill: teethDiagnozis.tooth31.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth31.seal_left ? teethDiagnozis.tooth31.seal_left_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                C1103.8,1195.5,1107.2,1198.4,1109.6,1200.4z"
                                style={{
                                    fill: teethDiagnozis.tooth31.caries_center ? '#606c80' : 
                                    teethDiagnozis.tooth31.seal_center ? teethDiagnozis.tooth31.seal_center_color : 'transparent',
                                }}
                            />
                        </g>
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_top && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_right && tooth31Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_top && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_top && tooth31Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_top) ||
                                        (tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_center && !tooth31Diagnozis.seal_top) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}  
