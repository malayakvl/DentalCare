...
export default function Tooth31() {
    ...
    return (
        <>
            <g id="31" className={`tooth-number-active ${teethType === 'child' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1061.5439 842.0025)" className={`st3 st4 st5 ${toothActive.tooth31.active ? 'num-active' : ''}`}>31</text>
            </g>
            <g id="TH-31" className={`f-tooth-init ${(teethDiagnozis.tooth31.show && !teethDiagnozis.tooth31.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (!teethDiagnozis.tooth31.show) {
                        if (teethType === 'adult') {
                            document.getElementById('TH-31').style.visibility = 'inherit'
                        }
                    } 
                    if (teethDiagnozis.tooth31.show && !teethDiagnozis.tooth31.absent && teethType === 'child') {
                        document.getElementById('TH-31').style.visibility = 'hidden'
                    }
                    (!toothActive && !allTeeth) && document.getElementById('31').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    (!toothActive && !allTeeth) && document.getElementById('31').classList.remove('tooth-number-hover')
                }}
                onClick={() => {
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth31Diagnozis.culttab && !tooth31Diagnozis.abutment && !tooth31Diagnozis.implant && !tooth31Diagnozis.shaper && !tooth31Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="with up">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_right && tooth31Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_right && !tooth31Diagnozis.seal_bottom) ||
                                        (tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_right) 
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_bottom && tooth31Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        ...
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_bottom && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_bottom && tooth31Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        ...
                                        (tooth31Diagnozis.seal_left && !tooth31Diagnozis.seal_top && !tooth31Diagnozis.seal_center) ||
                                        (!tooth31Diagnozis.seal_left && tooth31Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                        ...
                        <g className="with down">
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        ...
                                        (tooth31Diagnozis.seal_center && !tooth31Diagnozis.seal_right)
                                    ) ? 5 : 0
                                }}
