...
export default function Tooth22() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth22.caries_bottom = !teethDiagnozis.tooth22.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth22.caries_center = !teethDiagnozis.tooth22.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth22.caries_left = !teethDiagnozis.tooth22.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth22.caries_right = !teethDiagnozis.tooth22.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth22.caries_top = !teethDiagnozis.tooth22.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth22.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth22.seal_center_color = sealColor1;
                    teethDiagnozis.tooth22.seal_center = true;
                } else if (teethDiagnozis.tooth22.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth22.seal_center_color = sealColor2;
                    teethDiagnozis.tooth22.seal_center = true;
                } else if (teethDiagnozis.tooth22.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth22.seal_center_color = sealColor3;
                    teethDiagnozis.tooth22.seal_center = true;
                } else {
                    teethDiagnozis.tooth22.seal_center = !teethDiagnozis.tooth22.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth22.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth22.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth22.seal_bottom = true;
                } else if (teethDiagnozis.tooth22.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth22.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth22.seal_bottom = true;
                } else if (teethDiagnozis.tooth22.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth22.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth22.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth22.seal_bottom = !teethDiagnozis.tooth22.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth22.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth22.seal_left_color = sealColor1;
                    teethDiagnozis.tooth22.seal_left = true;
                } else if (teethDiagnozis.tooth22.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth22.seal_left_color = sealColor2;
                    teethDiagnozis.tooth22.seal_left = true;
                } else if (teethDiagnozis.tooth22.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth22.seal_left_color = sealColor3;
                    teethDiagnozis.tooth22.seal_left = true;
                } else {
                    teethDiagnozis.tooth22.seal_left = !teethDiagnozis.tooth22.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth22.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth22.seal_right_color = sealColor1;
                    teethDiagnozis.tooth22.seal_right = true;
                } else if (teethDiagnozis.tooth22.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth22.seal_right_color = sealColor2;
                    teethDiagnozis.tooth22.seal_right = true;
                } else if (teethDiagnozis.tooth22.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth22.seal_right_color = sealColor3;
                    teethDiagnozis.tooth22.seal_right = true;
                } else {
                    teethDiagnozis.tooth22.seal_right = !teethDiagnozis.tooth22.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth22.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth22.seal_top_color = sealColor1;
                    teethDiagnozis.tooth22.seal_top = true;
                } else if (teethDiagnozis.tooth22.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth22.seal_top_color = sealColor2;
                    teethDiagnozis.tooth22.seal_top = true;
                } else if (teethDiagnozis.tooth22.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth22.seal_top_color = sealColor3;
                    teethDiagnozis.tooth22.seal_top = true;
                } else {
                    teethDiagnozis.tooth22.seal_top = !teethDiagnozis.tooth22.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth22.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth22.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth22.wedge_shaped_defect_color = !teethDiagnozis.tooth22.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
        ...
        <>
            ...
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    // dispatch(setTooth22Active(!toothActive));
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth22.change_color = !teethDiagnozis.tooth22.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth22.fissure = !teethDiagnozis.tooth22.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth22.caries = !teethDiagnozis.tooth22.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth22.cervical_caries = !teethDiagnozis.tooth22.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth22.wedge_shaped_defect = !teethDiagnozis.tooth22.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth22.tartar = !teethDiagnozis.tooth22.tartar;
                            ...
                            if (teethDiagnozis.tooth22.periodontit_stage !== subDiagnozis) {
                                ...
                                teethDiagnozis.tooth22.periodontit = true;
                            } else {
                                teethDiagnozis.tooth22.periodontit = !teethDiagnozis.tooth22.periodontit;
                            }
                            teethDiagnozis.tooth22.channel_class = teethDiagnozis.tooth22.periodontit ? 'periodontit' : '';
                            ...
                            if (!teethDiagnozis.tooth22.seal_cervical && teethDiagnozis.tooth22.seal_cervical_color === "") {
                                ...
                                teethDiagnozis.tooth22.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth22.seal_cervical && teethDiagnozis.tooth22.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth22.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth22.seal_cervical = false;
                                teethDiagnozis.tooth22.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth22.vinir && teethDiagnozis.tooth22.vinir_color === "") {
                                teethDiagnozis.tooth22.vinir = true;
                                teethDiagnozis.tooth22.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth22.vinir && teethDiagnozis.tooth22.vinir_color != vinirColor) {
                                teethDiagnozis.tooth22.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth22.vinir = false;
                                teethDiagnozis.tooth22.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth22.temporary_crown = !teethDiagnozis.tooth22.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth22.ceramic_crown && teethDiagnozis.tooth22.ceramic_crown_color === "") {
                                teethDiagnozis.tooth22.ceramic_crown = true;
                                teethDiagnozis.tooth22.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth22.ceramic_crown && teethDiagnozis.tooth22.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth22.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth22.ceramic_crown = false;
                                teethDiagnozis.tooth22.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth22.mceramic_crown && teethDiagnozis.tooth22.mceramic_crown_color === "") {
                                teethDiagnozis.tooth22.mceramic_crown = true;
                                teethDiagnozis.tooth22.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth22.mceramic_crown && teethDiagnozis.tooth22.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth22.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth22.mceramic_crown = false;
                                teethDiagnozis.tooth22.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth22.metalic_crown && teethDiagnozis.tooth22.metalic_crown_color === "") {
                                teethDiagnozis.tooth22.metalic_crown = true;
                                teethDiagnozis.tooth22.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth22.metalic_crown && teethDiagnozis.tooth22.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth22.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth22.metalic_crown = false;
                                teethDiagnozis.tooth22.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth22.zirconia_crown && teethDiagnozis.tooth22.zirconia_crown_color === "") {
                                teethDiagnozis.tooth22.zirconia_crown = true;
                                teethDiagnozis.tooth22.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth22.zirconia_crown && teethDiagnozis.tooth22.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth22.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth22.zirconia_crown = false;
                                teethDiagnozis.tooth22.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth22.pin = !teethDiagnozis.tooth22.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth22.culttab = !teethDiagnozis.tooth22.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth22.abutment = !teethDiagnozis.tooth22.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth22.shaper = !teethDiagnozis.tooth22.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth22.implant = !teethDiagnozis.tooth22.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth22.apex = !teethDiagnozis.tooth22.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth22.absent = !teethDiagnozis.tooth22.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth22.cervical_caries = !teethDiagnozis.tooth22.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth22.caries = !teethDiagnozis.tooth22.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth22.parodontit) {
                                if (teethDiagnozis.tooth22.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth22.parodontit = false;
                                    teethDiagnozis.tooth22.active = false;
                                } else {
                                    teethDiagnozis.tooth22.parodontit = true;
                                    teethDiagnozis.tooth22.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth22.parodontit = true;
                                teethDiagnozis.tooth22.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth22.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_22_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g className="hEmpty hRoot hImplant" style={{visibility: !tooth22Diagnozis.culttab && !tooth22Diagnozis.implant && !tooth22Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className="st24" d="M1211.2,597.2c1.9-4.6-2.9-8.6-9-10.1c-5.2-1.3-11.1-1.3-17-1.4
                        ...
                        <g className={`hIntact hImplant hEmpty`} style={{visibility: tooth22Diagnozis?.apex || tooth22Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                        <path className={`st24 change-color ${tooth22Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth22Diagnozis?.apex ? 'apex' : ''}`}  
                                d="M1215.51 594.821C1217.72 588.167 1212.14 582.381 1205.05 580.211C1199.01 578.331 1192.16 578.331 1185.3 578.187C1178.45 578.042 1171.6 577.608 1165.44 578.91C1158.82 580.212 1152.77 584.406 1153.01 591.205C1153.12 594.821 1155.45 597.858 1158 600.317C1160.91 603.065 1164.28 605.38 1166.95 608.562C1170.32 612.757 1172.18 618.108 1175.66 
                                622.158C1177.64 624.473 1179.96 626.208 1182.75 626.787C1186.81 627.655 1190.88 625.775 1194.02 622.882C1197.97 619.121 1200.06 613.624 1202.85 608.996C1204.01 606.971 1205.4 604.946 1207.15 603.355C1210.17 600.606 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth22Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth22Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth22.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth22Diagnozis.culttab && !tooth22Diagnozis.abutment && !tooth22Diagnozis.implant && !tooth22Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_22_4" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth22.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth22.seal_left ? `seal-fill ${teethDiagnozis.tooth22.seal_left_color}` : ''}
                                `} 
                        ...
                        <g id="s_header_22_3" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_22_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth22.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth22.seal_right ? `seal-fill ${teethDiagnozis.tooth22.seal_right_color}` : ''}
                                `} 
                        ...
                        {/*КАРИЕС TOP*/}
                        <g id="s_header_22_1" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth22.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth22.seal_top ? `seal-fill ${teethDiagnozis.tooth22.seal_top_color}` : ''}
                                `} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth22Diagnozis.temporary_crown || tooth22Diagnozis.ceramic_crown || tooth22Diagnozis.mceramic_crown || tooth22Diagnozis.metalic_crown || tooth22Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth22Diagnozis.temporary_crown || tooth22Diagnozis.ceramic_crown || tooth22Diagnozis.mceramic_crown || tooth22Diagnozis.metalic_crown || tooth22Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth22Diagnozis.ceramic_crown_color}
                                ${tooth22Diagnozis.mceramic_crown_color}
                                ${tooth22Diagnozis.metalic_crown_color}
                                ${tooth22Diagnozis.zirconia_crown_color}
                            `} 
                ...
                <g id="T_22" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g id="dentin_v_22" className="hRoot hImplant hEmpty" style={{visibility: !tooth22Diagnozis.implant && !tooth22Diagnozis.apex && !tooth22Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        <g id="dentin_n_22" className="hImplant hEmpty" style={{visibility: !tooth22Diagnozis.implant && !tooth22Diagnozis.apex && !tooth22Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_x5F_n_x5F_22_1_" className={`st10 change-color ${tooth22Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth22Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth22Diagnozis.abutment ? 1 : 0}}>
                        ...
                        />
                        <line className="st19" x1="1174.8" y1="382.1" x2="1218.2" y2="391.9" />
                        <line className="st19" x1="1177" y1="359.1" x2="1220.4" y2="368.9" />
                        <line className="st19" x1="1180" y1="336.1" x2="1223.4" y2="345.9" />
                        <line className="st19" x1="1182.2" y1="313.1" x2="1225.6" y2="322.9" />
                        <line className="st19" x1="1184.3" y1="290.1" x2="1227.7" y2="299.9" />
                    </g>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty" style={{visibility: !tooth22Diagnozis.culttab && !tooth22Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth22Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  
                            d="M1212.07 434.254C1210.34 428.351 1206.88 422.999 1201.6 420.086C1196.64 417.41 1190.82 417.489 1185.55 419.299C1181.3 420.795 1177.36 423.235 1174.05 426.54C1171.22 429.295 1168.94 432.522 1166.97 436.064C1166.79 436.394 1166.61 436.728 1166.44 437.063C1165.74 438.388 1166.77 439.923 1168.27 439.859L1210.68 438.025C1211.9 
                            437.972 1212.8 436.843 1212.48 435.661C1212.36 435.192 1212.22 434.723 1212.07 434.254Z" 
                        />
                        <path className={
                                `st60
                                    ${(tooth22Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth22Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth22Diagnozis.seal_cervical_color}
                                `
                            } 
                            d="M1212.07 434.254C1210.34 428.351 1206.88 422.999 1201.6 420.086C1196.64 417.41 1190.82 417.489 1185.55 419.299C1181.3 420.795 1177.36 423.235 1174.05 426.54C1171.22 429.295 1168.94 432.522 1166.97 436.064C1166.79 436.394 1166.61 436.728 1166.44 437.063C1165.74 438.388 1166.77 
                            439.923 1168.27 439.859L1210.68 438.025C1211.9 437.972 1212.8 436.843 1212.48 435.661C1212.36 435.192 1212.22 434.723 1212.07 434.254Z"
                        />
                    </g>
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth22.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth22Diagnozis.culttab && !tooth22Diagnozis.abutment && !tooth22Diagnozis.implant && !tooth22Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            `} 
                                ...
                                c2.9,5.1,7,12.6,7.7,15.5C1170,455,1164.3,490.4,1161.3,508.2z"  
                                style={{
                                    fill: teethDiagnozis.tooth22.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth22.seal_left ? teethDiagnozis.tooth22.seal_left_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                C1221.3,448.8,1221.1,455.4,1221,462z" 
                                style={{
                                    fill: teethDiagnozis.tooth22.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth22.seal_right ? teethDiagnozis.tooth22.seal_right_color : 'transparent',
