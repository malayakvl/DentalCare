...
export default function Bone16({
  className = '',
    ...
    return (
        <g id="bone_16" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M620.7,373c-5.9-0.3-23.6-22.3-63-26c-66.9-6.5-66.2,10.9-81.4,11.8"
                      style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
