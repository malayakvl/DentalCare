...
export default function Bone31({
  className = '',
    ...
    return (
        <g id="bone_31" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-5.7,0-11.8,17.4-33.7,16.6C1059.5,1262.1,1056,1248.8,1048.9,1246.7z" style={{strokeWidth: 2}} />
                <path className="st43" d="M1115.5,1246.7c-0.5-0.2-0.9-0.3-1.4-0.3c-5.7,0-11.8,17.4-33.7,16.6
                c-20.9-0.8-24.4-14.2-31.5-16.3" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-5.8,0.1-10.7,14.7-32.6,14.4C1060.2,1290.3,1055.3,1278.4,1049,1275.8z" style={{strokeWidth: 2}} />
                <path className="st43" d="M1116.6,1276.6c-0.5-0.2-0.9-0.3-1.4-0.3c-5.8,0.1-10.7,14.7-32.6,14.4
                c-22.4-0.4-27.3-12.4-33.6-14.9" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-23.6-1.1-26.9-13-33.1-15.1" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
