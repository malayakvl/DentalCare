...
export default function PeriodontitStage26() {
    ...
    return ( 
        <>
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth26Diagnozis.periodontit_stage === 'st1'  ? 1 : 0),
                    // opacity: ((tooth26Diagnozis.periodontit && pStage === 'st1' ) ? 1 : 0)
                }}
            >
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth26Diagnozis.periodontit_stage === 'st2'  ? 1 : 0)
            }}
                    // opacity: ((tooth26Diagnozis.periodontit && pStage === 'st2' ) ? 1 : 0)}}
            >
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth26Diagnozis.periodontit_stage === 'st3'  ? 1 : 0),
                    // opacity: ((tooth26Diagnozis.periodontit && pStage === 'st3' ) ? 1 : 0)
                }}
            >
