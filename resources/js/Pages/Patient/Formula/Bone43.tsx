...
export default function Bone43({
  className = '',
    ...
    return (
        <g id="bone_43" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                <path className="st0" d="M914.9,1213.9c-4.1,47.6-8.1,98.8-12.2,146.1c-4.1,47.2-8.1,102.5-12.1,150.2
                        ...
                        c4.6-4.3,10.4-17.1,14.8-21.6C911.9,1215.3,913.2,1214.2,914.9,1213.9z" style={{strokeWidth: 2}}/>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                <path className="st0" d="M912.3,1244.5c-3.2,38.5-6.4,78.2-9.6,115.5c-4.1,47.2-8.1,102.5-12.2,150.2
                            ...
                            c5.3,1.6,13.6,31.5,46.2,31.2C902.7,1271.8,906.4,1245,912.3,1244.5z" style={{strokeWidth: 2}}/>
                <path className="st43"
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                <path className="st0" d="M909.5,1277.9c-2.3,27.7-4.6,55.5-6.8,82.1c-4.1,47.2-8.1,102.5-12.2,150.2
                            ...
                            c7.7,0.3,12.4,26.8,47.9,25.7C900.7,1298.9,903.8,1279.6,909.5,1277.9z" style={{strokeWidth: 2}}/>
                <path className="st43"
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M820.4,1299.7c0.1,0,0.2,0,0.3,0c6.8-0.2,7.9,28.9,43.3,30.2
                            c31.4,1.1,37.9-23.8,43.4-25.4" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
