...
import PeriodontitStage37 from './periodontit37';
...
export default function Tooth37() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth37.caries_bottom = !teethDiagnozis.tooth37.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth37.caries_center = !teethDiagnozis.tooth37.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth37.caries_left = !teethDiagnozis.tooth37.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth37.caries_right = !teethDiagnozis.tooth37.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth37.caries_top = !teethDiagnozis.tooth37.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth37.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth37.seal_center_color = sealColor1;
                    teethDiagnozis.tooth37.seal_center = true;
                } else if (teethDiagnozis.tooth37.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth37.seal_center_color = sealColor2;
                    teethDiagnozis.tooth37.seal_center = true;
                } else if (teethDiagnozis.tooth37.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth37.seal_center_color = sealColor3;
                    teethDiagnozis.tooth37.seal_center = true;
                } else {
                    teethDiagnozis.tooth37.seal_center = !teethDiagnozis.tooth37.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth37.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth37.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth37.seal_bottom = true;
                } else if (teethDiagnozis.tooth37.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth37.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth37.seal_bottom = true;
                } else if (teethDiagnozis.tooth37.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth37.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth37.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth37.seal_bottom = !teethDiagnozis.tooth37.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth37.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth37.seal_left_color = sealColor1;
                    teethDiagnozis.tooth37.seal_left = true;
                } else if (teethDiagnozis.tooth37.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth37.seal_left_color = sealColor2;
                    teethDiagnozis.tooth37.seal_left = true;
                } else if (teethDiagnozis.tooth37.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth37.seal_left_color = sealColor3;
                    teethDiagnozis.tooth37.seal_left = true;
                } else {
                    teethDiagnozis.tooth37.seal_left = !teethDiagnozis.tooth37.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth37.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth37.seal_right_color = sealColor1;
                    teethDiagnozis.tooth37.seal_right = true;
                } else if (teethDiagnozis.tooth37.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth37.seal_right_color = sealColor2;
                    teethDiagnozis.tooth37.seal_right = true;
                } else if (teethDiagnozis.tooth37.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth37.seal_right_color = sealColor3;
                    teethDiagnozis.tooth37.seal_right = true;
                } else {
                    teethDiagnozis.tooth37.seal_right = !teethDiagnozis.tooth37.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth37.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth37.seal_top_color = sealColor1;
                    teethDiagnozis.tooth37.seal_top = true;
                } else if (teethDiagnozis.tooth37.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth37.seal_top_color = sealColor2;
                    teethDiagnozis.tooth37.seal_top = true;
                } else if (teethDiagnozis.tooth37.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth37.seal_top_color = sealColor3;
                    teethDiagnozis.tooth37.seal_top = true;
                } else {
                    teethDiagnozis.tooth37.seal_top = !teethDiagnozis.tooth37.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth37.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth37.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth37.wedge_shaped_defect_color = !teethDiagnozis.tooth37.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }  
    ...
    return (
        <>
            <g id="37" className={`tooth-number-active ${teethType === 'child' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1668.877 842.0025)" className={`st3 st4 st5 ${toothActive.tooth37.active ? 'num-active' : ''}`}>37</text>
            </g>
            <g id="TH-37" className={`f-tooth-init ${(teethDiagnozis.tooth37.show && !teethDiagnozis.tooth37.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (!teethDiagnozis.tooth37.show) {
                        if (teethType === 'adult') {
                            document.getElementById('TH-37').style.visibility = 'inherit'
                        }
                    } 
                    if (teethDiagnozis.tooth37.show && !teethDiagnozis.tooth37.absent && teethType === 'child') {
                        document.getElementById('TH-37').style.visibility = 'hidden'
                    }
                    (!toothActive && !allTeeth) && document.getElementById('37').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    (!toothActive && !allTeeth) && document.getElementById('37').classList.remove('tooth-number-hover')
                }}
                onClick={() => {
                    dispatch(setSelectedToothNumber(37));
                    if (toothActive.tooth37.active) {
                        dispatch(setNewToothActive({tooth37: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth37.change_color = !teethDiagnozis.tooth37.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth37.fissure = !teethDiagnozis.tooth37.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth37.caries = !teethDiagnozis.tooth37.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth37.cervical_caries = !teethDiagnozis.tooth37.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth37.wedge_shaped_defect = !teethDiagnozis.tooth37.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth37.tartar = !teethDiagnozis.tooth37.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth37.pulpit = !teethDiagnozis.tooth37.pulpit;
                            teethDiagnozis.tooth37.channel_class = teethDiagnozis.tooth37.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth37.channel_not_sealed = !teethDiagnozis.tooth37.channel_not_sealed;
                            teethDiagnozis.tooth37.channel_class = teethDiagnozis.tooth37.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth37.channel_top_sealed = !teethDiagnozis.tooth37.channel_top_sealed;
                            teethDiagnozis.tooth37.channel_class = teethDiagnozis.tooth37.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth37.channel_part_sealed = !teethDiagnozis.tooth37.channel_part_sealed;
                            teethDiagnozis.tooth37.channel_class = teethDiagnozis.tooth37.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth37.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth37.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth37.periodontit = true;
                            } else {
                                teethDiagnozis.tooth37.periodontit = !teethDiagnozis.tooth37.periodontit;
                            }
                            teethDiagnozis.tooth37.channel_class = teethDiagnozis.tooth37.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth37.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth37.seal = !teethDiagnozis.tooth37.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth37.seal_cervical && teethDiagnozis.tooth37.seal_cervical_color === "") {
                                teethDiagnozis.tooth37.seal_cervical = true;
                                teethDiagnozis.tooth37.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth37.seal_cervical && teethDiagnozis.tooth37.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth37.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth37.seal_cervical = false;
                                teethDiagnozis.tooth37.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth37.vinir && teethDiagnozis.tooth37.vinir_color === "") {
                                teethDiagnozis.tooth37.vinir = true;
                                teethDiagnozis.tooth37.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth37.vinir && teethDiagnozis.tooth37.vinir_color != vinirColor) {
                                teethDiagnozis.tooth37.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth37.vinir = false;
                                teethDiagnozis.tooth37.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth37.temporary_crown = !teethDiagnozis.tooth37.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth37.ceramic_crown && teethDiagnozis.tooth37.ceramic_crown_color === "") {
                                teethDiagnozis.tooth37.ceramic_crown = true;
                                teethDiagnozis.tooth37.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth37.ceramic_crown && teethDiagnozis.tooth37.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth37.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth37.ceramic_crown = false;
                                teethDiagnozis.tooth37.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth37.mceramic_crown && teethDiagnozis.tooth37.mceramic_crown_color === "") {
                                teethDiagnozis.tooth37.mceramic_crown = true;
                                teethDiagnozis.tooth37.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth37.mceramic_crown && teethDiagnozis.tooth37.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth37.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth37.mceramic_crown = false;
                                teethDiagnozis.tooth37.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth37.metalic_crown && teethDiagnozis.tooth37.metalic_crown_color === "") {
                                teethDiagnozis.tooth37.metalic_crown = true;
                                teethDiagnozis.tooth37.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth37.metalic_crown && teethDiagnozis.tooth37.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth37.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth37.metalic_crown = false;
                                teethDiagnozis.tooth37.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth37.zirconia_crown && teethDiagnozis.tooth37.zirconia_crown_color === "") {
                                teethDiagnozis.tooth37.zirconia_crown = true;
                                teethDiagnozis.tooth37.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth37.zirconia_crown && teethDiagnozis.tooth37.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth37.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth37.zirconia_crown = false;
                                teethDiagnozis.tooth37.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth37.pin = !teethDiagnozis.tooth37.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth37.culttab = !teethDiagnozis.tooth37.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth37.abutment = !teethDiagnozis.tooth37.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth37.shaper = !teethDiagnozis.tooth37.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth37.implant = !teethDiagnozis.tooth37.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth37.apex = !teethDiagnozis.tooth37.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth37.absent = !teethDiagnozis.tooth37.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth37.cervical_caries = !teethDiagnozis.tooth37.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth37.caries = !teethDiagnozis.tooth37.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth37.parodontit) {
                                if (teethDiagnozis.tooth37.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth37.parodontit = false;
                                    teethDiagnozis.tooth37.active = false;
                                } else {
                                    teethDiagnozis.tooth37.parodontit = true;
                                    teethDiagnozis.tooth37.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth37.parodontit = true;
                                teethDiagnozis.tooth37.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth37.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_37_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g style={{visibility: !tooth37Diagnozis.culttab && !tooth37Diagnozis.implant && !tooth37Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className="st6" 
                        ...
                        <g style={{visibility: !tooth37Diagnozis.culttab && !tooth37Diagnozis.implant && !tooth37Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth37Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth37Diagnozis?.apex ? 'apex' : ''}`}  
                                d="M1762.3 962.7C1762.9 966.7 1763.8 970.7 1764 974.8C1764.4 982.4 1762.5 990.1 1758.5 997.1C1755.6 1002.1 1751.7 1006.9 1746.2 1010.4C1742.3 1012.9 1737.9 1014.6 1733.3 1016.3C1726.8 1018.6 1720.1 1020.7 1713 1021.7C1705.8 1022.7 1698.5 1022.4 1691.3 1022.1C1684.9 1021.8 1678.5 1021.5 1672.2 1020.6C1667.5 1019.9 1662.8 1018.8 1658.5 1017.2C1654.5 1015.7 1650.9 1013.8 1647.4 1011.8C1642.4 
                                1008.8 1637.9 1005.4 1634.6 1001.2C1631.1 996.9 1629.2 991.9 1627.8 986.9C1625.3 978.5 1623.9 969.8 1624.9 961.1C1625.6 955 1627.4 948.9 1630.9 943.3C1634.7 937.3 1640.3 932.1 1647.7 928.5C1655.3 924.8 1664.3 923.1 1673.3 922.5C1677.9 922.2 1682.6 922.1 1687 923C1690.4 923.7 1693.5 925 1697.1 925.1C1699.7 925.1 1702.2 924.4 1704.7 923.8C1709.6 
                                922.6 1714.7 921.9 1719.8 921.6C1724.8 921.3 1729.9 921.2 1734.8 921.9C1740.5 922.7 1745.9 924.5 1750.4 927.3C1753.9 929.6 1756.6 932.3 1758.2 935.6C1759.7 938.6 1760.1 941.9 1760.5 945.1C1761 950.8 1761.3 956.7 1762.3 962.7Z"
                            />
                            <path className={`st24 change-color ${tooth37Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth37Diagnozis?.apex ? 'apex' : ''}`}  
                    ...
                    {/* PULPIT */}
                    <g className="pulp">
                        <g className="pulpitis-pfilling" style={{visibility: tooth37Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                            <ellipse className="st22 target" rx="10.9723" ry="7.35396" transform="matrix(0.0172822 -0.999851 -0.999851 -0.0172822 1718.55 969.098)" style={{fill: 'rgb(254, 246, 249)'}}></ellipse>
                            <ellipse className="st22 target" rx="8.41967" ry="7.78385" transform="matrix(0.643274 -0.765636 -0.765636 -0.643274 1674.72 960.454)" style={{fill: 'rgb(254, 246, 249)'}}></ellipse>
                            <ellipse className="st22 target" rx="8.72166" ry="7.94529" transform="matrix(-0.99786 -0.0653869 -0.0653869 0.99786 1674.87 980.499)" style={{fill: 'rgb(254, 246, 249)'}}></ellipse>
                        </g>
                    </g>
                    {/* IMPLANT */}
                    <g className="implant" style={{visibility: tooth37Diagnozis.implant || tooth37Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="1695.5" cy="970.5" r="26.5"></circle>
                        <g className="st27">
                            <mask id="implant_37" className="st49">
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth37Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth37Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility : 'inherit', opacity: teethDiagnozis.tooth37.tartar ? 1 : 0}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth37Diagnozis.culttab && !tooth37Diagnozis.abutment && !tooth37Diagnozis.implant && !tooth37Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth37.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth37.seal_center ? `seal-fill ${teethDiagnozis.tooth37.seal_center_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth37.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth37.seal_right ? `seal-fill ${teethDiagnozis.tooth37.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth37.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth37.seal_bottom ? `seal-fill ${teethDiagnozis.tooth37.seal_bottom_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth37.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth37.seal_left ? `seal-fill ${teethDiagnozis.tooth37.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth37.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth37.seal_top ? `seal-fill ${teethDiagnozis.tooth37.seal_top_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_right && !tooth37Diagnozis.seal_top) ||
                                        (!tooth37Diagnozis.seal_right && tooth37Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_right && !tooth37Diagnozis.seal_center) ||
                                        (!tooth37Diagnozis.seal_right && tooth37Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_right && !tooth37Diagnozis.seal_bottom) ||
                                        (!tooth37Diagnozis.seal_right && tooth37Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_center && !tooth37Diagnozis.seal_bottom) ||
                                        (!tooth37Diagnozis.seal_center && tooth37Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_left && !tooth37Diagnozis.seal_bottom) ||
                                        (!tooth37Diagnozis.seal_left && tooth37Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth37Diagnozis.seal_left && tooth37Diagnozis.seal_center) ||
                                        (tooth37Diagnozis.seal_left && !tooth37Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_left && !tooth37Diagnozis.seal_top) ||
                                        (!tooth37Diagnozis.seal_left && tooth37Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}  
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth37Diagnozis.vinir_color}`}
                                d="M1620.9 990.7C1622.6 997.8 1624.7 1004.9 1628.6 1011.1C1631.5 1015.8 1635.3 1019.9 1639.5 1023.6L1642.8 1026.3C1646.6 1029.3 1650.6 1032 1655 1034.2C1659.8 1036.5 1664.8 1038.1 1670 1039.2C1676.9 1040.6 1683.9 1041.1 1690.9 1041.5C1698.8 1042 1706.8 1042.5 1714.7 
                                1041.2C1722.4 1039.9 1729.7 1037 1736.8 1033.8C1741.7 1031.5 1746.6 1029 1750.8 1025.6C1755.7 1021.5 1759.5 1016.3 1762.4 1010.6C1763 1009.4 1763.6 1008.1 1764.19 1006.81L1764.2 1006.8C1768.4 996.7 1770.4 985.9 1769.8 975C1769.66 972.319 1769.37 
                                969.658 1769.03 967C1766.24 967.5 1760.49 969.4 1759.83 973C1759.86 973.439 1759.88 973.879 1759.91 974.319C1760.43 983.862 1758.69 993.317 1755.03 1002.16L1755.03 1002.16C1754.51 1003.3 1753.99 1004.44 1753.46 1005.49C1750.94 1010.48 1747.63 1015.03 1743.37 1018.62C1739.71 1021.6 1735.44 1023.78 1731.18 1025.8C1725 1028.6 
                                1718.64 1031.14 1711.94 1032.28C1705.06 1033.41 1698.09 1032.98 1691.22 1032.54C1685.12 1032.19 1679.03 1031.75 1673.02 1030.52C1668.49 1029.56 1664.14 1028.16 1659.96 1026.15C1656.13 1024.22 1652.65 1021.86 1649.34 1019.23L1646.47 1016.87C1642.81 1013.63 1639.5 1010.04 1636.98 1005.92C1633.58 1000.5 1631.75 994.28 1630.27 988.064C1629.87 986.385 1629.5 984.696 1629.16 983C1628.37 979.4 1621.72 978.5 1618.49 978.5C1619.11 982.602 
                                1619.92 986.673 1620.9 990.7Z"
                            />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
                    <g className="crown" style={{
                        visibility: (tooth37Diagnozis.temporary_crown || tooth37Diagnozis.ceramic_crown || tooth37Diagnozis.mceramic_crown || tooth37Diagnozis.metalic_crown || tooth37Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth37Diagnozis.temporary_crown || tooth37Diagnozis.ceramic_crown || tooth37Diagnozis.mceramic_crown || tooth37Diagnozis.metalic_crown || tooth37Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth37Diagnozis.ceramic_crown_color}
                                ${tooth37Diagnozis.mceramic_crown_color}
                                ${tooth37Diagnozis.metalic_crown_color}
                                ${tooth37Diagnozis.zirconia_crown_color}
                            `} 
                            ...
                            C1768.4,996.7,1770.4,985.9,1769.8,975z"
                        />
                        <path className={`st3 fissure ${tooth37Diagnozis.fissure ? 'diagnoze' : tooth37Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    {/*FISSURES*/}
                    <g className="fissures" style={{visibility: (!tooth37Diagnozis.culttab && !tooth37Diagnozis.abutment && !tooth37Diagnozis.implant && !tooth37Diagnozis.apex && !tooth37Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth37Diagnozis.fissure ? 'diagnoze' : ''}`}  
                            d="M1742.7,946.3c-1.5,2.6-2.9,5.3-4.1,8.1l-0.2,0.4c-1,2.3-2,4.7-4.1,5.9
                            c-2.4,1.3-4.9,0.8-7.7,0.2c-0.5-0.1-1.1-0.2-1.6-0.3c-5.9-1.1-12.3-0.1-17.7,1c-5,1-10,2.4-14.8,4.2c-0.2-1.9-0.1-3.8,0-5.5
                            c0.1-0.9,0.2-1.9,0.3-2.8c0.3-2.2,0.5-4.4,0.5-6.6c0-2.7-0.5-5.5-0.9-8.1c-0.5-3.2-1.1-6.5-0.8-9.8c0.4-5,2.5-9.8,6.1-13.4
                            l-0.8-0.8c-3.7,3.8-6,8.8-6.4,14c-0.3,3.4,0.3,6.8,0.8,10c0.4,2.6,0.9,5.3,0.9,8c0,2.2-0.3,4.4-0.5,6.5c-0.1,0.9-0.2,1.9-0.3,2.8
                ...
                <g id="T_37" className="common-view" style={{visibility: tooth37Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    <g className="dentin">
                        <g id="dentin_v_37" style={{visibility: !tooth37Diagnozis.implant && !tooth37Diagnozis.apex && !tooth37Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`} 
                        ...
                        <g id="dentin_n_37" style={{visibility: !tooth37Diagnozis.culttab && !tooth37Diagnozis.abutment && !tooth37Diagnozis.implant && !tooth37Diagnozis.shaper && !tooth37Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_37" className={`st10 change-color ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`}
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth37Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact" d="M1775.1 1133C1775.1 1133.6 1775 1134.2 1775 1134.9C1766.3 1143.9 1756.3 1153 1745.7 1160.3C1743.6 1161.8 1741.4 1163.2 1739.3 1164.5C1738.9 1164.7 1738.6 1164.9 1738.2 1165.2C1736.1 1166.4 1734 1167.7 1731.8 1168.8C1719.2 1175.6 1705.7 1180.6 1691.5 1182.5C1690.2 1182.7 1688.9 1182.8 1687.6 1183C1672.4 1184.5 1657 1182.4 1642.7 1176.7C1642.6 1176.6 1642.5 1176.5 1642.4 1176.3C1640.5 1168.2 1637.7 1146.8 1637.4 1138.6C1637 1127.1 1638.3 1115.7 1641.1 
                            1104.5L1702 1111.1L1739.2 1087.8C1744.9 1093.8 1750.5 1099.8 1756.1 1105.9C1762.4 1112.8 1771.7 1121.7 1775.1 1133Z"
                        />
                        <path className="st57" d="M1684.4 1109.3L1765.3 1211.1L1766.5 1212.6L1780.4 1230.1C1781.1 1231 1782.4 1231.2 1783.3 1230.6C1784.3 1230 1784.6 1228.7 1784 1227.7L1771.4 1205.5L1745.6 1160.4L1713.4 
                            1104.1L1702 1111.2L1684.4 1109.3Z"
                            style={{fill: tooth37Diagnozis.pin ? '#dbd9d3' : 'none'}}
                        />
                    </g>
                    {/* CULT TAB */}
                    <g className="stump" style={{visibility: tooth37Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth37Diagnozis.culttab ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth37Diagnozis.abutment || tooth37Diagnozis.implant || tooth37Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="1753.5" y1="1183.9" x2="1698.7" y2="1215.8" />
                        <line className="st19" x1="1759.5" y1="1201.9" x2="1704.7" y2="1233.8" />
                        <line className="st19" x1="1766.5" y1="1217.9" x2="1713.7" y2="1249.8" />
                        <line className="st19" x1="1772.5" y1="1235.9" x2="1719.7" y2="1267.8" />
                        <line className="st19" x1="1778.5" y1="1252.9" x2="1725.7" y2="1284.8" />
                    </g>
                    ...
                    <g className="wedge-shaped " style={{visibility: !tooth37Diagnozis.culttab && !tooth37Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        <path className="st7 st59" d="M1774.22 1123.92C1774.5 1125.62 1774.75 1127.13 1774.9 1128.6C1775.1 1130.6 1775.2 1132.6 1774.8 1135C1764.1 1146.1 1751.2 1157.4 1738 1165.3C1722.5 1174.5 1705.5 1181.3 1687.5 1183.1C1672.2 1184.6 1656.6 1182.4 1642.3 1176.7C1638.7 1173.3 1635.4 1169.5 1632.5 1165.5C1629.1 1160.8 1626.2 1155.6 1623.9 1150.2C1620.9 1143 1619 1135.4 1617.4 1127.7C1617.3 1127.3 1617.23 1126.9 1617.15 1126.5C1617.08 1126.1 1617 1125.7 1616.9 1125.3C1617.1 1113.3 1621.2 1101.7 1628.5 1092.3C1632.1 1087.6 1636.4 1083.6 1641.3 1080.4C1641.3 1080.34 1641.34 1080.31 1641.39 1080.28C1641.42 1080.26 1641.46 1080.24 1641.5 1080.2L1650.2 1079C1652.27 1080.4 1654.25 
                            ...
                            1065.2L1719.5 1062.8C1723.5 1063.6 1727.4 1064.7 1731.3 1066C1734 1066.9 1736.7 1067.9 1739.3 1069.1C1744.7 1071.4 1749.8 1074.3 1754.7 1077.6C1758.2 1082.8 1761.4 1088.2 1764.3 1093.8C1768.9 1102.7 1772.5 1112.1 1773.9 1122C1774.01 1122.67 1774.12 1123.31 1774.22 1123.92ZM1732.31 1162.2C1719 1170.1 1704.4 1175.94 1688.95 1177.48C1671.4 1179.2 1652.49 1177.22 1641.72 1162.37C1640.07 1160.09 1638.56 1157.67 1637.2 1155.16C1636.57 1154 1637.29 1152.59 1638.58 1152.33C1686.47 1142.78 1713.93 1136.1 1760.51 1122.61C1761.64 1122.29 1762.83 1123 1762.93 
                            1124.17C1764.56 1143.38 1738.11 1158.81 1732.85 1161.88C1732.63 1162.01 1732.45 1162.11 1732.31 1162.2Z"
                        />
                        <path className={`st7 ${tooth37Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  d="M1688.95 1177.48C1704.4 1175.94 1719 1170.1 1732.31 1162.2C1735.87 1160.08 1764.62 1144.18 1762.93 1124.17C1762.83 1123 1761.64 1122.29 1760.51 1122.61C1713.93 1136.1 1686.47 1142.78 1638.58 1152.33C1637.29 1152.59 1636.57 1154 1637.2 1155.16C1638.56 1157.67 1640.07 1160.09 1641.72 1162.37C1652.49 1177.22 1671.4 
                            1179.2 1688.95 1177.48Z" />
                        <path className={
                                `st60
                                    ${(tooth37Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth37Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth37Diagnozis.seal_cervical_color}
                                `
                            } 
                            d="M1688.95 1177.48C1704.4 1175.94 1719 1170.1 1732.31 1162.2C1735.87 1160.08 1764.62 1144.18 1762.93 1124.17C1762.83 1123 1761.64 1122.29 1760.51 1122.61C1713.93 1136.1 1686.47 1142.78 1638.58 1152.33C1637.29 1152.59 1636.57 1154 1637.2 1155.16C1638.56 1157.67 1640.07 1160.09 1641.72 1162.37C1652.49 
                            1177.22 1671.4 1179.2 1688.95 1177.48Z"
                        />
                    </g>
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth37.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling" style={{visibility: 'inherit'}}>
                        ...
                        >
                            ...
                            <path className={
                                ...
                                ${tooth37Diagnozis.caries_top ? 'caries-fill' : ''}
                                ${tooth37Diagnozis.seal_top ? `seal-fill ${teethDiagnozis.tooth37.seal_top_color}` : ''}
                            `} 
                        ...
                        <g className="with with-b">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_right && !tooth37Diagnozis.seal_top && !tooth37Diagnozis.seal_center) ||
                                        (tooth37Diagnozis.seal_right && tooth37Diagnozis.seal_top && !tooth37Diagnozis.seal_center) ||
                                        (!tooth37Diagnozis.seal_right && tooth37Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth37Diagnozis.seal_left && !tooth37Diagnozis.seal_top) ||
                                        (!tooth37Diagnozis.seal_left && tooth37Diagnozis.seal_top && !tooth37Diagnozis.seal_center) ||
                                        (!tooth37Diagnozis.seal_left && tooth37Diagnozis.seal_top && tooth37Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
