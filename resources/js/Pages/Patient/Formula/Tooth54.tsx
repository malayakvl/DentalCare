...
export default function Tooth54() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth54.caries_bottom = !teethDiagnozis.tooth54.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth54.caries_center = !teethDiagnozis.tooth54.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth54.caries_left = !teethDiagnozis.tooth54.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth54.caries_right = !teethDiagnozis.tooth54.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth54.caries_top = !teethDiagnozis.tooth54.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth54.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth54.seal_center_color = sealColor1;
                    teethDiagnozis.tooth54.seal_center = true;
                } else if (teethDiagnozis.tooth54.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth54.seal_center_color = sealColor2;
                    teethDiagnozis.tooth54.seal_center = true;
                } else if (teethDiagnozis.tooth54.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth54.seal_center_color = sealColor3;
                    teethDiagnozis.tooth54.seal_center = true;
                } else {
                    teethDiagnozis.tooth54.seal_center = !teethDiagnozis.tooth54.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth54.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth54.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth54.seal_bottom = true;
                } else if (teethDiagnozis.tooth54.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth54.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth54.seal_bottom = true;
                } else if (teethDiagnozis.tooth54.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth54.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth54.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth54.seal_bottom = !teethDiagnozis.tooth54.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth54.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth54.seal_left_color = sealColor1;
                    teethDiagnozis.tooth54.seal_left = true;
                } else if (teethDiagnozis.tooth54.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth54.seal_left_color = sealColor2;
                    teethDiagnozis.tooth54.seal_left = true;
                } else if (teethDiagnozis.tooth54.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth54.seal_left_color = sealColor3;
                    teethDiagnozis.tooth54.seal_left = true;
                } else {
                    teethDiagnozis.tooth54.seal_left = !teethDiagnozis.tooth54.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth54.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth54.seal_right_color = sealColor1;
                    teethDiagnozis.tooth54.seal_right = true;
                } else if (teethDiagnozis.tooth54.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth54.seal_right_color = sealColor2;
                    teethDiagnozis.tooth54.seal_right = true;
                } else if (teethDiagnozis.tooth54.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth54.seal_right_color = sealColor3;
                    teethDiagnozis.tooth54.seal_right = true;
                } else {
                    teethDiagnozis.tooth54.seal_right = !teethDiagnozis.tooth54.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth54.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth54.seal_top_color = sealColor1;
                    teethDiagnozis.tooth54.seal_top = true;
                } else if (teethDiagnozis.tooth54.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth54.seal_top_color = sealColor2;
                    teethDiagnozis.tooth54.seal_top = true;
                } else if (teethDiagnozis.tooth54.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth54.seal_top_color = sealColor3;
                    teethDiagnozis.tooth54.seal_top = true;
                } else {
                    teethDiagnozis.tooth54.seal_top = !teethDiagnozis.tooth54.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth54.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth54.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth54.wedge_shaped_defect_color = !teethDiagnozis.tooth54.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth54.show && !teethDiagnozis.tooth14.show) {
                document.getElementById('TH-54').classList.add('f-tooth-active');
                document.getElementById('TH-54').style.opacity = "1"
            }
            if (teethType === 'child' && !teethDiagnozis.tooth54.show && teethDiagnozis.tooth14.show) {
                document.getElementById('TH-54').classList.add('f-tooth-active');
        ...
        if (type === 'leave') {
            if (teethType === 'child' && !teethDiagnozis.tooth54.show && !teethDiagnozis.tooth14.show) {
                document.getElementById('TH-54').classList.remove('f-tooth-active');
                document.getElementById('TH-54').style.opacity = "0";
            }
            if (teethType === 'child' && !teethDiagnozis.tooth54.show && teethDiagnozis.tooth14.show) {
                document.getElementById('TH-54').classList.remove('f-tooth-active');
                document.getElementById('TH-14').classList.add('f-tooth-active');
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && teethDiagnozis.tooth14.show) {
                document.getElementById('TH-54').classList.add('f-tooth-active');
                document.getElementById('TH-14').classList.remove('f-tooth-active');
            }
            if (teethType === 'adult' && teethDiagnozis.tooth54.show) {
                document.getElementById('TH-54').classList.remove('f-tooth-active');
                document.getElementById('TH-14').classList.add('f-tooth-active');
            }
        }
    ...
    return (
        <>
            <g id="54" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 720 716)" className={`st3 st4 st5 ${selectedTooth === 54 ? 'num-active' : ''}`}>54</text>
            </g>
            <g id="TH-54" className={`f-tooth-init-milk ${((teethDiagnozis.tooth54.show || allTeeth) && !teethDiagnozis.tooth54.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
                    teethDiagnozis.tooth54.show = !teethDiagnozis.tooth54.show;
                    teethDiagnozis.tooth14.show = false;

                    dispatch(setSelectedToothNumber(54));
            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 244, 33)'}}
                    onMouseOver={() => {
                        showHideOverlay('over');
                    }}
                    onMouseLeave={() => {
                ...
                >
                    ...
                    <g className="shaper hEmpty hIntact hRoot" style={{visibility: 'hidden', opacity: 0}} >
                        ...
                        <path className="st45"
                              d="M529.577 589.739C530.129 587.804 532.871 587.804 533.423 589.739L533.929 591.511C534.225 592.549 535.291 593.164 536.338 592.902L538.126 592.454C540.077 591.965 541.448 594.339 540.049 595.785L538.767 597.109C538.016 597.884 538.016 599.116 538.767 599.891L540.049 601.215C541.448 602.661 540.077 605.035 538.126 604.546L536.338 604.098C535.291 603.836 534.225 604.451 533.929 605.489L533.423 607.261C532.871 609.196 530.129 609.196 529.577 607.261L529.071 605.489C528.775 604.451 527.709 603.836 526.662 604.098L524.874 604.546C522.923 605.035 521.552 602.661 522.951 601.215L524.233 599.891C524.984 599.116 524.984 597.884 524.233 597.109L522.951 595.785C521.552 594.339 522.923 591.965 524.874 592.454L526.662 592.902C527.709 593.164 528.775 592.549 529.071 591.511L529.577 589.739Z"></path>
                    </g>
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth54Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth54Diagnozis.abutment ? 1 : 0}}>
                        <path className="st47"
                              d="M462 607.2C463.5 603.7 465.3 600.3 466.8 596.9C470.7 588 473 578 478.5 569.5C483.8 561.2 491.7 554.7 503.4 552.4C512.9 550.5 522.9 552.5 532.8 552.1C537.9 551.9 543.2 551.1 548.2 550.5C565.5 548.2 583.3 548.7 592.7 560C595.4 563.2 596.7 566.9 597.5 570.6C599.1 577.8 598.9 585 597.9 592.2C596.5 602.6 593.7 613.1 588.7 622.8C584.8 630.2 579.6 637.2 571 641.7C563.7 645.5 554.8 646.7 546.1 645.9C541.2 645.4 536.4 644.2 531.4 644.3C522.8 644.4 515.1 648.2 506.7 649.5C501.4 650.4 495.9 650.3 490.6 649.5C485 648.7 479.6 647.3 474.7 645C469.3 642.4 464.8 638.7 462.1 634.2C457 625.8 458.3 616.1 462 607.2Z"></path>
                        <path className="st47"
                              d="M479.403 605.458C480.507 602.887 481.832 600.39 482.936 597.892C485.807 591.354 487.499 584.009 491.548 577.765C495.449 571.668 501.263 566.893 509.875 565.203C516.867 563.808 524.227 565.277 531.514 564.983C535.267 564.836 539.168 564.248 542.848 563.808C555.581 562.118 568.683 562.485 575.601 570.786C577.588 573.137 578.545 575.855 579.134 578.573C580.312 583.862 580.165 589.151 579.429 594.44C578.398 602.079 576.337 609.792 572.657 616.918C569.787 622.354 565.959 627.496 559.63 630.802C554.257 633.593 547.706 634.474 541.303 633.887C537.696 633.52 534.163 632.638 530.483 632.711C524.153 632.785 518.486 635.576 512.303 636.531C508.402 637.192 504.354 637.119 500.453 636.531C496.332 635.944 492.357 634.915 488.751 633.226C484.776 631.316 481.464 628.598 479.477 625.292C475.723 619.122 476.68 611.996 479.403 605.458Z"></path>
                        <circle className="st45" cx="531" cy="598" r="13"></circle>
                    </g>
                    {/* PIN */}
                    <g className="abutment" style={{visibility: 'inherit', opacity: tooth54Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact"
                              d="M462 607.201C463.5 603.701 465.3 600.301 466.8 596.901C470.7 588.001 473 578.001 478.5 569.501C483.8 561.201 491.7 554.701 503.4 552.401C512.9 550.501 522.9 552.501 532.8 552.101C537.9 551.901 543.2 551.101 548.2 550.501C565.5 548.201 583.3 548.701 592.7 560.001C595.4 563.201 596.7 566.901 597.5 570.601C599.1 577.801 598.9 585.001 597.9 592.201C596.5 602.601 593.7 613.101 588.7 622.801C584.8 630.201 579.6 637.201 571 641.701C563.7 645.501 554.8 646.701 546.1 645.901C541.2 645.401 536.4 644.201 531.4 644.301C522.8 644.401 515.1 648.201 506.7 649.501C501.4 650.401 495.9 650.301 490.6 649.501C485 648.701 479.6 647.301 474.7 645.001C469.3 642.401 464.8 638.701 462.1 634.201C457 625.801 458.3 616.101 462 607.201Z"
                              style={{visibility: 'hidden'}}></path>
                        <path className="st56 hIntact"
                              d="M479.403 605.459C480.507 602.888 481.832 600.391 482.936 597.893C485.807 591.355 487.499 584.01 491.548 577.766C495.449 571.669 501.263 566.894 509.875 565.204C516.867 563.809 524.227 565.278 531.514 564.984C535.267 564.837 539.168 564.249 542.848 563.809C555.581 562.119 568.683 562.486 575.601 570.787C577.588 573.138 578.545 575.856 579.134 578.574C580.312 583.863 580.165 589.152 579.429 594.441C578.398 602.08 576.337 609.793 572.657 616.919C569.787 622.355 565.959 627.497 559.63 630.803C554.257 633.594 547.706 634.475 541.303 633.888C537.696 633.521 534.163 632.639 530.483 632.712C524.153 632.786 518.486 635.577 512.303 636.532C508.402 637.193 504.354 637.12 500.453 636.532C496.332 635.945 492.357 634.916 488.751 633.227C484.776 631.317 481.464 628.599 479.477 625.293C475.723 619.123 476.68 611.997 479.403 605.459Z"
                              style={{visibility: 'hidden'}}></path>
                        <circle className="st57" cx="531" cy="598.001" r="12.25"></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth54Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth54Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47"
                              d="M462 607.2C463.5 603.7 465.3 600.3 466.8 596.9C470.7 588 473 578 478.5 569.5C483.8 561.2 491.7 554.7 503.4 552.4C512.9 550.5 522.9 552.5 532.8 552.1C537.9 551.9 543.2 551.1 548.2 550.5C565.5 548.2 583.3 548.7 592.7 560C595.4 563.2 596.7 566.9 597.5 570.6C599.1 577.8 598.9 585 597.9 592.2C596.5 602.6 593.7 613.1 588.7 622.8C584.8 630.2 579.6 637.2 571 641.7C563.7 645.5 554.8 646.7 546.1 645.9C541.2 645.4 536.4 644.2 531.4 644.3C522.8 644.4 515.1 648.2 506.7 649.5C501.4 650.4 495.9 650.3 490.6 649.5C485 648.7 479.6 647.3 474.7 645C469.3 642.4 464.8 638.7 462.1 634.2C457 625.8 458.3 616.1 462 607.2Z"></path>
                        <path className="st47"
                              d="M479.403 605.458C480.507 602.887 481.832 600.39 482.936 597.892C485.807 591.354 487.499 584.009 491.548 577.765C495.449 571.668 501.263 566.893 509.875 565.203C516.867 563.808 524.227 565.277 531.514 564.983C535.267 564.836 539.168 564.248 542.848 563.808C555.581 562.118 568.683 562.485 575.601 570.786C577.588 573.137 578.545 575.855 579.134 578.573C580.312 583.862 580.165 589.151 579.429 594.44C578.398 602.079 576.337 609.792 572.657 616.918C569.787 622.354 565.959 627.496 559.63 630.802C554.257 633.593 547.706 634.474 541.303 633.887C537.696 633.52 534.163 632.638 530.483 632.711C524.153 632.785 518.486 635.576 512.303 636.531C508.402 637.192 504.354 637.119 500.453 636.531C496.332 635.944 492.357 634.915 488.751 633.226C484.776 631.316 481.464 628.598 479.477 625.292C475.723 619.122 476.68 611.996 479.403 605.458Z"></path>
                    </g>
                    <g style={{visibility: (!tooth54Diagnozis.culttab && !tooth54Diagnozis.abutment && !tooth54Diagnozis.implant && !tooth54Diagnozis.apex && !tooth54Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className="st46" 
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth54Diagnozis.culttab && !tooth54Diagnozis.abutment && !tooth54Diagnozis.implant && !tooth54Diagnozis.shaper && !tooth54Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth54.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth54.seal_center ? `seal-fill ${teethDiagnozis.tooth54.seal_center_color}` : ''}
                                `} 
                                d="M486.1,612.3c0.3,3.3,1.1,6,2.4,8.4c3.6,6.5,11.8,9.4,29.3,10.8c20.6,1.6,32.6-2,42.5-8.1
                                c1.5-0.9,2.9-1.9,4.4-2.9c10.9-7.8,11.7-30,11.7-35.6c0-3.1-1.1-6.3-3.4-9c-1.8-2.1-4.4-3.9-7.8-5.3c-7.7-3-31.4-3.9-31.4-3.9
                                c-20.7-0.9-31.9,2.4-37.7,6.8c-2.7,2.1-4.3,4.4-5.2,6.6C488.2,587,484.8,599.8,486.1,612.3z"
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth54.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth54.seal_left ? `seal-fill ${teethDiagnozis.tooth54.seal_left_color}` : ''}
                                `} 
                                d="M453.4,646.4c2.4-1.5,5.6-3.2,10-4.8c10.5-3.9,20.2-12.4,25.1-20.9c-1.3-2.3-2-5.1-2.4-8.4
                                c-1.3-12.5,2.1-25.3,4.8-32.2c0.8-2.2,2.4-4.5,5.2-6.6c-6.3-13.3-14.1-22.6-18.7-27.5c-2.2,2.9-4.2,6-6,9.4
                                c-6.1,12-8.6,26.1-13,38.5c-1.7,4.9-3.7,9.6-5.4,14.5C448.9,621,447.6,634.6,453.4,646.4z"
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth54.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth54.seal_bottom ? `seal-fill ${teethDiagnozis.tooth54.seal_bottom_color}` : ''}
                                `} 
                                d="M453.4,646.4C453.4,646.4,453.4,646.4,453.4,646.4c3.2,6.4,8.3,11.6,14.4,15.4c5.5,3.3,11.6,5.4,18,6.5
                                c6,1.1,12.2,1.3,18.2,0.1c9.5-1.8,18.2-7,28-7.1c5.6,0,11,1.6,16.6,2.4c9.9,1.3,20-0.4,28.1-5.6c2.9-1.8,5.4-4,7.7-6.4
                                c-12-10.3-20.2-21.9-24.2-28.1c-9.9,6.1-21.9,9.7-42.5,8.1c-17.5-1.4-25.7-4.3-29.3-10.8c-4.9,8.6-14.6,17-25.1,20.9
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth54.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth54.seal_right ? `seal-fill ${teethDiagnozis.tooth54.seal_right_color}` : ''}
                                `}  
                                d="M560.3,623.4c3.9,6.2,12.1,17.9,24.2,28.1c5.3-5.7,9.1-12.7,12.1-20c5.7-13.7,8.7-28.4,10.2-43
                                c1-10.1,1.2-20.2-0.7-30.4c-0.7-4-1.8-7.9-3.6-11.6c-5.9,7.5-16.6,19.7-29.5,29.4c2.3,2.7,3.4,5.8,3.4,9c0,5.6-0.8,27.9-11.7,35.6
                                C563.2,621.5,561.8,622.5,560.3,623.4z" 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth54.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth54.seal_top ? `seal-fill ${teethDiagnozis.tooth54.seal_top_color}` : ''}
                                `}  
                                d="M477.3,546c4.6,4.9,12.4,14.2,18.7,27.5c5.9-4.4,17-7.8,37.7-6.8c0,0,23.7,0.9,31.4,3.9
                                c3.4,1.4,6,3.2,7.8,5.3c12.9-9.6,23.6-21.9,29.5-29.4c-0.6-1.2-1.2-2.3-2-3.4c-10.8-16-30.9-16.9-50.5-13.8
                                c-5.6,0.9-11.6,1.9-17.4,2.1c-11.2,0.5-22.5-2.4-33.3,0.1C490,533.8,482.8,539,477.3,546z"
                        ...
                        <g className="with">
                            <path className="st54" 
                                  ...
                                  style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_left && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M488.5 621C483 612 482.8 583.5 496 573.5"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_left && !tooth54Diagnozis.seal_center) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M496 574C495.5 568.333 491.8 555.6 481 550"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_left && !tooth54Diagnozis.seal_top) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M496 574C509 566.5 566.6 565.2 573 576"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_center && !tooth54Diagnozis.seal_top) ||
                                        (!tooth54Diagnozis.seal_center && tooth54Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M573 576C579.167 572.167 593 561.8 599 551"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_right && !tooth54Diagnozis.seal_top) ||
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M573 576C578 580.5 577.3 614.4 560.5 624"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_center) ||
                                        (tooth54Diagnozis.seal_right && !tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M560.5 624C561.833 628.167 567.8 639 581 649"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_right && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M560.5 624C550.5 630 505.6 631.5 488 621.5"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_center && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_center && tooth54Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                    ...
                    <g>
                        <g className="vinir"
                            style={
                                {
                                    visibility: tooth54Diagnozis.vinir ? 'inherit' : 'hidden',
                                    opacity: tooth54Diagnozis.vinir ? 1 : 0
                                }}
                        >
                            <path className={`vinir-fill ${tooth54Diagnozis.vinir_color}`} 
                                d="M471.31 555.476C473.009 552.076 475.008 548.976 477.207 546.076C482.704 539.076 489.8 533.876 499.195 531.576C509.989 528.976 521.283 531.976 532.476 531.476C538.273 531.176 544.27 530.276 549.867 529.376C569.456 526.376 589.545 527.176 600.339 543.176C601.039 544.276 601.739 545.376 602.338 546.576C604.137 550.176 605.137 554.176 605.936 558.176C607.835 568.376 607.636 578.476 606.636 588.576C606.486 590.043 606.322 591.51 606.141 592.976C603.425 592.876 597.594 
                                591.856 596.004 588.576C596.749 580.364 596.823 572.148 595.274 563.855C594.586 560.425 593.726 556.995 592.177 553.907C591.661 552.878 591.059 551.935 590.457 550.991C581.169 537.27 563.881 536.584 547.024 539.157C542.207 539.928 537.047 540.7 532.058 540.958C522.426 541.386 512.707 538.814 503.418 541.043C495.334 543.016 489.227 547.475 484.497 553.478C482.604 555.965 480.884 558.624 479.422 561.54C475.148 569.854 472.929 579.419 470.207 588.476C469.043 
                                592.476 462.026 593.142 458.664 592.976C462.85 580.728 465.375 567.06 471.31 555.476Z"
                            />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
                    <g className="crown" style={{
                        visibility: (tooth54Diagnozis.temporary_crown || tooth54Diagnozis.ceramic_crown || tooth54Diagnozis.mceramic_crown || tooth54Diagnozis.metalic_crown || tooth54Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth54Diagnozis.temporary_crown || tooth54Diagnozis.ceramic_crown || tooth54Diagnozis.mceramic_crown || tooth54Diagnozis.metalic_crown || tooth54Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth54Diagnozis.ceramic_crown_color}
                                ${tooth54Diagnozis.mceramic_crown_color}
                                ${tooth54Diagnozis.metalic_crown_color}
                                ${tooth54Diagnozis.zirconia_crown_color}
                            `}  
                            d="M606.1,558.1c-0.7-4-1.8-7.9-3.6-11.6c-0.6-1.2-1.2-2.3-2-3.4
                            c-10.8-16-30.9-16.9-50.5-13.8c-5.6,0.9-11.6,1.9-17.4,2.1c-11.2,0.5-22.5-2.4-33.3,0.1c-9.4,2.2-16.5,7.5-22,14.5
                            c-2.2,2.9-4.2,6-6,9.4c-6.1,12-8.6,26.1-13,38.5c-1.7,4.9-3.7,9.6-5.4,14.5c-4.2,12.6-5.5,26.1,0.3,37.9c0,0,0,0,0,0.1
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth54Diagnozis.fissure ? 'diagnoze' : tooth54Diagnozis.fissure ? 'hidden' : ''}`}  
                    ...
                    {/* FISSURES */}
                    <g  style={{visibility: (!tooth54Diagnozis.culttab && !tooth54Diagnozis.abutment && !tooth54Diagnozis.implant && !tooth54Diagnozis.apex && !tooth54Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth54Diagnozis.fissure ? 'diagnoze' : ''}`}  
                            d="M596.6,579.3l-19.1,13.1c-6.9-0.2-13.8,0-20.6,0.7c-8.2,0.9-14.7,2.2-20.5,4.3c-8.6,3.2-16.4,8.4-22.6,15.1
                            c-0.4-0.6-0.8-1.1-1.3-1.6l-0.5,0.5c-4.2-2.7-8.5-5.3-12.8-7.8l-1.2-0.7c-4.2-2.4-8.6-4.9-12-8.3c-2.9-2.9-5.3-6.4-6.7-10.2
                            l-1,0.4c1.5,3.9,3.9,7.6,7,10.6c3.6,3.5,8,6,12.3,8.4l1.2,0.7c4.9,2.8,9.9,5.8,14.6,8.9c0,0,0,0,0,0.1c2.3,3.4,2.9,7.5,3.5,11.8
                            c0.2,1.5,0.4,3,0.7,4.5c1.3,6.9,4.5,13.4,9.2,18.7l0.8-0.7c-4.6-5.2-7.7-11.5-9-18.2c-0.3-1.5-0.5-3-0.7-4.4
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth54Diagnozis.implant && !tooth54Diagnozis.apex && !tooth54Diagnozis.shaper && !tooth54Diagnozis.apex ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth54Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling"  style={{visibility: 'inherit'}}>
                            <path className={`st22 target top ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.pulpit ? 'pulpit' : ''} ${tooth54Diagnozis.periodontit ? 'periodontit' : ''}`}
                        ...
                        <g className="hEmpty hImplant pulpitis-pfilling"  style={{visibility: 'inherit'}}>
                            <path className={`st22 target middle ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.pulpit ? 'pulpit' : ''} ${tooth54Diagnozis.periodontit ? 'periodontit' : ''}`}  
                    ...
                    <g className="pin hEmpty hImplant" style={{
                        visibility: 'inherit', opacity: tooth54Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact"
                              d="M491.7 449.2L519.7 441.1L549 453.1L570.6 450.3L588.9 463.4C594.6 453.7 599 443.4 601.9 432.7C604.1 424.6 605.5 416.4 606.8 408.2C606.7 407.6 606.7 407 606.6 406.4C606.2 406 605.8 405.5 605.3 405.1C600.9 400.6 595.8 396.5 590.3 393C588.9 392.1 587.5 391.2 586.1 390.4C585 389.8 583.9 389.2 582.7 388.6C581.3 387.8 579.8 387.1 578.3 386.4C578 386.3 577.7 386.1 577.4 386C577.2 385.9 577 385.8 576.9 385.8C576.3 385.5 575.7 385.3 575 385C574.5 384.8 574.1 384.6 573.6 384.4C573.4 384.3 573.1 384.2 572.8 384.1C572.1 383.8 571.4 383.6 570.7 383.3C570.4 383.2 570.1 383.1 569.8 383C569.6 382.9 569.4 382.9 569.2 382.8C568.3 382.5 567.4 382.2 566.5 381.9C565.7 381.6 564.9 381.4 564.1 381.1C563.9 381 563.7 381 563.5 380.9C562.6 380.7 561.8 380.4 560.9 380.2C560 380 559.1 379.7 558.3 379.5H558.2C557.2 379.3 556.3 379.1 555.4 378.9C555.3 378.9 555.2 378.9 555.1 378.8C554.7 378.7 554.3 378.6 553.9 378.6C553.7 378.6 553.6 378.5 553.4 378.5C553.2 378.5 553 378.4 552.8 378.4C552.7 378.4 552.6 378.4 552.5 378.3C552.2 378.2 551.9 378.2 551.5 378.1C551.1 378 550.6 377.9 550.2 377.9C549.9 377.9 549.7 377.8 549.4 377.8C549.4 377.8 549.3 377.8 549.2 377.8C548.3 377.7 547.5 377.6 546.6 377.4C546.3 377.4 546 377.3 545.7 377.3C545.5 377.3 545.4 377.3 545.2 377.2C545.1 377.2 545 377.2 545 377.2C544.4 377.1 543.9 377.1 543.3 377C542.6 376.9 541.8 376.9 541.1 376.8C540.9 376.8 540.7 376.8 540.5 376.8C540.1 376.8 539.6 376.7 539.2 376.7C539 376.7 538.9 376.7 538.7 376.7C538.2 376.7 537.6 376.6 537 376.6C536.5 376.6 536.1 376.6 535.6 376.6C535.5 376.6 535.4 376.6 535.3 376.6C534.8 376.6 534.4 376.6 533.9 376.6C533.7 376.6 533.4 376.6 533.2 376.6C531.4 376.6 529.6 376.6 527.8 376.7C523.3 376.9 518.8 377.3 514.3 378C506.9 379.2 499.7 381 492.9 383.6C490.6 384.5 488.4 385.4 486.2 386.4C486.1 386.5 486.1 386.6 486 386.6C484.8 390.3 483.8 394 483 397.7C479.9 415 483.5 433 491.7 449.2Z"
                              style={{visibility: 'hidden'}}
                        />
                        <path className="st57"
                            d="M534.5 447.099L549.1 453.099L569.9 450.399L560.6 356.299V355.799L552.6 274.599C552.4 273.499 551.5 272.699 550.4 272.699C549.2 272.699 548.3 273.599 548.2 274.799L543.4 340.099L543.2 342.699L534.5 447.099Z"
                            style={{fill: tooth54Diagnozis.pin ? '#dbd9d3' : 'none'}}  
                        />
                    </g>
                    {/* CULT TAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: tooth54Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth54Diagnozis.culttab ? 1 : 0}}>
                        <path className="st14" 
                            d="M540.6,376.7c0.2,0,0.4,0,0.6,0c0.7,0,1.5,0.1,2.2,0.2c0.6,0,1.1,0.1,1.7,0.2c0.1,0,0.2,0,0.2,0
                        ...
                        />
                        <path className="st15" 
                            d="M491.7,449.2l28-8.1l29.3,12l21.6-2.8l18.3,13.1c5.7-9.7,10.1-20,13-30.7c2.2-8.1,3.6-16.3,4.9-24.5v0
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth54Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth54Diagnozis.abutment ? 1 : 0}}>
                    ...
                    <g className="shaper hEmpty hIntact hRoot" style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st44"
                              d="M574.743 408.394C575.035 410.859 573.033 412.992 570.554 412.857L521.378 410.186C518.9 410.052 517.141 407.717 517.696 405.298L526.639 366.305C527.075 364.403 528.82 363.094 530.768 363.206L566.319 365.254C568.256 365.366 569.833 366.852 570.061 368.778L574.743 408.394Z"
                        />
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth54Diagnozis.abutment || tooth54Diagnozis.implant || tooth54Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth54Diagnozis.culttab && !tooth54Diagnozis.abutment && !tooth54Diagnozis.implant && !tooth54Diagnozis.shaper && !tooth54Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                        <path className="st46" 
                    ...
                    <g className="header caries-filling" style={{visibility: 'inherit'}}>
                        ...
                        >
                            ...
                            <path className={
                                ...
                                ${tooth54Diagnozis.caries_left ? 'caries-fill' : ''}
                                ${tooth54Diagnozis.seal_left ? `seal-fill ${teethDiagnozis.tooth54.seal_left_color}` : ''}
                            `} 
                                d="M464.3,454.2c2.4,6.4,5.9,12.6,10.3,18.2l5.6,1.3c0.9-0.5,1.9-1,2.9-1.4c1.7-0.6,3.4-1,5.2-1.1
                                c-2.4-2-4.6-4.2-6.6-6.5c-2.9-3.1-5.4-6.5-6.9-10.2c-0.7-1.8-1.2-3.6-1.4-5.5l1.7-0.2c0.2,2,0.8,3.9,1.6,5.8
                                c2.7,6.5,8.3,11.8,14.4,16.5c2.7,2,5.5,4,8.4,5.8c0.6-9,1.8-26,2.7-40.6c0.8-13.7,1.5-25.3,1.2-26.1c-0.5-1.5-12.7-17.4-17.9-24.1
                        ...
                        <g className="with">
                            <path className="st54" d="M502.5 435.999L500 471.499"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_left && !tooth54Diagnozis.seal_top && !tooth54Diagnozis.seal_center) ||
                                        (tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_top && !tooth54Diagnozis.seal_center) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" d="M502.5 435.999C504 403.999 508.5 411.999 488.5 389.999"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_left && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_bottom && !tooth54Diagnozis.seal_center) ||
                                        (!tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_bottom && tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M502.5 436.999C518.5 420.999 559.7 421.699 578.5 440.499"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_bottom && !tooth54Diagnozis.seal_center) ||
                                        (tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_left && tooth54Diagnozis.seal_center && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_bottom && !tooth54Diagnozis.seal_top && tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M578.5 440.499C586.5 416.999 586.7 413.999 601.5 409.999"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_right && !tooth54Diagnozis.seal_bottom) ||
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_bottom && !tooth54Diagnozis.seal_center) ||
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_bottom && tooth54Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }}
                            ...
                            <path className="st54" d="M578.5 440.499L567.5 476.499"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth54Diagnozis.seal_right && !tooth54Diagnozis.seal_top && !tooth54Diagnozis.seal_center) ||
                                        (tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_top && !tooth54Diagnozis.seal_center) ||
                                        (!tooth54Diagnozis.seal_right && tooth54Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth54Diagnozis.vinir_color}`} 
                                d="M607.9 422.5C607.4 417.1 606.8 411.7 606.1 406.3C606.1 406.2 606.1 406.2 606.1 406.1C599.4 399 591.4 393 582.2 388.2C561.6 377.4 537.2 373.9 514 377.5C504.1 379 494.6 381.9 485.9 385.9C485.8 386 485.7 386.1 485.7 386.1C481.8 390.3 478.1 394.7 474.7 399.3C471.3 403.9 468.1 408.6 465.7 413.6C463.3 418.5 461.7 423.6 460.8 428.9C460.1 437.4 461.3 445.9 464.4 454.1C466.8 460.5 470.3 466.7 
                                ...
                                540.2 467.2L543.9 460.3L545.1 450.2L550.5 445.1L551.5 446.5L546.6 450.7L545.6 460.6L542.2 467.9C544 469.1 545.8 470.2 547.7 471.3C553.7 474.8 560.2 477.8 565.8 481.7C566.4 482.1 567 482.5 567.5 482.9C569.6 484.4 571.4 486.1 573.2 487.9L579.3 488.7C587.1 485.3 593.9 480.5 599.1 474.6C602.3 471 604.9 467.1 606.8 462.9C608.3 456.4 609.1 449.8 609.2 443.2C609.2 436.4 608.6 429.4 607.9 422.5Z"
                            />
                        </g>
                    </g>
