...
import PeriodontitStage33 from './periodontit33';
...
export default function Tooth33() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth33.caries_bottom = !teethDiagnozis.tooth33.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth33.caries_center = !teethDiagnozis.tooth33.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth33.caries_left = !teethDiagnozis.tooth33.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth33.caries_right = !teethDiagnozis.tooth33.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth33.caries_top = !teethDiagnozis.tooth33.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth33.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth33.seal_center_color = sealColor1;
                    teethDiagnozis.tooth33.seal_center = true;
                } else if (teethDiagnozis.tooth33.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth33.seal_center_color = sealColor2;
                    teethDiagnozis.tooth33.seal_center = true;
                } else if (teethDiagnozis.tooth33.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth33.seal_center_color = sealColor3;
                    teethDiagnozis.tooth33.seal_center = true;
                } else {
                    teethDiagnozis.tooth33.seal_center = !teethDiagnozis.tooth33.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth33.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth33.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth33.seal_bottom = true;
                } else if (teethDiagnozis.tooth33.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth33.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth33.seal_bottom = true;
                } else if (teethDiagnozis.tooth33.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth33.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth33.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth33.seal_bottom = !teethDiagnozis.tooth33.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth33.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth33.seal_left_color = sealColor1;
                    teethDiagnozis.tooth33.seal_left = true;
                } else if (teethDiagnozis.tooth33.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth33.seal_left_color = sealColor2;
                    teethDiagnozis.tooth33.seal_left = true;
                } else if (teethDiagnozis.tooth33.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth33.seal_left_color = sealColor3;
                    teethDiagnozis.tooth33.seal_left = true;
                } else {
                    teethDiagnozis.tooth33.seal_left = !teethDiagnozis.tooth33.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth33.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth33.seal_right_color = sealColor1;
                    teethDiagnozis.tooth33.seal_right = true;
                } else if (teethDiagnozis.tooth33.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth33.seal_right_color = sealColor2;
                    teethDiagnozis.tooth33.seal_right = true;
                } else if (teethDiagnozis.tooth33.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth33.seal_right_color = sealColor3;
                    teethDiagnozis.tooth33.seal_right = true;
                } else {
                    teethDiagnozis.tooth33.seal_right = !teethDiagnozis.tooth33.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth33.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth33.seal_top_color = sealColor1;
                    teethDiagnozis.tooth33.seal_top = true;
                } else if (teethDiagnozis.tooth33.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth33.seal_top_color = sealColor2;
                    teethDiagnozis.tooth33.seal_top = true;
                } else if (teethDiagnozis.tooth33.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth33.seal_top_color = sealColor3;
                    teethDiagnozis.tooth33.seal_top = true;
                } else {
                    teethDiagnozis.tooth33.seal_top = !teethDiagnozis.tooth33.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth33.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth33.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth33.wedge_shaped_defect_color = !teethDiagnozis.tooth33.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    return (
        <>
            <g id="33" className="df-tooth-text">
                <text transform="matrix(1 0 0 1 1204.7012 842.0025)" className={`st3 st4 st5 ${toothActive.tooth33.active ? 'num-active' : ''}`}>33</text>
            </g>
            <g id="TH-33" className={`f-tooth-init ${(teethDiagnozis.tooth33.show && !teethDiagnozis.tooth33.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth33.active) {
                        dispatch(setNewToothActive({tooth33: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth33.change_color = !teethDiagnozis.tooth33.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth33.fissure = !teethDiagnozis.tooth33.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth33.caries = !teethDiagnozis.tooth33.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth33.cervical_caries = !teethDiagnozis.tooth33.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth33.wedge_shaped_defect = !teethDiagnozis.tooth33.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth33.tartar = !teethDiagnozis.tooth33.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth33.pulpit = !teethDiagnozis.tooth33.pulpit;
                            teethDiagnozis.tooth33.channel_class = teethDiagnozis.tooth33.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth33.channel_not_sealed = !teethDiagnozis.tooth33.channel_not_sealed;
                            teethDiagnozis.tooth33.channel_class = teethDiagnozis.tooth33.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth33.channel_top_sealed = !teethDiagnozis.tooth33.channel_top_sealed;
                            teethDiagnozis.tooth33.channel_class = teethDiagnozis.tooth33.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth33.channel_part_sealed = !teethDiagnozis.tooth33.channel_part_sealed;
                            teethDiagnozis.tooth33.channel_class = teethDiagnozis.tooth33.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth33.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth33.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth33.periodontit = true;
                            } else {
                                teethDiagnozis.tooth33.periodontit = !teethDiagnozis.tooth33.periodontit;
                            }
                            teethDiagnozis.tooth33.channel_class = teethDiagnozis.tooth33.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth33.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth33.seal_cervical && teethDiagnozis.tooth33.seal_cervical_color === "") {
                                teethDiagnozis.tooth33.seal_cervical = true;
                                teethDiagnozis.tooth33.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth33.seal_cervical && teethDiagnozis.tooth33.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth33.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth33.seal_cervical = false;
                                teethDiagnozis.tooth33.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth33.vinir && teethDiagnozis.tooth33.vinir_color === "") {
                                teethDiagnozis.tooth33.vinir = true;
                                teethDiagnozis.tooth33.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth33.vinir && teethDiagnozis.tooth33.vinir_color != vinirColor) {
                                teethDiagnozis.tooth33.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth33.vinir = false;
                                teethDiagnozis.tooth33.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth33.temporary_crown = !teethDiagnozis.tooth33.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth33.ceramic_crown && teethDiagnozis.tooth33.ceramic_crown_color === "") {
                                teethDiagnozis.tooth33.ceramic_crown = true;
                                teethDiagnozis.tooth33.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth33.ceramic_crown && teethDiagnozis.tooth33.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth33.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth33.ceramic_crown = false;
                                teethDiagnozis.tooth33.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth33.mceramic_crown && teethDiagnozis.tooth33.mceramic_crown_color === "") {
                                teethDiagnozis.tooth33.mceramic_crown = true;
                                teethDiagnozis.tooth33.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth33.mceramic_crown && teethDiagnozis.tooth33.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth33.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth33.mceramic_crown = false;
                                teethDiagnozis.tooth33.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth33.metalic_crown && teethDiagnozis.tooth33.metalic_crown_color === "") {
                                teethDiagnozis.tooth33.metalic_crown = true;
                                teethDiagnozis.tooth33.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth33.metalic_crown && teethDiagnozis.tooth33.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth33.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth33.metalic_crown = false;
                                teethDiagnozis.tooth33.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth33.zirconia_crown && teethDiagnozis.tooth33.zirconia_crown_color === "") {
                                teethDiagnozis.tooth33.zirconia_crown = true;
                                teethDiagnozis.tooth33.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth33.zirconia_crown && teethDiagnozis.tooth33.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth33.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth33.zirconia_crown = false;
                                teethDiagnozis.tooth33.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth33.pin = !teethDiagnozis.tooth33.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth33.culttab = !teethDiagnozis.tooth33.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth33.abutment = !teethDiagnozis.tooth33.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth33.shaper = !teethDiagnozis.tooth33.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth33.implant = !teethDiagnozis.tooth33.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth33.apex = !teethDiagnozis.tooth33.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth33.absent = !teethDiagnozis.tooth33.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth33.cervical_caries = !teethDiagnozis.tooth33.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth33.caries = !teethDiagnozis.tooth33.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth33.parodontit) {
                                if (teethDiagnozis.tooth33.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth33.parodontit = false;
                                    teethDiagnozis.tooth33.active = false;
                                } else {
                                    teethDiagnozis.tooth33.parodontit = true;
                                    teethDiagnozis.tooth33.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth33.parodontit = true;
                                teethDiagnozis.tooth33.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth33.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
                ...
                <g id="T_33_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        <g style={{visibility: !tooth33Diagnozis.implant && !tooth33Diagnozis.apex && !tooth33Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`} 
                        ...
                        <g style={{visibility: tooth33Diagnozis?.apex || tooth33Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth33Diagnozis.culttab && !tooth33Diagnozis.abutment && !tooth33Diagnozis.implant && !tooth33Diagnozis.shaper && !tooth33Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            <path className="st7" d="M1199.62 952.7C1199.42 953.1 1199.22 953.6 1198.92 954C1200.22 961.492 1206.71 965.237 1211.32 970.5C1213.49 972.964 1215.03 976.152 1215.82 979.5C1233.42 983.1 1250.82 965.5 1254.82 954.5C1252.82 950.9 1251.02 947.2 1248.92 943.6C1246.32 939.2 1243.32 934.9 1239.02 931.9C1234.92 929 1229.82 927.5 1224.62 928C1216.52 928.9 1210.12 934.4 1205.92 941.1C1203.52 944.8 1201.72 948.9 1199.62 952.7Z"></path>
                            <path className={
                                    `st8 caries-bottom
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth33.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth33.seal_bottom ? `seal-fill ${teethDiagnozis.tooth33.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g className="with up">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth33Diagnozis.seal_bottom && !tooth33Diagnozis.seal_center) ||
                                        (!tooth33Diagnozis.seal_bottom && tooth33Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className="st55" d="M1267.12 1000.4C1265.12 1004.5 1262.52 1008.2 1259.62 1011.7C1258.02 1013.5 1256.42 1015.3 1254.72 1017C1246.72 1025 1237.12 1032.2 1225.82 1032C1220.92 1031.9 1216.32 1030.4 1211.92 1028.2C1206.92 1025.7 1202.52 1022.3 1198.12 1018.8C1193.92 1015.5 1189.82 1011.9 1186.62 1007.7C1184.62 1005 1182.92 1002.1 1182.02 998.8C1181.11 995.629 1180.92 992.29 1181.25 989C1184.33 989.067 1190.7 990.16 1191.5 994C1191.56 994.283 1191.64 994.565 1191.71 994.845C1192.42 997.444 1193.75 999.729 1195.31 1001.86C1197.81 1005.16 1201.02 1008 1204.3 1010.6C1207.74 1013.36 1211.18 1016.03 1215.09 1018C1218.53 1019.74 1222.12 1020.92 1225.95 1021C1234.79 1021.15 1242.29 1015.48 1248.55 1009.18C1249.88 1007.84 1251.13 1006.42 1252.38 1005.01L1252.38 1005.01C1254.64 1002.25 1256.68 999.335 1258.24 996.105C1258.65 995.252 1259.02 994.383 1259.35 993.5C1261.26 989.5 1267.6 988.5 1270.53 988.5C1270.16 992.603 1268.95 996.631 1267.12 1000.4Z"></path>
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
                    <g className="crown" style={{
                        visibility: (tooth33Diagnozis.temporary_crown || tooth33Diagnozis.ceramic_crown || tooth33Diagnozis.mceramic_crown || tooth33Diagnozis.metalic_crown || tooth33Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth33Diagnozis.temporary_crown || tooth33Diagnozis.ceramic_crown || tooth33Diagnozis.mceramic_crown || tooth33Diagnozis.metalic_crown || tooth33Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth33Diagnozis.ceramic_crown_color}
                                ${tooth33Diagnozis.mceramic_crown_color}
                                ${tooth33Diagnozis.metalic_crown_color}
                                ${tooth33Diagnozis.zirconia_crown_color}
                            `} 
                            ...
                            c2.9-3.5,5.6-7.2,7.5-11.3C1271,993,1272.2,984.7,1269.3,976.6z"
                        />
                        <path className={`st3 fissure ${tooth33Diagnozis.fissure ? 'diagnoze' : tooth33Diagnozis.fissure ? 'hidden' : ''}`}  
                    ...
                    <g className="fissures" style={{visibility: (!tooth33Diagnozis.culttab && !tooth33Diagnozis.abutment && !tooth33Diagnozis.implant && !tooth33Diagnozis.apex && !tooth33Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth33Diagnozis.fissure ? 'diagnoze' : ''}`}  
                            d="M1223.6,981.3c-4.9,0-9.7-0.8-14.4-2.3l0.3-1c5.4,1.7,11,2.5,16.5,2.2c5.3-0.3,10.6-1.5,15.5-3.7l0.4,1
                            c-5,2.2-10.4,3.5-15.9,3.8C1225.3,981.3,1224.5,981.3,1223.6,981.3z" 
                        />
                    </g>
                ...
                <g id="T_33" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        <g id="dentin_v_33" style={{visibility: !tooth33Diagnozis.implant && !tooth33Diagnozis.apex && !tooth33Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_v_33" className={`st9 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}
                        ...
                        <g id="dentin_n_33" style={{visibility: !tooth33Diagnozis.implant && !tooth33Diagnozis.abutment && !tooth33Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_33" className={`st10 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage33 />
                        {/* <g className="level hEmpty hImplant periodontitis"  dataposition="33"  style={{visibility: 'inherit', opacity:0}}>
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth33Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" style={{fill: tooth33Diagnozis.pin ? '#dbd9d3' : 'none'}}
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth33Diagnozis.abutment || tooth33Diagnozis.implant || tooth33Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="1255.7" y1="1264.7" x2="1209" y2="1274.7" />
                        <line className="st19" x1="1258.7" y1="1291.7" x2="1212" y2="1301.7" />
                        <line className="st19" x1="1261.7" y1="1318.7" x2="1215" y2="1328.7" />
                        <line className="st19" x1="1263.7" y1="1346.7" x2="1217" y2="1356.7" />
                        <line className="st19" x1="1265.7" y1="1373.7" x2="1219" y2="1383.7" />
                    </g>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth33Diagnozis.culttab && !tooth33Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth33Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} d="M1201.96 1200.79C1202.84 1202.8 1203.8 1204.8 1204.76 1206.73C1207.2 1211.55 1209.93 1216.3 1213.11 1220.75C1216.8 1225.87 1221.53 1230.69 1227.73 1230.99C1231.65 1231.14 1235.34 1229.36 1238.44 1226.98C1243.83 1222.76 1247.53 1216.89 1250.41 1210.74C1251.59 1208.21 1252.7 1205.62 1253.73 1202.95C1255.12 1199.2 1256.3 1195.42 1257.34 1191.56C1257.68 1190.28 1256.68 1189.04 1255.35 1189.08L1200.71 1190.84C1199.36 1190.88 1198.44 1192.21 1198.91 1193.47C1199.84 1195.94 1200.87 1198.38 1201.96 1200.79Z" />
                        <path className={
                                `st60
                                    ${(tooth33Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth33Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth33Diagnozis.seal_cervical_color}
                                `
                            }  
                            d="M1201.96 1200.79C1202.84 1202.8 1203.8 1204.8 1204.76 1206.73C1207.2 1211.55 1209.93 1216.3 1213.11 1220.75C1216.8 1225.87 1221.53 1230.69 1227.73 1230.99C1231.65 1231.14 1235.34 1229.36 1238.44 1226.98C1243.83 1222.76 1247.53 1216.89 1250.41 1210.74C1251.59 1208.21 1252.7 1205.62 1253.73 1202.95C1255.12 1199.2 1256.3 1195.42 1257.34 1191.56C1257.68 1190.28 1256.68 1189.04 1255.35 
                            1189.08L1200.71 1190.84C1199.36 1190.88 1198.44 1192.21 1198.91 1193.47C1199.84 1195.94 1200.87 1198.38 1201.96 1200.79Z" 
                        />
                    </g>
                    {/* TARTAR */}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth33.tartar ? 1 : 0}}>
