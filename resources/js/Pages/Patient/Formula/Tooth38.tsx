        ...
        <>
            ...
            >
                ...
                <g id="T_38_up" className="top-view" style={{visibility: tooth38Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/* PULPIT */}
                    <g className="pulp">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" style={{visibility: tooth38Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/* PIN */}
                    <g className="pin hEmpty hImplant" style={{visibility: 'inherit', opacity: tooth38Diagnozis.pin ? 1 : 0}}>
                    ...
                    {/*VINIR*/}
                    <g className="hEmpty hImplant " style={{visibility: 'inherit'}}>
                        <g className="vinir"
                            style={
                                {
                    ...
                    {/*FISSURES*/}
                    <g className="fissures hEmpty  hImplant" style={{visibility: (!tooth38Diagnozis.culttab && !tooth38Diagnozis.abutment && !tooth38Diagnozis.implant && !tooth38Diagnozis.apex && !tooth38Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                ...
                <g id="T_48" className="common-view" style={{visibility: tooth38Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="toutline  hImplant hEmpty" style={{visibility: !tooth38Diagnozis.culttab && !tooth38Diagnozis.abutment && !tooth38Diagnozis.implant && !tooth38Diagnozis.shaper && !tooth38Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped  hImplant hEmpty" style={{visibility: !tooth38Diagnozis.culttab && !tooth38Diagnozis.abutment ? 'inherit' : 'hidden'}}>
