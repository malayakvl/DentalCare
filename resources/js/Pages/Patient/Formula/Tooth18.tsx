            ...
            >
                ...
                <g id="T_18_up" className="top-view"
                    ...
                    <g className="shaper hEmpty hIntact hRoot" style={{visibility: 'hidden', opacity: 0}}>
                        <circle className="st44" cx="278.5" cy="598.5" r="28.5"></circle>
                        <path className="st45"
                    ...
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth18Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth18Diagnozis.abutment ? 1 : 0}}>
                        ...
                        <circle className="st45" cx="279" cy="598" r="13"></circle>
                    </g>
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth18Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact"
                            ...
                            594.999Z"
                            style={{visibility: tooth18Diagnozis.pin ? 'inherit' : 'hidden'}}
                        />
                        <path className="st56 hIntact"
                            ...
                            style={{visibility: tooth18Diagnozis.pin ? 'inherit' : 'hidden'}}
                        />
                        <circle className="st57" cx="279" cy="598" r="12.25" />
                    </g>
                    {/* CULTTAB */}
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty"
                        style={{visibility: 'inherit', opacity: teethDiagnozis.tooth18.tartar ? 1 : 0}}>
                    ...
                    <g className="crown" style={{
                        ...
                        />
                        <path className={`st3 fissure ${tooth18Diagnozis.fissure ? 'diagnoze' : ''}`} d="M241.9,612.3l-0.4-1c2-0.7,3.7-2,5.1-3.6c0.8-1,1.6-2,2.3-3.1c1.5-2.1,2.8-4.1,4.9-5.1l0.4,1
