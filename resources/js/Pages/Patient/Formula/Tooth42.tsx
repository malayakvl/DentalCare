...
export default function Tooth42() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth42.caries_bottom = !teethDiagnozis.tooth42.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth42.caries_center = !teethDiagnozis.tooth42.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth42.caries_left = !teethDiagnozis.tooth42.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth42.caries_right = !teethDiagnozis.tooth42.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth42.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth42.seal_center_color = sealColor1;
                    teethDiagnozis.tooth42.seal_center = true;
                } else if (teethDiagnozis.tooth42.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth42.seal_center_color = sealColor2;
                    teethDiagnozis.tooth42.seal_center = true;
                } else if (teethDiagnozis.tooth42.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth42.seal_center_color = sealColor3;
                    teethDiagnozis.tooth42.seal_center = true;
                } else {
                    teethDiagnozis.tooth42.seal_center = !teethDiagnozis.tooth42.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth42.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth42.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth42.seal_bottom = true;
                } else if (teethDiagnozis.tooth42.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth42.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth42.seal_bottom = true;
                } else if (teethDiagnozis.tooth42.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth42.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth42.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth42.seal_bottom = !teethDiagnozis.tooth42.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth42.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth42.seal_left_color = sealColor1;
                    teethDiagnozis.tooth42.seal_left = true;
                } else if (teethDiagnozis.tooth42.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth42.seal_left_color = sealColor2;
                    teethDiagnozis.tooth42.seal_left = true;
                } else if (teethDiagnozis.tooth42.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth42.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth42.seal_right_color = sealColor1;
                    teethDiagnozis.tooth42.seal_right = true;
                } else if (teethDiagnozis.tooth42.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth42.seal_right_color = sealColor2;
                    teethDiagnozis.tooth42.seal_right = true;
                } else if (teethDiagnozis.tooth42.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth42.seal_right_color = sealColor3;
                    teethDiagnozis.tooth42.seal_right = true;
                } else {
                    teethDiagnozis.tooth42.seal_right = !teethDiagnozis.tooth42.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth42.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth42.seal_top_color = sealColor1;
                    teethDiagnozis.tooth42.seal_top = true;
                } else if (teethDiagnozis.tooth42.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth42.seal_top_color = sealColor2;
                    teethDiagnozis.tooth42.seal_top = true;
                } else if (teethDiagnozis.tooth42.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth42.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth42.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth42.wedge_shaped_defect_color = !teethDiagnozis.tooth42.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="42" className="df-tooth-text">
            ...
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth42.active) {
                        dispatch(setNewToothActive({tooth42: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth42.change_color = !teethDiagnozis.tooth42.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth42.fissure = !teethDiagnozis.tooth42.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth42.caries = !teethDiagnozis.tooth42.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth42.cervical_caries = !teethDiagnozis.tooth42.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth42.wedge_shaped_defect = !teethDiagnozis.tooth42.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth42.tartar = !teethDiagnozis.tooth42.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth42.pulpit = !teethDiagnozis.tooth42.pulpit;
                            teethDiagnozis.tooth42.channel_class = teethDiagnozis.tooth42.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth42.channel_not_sealed = !teethDiagnozis.tooth42.channel_not_sealed;
                            teethDiagnozis.tooth42.channel_class = teethDiagnozis.tooth42.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth42.channel_top_sealed = !teethDiagnozis.tooth42.channel_top_sealed;
                            teethDiagnozis.tooth42.channel_class = teethDiagnozis.tooth42.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth42.channel_part_sealed = !teethDiagnozis.tooth42.channel_part_sealed;
                            teethDiagnozis.tooth42.channel_class = teethDiagnozis.tooth42.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth42.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth42.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth42.periodontit = true;
                            } else {
                                teethDiagnozis.tooth42.periodontit = !teethDiagnozis.tooth42.periodontit;
                            }
                            teethDiagnozis.tooth42.channel_class = teethDiagnozis.tooth42.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth42.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth42.seal_cervical && teethDiagnozis.tooth42.seal_cervical_color === "") {
                                teethDiagnozis.tooth42.seal_cervical = true;
                                teethDiagnozis.tooth42.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth42.seal_cervical && teethDiagnozis.tooth42.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth42.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth42.seal_cervical = false;
                                teethDiagnozis.tooth42.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth42.vinir && teethDiagnozis.tooth42.vinir_color === "") {
                                teethDiagnozis.tooth42.vinir = true;
                                teethDiagnozis.tooth42.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth42.vinir && teethDiagnozis.tooth42.vinir_color != vinirColor) {
                                teethDiagnozis.tooth42.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth42.vinir = false;
                                teethDiagnozis.tooth42.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth42.temporary_crown = !teethDiagnozis.tooth42.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth42.ceramic_crown && teethDiagnozis.tooth42.ceramic_crown_color === "") {
                                teethDiagnozis.tooth42.ceramic_crown = true;
                                teethDiagnozis.tooth42.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth42.ceramic_crown && teethDiagnozis.tooth42.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth42.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth42.ceramic_crown = false;
                                teethDiagnozis.tooth42.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth42.mceramic_crown && teethDiagnozis.tooth42.mceramic_crown_color === "") {
                                teethDiagnozis.tooth42.mceramic_crown = true;
                                teethDiagnozis.tooth42.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth42.mceramic_crown && teethDiagnozis.tooth42.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth42.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth42.mceramic_crown = false;
                                teethDiagnozis.tooth42.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth42.metalic_crown && teethDiagnozis.tooth42.metalic_crown_color === "") {
                                teethDiagnozis.tooth42.metalic_crown = true;
                                teethDiagnozis.tooth42.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth42.metalic_crown && teethDiagnozis.tooth42.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth42.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth42.metalic_crown = false;
                                teethDiagnozis.tooth42.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth42.zirconia_crown && teethDiagnozis.tooth42.zirconia_crown_color === "") {
                                teethDiagnozis.tooth42.zirconia_crown = true;
                                teethDiagnozis.tooth42.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth42.zirconia_crown && teethDiagnozis.tooth42.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth42.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth42.zirconia_crown = false;
                                teethDiagnozis.tooth42.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth42.pin = !teethDiagnozis.tooth42.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth42.culttab = !teethDiagnozis.tooth42.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth42.abutment = !teethDiagnozis.tooth42.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth42.shaper = !teethDiagnozis.tooth42.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth42.implant = !teethDiagnozis.tooth42.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth42.apex = !teethDiagnozis.tooth42.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth42.absent = !teethDiagnozis.tooth42.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth42.cervical_caries = !teethDiagnozis.tooth42.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth42.caries = !teethDiagnozis.tooth42.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth42.parodontit) {
                                if (teethDiagnozis.tooth42.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth42.parodontit = false;
                                    teethDiagnozis.tooth42.active = false;
                                } else {
                                    teethDiagnozis.tooth42.parodontit = true;
                                    teethDiagnozis.tooth42.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth42.parodontit = true;
                                teethDiagnozis.tooth42.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth42.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_42_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g style={{visibility: tooth42Diagnozis.implant || tooth42Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth42Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth42Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{opacity: teethDiagnozis.tooth42.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth42Diagnozis.culttab && !tooth42Diagnozis.abutment && !tooth42Diagnozis.implant && !tooth42Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС C*/}
                        <g id="s_header_14_5" 
                            onClick={() => {
                        ...
                        <g className="with up">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_left && !tooth42Diagnozis.seal_top && !tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_left && !tooth42Diagnozis.seal_top && !tooth42Diagnozis.seal_center) ||
                                        (!tooth42Diagnozis.seal_left && tooth42Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_left && !tooth42Diagnozis.seal_bottom) ||
                                        (!tooth42Diagnozis.seal_left && tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (!tooth42Diagnozis.seal_left && tooth42Diagnozis.seal_bottom && tooth42Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (!tooth42Diagnozis.seal_bottom && tooth42Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_right && !tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (!tooth42Diagnozis.seal_right && tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_right && !tooth42Diagnozis.seal_bottom && tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_center && tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_right)
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth42Diagnozis.seal_right && tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_right && !tooth42Diagnozis.seal_center)
                    ...
                    <g className="crown" style={{
                        visibility: (tooth42Diagnozis.temporary_crown || tooth42Diagnozis.ceramic_crown || tooth42Diagnozis.mceramic_crown || tooth42Diagnozis.metalic_crown || tooth42Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth42Diagnozis.temporary_crown || tooth42Diagnozis.ceramic_crown || tooth42Diagnozis.mceramic_crown || tooth42Diagnozis.metalic_crown || tooth42Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                ...
                <g id="T_42" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g id="dentin_n_42" style={{visibility: !tooth42Diagnozis.culttab && !tooth42Diagnozis.abutment && !tooth42Diagnozis.implant && !tooth42Diagnozis.shaper && !tooth42Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_42" className={`st10 change-color ${tooth42Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    <g className="implant" style={{visibility: tooth42Diagnozis.abutment || tooth42Diagnozis.implant || tooth42Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="925.9" y1="1246.3" x2="965" y2="1254.3" />
                        <line className="st19" x1="923.9" y1="1269.3" x2="963" y2="1277.3" />
                        <line className="st19" x1="921.9" y1="1293.3" x2="961" y2="1301.3" />
                        <line className="st19" x1="920.8" y1="1316.8" x2="960.1" y2="1323.8" />
                        <line className="st19" x1="918.8" y1="1339.8" x2="958.1" y2="1346.8" />
                    </g>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling" style={{visibility: (!tooth42Diagnozis.culttab && !tooth42Diagnozis.abutment && !tooth42Diagnozis.implant && !tooth42Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС R*/}
                        ...
                        <g className="with down">
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_left && !tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center && tooth42Diagnozis.seal_left) ||
                                        (!tooth42Diagnozis.seal_left && !tooth42Diagnozis.seal_bottom && tooth42Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth42Diagnozis.seal_right && !tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center) ||
                                        (tooth42Diagnozis.seal_bottom && !tooth42Diagnozis.seal_center && tooth42Diagnozis.seal_right) ||
                                        (!tooth42Diagnozis.seal_right && !tooth42Diagnozis.seal_bottom && tooth42Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
