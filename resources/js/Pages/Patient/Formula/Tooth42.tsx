            ...
            >
                ...
                <g id="T_42_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g style={{visibility: tooth42Diagnozis?.apex || tooth42Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth42Diagnozis.change_color ? 'diagnoze' : ''}`}   
                    ...
                    <g className="pulp">
                        <g style={{visibility: tooth42Diagnozis.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth42Diagnozis.culttab && !tooth42Diagnozis.abutment && !tooth42Diagnozis.implant && !tooth42Diagnozis.shaper && !tooth42Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС C*/}
                        <g id="s_header_14_5" 
                            onClick={() => {
