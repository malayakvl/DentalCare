...
export default function Tooth25() {
    ...
    return (
        <>
            <g className="df-tooth-text" style={{opacity: 1}}>
            ...
            >
                ...
                <g id="T_25_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling-bottom hRoot hImplant hEmpty" style={{visibility: (!tooth25Diagnozis.culttab && !tooth25Diagnozis.abutment && !tooth25Diagnozis.implant && !tooth25Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g id="s_header_25_5" 
