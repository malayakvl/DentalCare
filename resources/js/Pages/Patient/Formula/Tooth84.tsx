...
export default function tooth84() {
    ...
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth84.show && !teethDiagnozis.tooth44.show) {
    ...
    return (
        <>
            ...
            <g id="TH-84" className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth84.show && !teethDiagnozis.tooth84.absent)  ? 'f-tooth-active' : ''}`}                
                onClick={() => {
            ...
            >
                <g className={`underlay ${selectedTooth === 84 ? 'selected' : ''}`}  
                    onMouseOver={() => {
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 255, 40)'}}
                    onMouseOver={() => {
                ...
                >
                    <g className="dentin">
                        <g style={{visibility: !tooth84Diagnozis.culttab && !tooth84Diagnozis.implant && !tooth84Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth84Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth84Diagnozis?.apex ? 'apex' : ''}`} 
                        ...
                        <g style={{visibility: tooth84Diagnozis?.apex || tooth84Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth84Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth84Diagnozis?.apex ? 'apex' : ''}`}
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth84Diagnozis.implant || tooth84Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth84Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth84Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth84Diagnozis.pin ? 1 : 0}}>
                        ...
                        <circle className="st57" cx="559" cy="979" r="12.25" style={{fill: 'black', opacity: tooth84Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth84Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth84Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M490.129 970.069L490.132 970.062L490.135 970.055C490.763 968.401 491.363 966.764 491.956 965.144C493.463 961.034 494.93 957.031 496.71 953.114L496.713 953.107L496.717 953.1C499.099 947.641 502.112 942.044 507.593 938.006L507.594 938.005C511.647 935.013 516.706 933.056 522.13 931.774L522.13 931.774L522.138 931.772C526.95 930.593 531.979 930.098 537.059 929.799C542.107 929.502 547.224 929.603 552.223 930.485C553.344 930.691 554.48 930.942 555.632 931.196C558.224 931.769 560.892 932.358 563.649 932.499L563.652 932.499C567.078 932.662 570.461 932.114 573.708 931.588C574.564 931.449 575.41 931.312 576.245 931.19L576.245 931.19L576.258 931.188C586.179 929.601 596.445 929.63 604.881 933.508C613.67 937.565 618.632 944.815 621.879 952.49L621.879 952.491C624.59 958.881 626.261 965.565 627.931 972.249L628.03 972.643C628.119 972.999 628.208 973.354 628.297 973.709C630.027 980.601 631.715 987.325 630.614 993.936C630.037 997.394 628.686 1000.79 626.916 1004.13L626.916 1004.13C625.058 1007.65 622.744 1010.92 619.305 1013.5C615.094 1016.56 609.8 1018.21 603.97 1018.4C601.874 1018.46 599.811 1018.34 597.712 1018.21C596.481 1018.14 595.237 1018.06 593.968 1018.03C590.615 1017.92 587.223 1018.09 584.029 1019.37L584.022 1019.37L584.015 1019.38C582.73 1019.91 581.594 1020.6 580.527 1021.3C580.19 1021.52 579.864 1021.74 579.543 1021.96C578.829 1022.43 578.138 1022.9 577.399 1023.34C573.201 1025.72 567.79 1026.7 562.367 1026.9C552.999 1027.2 543.715 1025.42 536.533 1020.95C534.897 1019.91 533.421 1018.76 531.914 1017.59C531.153 1017 530.384 1016.4 529.583 1015.81C527.238 1014.07 524.713 1012.45 521.614 1011.45C518.992 1010.56 516.185 1010.25 513.484 1009.99C513.291 1009.97 513.099 1009.96 512.908 1009.94C510.372 1009.69 507.941 1009.46 505.665 1008.84L505.656 1008.83C500.984 1007.59 497.13 1004.82 493.897 1001.68C489.961 997.846 486.93 993.525 486.084 988.921C484.999 982.954 487.354 977.04 489.774 970.963C489.893 970.665 490.011 970.368 490.129 970.069Z"></path>
                        <path className="st47" d="M509.121 972.549L509.123 972.542L509.126 972.535C509.585 971.313 510.022 970.106 510.455 968.912C511.549 965.895 512.611 962.965 513.901 960.095L513.904 960.088L513.907 960.081C515.635 956.077 517.804 952.016 521.73 949.09L521.731 949.089C524.638 946.92 528.278 945.492 532.2 944.555L532.2 944.555L532.208 944.553C535.682 943.693 539.319 943.329 543.007 943.11C546.663 942.893 550.36 942.967 553.966 943.61C554.761 943.758 555.575 943.94 556.406 944.126C558.301 944.549 560.282 944.99 562.31 945.096L562.314 945.096C564.837 945.217 567.336 944.808 569.7 944.42C570.318 944.319 570.927 944.219 571.525 944.13L571.538 944.128C578.73 942.965 586.128 942.995 592.188 945.812C598.494 948.755 602.066 954.017 604.414 959.629L604.414 959.63C606.377 964.309 607.588 969.207 608.804 974.128L608.874 974.409C608.937 974.665 609.001 974.921 609.064 975.176C610.326 980.259 611.541 985.155 610.749 989.962C610.335 992.468 609.366 994.937 608.086 997.381L608.086 997.382C606.745 999.95 605.086 1002.31 602.629 1004.18C599.618 1006.39 595.824 1007.59 591.633 1007.73C590.12 1007.77 588.646 1007.68 587.131 1007.59C586.233 1007.54 585.322 1007.48 584.38 1007.45C581.93 1007.38 579.416 1007.5 577.039 1008.46L577.032 1008.46L577.026 1008.47C576.067 1008.87 575.224 1009.39 574.444 1009.91C574.193 1010.07 573.954 1010.23 573.719 1010.39C573.203 1010.74 572.712 1011.08 572.182 1011.39C569.185 1013.11 565.304 1013.83 561.383 1013.98C554.609 1014.19 547.919 1012.89 542.758 1009.65C541.578 1008.88 540.523 1008.06 539.434 1007.2C538.878 1006.76 538.314 1006.32 537.72 1005.88C536.007 1004.59 534.143 1003.38 531.848 1002.63C529.907 1001.97 527.836 1001.74 525.875 1001.55C525.737 1001.53 525.599 1001.52 525.462 1001.51C523.612 1001.33 521.868 1001.16 520.237 1000.7L520.237 1000.7L520.229 1000.7C516.895 999.808 514.132 997.802 511.799 995.514C508.955 992.709 506.794 989.579 506.192 986.27C505.417 981.958 507.104 977.673 508.872 973.182C508.955 972.972 509.038 972.761 509.121 972.549Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment && !tooth84Diagnozis.implant && !tooth84Diagnozis.apex && !tooth84Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth84.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment && !tooth84Diagnozis.implant && !tooth84Diagnozis.shaper && !tooth84Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        <g
                        ...
                        <g id="s_header_84_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_84_5" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_left && !tooth84Diagnozis.seal_bottom) ||
                                        (!tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_left && !tooth84Diagnozis.seal_center) ||
                                        (!tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth84Diagnozis.seal_right && tooth84Diagnozis.seal_center) ||
                                        (tooth84Diagnozis.seal_right && !tooth84Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_right && !tooth84Diagnozis.seal_bottom) ||
                                        (!tooth84Diagnozis.seal_right && tooth84Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_center && !tooth84Diagnozis.seal_bottom) ||
                                        (!tooth84Diagnozis.seal_center && tooth84Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g className="crown" style={{
                        visibility: (tooth84Diagnozis.temporary_crown || tooth84Diagnozis.ceramic_crown || tooth84Diagnozis.mceramic_crown || tooth84Diagnozis.metalic_crown || tooth84Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth84Diagnozis.temporary_crown || tooth84Diagnozis.ceramic_crown || tooth84Diagnozis.mceramic_crown || tooth84Diagnozis.metalic_crown || tooth84Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                            ...
                            C639.9,991.7,637.9,981.6,635.9,971.6z"
                        />
                        <path className={`st3 fissure ${tooth84Diagnozis.fissure ? 'diagnoze' : tooth84Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment && !tooth84Diagnozis.implant && !tooth84Diagnozis.apex && !tooth84Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth84Diagnozis.fissure ? 'diagnoze' : ''}`} 
                            d="M613.8,968.6c-4.5,0.5-8.6,2.8-11.3,6.4c-0.8,1.1-1.6,2.3-2.3,3.5c-2,3.2-3.8,6.3-7.3,6.6
                            c-2.2,0.2-4.2-0.9-6.2-2l-0.4-0.2c-6-3.3-12.3-5.7-18.9-7.2c-0.3-3.3,0-6,1-8.2c0.3-0.6,0.6-1.2,1-1.8c0.9-1.6,1.9-3.3,1.7-5.4
                            c-0.2-2.2-1.6-3.7-3-5.2c-0.9-0.9-1.8-1.9-2.4-3c-1.5-3-0.4-6.4,0.7-9.7c0.2-0.6,0.4-1.2,0.6-1.8c1.2-3.8,1.7-7.8,1.5-11.8
                            l-1.1,0.1c0.2,3.9-0.3,7.7-1.4,11.4c-0.2,0.6-0.4,1.2-0.6,1.8c-1.1,3.5-2.3,7.1-0.6,10.5c0.6,1.3,1.6,2.3,2.5,3.3
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 285, 35)'}}
                    onMouseOver={() => {
                        showHideTopCommonView('over')
                    }}
                    onMouseLeave={() => {
                ...
                >
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth84Diagnozis.channel_class} ${tooth84Diagnozis.channel_class} ${tooth84Diagnozis.pulpit ? 'pulpit' : ''} ${tooth84Diagnozis.periodontit ? 'periodontit' : ''}`}  
                        ...
                        <g>
                            <path className={`st22 target part ${tooth84Diagnozis.channel_class} ${tooth84Diagnozis.channel_class} ${tooth84Diagnozis.pulpit ? 'pulpit' : ''} ${tooth84Diagnozis.periodontit ? 'periodontit' : ''} top-sealed-part`}  
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth84Diagnozis.pin ? 1 : 0
                    }}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth84Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth84Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth84Diagnozis.abutment || tooth84Diagnozis.implant || tooth84Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment && !tooth84Diagnozis.implant && !tooth84Diagnozis.shaper && !tooth84Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth84.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth84Diagnozis.culttab && !tooth84Diagnozis.abutment && !tooth84Diagnozis.implant && !tooth84Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС TOP*/}
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_left && !tooth84Diagnozis.seal_top && !tooth84Diagnozis.seal_center) ||
                                        (tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_top && !tooth84Diagnozis.seal_center) ||
                                        (!tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_left && !tooth84Diagnozis.seal_bottom) ||
                                        (!tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_bottom && !tooth84Diagnozis.seal_center) ||
                                        (!tooth84Diagnozis.seal_left && tooth84Diagnozis.seal_bottom && tooth84Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_bottom && !tooth84Diagnozis.seal_center) ||
                                        (!tooth84Diagnozis.seal_bottom && tooth84Diagnozis.seal_center) ||
                                        (tooth84Diagnozis.seal_right && tooth84Diagnozis.seal_left && !tooth84Diagnozis.seal_center && !tooth84Diagnozis.seal_top) ||
                                        (!tooth84Diagnozis.seal_top && !tooth84Diagnozis.seal_bottom && tooth84Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth84Diagnozis.seal_right && !tooth84Diagnozis.seal_bottom) ||
                                        (!tooth84Diagnozis.seal_right && tooth84Diagnozis.seal_bottom && !tooth84Diagnozis.seal_center) ||
                                        (!tooth84Diagnozis.seal_right && tooth84Diagnozis.seal_bottom && tooth84Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
