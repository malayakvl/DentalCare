...
export default function tooth84() {
    ...
    return (
        <>
            ...
            <g id="TH-84" className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth84.show && !teethDiagnozis.tooth84.absent)  ? 'f-tooth-active' : ''}`}                onClick={() => {
            ...
            >
                <g className={`underlay ${selectedTooth === 84 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}
                    onMouseOver={() => {
