...
export default function Tooth41() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth41.caries_bottom = !teethDiagnozis.tooth41.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth41.caries_center = !teethDiagnozis.tooth41.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth41.caries_left = !teethDiagnozis.tooth41.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth41.caries_right = !teethDiagnozis.tooth41.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth41.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth41.seal_center_color = sealColor1;
                    teethDiagnozis.tooth41.seal_center = true;
                } else if (teethDiagnozis.tooth41.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth41.seal_center_color = sealColor2;
                    teethDiagnozis.tooth41.seal_center = true;
                } else if (teethDiagnozis.tooth41.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth41.seal_center_color = sealColor3;
                    teethDiagnozis.tooth41.seal_center = true;
                } else {
                    teethDiagnozis.tooth41.seal_center = !teethDiagnozis.tooth41.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth41.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth41.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth41.seal_bottom = true;
                } else if (teethDiagnozis.tooth41.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth41.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth41.seal_bottom = true;
                } else if (teethDiagnozis.tooth41.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth41.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth41.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth41.seal_bottom = !teethDiagnozis.tooth41.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth41.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth41.seal_left_color = sealColor1;
                    teethDiagnozis.tooth41.seal_left = true;
                } else if (teethDiagnozis.tooth41.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth41.seal_left_color = sealColor2;
                    teethDiagnozis.tooth41.seal_left = true;
                } else if (teethDiagnozis.tooth41.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth41.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth41.seal_right_color = sealColor1;
                    teethDiagnozis.tooth41.seal_right = true;
                } else if (teethDiagnozis.tooth41.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth41.seal_right_color = sealColor2;
                    teethDiagnozis.tooth41.seal_right = true;
                } else if (teethDiagnozis.tooth41.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth41.seal_right_color = sealColor3;
                    teethDiagnozis.tooth41.seal_right = true;
                } else {
                    teethDiagnozis.tooth41.seal_right = !teethDiagnozis.tooth41.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth41.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth41.seal_top_color = sealColor1;
                    teethDiagnozis.tooth41.seal_top = true;
                } else if (teethDiagnozis.tooth41.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth41.seal_top_color = sealColor2;
                    teethDiagnozis.tooth41.seal_top = true;
                } else if (teethDiagnozis.tooth41.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth41.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth41.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth41.wedge_shaped_defect_color = !teethDiagnozis.tooth41.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="41" className={`tooth-number-active ${teethType === 'child' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 995.4922 842.0025)" className={`st3 st4 st5 ${toothActive.tooth41.active ? 'num-active' : ''}`}>41</text>
            </g>
            <g id="TH-41" className={`f-tooth-init ${(teethDiagnozis.tooth41.show && !teethDiagnozis.tooth41.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (!teethDiagnozis.tooth41.show) {
                        if (teethType === 'adult') {
                    ...
                    (!toothActive && !allTeeth) && document.getElementById('41').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    (!toothActive && !allTeeth) && document.getElementById('41').classList.remove('tooth-number-hover')
                }}
                onClick={() => {
                    dispatch(setSelectedToothNumber(16));
                    if (toothActive.tooth41.active) {
                        dispatch(setNewToothActive({tooth41: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth41.change_color = !teethDiagnozis.tooth41.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth41.fissure = !teethDiagnozis.tooth41.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth41.caries = !teethDiagnozis.tooth41.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth41.cervical_caries = !teethDiagnozis.tooth41.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth41.wedge_shaped_defect = !teethDiagnozis.tooth41.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth41.tartar = !teethDiagnozis.tooth41.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth41.pulpit = !teethDiagnozis.tooth41.pulpit;
                            teethDiagnozis.tooth41.channel_class = teethDiagnozis.tooth41.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth41.channel_not_sealed = !teethDiagnozis.tooth41.channel_not_sealed;
                            teethDiagnozis.tooth41.channel_class = teethDiagnozis.tooth41.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth41.channel_top_sealed = !teethDiagnozis.tooth41.channel_top_sealed;
                            teethDiagnozis.tooth41.channel_class = teethDiagnozis.tooth41.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth41.channel_part_sealed = !teethDiagnozis.tooth41.channel_part_sealed;
                            teethDiagnozis.tooth41.channel_class = teethDiagnozis.tooth41.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth41.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth41.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth41.periodontit = true;
                            } else {
                                teethDiagnozis.tooth41.periodontit = !teethDiagnozis.tooth41.periodontit;
                            }
                            teethDiagnozis.tooth41.channel_class = teethDiagnozis.tooth41.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth41.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth41.seal_cervical && teethDiagnozis.tooth41.seal_cervical_color === "") {
                                teethDiagnozis.tooth41.seal_cervical = true;
                                teethDiagnozis.tooth41.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth41.seal_cervical && teethDiagnozis.tooth41.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth41.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth41.seal_cervical = false;
                                teethDiagnozis.tooth41.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth41.vinir && teethDiagnozis.tooth41.vinir_color === "") {
                                teethDiagnozis.tooth41.vinir = true;
                                teethDiagnozis.tooth41.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth41.vinir && teethDiagnozis.tooth41.vinir_color != vinirColor) {
                                teethDiagnozis.tooth41.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth41.vinir = false;
                                teethDiagnozis.tooth41.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth41.temporary_crown = !teethDiagnozis.tooth41.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth41.ceramic_crown && teethDiagnozis.tooth41.ceramic_crown_color === "") {
                                teethDiagnozis.tooth41.ceramic_crown = true;
                                teethDiagnozis.tooth41.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth41.ceramic_crown && teethDiagnozis.tooth41.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth41.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth41.ceramic_crown = false;
                                teethDiagnozis.tooth41.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth41.mceramic_crown && teethDiagnozis.tooth41.mceramic_crown_color === "") {
                                teethDiagnozis.tooth41.mceramic_crown = true;
                                teethDiagnozis.tooth41.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth41.mceramic_crown && teethDiagnozis.tooth41.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth41.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth41.mceramic_crown = false;
                                teethDiagnozis.tooth41.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth41.metalic_crown && teethDiagnozis.tooth41.metalic_crown_color === "") {
                                teethDiagnozis.tooth41.metalic_crown = true;
                                teethDiagnozis.tooth41.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth41.metalic_crown && teethDiagnozis.tooth41.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth41.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth41.metalic_crown = false;
                                teethDiagnozis.tooth41.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth41.zirconia_crown && teethDiagnozis.tooth41.zirconia_crown_color === "") {
                                teethDiagnozis.tooth41.zirconia_crown = true;
                                teethDiagnozis.tooth41.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth41.zirconia_crown && teethDiagnozis.tooth41.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth41.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth41.zirconia_crown = false;
                                teethDiagnozis.tooth41.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth41.pin = !teethDiagnozis.tooth41.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth41.culttab = !teethDiagnozis.tooth41.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth41.abutment = !teethDiagnozis.tooth41.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth41.shaper = !teethDiagnozis.tooth41.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth41.implant = !teethDiagnozis.tooth41.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth41.apex = !teethDiagnozis.tooth41.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth41.absent = !teethDiagnozis.tooth41.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth41.cervical_caries = !teethDiagnozis.tooth41.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth41.caries = !teethDiagnozis.tooth41.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth41.parodontit) {
                                if (teethDiagnozis.tooth41.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth41.parodontit = false;
                                    teethDiagnozis.tooth41.active = false;
                                } else {
                                    teethDiagnozis.tooth41.parodontit = true;
                                    teethDiagnozis.tooth41.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth41.parodontit = true;
                                teethDiagnozis.tooth41.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth41.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_41_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g style={{visibility: !tooth41Diagnozis.implant && !tooth41Diagnozis.apex && !tooth41Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        <g style={{visibility: !tooth41Diagnozis.implant && !tooth41Diagnozis.abutment && !tooth41Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth41Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g style={{visibility: tooth41Diagnozis.implant || tooth41Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth41Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth41Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth41Diagnozis.pin ? 1 : 0}}>
                        ...
                        <path className="st56 hIntact" d="M1033.2 983.571L1033.2 983.571L1033.2 983.58C1034.22 985.054 1034.24 986.797 1033.4 988.406C1032.17 990.546 1029.65 991.929 1026.77 992.991C1022.91 994.35 1018.77 994.918 1014.52 995C1009.53 994.999 1004.5 994.268 1000.06 992.586C997.589 991.604 995.487 990.393 994.501 988.588C993.826 987.238 993.812 985.678 994.587 984.134C995.333 982.731 996.547 981.511 997.879 980.271L997.885 980.266L997.891 980.26C1000.5 977.751 1003.05 974.975 1005.18 972.017L1005.18 972.01L1005.19 972.002C1005.21 971.962 1005.24 971.921 1005.27 971.88C1006.18 970.562 1007.07 969.285 1008.2 968.437C1009.75 967.343 1011.67 966.829 1013.67 967.05C1016.34 967.345 1018.64 968.903 1020.57 970.814C1021.7 971.964 1022.7 973.19 1023.72 974.451C1024.03 974.823 1024.33 975.199 1024.64 975.576C1026 977.208 1027.45 978.847 1029.24 980.239C1029.68 980.601 1030.2 980.972 1030.69 981.319C1030.98 981.527 1031.26 981.726 1031.5 981.909C1032.21 982.447 1032.79 982.966 1033.2 983.571Z" style={{visibility: 'hidden'}}></path>
                        <circle className="st57" cx="1013" cy="983" r="12.25"></circle>
                    </g>
                    <g className="stump" style={{visibility: !tooth41Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth41Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1037.27 983.855L1037.27 983.855L1037.27 983.864C1038.54 985.72 1038.56 987.915 1037.52 989.923C1036.01 992.581 1032.92 994.274 1029.46 995.561C1024.79 997.212 1019.81 997.901 1014.69 998.001C1008.69 998 1002.62 997.113 997.264 995.069C994.294 993.881 991.708 992.393 990.488 990.14C989.644 988.442 989.63 986.483 990.59 984.557C991.504 982.826 992.985 981.329 994.584 979.83L994.59 979.825L994.595 979.819C997.725 976.791 1000.77 973.445 1003.31 969.882L1003.32 969.875L1003.32 969.867C1003.36 969.814 1003.4 969.76 1003.43 969.707C1004.52 968.123 1005.6 966.554 1006.99 965.508C1008.89 964.156 1011.24 963.522 1013.69 963.794C1016.96 964.158 1019.76 966.077 1022.09 968.403C1023.45 969.801 1024.65 971.293 1025.89 972.819C1026.25 973.268 1026.62 973.72 1026.99 974.173C1028.61 976.145 1030.34 978.112 1032.47 979.781C1033 980.216 1033.61 980.656 1034.19 981.071C1034.54 981.324 1034.88 981.568 1035.18 981.797C1036.04 982.451 1036.76 983.095 1037.27 983.855Z"></path>
                        <path className="st47" d="M1033.2 983.571L1033.2 983.571L1033.2 983.58C1034.22 985.054 1034.24 986.797 1033.4 988.406C1032.17 990.546 1029.65 991.929 1026.77 992.991C1022.91 994.35 1018.77 994.918 1014.52 995C1009.53 994.999 1004.5 994.268 1000.06 992.586C997.589 991.604 995.487 990.393 994.501 988.588C993.826 987.238 993.812 985.678 994.587 984.134C995.333 982.731 996.547 981.511 997.879 980.271L997.885 980.266L997.891 980.26C1000.5 977.751 1003.05 974.975 1005.18 972.017L1005.18 972.01L1005.19 972.002C1005.21 971.962 1005.24 971.921 1005.27 971.88C1006.18 970.562 1007.07 969.285 1008.2 968.437C1009.75 967.343 1011.67 966.829 1013.67 967.05C1016.34 967.345 1018.64 968.903 1020.57 970.814C1021.7 971.964 1022.7 973.19 1023.72 974.451C1024.03 974.823 1024.33 975.199 1024.64 975.576C1026 977.208 1027.45 978.847 1029.24 980.239C1029.68 980.601 1030.2 980.972 1030.69 981.319C1030.98 981.527 1031.26 981.726 1031.5 981.909C1032.21 982.447 1032.79 982.966 1033.2 983.571Z"></path>
                    </g>
                    <g style={{visibility: (!tooth41Diagnozis.culttab && !tooth41Diagnozis.abutment && !tooth41Diagnozis.implant && !tooth41Diagnozis.apex && !tooth41Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{opacity: teethDiagnozis.tooth41.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth41Diagnozis.culttab && !tooth41Diagnozis.abutment && !tooth41Diagnozis.implant && !tooth41Diagnozis.shaper && !tooth41Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_left && !tooth41Diagnozis.seal_top && !tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_left && !tooth41Diagnozis.seal_top && !tooth41Diagnozis.seal_center) ||
                                        (!tooth41Diagnozis.seal_left && tooth41Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_left && !tooth41Diagnozis.seal_bottom) ||
                                        (!tooth41Diagnozis.seal_left && tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (!tooth41Diagnozis.seal_left && tooth41Diagnozis.seal_bottom && tooth41Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (!tooth41Diagnozis.seal_bottom && tooth41Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_right && !tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (!tooth41Diagnozis.seal_right && tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_right && !tooth41Diagnozis.seal_bottom && tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_center && tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_right)
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth41Diagnozis.seal_right && tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_right && !tooth41Diagnozis.seal_center)
                    ...
                    <g className="crown" style={{
                        visibility: (tooth41Diagnozis.temporary_crown || tooth41Diagnozis.ceramic_crown || tooth41Diagnozis.mceramic_crown || tooth41Diagnozis.metalic_crown || tooth41Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth41Diagnozis.temporary_crown || tooth41Diagnozis.ceramic_crown || tooth41Diagnozis.mceramic_crown || tooth41Diagnozis.metalic_crown || tooth41Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                ...
                <g id="T_41" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        <g id="dentin_v_41" style={{visibility: !tooth41Diagnozis.implant && !tooth41Diagnozis.apex && !tooth41Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_v_41" className={`st10 change-color ${tooth41Diagnozis.change_color ? 'diagnoze' : ''}`}   d="M1040.3,1172.7c0,5.2-0.1,10.4-0.3,15.6c-0.8,18.5-2.6,37.1-4.5,55.6
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth41Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56" d="M990.5 1206.6C990.8 1207.3 991.1 1208 991.4 1208.8C993.8 1214.4 997 1219.6 1002.2 1222.9C1003.9 1224 1005.8 1224.8 1007.7 1225.4H1007.8C1011.4 1226.4 1015.1 1226.4 1018.7 1225.5C1019.1 1225.4 1019.5 1225.3 1019.9 1225.2C1021.4 1224.7 1022.8 1224.1 1024.2 1223.3C1032.5 1218.5 1036.5 1209.3 1039.4 1200.2C1039.7 1196.2 1039.9 1192.2 1040 1188.3C1040.2 1183.1 1040.3 1177.9 1040.3 1172.7C1040.3 1165.2 1040 1157.8 1039.3 1150.3L1037.9 1147.8L1036.2 1146.8L998.3 1146.9L996.7 1148.3L995.8 1149.8C994 1158.4 992.6 1167 991.7 1175.8C991.2 1180.8 990.8 1185.9 990.6 1191C990.5 1196.2 990.4 1201.4 990.5 1206.6Z" style={{visibility: 'hidden'}}></path>
                        <path className="st57" style={{fill: tooth41Diagnozis.pin ? '#dbd9d3' : 'none'}}
                    ...
                    {/* ФОРМУВАЧ */}
                    <g className="shaper" style={{visibility: 'hidden', opacity: 0}} >
                        <path className="st44" d="M996.559 1196.45C996.364 1194.08 998.261 1192.07 1000.63 1192.12L1026.41 1192.7C1028.79 1192.75 1030.59 1194.85 1030.29 1197.2L1025.3 1236.51C1025.04 1238.55 1023.28 1240.06 1021.22 1240.01L1003.67 1239.52C1001.63 1239.46 999.962 1237.88 999.795 1235.85L996.559 1196.45Z"
                        />
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth41Diagnozis.abutment || tooth41Diagnozis.implant || tooth41Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="991.2" y1="1247.3" x2="1032.6" y2="1254.7" />
                        <line className="st19" x1="991.2" y1="1271.3" x2="1030.6" y2="1277.7" />
                        <line className="st19" x1="989.2" y1="1294.3" x2="1028.6" y2="1300.7" />
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth41Diagnozis.culttab && !tooth41Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    {/* TARTAR */}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth41.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling" style={{visibility: (!tooth41Diagnozis.culttab && !tooth41Diagnozis.abutment && !tooth41Diagnozis.implant && !tooth41Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС R*/}
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_left && !tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center && tooth41Diagnozis.seal_left) ||
                                        (!tooth41Diagnozis.seal_left && !tooth41Diagnozis.seal_bottom && tooth41Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth41Diagnozis.seal_right && !tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center) ||
                                        (tooth41Diagnozis.seal_bottom && !tooth41Diagnozis.seal_center && tooth41Diagnozis.seal_right) ||
                                        (!tooth41Diagnozis.seal_right && !tooth41Diagnozis.seal_bottom && tooth41Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
