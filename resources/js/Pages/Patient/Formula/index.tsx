            ...
            <section>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                    ...
                    <g className="pointers">
                        ...
                        <path className="st35 st_pointers" d="M948.6,773l-4.3-15.9H963l-9.3,34.7 L948.6,773" id="pointer_42"  style={{opacity: activeNumber == 42 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1007.3,773l-4.3-15.9h18.7l-9.3,34.7 L1007.3,773" id="pointer_41" style={{opacity: activeNumber == 41 ? 1 : 0}} />
                        ...
                        <path className="st35 st_pointers" d="M1422.2,773l-5.1,18.8l-9.3-34.7h18.7 L1422.2,773" id="pointer_35" style={{opacity: activeNumber == 35 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1326.7,773l-5.1,18.8l-9.3-34.7h18.7 L1326.7,773" id="pointer_34" style={{opacity: activeNumber == 34 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1234.3,773l-5.1,18.8l-9.3-34.7h18.7 L1234.3,773" id="pointer_33" style={{opacity: activeNumber == 33 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1150.6,773l-5.1,18.8l-9.3-34.7h18.7 L1150.6,773" id="pointer_32" style={{opacity: activeNumber == 32 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1091.9,773l-5.1,18.8l-9.3-34.7h18.7 L1091.9,773" id="pointer_31" style={{opacity: activeNumber == 31 ? 1 : 0}} />
                        ...
                        <path className="st35 st_pointers" d="M656.4,739.2l5.1-18.8l9.3,34.7h-18.7 L656.4,739.2" id="pointer_15" style={{opacity: activeNumber == 15 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M734,739.2l5.1-18.8l9.3,34.7h-18.7 L734,739.2" id="pointer_14" style={{opacity: activeNumber == 14 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M827.9,739.2l5.1-18.8l9.3,34.7h-18.7 L827.9,739.2" id="pointer_13" style={{opacity: activeNumber == 13 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M907.6,739.2l5.1-18.8l9.3,34.7h-18.7 L907.6,739.2" id="pointer_12" style={{opacity: activeNumber == 12 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M998.5,739.2l5.1-18.8l9.3,34.7h-18.7 L998.5,739.2" id="pointer_11" style={{opacity: activeNumber == 11 ? 1 : 0}} />
                        ...
                        <path className="st35 st_pointers" d="M1442.1,739.2l4.3,15.9h-18.7l9.3-34.7 L1442.1,739.2" id="pointer_25" style={{opacity: activeNumber == 25 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1364.5,739.2l4.3,15.9h-18.7l9.3-34.7 L1364.5,739.2" id="pointer_24" style={{opacity: activeNumber == 24 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1270.6,739.2l4.3,15.9h-18.7l9.3-34.7 L1270.6,739.2" id="pointer_23" style={{opacity: activeNumber == 23 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1190.9,739.2l4.3,15.9h-18.7l9.3-34.7 L1190.9,739.2" id="pointer_22" style={{opacity: activeNumber == 22 ? 1 : 0}} />
                        <path className="st35 st_pointers" d="M1100,739.2l4.3,15.9h-18.7l9.3-34.7 L1100,739.2" id="pointer_21" style={{opacity: activeNumber == 21 ? 1 : 0}} />
                    </g>
                </svg>
