...
import {
    ...
    teethTypeSelector,
    getActiveToothNumberSelector, allTeethChildSelector
...
export default function Tooth64() {
    ...
    return (
        <>
            ...
            <g id="TH-64" className={`f-tooth-init-milk ${((teethDiagnozis.tooth64.show || allTeeth) && !teethDiagnozis.tooth64.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
            ...
            >
                ...
                >
                    ...
                    <g className="dentin">
                        <g className={`d-ch-color`} style={{visibility: !tooth64Diagnozis.culttab && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility: "hidden"}}>
                            <path className={`st24 ${tooth64Diagnozis.apex ? 'apex' : ''}`} 
                            ...
                            <path className={`st24 ${tooth64Diagnozis.apex ? 'apex' : ''}`} 
                                d="M1603.33 588.108C1603.33 604.978 1607.18 623 1588.48 623C1580.07 623 1571.77 613.671 1561.23 608.158C1546.61 600.512 1530.66 600.403 1530.66 588.108C1530.66 575.812 1546.51 578.474 1566.57 578.474C1586.64 578.474 1599.59 574.763 1603.33 588.108Z"></path>
                        </g>
                    </g>
                    {/*PULPIT/CHANNEL NOT SEALED/PART SALED*/}
                    <g className="pulp" style={{visibility: tooth64Diagnozis.apex || tooth64Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling"  style={{visibility: tooth64Diagnozis.apex || tooth64Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                            <ellipse className="st22 target" rx="8.35873" ry="8.88548" transform="matrix(0.20079 0.979634 -0.979591 0.201001 1589.24 611.974)"
                                style={{fill: "#e80808"}}
                            />
                            <ellipse className="st22 target" rx="7.49795" ry="8.49071" transform="matrix(0.462479 -0.88663 0.886423 0.462876 1590.63 588.578)"
                                style={{fill: "#e80808"}}
                            />
                            <ellipse className="st22 target" rx="7.52553" ry="9.0049" transform="matrix(0.639533 0.768764 -0.768421 0.639945 1543.54 588.522)"
                                style={{fill: "#e80808"}}
                            />
                        </g>
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth64Diagnozis.implant || tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth64Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth64Diagnozis.abutment ? 1 : 0}}>
                    ...
                    <g style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.apex && !tooth64Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth64.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper && !tooth64Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g
                        ...
                        <g className="with">
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_left && !tooth64Diagnozis.seal_bottom) ||
                                        (!tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_bottom) ||
                                        (!tooth64Diagnozis.seal_center && tooth64Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g>
                        ...
                        >
                            <path className={`vinir-fill ${tooth64Diagnozis.vinir_color}`}  
                                d="M1626.2 555.5C1624.51 552.1 1622.51 549 1620.31 546.1C1614.81 539.1 1607.71 533.9 1598.32 531.6C1587.53 529 1576.23 532 1565.04 531.5C1559.24 531.2 1553.24 530.3 1547.65 529.4C1528.06 526.4 1507.97 527.2 1497.18 543.2C1496.48 544.3 1495.78 545.4 1495.18 546.6C1493.38 550.2 1492.38 554.2 1491.58 558.2C1489.68 568.4 1489.88 
                                578.5 1490.88 588.6C1491.03 590.067 1491.19 591.534 1491.37 593C1494.09 592.9 1499.92 591.881 1501.51 588.6C1500.77 580.389 1500.69 572.173 1502.24 563.88C1502.93 560.449 1503.79 557.019 1505.34 553.932C1505.85 552.903 1506.46 551.959 1507.06 551.016C1516.35 537.294 1533.63 536.608 1550.49 539.181C1555.31 539.953 1560.47 540.725 1565.46 540.982C1575.09 541.411 
                                1584.81 538.838 1594.1 541.068C1602.18 543.04 1608.29 547.5 1613.02 553.503C1614.91 555.99 1616.63 558.648 1618.09 561.564C1622.37 569.878 1624.59 579.444 1627.31 588.5C1628.47 592.5 1635.49 593.167 1638.85 593C1634.66 580.752 1632.14 567.084 1626.2 555.5Z"
                            />
                        </g>
                    </g>
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth64Diagnozis.implant && !tooth64Diagnozis.apex && !tooth64Diagnozis.shaper && !tooth64Diagnozis.apex ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth64Diagnozis.change_color ? 'diagnoze' : ''}`} 
                        ...
                        <g style={{visibility: !tooth64Diagnozis.implant && !tooth64Diagnozis.abutment && !tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="pin hEmpty hImplant" style={{
                        ...
                        <path className="st57" style={{fill: tooth64Diagnozis.pin ? '#dbd9d3' : 'none'}}  
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth64Diagnozis.abutment || tooth64Diagnozis.implant || tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth64Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} 
                            d="M1579.83 383.081C1560.45 380.202 1539.99 383.081 1522.87 391.64C1510.05 397.431 1504.44 406.132 1502.63 411.461C1502.21 412.71 1503.29 413.832 1504.6 413.662L1608.51 400.138C1610.05 399.938 1610.77 398.14 1609.74 396.981C1601.57 387.814 1593.34 385.172 1579.83 383.081Z"></path>
                        <path className={
                                `st60
                    ...
                    <g className="header caries-filling" style={{visibility: 'inherit'}}>
                        ...
                        >
                            ...
                            <path className={
                                `st8 caries-bottom
                                ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                ${tooth64Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                ${tooth64Diagnozis.seal_bottom ? `seal-fill ${teethDiagnozis.tooth64.seal_bottom_color}` : ''}
                            `} 
                        ...
                        <g className="with">
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        ...
                                        (tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_bottom) ||
                                        (!tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_top && tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_left && !tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center) ||
                                        (!tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth64Diagnozis.vinir_color}`}  
                                d="M1637.3 429C1636.4 423.7 1634.8 418.6 1632.4 413.7C1630 408.7 1626.8 403.9 1623.4 399.4C1620 394.8 1616.3 390.4 1612.4 386.2C1612.3 386.1 1612.3 386 1612.2 386C1603.4 382 1594 379.2 1584.1 377.6C1560.9 374 1536.4 377.6 1515.9 388.3C1506.8 393.1 1498.7 399.1 1492 406.2C1492 406.3 1492 406.3 1492 406.4C1491.4 411.8 1490.8 417.2 1490.2 422.6C1489.5 429.5 1488.8 436.5 1488.9 443.4C1489 450 1489.8 456.6 1491.3 463.1C1493.2 467.3 1495.8 471.2 1499 474.8C1504.2 480.7 1511 485.5 1518.8 488.9L1524.9 488.1C1526.6 486.3 1528.5 484.6 1530.6 483.1C1531.2 482.7 1531.7 
                                482.3 1532.3 481.9C1538 478 1544.4 475 1550.4 471.5C1552.3 470.4 1554.1 469.3 1555.9 468.1L1552.5 460.8L1551.5 450.9L1546.6 446.7L1547.6 445.3L1553 450.4L1554.2 460.5L1557.9 467.4C1559.3 468.3 1560.7 469 1562.3 469.6C1567.4 471.5 1573.2 471.9 1578.6 473.2C1583.3 474.4 1587.6 476.3 1591.3 478.9L1595.9 478.6C1596.8 478.1 1597.6 477.6 1598.5 477C1601.4 475.2 1604.2 473.3 1606.9 471.2C1613 466.5 1618.6 461.2 1621.3 454.7C1622.1 452.8 1622.6 450.9 1622.9 448.9L1624.6 449.1C1624.4 451 1623.9 452.8 1623.2 454.6C1621.7 458.3 1619.1 461.7 1616.3 464.8C1614.2 467.1 1612 469.2 1609.7 471.3C1611.5 471.4 1613.3 471.8 1614.9 472.4C1615.9 472.8 
                                1616.9 473.2 1617.8 473.8L1623.4 472.5C1627.9 466.8 1631.3 460.7 1633.7 454.3C1636.8 446 1638 437.4 1637.3 429Z"
                            />
                        </g>
                    </g>
