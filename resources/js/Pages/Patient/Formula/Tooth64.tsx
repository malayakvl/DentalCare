...
export default function Tooth64() {
    ...
    return (
        <>
            ...
            <g id="TH-61" className={`f-tooth-init-milk ${(teethDiagnozis.tooth64.show && !teethDiagnozis.tooth64.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (teethType === 'child') {
               ...
               onClick={() => {
                    // 
                    dispatch(setSelectedToothNumber(61));
                    // effects block
                    if (teethType === 'child' && teethDiagnozis.tooth64.show) {
                        teethDiagnozis.tooth64.show = false;
                        teethDiagnozis.tooth64.show = true;
                    } else if (teethType === 'child' && !teethDiagnozis.tooth64.show) {
                        teethDiagnozis.tooth64.show = false;
                        teethDiagnozis.tooth64.show = true;
                    } else {
                        teethDiagnozis.tooth64.show = true;
            ...
            > 
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 24, 17)'}}>
                    ...
                    <g className="dentin">
                        <g style={{visibility: !tooth64Diagnozis.culttab && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g style={{visibility: tooth64Diagnozis.implant || tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth64Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth64Diagnozis.abutment ? 1 : 0}}>
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.apex && !tooth64Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth64.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper && !tooth64Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС CENTER*/}
                        <g id="s_header_64_5" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth64.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth64.seal_center ? `seal-fill ${teethDiagnozis.tooth64.seal_center_color}` : ''}
                                `} 
                        ...
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_64_4" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth64.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth64.seal_left ? `seal-fill ${teethDiagnozis.tooth64.seal_left_color}` : ''}
                                `} 
                        ...
                        {/*КАРИЕС BOTTOM*/}
                        <g id="s_header_64_3 hoho-bottom" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth64.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth64.seal_bottom ? `seal-fill ${teethDiagnozis.tooth64.seal_bottom_color}` : ''}
                                `} 
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_64_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={`
                                    ...
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth64.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth64.seal_right ? `seal-fill ${teethDiagnozis.tooth64.seal_right_color}` : ''}
                                `}  
                        ...
                        {/*КАРИЕС TOP*/}
                        <g id="s_header_24_1" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={`
                                    st8 target caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth64.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth64.seal_top ? `seal-fill ${teethDiagnozis.tooth64.seal_top_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_right) ||
                                        (tooth64Diagnozis.seal_right && !tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_right && !tooth64Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_right && !tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_right && !tooth64Diagnozis.seal_top) ||
                                        (!tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_top) ||
                                        (!tooth64Diagnozis.seal_center && tooth64Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_left && !tooth64Diagnozis.seal_top) ||
                                        (!tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_left && !tooth64Diagnozis.seal_center) ||
                                        (!tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_left && !tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_left)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (!tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_bottom && !tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth64Diagnozis.fissure ? 'diagnoze' : tooth64Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    {/* FISSURES */}
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.apex && !tooth64Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth64Diagnozis.fissure ? 'diagnoze' : ''}`}
                            d="M1618.9,584.5c-1.5,3.9-3.7,7.3-6.7,10.2c-3.5,3.4-7.8,5.9-12.1,8.3l-1.2,0.7c-4.3,2.5-8.6,5.1-12.8,7.8
                            l-0.5-0.5c-0.5,0.5-0.9,1.1-1.3,1.6c-6.2-6.7-14-11.9-22.6-15.1c-5.7-2.1-12.2-3.5-20.5-4.3c-6.8-0.7-13.7-1-20.6-0.7l-19.1-13.1
                            l-0.6,0.9l19.4,13.3l0.2,0c6.9-0.2,13.8,0,20.6,0.7c8.1,0.8,14.6,2.2,20.2,4.3c8.5,3.1,16.3,8.3,22.4,15
                            c-2.2,3.6-2.8,7.7-3.3,11.8c-0.2,1.5-0.4,3-0.7,4.4c-1.3,6.7-4.4,13-9,18.2l0.8,0.7c4.7-5.3,7.9-11.8,9.2-18.7
                ...
                <g className="common-view"  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth64Diagnozis.implant && !tooth64Diagnozis.apex && !tooth64Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth64Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        ...
                        <g className="level hEmpty hImplant periodontitis"  dataposition="64"  style={{visibility: 'hidden', opacity: 0}}>
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth64Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        />
                        <path className="st57" d="M1564.1 446.9L1549.5 452.9L1528.7 450.2L1538 356.1L1538.1 355.6L1546.1 274.4C1546.3 273.3 1547.2 272.5 1548.3 272.5C1549.5 272.5 1550.4 273.4 1550.5 274.6L1555.3 339.9L1555.5 
                            342.5L1564.1 446.9Z"
                            style={{fill: tooth64Diagnozis.pin ? '#dbd9d3' : 'none'}}
                        />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth64Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth64Diagnozis.culttab ? 0 : 1}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper && !tooth64Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth64Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} 
                        ...
                        <path className={
                                `st60
                                    ${(tooth64Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth64Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth64Diagnozis.seal_cervical_color}
                                `
                            } 
                            d="M1579.83 383.081C1560.45 380.202 1539.99 383.081 1522.87 391.64C1510.05 397.431 1504.44 406.132 1502.63 411.461C1502.21 412.71 1503.29 413.832 1504.6 413.662L1608.51 400.138C1610.05 399.938 1610.77 398.14 1609.74 396.981C1601.57 387.814 1593.34 385.172 1579.83 383.081Z"
                        />
                    ...
                    {/* TARTAR */}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth64.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС CENTER*/}
                        ...
                        >
                            ...
                            `} 
                                d="M1598.5,476.9c-0.8,0.5-1.7,1-2.6,1.6l-4.6,0.3c-3.7-2.6-8-4.5-12.7-5.7c-5.4-1.4-11.2-1.7-16.3-3.6
                                    ...
                                    c3.8,0.2,16.2,6.6,22.8,10.2C1596.7,450.9,1597.8,467.9,1598.5,476.9z"
                                style={{
                                    fill: teethDiagnozis.tooth64.caries_center ? '#606c80' : 
                                    teethDiagnozis.tooth64.seal_center ? teethDiagnozis.tooth64.seal_center_color : 'transparent',
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_right && !tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center) ||
                                        (!tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_center) ||
                                        (tooth64Diagnozis.seal_right && tooth64Diagnozis.seal_left && tooth64Diagnozis.seal_center && !tooth64Diagnozis.seal_top) ||
                                        (!tooth64Diagnozis.seal_top && !tooth64Diagnozis.seal_bottom && tooth64Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth64Diagnozis.vinir_color}`}
                                d="M1637.3 429C1636.4 423.7 1634.8 418.6 1632.4 413.7C1630 408.7 1626.8 403.9 1623.4 399.4C1620 394.8 1616.3 390.4 1612.4 386.2C1612.3 386.1 1612.3 386 1612.2 386C1603.4 382 1594 379.2 1584.1 377.6C1560.9 374 1536.4 377.6 1515.9 388.3C1506.8 393.1 1498.7 399.1 1492 406.2C1492 406.3 1492 406.3 1492 406.4C1491.4 411.8 1490.8 417.2 1490.2 422.6C1489.5 429.5 1488.8 436.5 1488.9 443.4C1489 450 1489.8 456.6 1491.3 463.1C1493.2 467.3 1495.8 471.2 1499 474.8C1504.2 480.7 1511 485.5 1518.8 488.9L1524.9 488.1C1526.6 486.3 1528.5 484.6 1530.6 483.1C1531.2 482.7 1531.7 482.3 1532.3 481.9C1538 478 1544.4 475 1550.4 471.5C1552.3 
                                470.4 1554.1 469.3 1555.9 468.1L1552.5 460.8L1551.5 450.9L1546.6 446.7L1547.6 445.3L1553 450.4L1554.2 460.5L1557.9 467.4C1559.3 468.3 1560.7 469 1562.3 469.6C1567.4 471.5 1573.2 471.9 1578.6 473.2C1583.3 474.4 1587.6 476.3 1591.3 478.9L1595.9 478.6C1596.8 478.1 1597.6 477.6 1598.5 477C1601.4 475.2 1604.2 473.3 1606.9 471.2C1613 466.5 1618.6 461.2 1621.3 454.7C1622.1 452.8 1622.6 450.9 1622.9 448.9L1624.6 449.1C1624.4 451 1623.9 452.8 1623.2 454.6C1621.7 458.3 1619.1 461.7 1616.3 464.8C1614.2 467.1 1612 469.2 1609.7 471.3C1611.5 471.4 1613.3 471.8 1614.9 472.4C1615.9 472.8 1616.9 473.2 1617.8 473.8L1623.4 472.5C1627.9 466.8 1631.3 460.7 1633.7 
                                454.3C1636.8 446 1638 437.4 1637.3 429Z"
                            />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
