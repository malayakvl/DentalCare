...
export default function Tooth64() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth64.caries_bottom = !teethDiagnozis.tooth64.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth64.caries_center = !teethDiagnozis.tooth64.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth64.caries_left = !teethDiagnozis.tooth64.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth64.caries_right = !teethDiagnozis.tooth64.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth64.caries_top = !teethDiagnozis.tooth64.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth64.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth64.seal_center_color = sealColor1;
                    teethDiagnozis.tooth64.seal_center = true;
                } else if (teethDiagnozis.tooth64.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth64.seal_center_color = sealColor2;
                    teethDiagnozis.tooth64.seal_center = true;
                } else if (teethDiagnozis.tooth64.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth64.seal_center_color = sealColor3;
                    teethDiagnozis.tooth64.seal_center = true;
                } else {
                    teethDiagnozis.tooth64.seal_center = !teethDiagnozis.tooth64.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth64.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth64.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth64.seal_bottom = true;
                } else if (teethDiagnozis.tooth64.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth64.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth64.seal_bottom = true;
                } else if (teethDiagnozis.tooth64.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth64.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth64.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth64.seal_bottom = !teethDiagnozis.tooth64.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth64.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth64.seal_left_color = sealColor1;
                    teethDiagnozis.tooth64.seal_left = true;
                } else if (teethDiagnozis.tooth64.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth64.seal_left_color = sealColor2;
                    teethDiagnozis.tooth64.seal_left = true;
                } else if (teethDiagnozis.tooth64.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth64.seal_left_color = sealColor3;
                    teethDiagnozis.tooth64.seal_left = true;
                } else {
                    teethDiagnozis.tooth64.seal_left = !teethDiagnozis.tooth64.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth64.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth64.seal_right_color = sealColor1;
                    teethDiagnozis.tooth64.seal_right = true;
                } else if (teethDiagnozis.tooth64.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth64.seal_right_color = sealColor2;
                    teethDiagnozis.tooth64.seal_right = true;
                } else if (teethDiagnozis.tooth64.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth64.seal_right_color = sealColor3;
                    teethDiagnozis.tooth64.seal_right = true;
                } else {
                    teethDiagnozis.tooth64.seal_right = !teethDiagnozis.tooth64.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth64.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth64.seal_top_color = sealColor1;
                    teethDiagnozis.tooth64.seal_top = true;
                } else if (teethDiagnozis.tooth64.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth64.seal_top_color = sealColor2;
                    teethDiagnozis.tooth64.seal_top = true;
                } else if (teethDiagnozis.tooth64.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth64.seal_top_color = sealColor3;
                    teethDiagnozis.tooth64.seal_top = true;
                } else {
                    teethDiagnozis.tooth64.seal_top = !teethDiagnozis.tooth64.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth64.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth64.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth64.wedge_shaped_defect_color = !teethDiagnozis.tooth64.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            ...
            <g id="TH-64" className={`f-tooth-init-milk ${(teethDiagnozis.tooth64.show && !teethDiagnozis.tooth64.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (teethType === 'child') {
                        document.getElementById('TH-64').style.opacity = 1
                    } else {
                    ...
                    (!toothActive && !allTeeth) && document.getElementById('64').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth64.show) {
                        document.getElementById('TH-64').style.opacity = 0
                    }
                    if (teethDiagnozis.tooth64.show && teethType === 'adult') {
                        document.getElementById('TH-24').style.visibility = 'hidden'
                        document.getElementById('TH-64').style.visibility = 'inherit'
                    }
                    if (teethDiagnozis.tooth64.show && !teethDiagnozis.tooth64.absent && teethType === 'child') {
                        document.getElementById('TH-64').style.visibility = 'inherit'
                        document.getElementById('TH-24').style.visibility = 'hidden'
                    }
               ...
               onClick={() => {
                    ...
                    if (teethType === 'child') {
                        teethDiagnozis.tooth14.show = false;
                        teethDiagnozis.tooth64.show = !teethDiagnozis.tooth64.show;
                    } else {
                        teethDiagnozis.tooth64.show = false;
                    }

                    if (diagnozis) {
                        teethDiagnozis.tooth64.show = true;
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth64.change_color = !teethDiagnozis.tooth64.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth64.fissure = !teethDiagnozis.tooth64.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth64.caries = !teethDiagnozis.tooth64.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth64.cervical_caries = !teethDiagnozis.tooth64.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth64.wedge_shaped_defect = !teethDiagnozis.tooth64.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth64.tartar = !teethDiagnozis.tooth64.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth64.pulpit = !teethDiagnozis.tooth64.pulpit;
                            teethDiagnozis.tooth64.channel_class = teethDiagnozis.tooth64.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth64.channel_not_sealed = !teethDiagnozis.tooth64.channel_not_sealed;
                            teethDiagnozis.tooth64.channel_class = teethDiagnozis.tooth64.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth64.channel_top_sealed = !teethDiagnozis.tooth64.channel_top_sealed;
                            teethDiagnozis.tooth64.channel_class = teethDiagnozis.tooth64.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth64.channel_part_sealed = !teethDiagnozis.tooth64.channel_part_sealed;
                            teethDiagnozis.tooth64.channel_class = teethDiagnozis.tooth64.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth64.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth64.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth64.periodontit = true;
                            } else {
                                teethDiagnozis.tooth64.periodontit = !teethDiagnozis.tooth64.periodontit;
                            }
                            teethDiagnozis.tooth64.channel_class = teethDiagnozis.tooth64.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth64.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth64.seal = !teethDiagnozis.tooth64.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth64.seal_cervical && teethDiagnozis.tooth64.seal_cervical_color === "") {
                                teethDiagnozis.tooth64.seal_cervical = true;
                                teethDiagnozis.tooth64.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth64.seal_cervical && teethDiagnozis.tooth64.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth64.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth64.seal_cervical = false;
                                teethDiagnozis.tooth64.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth64.vinir && teethDiagnozis.tooth64.vinir_color === "") {
                                teethDiagnozis.tooth64.vinir = true;
                                teethDiagnozis.tooth64.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth64.vinir && teethDiagnozis.tooth64.vinir_color != vinirColor) {
                                teethDiagnozis.tooth64.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth64.vinir = false;
                                teethDiagnozis.tooth64.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth64.temporary_crown = !teethDiagnozis.tooth64.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth64.ceramic_crown && teethDiagnozis.tooth64.ceramic_crown_color === "") {
                                teethDiagnozis.tooth64.ceramic_crown = true;
                                teethDiagnozis.tooth64.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth64.ceramic_crown && teethDiagnozis.tooth64.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth64.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth64.ceramic_crown = false;
                                teethDiagnozis.tooth64.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth64.mceramic_crown && teethDiagnozis.tooth64.mceramic_crown_color === "") {
                                teethDiagnozis.tooth64.mceramic_crown = true;
                                teethDiagnozis.tooth64.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth64.mceramic_crown && teethDiagnozis.tooth64.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth64.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth64.mceramic_crown = false;
                                teethDiagnozis.tooth64.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth64.metalic_crown && teethDiagnozis.tooth64.metalic_crown_color === "") {
                                teethDiagnozis.tooth64.metalic_crown = true;
                                teethDiagnozis.tooth64.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth64.metalic_crown && teethDiagnozis.tooth64.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth64.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth64.metalic_crown = false;
                                teethDiagnozis.tooth64.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth64.zirconia_crown && teethDiagnozis.tooth64.zirconia_crown_color === "") {
                                teethDiagnozis.tooth64.zirconia_crown = true;
                                teethDiagnozis.tooth64.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth64.zirconia_crown && teethDiagnozis.tooth64.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth64.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth64.zirconia_crown = false;
                                teethDiagnozis.tooth64.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth64.pin = !teethDiagnozis.tooth64.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth64.culttab = !teethDiagnozis.tooth64.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth64.abutment = !teethDiagnozis.tooth64.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth64.shaper = !teethDiagnozis.tooth64.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth64.implant = !teethDiagnozis.tooth64.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth64.apex = !teethDiagnozis.tooth64.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth64.absent = !teethDiagnozis.tooth64.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth64.cervical_caries = !teethDiagnozis.tooth64.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth64.caries = !teethDiagnozis.tooth64.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth64.parodontit) {
                                if (teethDiagnozis.tooth64.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth64.parodontit = false;
                                    teethDiagnozis.tooth64.active = false;
                                } else {
                                    teethDiagnozis.tooth64.parodontit = true;
                                    teethDiagnozis.tooth64.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth64.parodontit = true;
                                teethDiagnozis.tooth64.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth64.active = true;
                            }
                        }
                    }
                    dispatch(setToothDiagnoze(teethDiagnozis))
            ...
            >
                <g className={`underlay ${selectedTooth === 64 ? 'selected' : ''}`}  style={{visibility: "inherit"}}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55,  -170, 31)'}}>
                    <g className="dentin">
                        <g className="hEmpty hRoot hImplant" style={{visibility: "inherit"}}>
                            ...
                            c5.4-2.6,9.9-6.3,12.6-10.8C1641.1,625.8,1639.8,616.1,1636,607.2z"></path>
                        </g>
                        <g className="hIntact hImplant hEmpty" style={{visibility: "hidden"}}>
                            <path className="st24" d="M1635.6 607.2C1634.1 603.7 1632.3 600.3 1630.8 596.9C1626.91 588 1624.61 578 1619.11 569.5C1613.81 561.2 1605.92 554.7 1594.22 552.4C1584.73 550.5 1574.74 552.5 1564.84 552.1C1559.74 551.9 1554.45 551.1 1549.45 550.5C1532.16 548.2 1514.37 548.7 1504.97 560C1502.27 563.2 1500.98 566.9 1500.18 570.6C1498.58 577.8 1498.78 585 1499.78 592.2C1501.18 602.6 1503.97 613.1 1508.97 622.8C1512.87 630.2 1518.07 637.2 1526.66 641.7C1533.96 645.5 1542.85 646.7 1551.55 645.9C1556.45 645.4 1561.24 644.2 1566.24 644.3C1574.84 644.4 1582.53 648.2 1590.93 649.5C1596.22 650.4 1601.72 650.3 1607.02 649.5C1612.61 648.7 1618.01 647.3 1622.91 645C1628.31 642.4 1632.8 638.7 1635.5 634.2C1640.7 625.8 1639.4 616.1 1635.6 607.2Z"></path>
                            <path className="st53" d="M1603.33 588.108C1603.33 604.978 1607.18 623 1588.48 623C1580.07 623 1571.77 613.671 1561.23 608.158C1546.61 600.512 1530.66 600.403 1530.66 588.108C1530.66 575.812 1546.51 578.474 1566.57 578.474C1586.64 578.474 1599.59 574.763 1603.33 588.108Z"></path>
                        </g>
                    </g>
                    <g className="pulp">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" data-position="64" style={{visibility: "hidden"}}>
                            <ellipse className="st22 target" rx="8.35873" ry="8.88548" transform="matrix(0.20079 0.979634 -0.979591 0.201001 1589.24 611.974)"></ellipse>
                            <ellipse className="st22 target" rx="7.49795" ry="8.49071" transform="matrix(0.462479 -0.88663 0.886423 0.462876 1590.63 588.578)"></ellipse>
                            <ellipse className="st22 target" rx="7.52553" ry="9.0049" transform="matrix(0.639533 0.768764 -0.768421 0.639945 1543.54 588.522)"></ellipse>
                        </g>
                    </g>
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: "hidden"}}>
                        <circle className="st48" cx="1566.5" cy="598.5" r="26.5"></circle>
                        <g className="st27">
                            <mask id="implant_64" className="st49">
                    ...
                    <g className="abutment hEmpty hIntact hRoot"  style={{visibility: "hidden", opacity: 0}}>
                        ...
                        <circle className="st45" r="13" transform="matrix(-1 0 0 1 1566.41 598)"></circle>
                    </g>
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <path className="st46" d="M1645,608.5c-1.6-4.9-3.7-9.6-5.4-14.5c-4.4-12.5-6.9-26.6-13-38.5
                            ...
                            C1650.5,634.6,1649.2,621,1645,608.5z"></path>
                    </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_header_64_5" className="caries-filling" data-position="64_5">
                            ...
                            c20.7-0.9,31.9,2.4,37.7,6.8c2.7,2.1,4.3,4.4,5.2,6.6C1609.8,587,1613.3,599.8,1611.9,612.3z"></path>
                            <path className="st8 target" d="M1611.9,612.3c-0.3,3.3-1.1,6-2.4,8.4c-3.6,6.5-11.8,9.4-29.3,10.8c-20.6,1.6-32.6-2-42.5-8.1
                            c-1.5-0.9-2.9-1.9-4.3-2.9c-10.9-7.8-11.7-30-11.7-35.6c0-3.1,1.1-6.3,3.4-9c1.8-2.1,4.4-3.9,7.8-5.3c7.7-3,31.4-3.9,31.4-3.9
                            c20.7-0.9,31.9,2.4,37.7,6.8c2.7,2.1,4.3,4.4,5.2,6.6C1609.8,587,1613.3,599.8,1611.9,612.3z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_64_4" className="caries-filling" data-position="64_4">
                            ...
                            C1534.8,621.5,1536.3,622.5,1537.8,623.4z"></path>
                            <path className="st8 target" d="M1537.8,623.4c-3.9,6.2-12.1,17.9-24.2,28.1c-5.3-5.7-9.1-12.7-12.1-20c-5.7-13.7-8.7-28.4-10.2-43
                            c-1-10.1-1.2-20.2,0.7-30.4c0.7-4,1.8-7.9,3.6-11.6c5.9,7.5,16.6,19.7,29.5,29.4c-2.3,2.7-3.4,5.8-3.4,9c0,5.6,0.8,27.9,11.7,35.6
                            C1534.8,621.5,1536.3,622.5,1537.8,623.4z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_64_3" className="caries-filling" data-position="64_3">
                            ...
                            C1639,643.2,1642.3,644.9,1644.7,646.4z"></path>
                            <path className="st8 target" d="M1644.7,646.4C1644.6,646.4,1644.6,646.4,1644.7,646.4c-3.2,6.4-8.3,11.6-14.4,15.4c-5.5,3.3-11.6,5.4-18,6.5
                            c-6,1.1-12.2,1.3-18.2,0.1c-9.5-1.8-18.2-7-28-7.1c-5.6,0-11,1.6-16.6,2.4c-9.9,1.3-20-0.4-28.1-5.6c-2.9-1.8-5.4-4-7.7-6.4
                            c12-10.3,20.2-21.9,24.2-28.1c9.9,6.1,21.9,9.7,42.5,8.1c17.5-1.4,25.7-4.3,29.3-10.8c4.9,8.6,14.6,17,25.1,20.9
                            C1639,643.2,1642.3,644.9,1644.7,646.4z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_64_2" className="caries-filling" data-position="64_2">
                            ...
                            c1.7,4.9,3.7,9.6,5.4,14.5C1649.2,621,1650.5,634.6,1644.7,646.4z"></path>
                            <path className="st8 target" d="M1644.7,646.4c-2.4-1.5-5.6-3.2-10-4.8c-10.5-3.9-20.2-12.4-25.1-20.9c1.3-2.3,2-5.1,2.4-8.4
                            c1.3-12.5-2.1-25.3-4.8-32.2c-0.8-2.2-2.4-4.5-5.2-6.6c6.3-13.3,14.1-22.6,18.7-27.5c2.2,2.9,4.2,6,6,9.4c6.1,12,8.6,26.1,13,38.5
                            c1.7,4.9,3.7,9.6,5.4,14.5C1649.2,621,1650.5,634.6,1644.7,646.4z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_64_1" className="caries-filling" data-position="64_1">
                            ...
                            c5.6,0.9,11.6,1.9,17.4,2.1c11.2,0.5,22.5-2.4,33.3,0.1C1608.1,533.8,1615.2,539,1620.7,546z"></path>
                            <path className="st8 target" d="M1620.7,546c-4.6,4.9-12.4,14.2-18.7,27.5c-5.8-4.4-17-7.8-37.7-6.8c0,0-23.7,0.9-31.4,3.9
                            c-3.4,1.4-6,3.2-7.8,5.3c-12.9-9.6-23.6-21.9-29.5-29.4c0.6-1.2,1.2-2.3,2-3.4c10.8-16,30.9-16.9,50.5-13.8
                            c5.6,0.9,11.6,1.9,17.4,2.1c11.2,0.5,22.5-2.4,33.3,0.1C1608.1,533.8,1615.2,539,1620.7,546z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="64_2 64_3" d="M1608.5 621C1611.67 625.333 1622.4 636.1 1640 644.5"></path>
                            <path className="st54" areas="64_2 64_5" d="M1608.5 621C1614 612 1614.2 583.5 1601 573.5"></path>
                            <path className="st54" areas="64_2 64_1" d="M1601 574C1601.5 568.333 1605.2 555.6 1616 550"></path>
                            <path className="st54" areas="64_1 64_5" d="M1601 574C1588 566.5 1530.4 565.2 1524 576"></path>
                            <path className="st54" areas="64_4 64_1" d="M1524 576C1517.83 572.167 1504 561.8 1498 551"></path>
                            <path className="st54" areas="64_4 64_5" d="M1524 576C1519 580.5 1519.7 614.4 1536.5 624"></path>
                            <path className="st54" areas="64_4 64_3" d="M1536.5 624C1535.17 628.167 1529.2 639 1516 649"></path>
                            <path className="st54" areas="64_3 64_5" d="M1536.5 624C1546.5 630 1591.4 631.5 1609 621.5"></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        <g className="vinir"  style={{visibility: "hidden", opacity: 0}}>
                            <path className="st55" d="M1626.2 555.5C1624.51 552.1 1622.51 549 1620.31 546.1C1614.81 539.1 1607.71 533.9 1598.32 531.6C1587.53 529 1576.23 532 1565.04 531.5C1559.24 531.2 1553.24 530.3 1547.65 529.4C1528.06 526.4 1507.97 527.2 1497.18 543.2C1496.48 544.3 1495.78 545.4 1495.18 546.6C1493.38 550.2 1492.38 554.2 1491.58 558.2C1489.68 568.4 1489.88 578.5 1490.88 588.6C1491.03 590.067 1491.19 591.534 1491.37 593C1494.09 592.9 1499.92 591.881 1501.51 588.6C1500.77 580.389 1500.69 572.173 1502.24 563.88C1502.93 560.449 1503.79 557.019 1505.34 553.932C1505.85 552.903 1506.46 551.959 1507.06 551.016C1516.35 537.294 1533.63 536.608 1550.49 539.181C1555.31 539.953 1560.47 540.725 1565.46 540.982C1575.09 541.411 1584.81 538.838 1594.1 541.068C1602.18 543.04 1608.29 547.5 1613.02 553.503C1614.91 555.99 1616.63 558.648 1618.09 561.564C1622.37 569.878 1624.59 579.444 1627.31 588.5C1628.47 592.5 1635.49 593.167 1638.85 593C1634.66 580.752 1632.14 567.084 1626.2 555.5Z"></path>
                        </g>
                    </g>
                    <g className="crown"  style={{visibility: "hidden", opacity: 0}}>
                        <path className="st46 target" d="M1645,608.5c-1.6-4.9-3.7-9.6-5.4-14.5c-4.4-12.5-6.9-26.6-13-38.5
                            c-1.7-3.4-3.7-6.5-5.9-9.4c-5.5-7-12.6-12.2-22-14.5c-10.8-2.6-22.1,0.4-33.3-0.1c-5.8-0.3-11.8-1.2-17.4-2.1
                            c-19.6-3-39.7-2.2-50.5,13.8c-0.7,1.1-1.4,2.2-2,3.4c-1.8,3.6-2.8,7.6-3.6,11.6c-1.9,10.2-1.7,20.3-0.7,30.4
                            c1.5,14.7,4.5,29.4,10.2,43c3,7.3,6.8,14.3,12.1,20c2.3,2.4,4.8,4.6,7.7,6.4c8.2,5.2,18.3,7,28.1,5.6c5.6-0.7,11-2.4,16.6-2.4
                            c9.8,0.1,18.4,5.3,28,7.1c6,1.2,12.2,1,18.2-0.1c6.4-1.1,12.5-3.2,18-6.5c6.1-3.7,11.2-8.9,14.4-15.3c0,0,0,0,0-0.1
                            C1650.5,634.6,1649.2,621,1645,608.5z"></path>
                        <path className="st3 fissure" d="M1618.9,584.5c-1.5,3.9-3.7,7.3-6.7,10.2c-3.5,3.4-7.8,5.9-12.1,8.3l-1.2,0.7c-4.3,2.5-8.6,5.1-12.8,7.8
                            ...
                            c3.1-3,5.4-6.6,7-10.6L1618.9,584.5z"></path>
                        <path className="st3 fissure" d="M1560,558.7c1.4,2.4,2.3,5.1,2.8,7.9l0.2,0l-8.1,27.5l1,0.3l9.1-31c0.8-3.6,2.1-7.1,4.1-10.3
                            c1.2-1.9,2.6-3.7,4.1-5.3l-0.8-0.8c-1.6,1.7-3.1,3.5-4.3,5.4c-2.1,3.3-3.5,6.9-4.3,10.6l-0.5,1.8c-0.6-2.3-1.4-4.6-2.6-6.7
                            c-2.8-5.1-7.4-9.6-11.7-11.5l-0.4,1C1552.9,549.5,1557.3,553.8,1560,558.7z"></path>
                    </g>
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, -165, 99)'}}>
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" data-position="64" style={{visibility: "inherit"}}>
                        ...
                        c-0.2,11.6,4.4,22.9,5.4,34.5C1576.3,414.6,1576.3,418.6,1575.8,422.5z"></path>
                        </g>
                        <g className="hEmpty hImplant pulpitis-pfilling" data-position="64" style={{visibility: "inherit"}}>
                        ...
                        c-1.5-9-1.3-18.2-0.4-27.4C1505.4,284.4,1508,270.8,1512,257.5z"></path>
                        ...
                        c-0.4,2.5-0.8,5-1.2,7.5c3.7-0.5,7.5-0.8,11.2-0.9c-0.2-4.1-0.4-8.3-0.6-12.5C1550.3,280.5,1550,260.6,1550.4,240.8z"></path>
                        ...
                        c1.3,0.2,2.5,0.5,3.6,0.7c0.1-0.4,0.2-0.9,0.3-1.3C1591.7,304.5,1592.4,293.9,1591.9,283.3z"></path>
                        </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g className="caries-filling" data-position="64_5">
                        ...
                        c-1.6-0.6-3.1-1.3-4.4-2.2l-3.7-6.9l-1.2-10.1l-5.4-5.1l-1,1.4l4.9,4.2l1,9.9l3.4,7.3c-1.8,1.2-3.6,2.3-5.5,3.4
                        c-6,3.5-12.5,6.5-18.1,10.4c-2.6-8.4-8.4-27-13.2-41.3c6.5-4.5,17.3-12.2,19.1-12.8c2.5-0.9,29.6-1.8,34.8-1.6
                        c3.8,0.2,16.2,6.6,22.8,10.2C1596.7,450.9,1597.8,467.9,1598.5,476.9z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" data-position="64_4">
                        ...
                        c-3.2-3.6-5.8-7.5-7.7-11.7c-1.5-6.5-2.3-13.1-2.4-19.7c-0.1-6.9,0.6-13.9,1.3-20.8c0.6-5.4,1.1-10.8,1.8-16.2
                        c5.6,4.3,17.1,13.1,19.7,15.6c1.2,1.1,4.1,8.8,7.4,18.6C1523.9,454.8,1529.7,473.4,1532.3,481.9z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" data-position="64_2">
                        ...
                        c-2.7,6.5-8.3,11.8-14.4,16.5c-2.7,2-5.5,4-8.4,5.8c-0.6-9-1.8-26-2.7-40.6c-0.8-13.7-1.5-25.3-1.2-26.1
                        c0.5-1.5,12.7-17.4,17.9-24.1c3.9,4.2,7.6,8.6,11,13.2c3.4,4.6,6.6,9.3,9,14.3c2.4,4.9,4,10,4.9,15.3
                        C1638,437.4,1636.8,446,1633.7,454.2z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" data-position="64_1">
                        ...
                        c-3.3-9.8-6.2-17.5-7.4-18.6c-2.6-2.5-14.1-11.3-19.7-15.6c0-0.1,0-0.1,0-0.2c6.7-7.1,14.7-13.1,23.9-17.9
                        c20.6-10.8,45-14.3,68.2-10.7c9.9,1.5,19.4,4.4,28.1,8.4c0.1,0.1,0.2,0.2,0.2,0.2c-5.2,6.7-17.3,22.6-17.9,24.1
                        C1594.3,411,1594.9,422.6,1595.8,436.3z" style={{strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="64_2 64_5" d="M1595.5 435.999L1598 471.499"></path>
                            <path className="st54" areas="64_1 64_2" d="M1595.5 435.999C1594 403.999 1589.5 411.999 1609.5 389.999"></path>
                            <path className="st54" areas="64_1 64_5" d="M1595.5 436.999C1579.5 420.999 1538.3 421.699 1519.5 440.499"></path>
                            <path className="st54" areas="64_1 64_4" d="M1519.5 440.499C1511.5 416.999 1511.3 413.999 1496.5 409.999"></path>
                            <path className="st54" areas="64_4 64_5" d="M1519.5 440.499L1530.5 476.499"></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        <g className="vinir"  style={{visibility: "hidden", opacity: 0}}>
