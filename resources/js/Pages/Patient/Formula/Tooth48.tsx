            ...
            >
                ...
                <g id="T_48" className="common-view" style={{visibility: tooth48Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    <g className="dentin">
                        ...
                        <g id="dentin_n_48" style={{visibility: !tooth48Diagnozis.culttab && !tooth48Diagnozis.abutment && !tooth48Diagnozis.implant && !tooth48Diagnozis.shaper && !tooth48Diagnozis.apex  ? 'inherit' : 'hidden'}}>
