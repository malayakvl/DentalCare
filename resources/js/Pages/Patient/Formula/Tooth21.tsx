...
import { setTooth21Active } from '@/Redux/Formula/actions';
        ...
        <>
            ...
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    dispatch(setTooth21Active(!toothActive));
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth21.pulpit ? 'pulpit' : '');
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth21.channel_not_sealed ? 'channel-not-sealed' : '');
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth21.channel_top_sealed ? 'channel-top-sealed' : '');
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth21.channel_part_sealed ? 'channel-part-sealed' : '');
            ...
            >
                ...
                <g id="T_21_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pulp">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" style={{visibility: 'inherit'}}>
