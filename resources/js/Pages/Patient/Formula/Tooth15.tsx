...
console.log('TOOTH PART', toothPart)        
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
    ...
    return (
        <>
            ...
            <g className={`f-tooth-active`} id="full-t-15"
                onMouseOver={() => {
...
console.log(111, diagnozis)                    
            ...
            >
                ...
                c4.8,4.3,8.6,9.4,11.5,15c0.8,1.5,1.5,3.1,2.2,4.7c0.9,2.1,1.6,4.3,2.2,6.5C690,417.1,690.2,417.6,690.3,418.1z"></path>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty"  style={{visibility: !tooth15Diagnozis.culttab && !tooth15Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth15Diagnozis.culttab && !tooth15Diagnozis.abutment && !tooth15Diagnozis.implant && !tooth15Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        <g className="caries-filling hoho2" style={{zIndex: 3000}}
                            onClick={() => {
                                setColordedPart(diagnozis, 'right');
                            }}
                        >
