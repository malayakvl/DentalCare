        ...
        <>
            ...
            >
                ...
                <g id="T_15_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pulp"  >
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" dataposition="15" style={{visibility: 'hidden'}}>
                    ...
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: 'hidden'}}>
                        <circle className="st48" cx="651.5" cy="595.5" r="20.5"></circle>
                        <g className="st27">
                    ...
                    <g className="shaper hEmpty hIntact hRoot" style={{visibility: 'hidden', opacity: 0}} >
                        <circle className="st44" cx="651.435" cy="595.435" r="22.435"></circle>
                    ...
                    <g className="abutment hEmpty hIntact hRoot"  style={{visibility: 'hidden', opacity: 0}}>
                        ...
                        <circle className="st45" cx="652" cy="595" r="13"></circle>
                    </g>
                    {/* PIN */}
                ...
                C695.4,579.4,694.9,573.5,692.5,568.1z"></path>
                    </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <g id="s_header_15_5" className="caries-filling" dataposition="15_5">
                    ...
                    c-0.4,0.3-0.7,0.7-1.1,1.2v0c-2,2.7-4.1,7.9-4.5,14.9C630.3,597.3,632.2,605.6,636,611.8z"></path>
                            <path className="st8 target" d="M636,611.8c2.7,4.4,6.4,7.9,11,8.6c6.3,0.9,11.3-4.1,14.8-10.1c2.7-4.6,4.5-9.6,5.3-12.9
                    c1.2-4.7,2.2-9.6,1.4-13.8c-0.5-2.5-1.6-4.8-3.7-6.6c-5.6-4.9-12.5-6.1-12.5-6.1c-8.6-1.7-14,3.3-16.2,5.4
                    c-0.4,0.3-0.7,0.7-1.1,1.2v0c-2,2.7-4.1,7.9-4.5,14.9C630.3,597.3,632.2,605.6,636,611.8z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_15_4" className="caries-filling" dataposition="15_4">
                    ...
                    C608,579,606.7,588.1,608.5,597.2z"></path>
                            <path className="st8 target" d="M608.5,597.2c1.5,7.4,5.1,13.6,7.6,20.4c1.2,3.3,2.2,6.7,3.5,10c8.7-5.6,13.8-11.9,16.4-15.8
                    c-3.8-6.3-5.7-14.5-5.4-19.4c0.4-7,2.5-12.2,4.5-14.9v0c-5.2-8.7-11.6-15-15.4-18.3c-3,3.5-5.7,7.4-7.7,11.5
                    C608,579,606.7,588.1,608.5,597.2z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_15_3" className="caries-filling" dataposition="15_3">
                            <path className="st7" d="M619.6,627.7c0.8,2,1.6,4,2.7,5.8c3.1,5.4,7.8,10.1,13.8,12.7c5,2.2,10.3,2.8,15.6,2.5
                    c6.1-0.3,12.3-1.9,17.4-5.4c4.1-2.8,7.1-6.9,9.7-11c0.2-0.2,0.3-0.5,0.5-0.8c-5.1-7.6-13.3-16.8-17.4-21.2
                    c-3.5,5.9-8.5,11-14.8,10.1c-4.6-0.7-8.3-4.1-11-8.6C633.4,615.8,628.3,622.1,619.6,627.7z"></path>
                            <path className="st8 target" d="M619.6,627.7c0.8,2,1.6,4,2.7,5.8c3.1,5.4,7.8,10.1,13.8,12.7c5,2.2,10.3,2.8,15.6,2.5
                    c6.1-0.3,12.3-1.9,17.4-5.4c4.1-2.8,7.1-6.9,9.7-11c0.2-0.2,0.3-0.5,0.5-0.8c-5.1-7.6-13.3-16.8-17.4-21.2
                    c-3.5,5.9-8.5,11-14.8,10.1c-4.6-0.7-8.3-4.1-11-8.6C633.4,615.8,628.3,622.1,619.6,627.7z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_15_2" className="caries-filling" dataposition="15_2">
                            <path className="st7" d="M661.8,610.3c4,4.3,12.3,13.5,17.4,21.2c3.6-5.9,6.6-11.8,9.2-18c3.7-8.8,6.3-18.2,6.7-28.1
                    c0.3-6-0.2-11.9-2.6-17.3c-5.1,2.8-16.5,9.1-24,15.5c0.8,4.2-0.2,9.1-1.4,13.8C666.3,600.7,664.5,605.8,661.8,610.3z"></path>
                            <path className="st8 target" d="M661.8,610.3c4,4.3,12.3,13.5,17.4,21.2c3.6-5.9,6.6-11.8,9.2-18c3.7-8.8,6.3-18.2,6.7-28.1
                    c0.3-6-0.2-11.9-2.6-17.3c-5.1,2.8-16.5,9.1-24,15.5c0.8,4.2-0.2,9.1-1.4,13.8C666.3,600.7,664.5,605.8,661.8,610.3z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_15_1" className="caries-filling" dataposition="15_1">
                    ...
                    c-4.1-2.8-8.8-4.8-13.2-7c-5-2.5-9.8-5.4-15.5-6.2c-10.6-1.5-20.2,4.2-27.9,11.2C623.3,555.4,621.5,557.3,619.7,559.3z"></path>
                            <path className="st8 target" d="M619.7,559.3c3.8,3.3,10.3,9.5,15.4,18.3c0.4-0.5,0.7-0.9,1.1-1.2c2.2-2.1,7.6-7.1,16.2-5.4
                    c0,0,6.9,1.2,12.5,6.1c2.1,1.8,3.2,4.1,3.7,6.6c7.5-6.4,18.8-12.8,24-15.5c0-0.1-0.1-0.1-0.1-0.2c-2.2-4.9-5.9-9.1-10.5-12.4
                    c-4.1-2.8-8.8-4.8-13.2-7c-5-2.5-9.8-5.4-15.5-6.2c-10.6-1.5-20.2,4.2-27.9,11.2C623.3,555.4,621.5,557.3,619.7,559.3z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="15_4 15_3" d="M636.5 612C634.833 614.5 630 620.5 624 624.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_4 15_5" d="M636.5 612C632.5 604.667 626.6 587.5 635 577.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_4 15_1" d="M635 578C633.833 575 630 567.8 624 563" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_1 15_5" d="M635 578C645.5 566.001 662.5 574.3 668.5 583.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_2 15_1" d="M668.5 583.5C670.667 580.667 677.6 574.1 688 570.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_2 15_5" d="M668.5 583.5C674.5 590 664.1 606.5 662.5 610.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_2 15_3" d="M662.5 610.5C664.167 611.5 669.2 616.2 676 627" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_3 15_5" d="M662.5 610.5C659 617.833 648.8 628.5 636 612.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
                            <path className="st55" d="M612.373 570.742C614.373 566.642 617.073 562.742 620.073 559.242C621.873 557.242 623.673 555.242 625.673 553.442C633.273 546.442 642.973 540.742 653.573 542.242C659.373 543.042 664.073 545.942 669.073 548.442C673.373 550.642 678.173 552.642 682.273 555.442C686.973 558.642 690.573 562.942 692.773 567.842C692.773 567.942 692.873 567.941 692.873 568.041C695.273 573.441 695.773 579.342 695.473 585.342C695.343 587.909 695.072 590.443 694.679 592.941C692.913 592.941 688.955 592.041 687.251 588.441C687.273 588.116 687.293 587.79 687.31 587.464C687.553 582.685 687.147 577.985 685.201 573.684C685.201 573.604 685.12 573.604 685.12 573.525C683.336 569.622 680.417 566.197 676.605 563.648C673.28 561.418 669.388 559.825 665.9 558.072C661.846 556.081 658.034 553.771 653.331 553.134C644.735 551.939 636.868 556.479 630.705 562.055C629.083 563.489 627.624 565.082 626.164 566.675C623.731 569.463 621.541 572.569 619.92 575.835C617.941 579.818 616.747 584.069 616.448 588.441C614.507 592.441 610.115 593.108 608.162 592.941C607.474 585.221 608.998 577.661 612.373 570.742Z"></path>
                        </g>
                    </g>
                    <g className="crown"  style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M692.5,568.1c0-0.1-0.1-0.1-0.1-0.2c-2.2-4.9-5.9-9.1-10.5-12.4c-4.1-2.8-8.8-4.8-13.2-7
                c-5-2.5-9.8-5.4-15.5-6.2c-10.6-1.5-20.2,4.2-27.9,11.2c-2,1.8-3.9,3.7-5.6,5.8c-3,3.5-5.7,7.4-7.7,11.5c-4,8.2-5.3,17.3-3.5,26.4
                c1.5,7.4,5.1,13.6,7.6,20.4c1.2,3.3,2.2,6.7,3.5,10c0.8,2,1.6,4,2.7,5.8c3.1,5.4,7.8,10.1,13.8,12.7c5,2.2,10.3,2.8,15.6,2.5
                c6.1-0.3,12.3-1.9,17.4-5.4c4.1-2.8,7.1-6.9,9.7-11c0.2-0.2,0.3-0.5,0.5-0.8c3.6-5.9,6.6-11.8,9.2-18c3.7-8.8,6.3-18.2,6.7-28.1
                C695.4,579.4,694.9,573.5,692.5,568.1z"></path>
                        <path className="st3 fissure" d="M654.2,602.9c-10.1,0-20-1.8-28.9-5.3l0.4-1c9.5,3.7,20.2,5.5,30.9,5.2c7.6-0.2,14.7-1.5,20.9-3.8l0.4,1
                c-6.4,2.3-13.5,3.6-21.3,3.8C655.8,602.9,655,602.9,654.2,602.9z"></path>
                        <path className="st3 fissure" d="M676.9,604.7c-3.3-1.6-9.3-2.4-15.5-2.3c-2.1,0.1-4.2,0.2-6.1,0.5l-0.2-1.1c2-0.3,4.1-0.5,6.2-0.5
                c6.4-0.1,12.5,0.8,16,2.4L676.9,604.7z"></path>
                    </g>
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: 'inherit'}} >
                        <path className="st3 fissure" d="M654.2,602.9c-10.1,0-20-1.8-28.9-5.3l0.4-1c9.5,3.7,20.2,5.5,30.9,5.2c7.6-0.2,14.7-1.5,20.9-3.8l0.4,1
                c-6.4,2.3-13.5,3.6-21.3,3.8C655.8,602.9,655,602.9,654.2,602.9z" style={{stroke: 'none'}}></path>
                        <path className="st3 fissure" d="M676.9,604.7c-3.3-1.6-9.3-2.4-15.5-2.3c-2.1,0.1-4.2,0.2-6.1,0.5l-0.2-1.1c2-0.3,4.1-0.5,6.2-0.5
                c6.4-0.1,12.5,0.8,16,2.4L676.9,604.7z" style={{stroke: 'none'}}></path>
                    </g>
                </g>
            ...
            c-9.4,2.1-17.5,8.4-22.2,16.9c-1.1,2-2,4.1-2.9,6.2C620.8,416.8,620.4,427.7,621.6,438.6z"></path>
                ...
                C695.7,454.8,695.9,447.6,694.8,440.6z"></path>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <g className="caries-filling" dataposition="15_5">
                ...
                c0.5-0.5,1-0.9,1.5-1.4c0.5-10.9,1.3-27.5,2.3-38.2c-5.1-2.3-14.9-6.4-22.1-7.1c-9.7-0.9-19.3,2.1-24.4,4.1
                C629.4,457,628.8,476.3,628.5,487.3z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" dataposition="15_4">
                ...
                c0.3-11,0.9-30.3,1-43.5c0.1-7.7,0-13.4-0.3-14.2c-0.8-2-6.7-11.1-10.3-16.5c-0.4,1-0.8,2.1-1.2,3.1c-2.4,6-5.5,11.7-7.5,17.9
                C608.1,441,607.5,448.3,608.7,455.5z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" dataposition="15_2">
                ...
                c-0.7-4.7-1.9-9.3-2.9-13.9c-0.5-2.1-0.9-4.3-1.4-6.4c-4.2,4-11.3,11.4-13.1,16.6c-0.5,1.6-1,5.2-1.5,9.8
                C675,457.5,674.1,474.1,673.7,485z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" dataposition="15_1">
                ...
                c1.7-5.2,8.9-12.6,13.1-16.6c-0.3-1.2-0.6-2.5-0.9-3.7c-2.8-10-8-19.2-15.9-26.2c-3.5-3.2-7.6-5.9-12.2-7.3
                c-3-0.9-6.2-1.3-9.3-1.1c-11.8,0.6-22.2,7.6-27.9,17.7c-2.4,4.2-3.8,8.9-5.5,13.4C622.5,418.5,628.4,427.6,629.2,429.6z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="15_4 15_5" d="M629.5 443.999L629 479.999" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_1 15_4" d="M629.5 443.999C629.5 430.999 629.6 424.699 622 417.499" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_1 15_5" d="M629.5 443.999C637 439.833 656.8 434.499 676 446.499" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_1 15_2" d="M676 446.499C677 430.499 679.4 426.799 687 423.999" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="15_2 15_5" d="M676 446.999L674 477.499" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
