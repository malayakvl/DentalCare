...
import { setTooth11Active } from '@/Redux/Formula/actions';
...
export default function Tooth11() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth11.caries_bottom = !teethDiagnozis.tooth11.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth11.caries_center = !teethDiagnozis.tooth11.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth11.caries_left = !teethDiagnozis.tooth11.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth11.caries_right = !teethDiagnozis.tooth11.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth11.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth11.seal_center_color = sealColor1;
                    teethDiagnozis.tooth11.seal_center = true;
                } else if (teethDiagnozis.tooth11.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth11.seal_center_color = sealColor2;
                    teethDiagnozis.tooth11.seal_center = true;
                } else if (teethDiagnozis.tooth11.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth11.seal_center_color = sealColor3;
                    teethDiagnozis.tooth11.seal_center = true;
                } else {
                    teethDiagnozis.tooth11.seal_center = !teethDiagnozis.tooth11.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth11.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth11.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth11.seal_bottom = true;
                } else if (teethDiagnozis.tooth11.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth11.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth11.seal_bottom = true;
                } else if (teethDiagnozis.tooth11.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth11.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth11.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth11.seal_bottom = !teethDiagnozis.tooth11.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth11.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth11.seal_left_color = sealColor1;
                    teethDiagnozis.tooth11.seal_left = true;
                } else if (teethDiagnozis.tooth11.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth11.seal_left_color = sealColor2;
                    teethDiagnozis.tooth11.seal_left = true;
                } else if (teethDiagnozis.tooth11.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth11.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth11.seal_right_color = sealColor1;
                    teethDiagnozis.tooth11.seal_right = true;
                } else if (teethDiagnozis.tooth11.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth11.seal_right_color = sealColor2;
                    teethDiagnozis.tooth11.seal_right = true;
                } else if (teethDiagnozis.tooth11.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth11.seal_right_color = sealColor3;
                    teethDiagnozis.tooth11.seal_right = true;
                } else {
                    teethDiagnozis.tooth11.seal_right = !teethDiagnozis.tooth11.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth11.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth11.seal_top_color = sealColor1;
                    teethDiagnozis.tooth11.seal_top = true;
                } else if (teethDiagnozis.tooth11.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth11.seal_top_color = sealColor2;
                    teethDiagnozis.tooth11.seal_top = true;
                } else if (teethDiagnozis.tooth11.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth11.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth11.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth11.wedge_shaped_defect_color = !teethDiagnozis.tooth11.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="11" className="df-tooth-text" style={{opacity: 1}}>
            ...
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth11.active) {
                        dispatch(setNewToothActive({tooth11: {active: true}}))
                    } else {
                        dispatch(setDisactiveAll());
                        dispatch(setNewToothActive({tooth11: {active: true}}))
                    }
                    // dispatch(setTooth11Active(!toothActive));
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth11.change_color = !teethDiagnozis.tooth11.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth11.fissure = !teethDiagnozis.tooth11.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth11.caries = !teethDiagnozis.tooth11.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth11.cervical_caries = !teethDiagnozis.tooth11.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth11.wedge_shaped_defect = !teethDiagnozis.tooth11.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth11.tartar = !teethDiagnozis.tooth11.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth11.pulpit = !teethDiagnozis.tooth11.pulpit;
                            teethDiagnozis.tooth11.channel_class = teethDiagnozis.tooth11.pulpit ? 'pulpit' : ''
                            // setDiagnozeClass(teethDiagnozis.tooth11.pulpit ? 'pulpit' : '');
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth11.channel_not_sealed = !teethDiagnozis.tooth11.channel_not_sealed;
                            teethDiagnozis.tooth11.channel_class = teethDiagnozis.tooth11.channel_not_sealed ? 'channel-not-sealed' : '';
                            // setDiagnozeClass(teethDiagnozis.tooth11.channel_not_sealed ? 'channel-not-sealed' : '');
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth11.channel_top_sealed = !teethDiagnozis.tooth11.channel_top_sealed;
                            teethDiagnozis.tooth11.channel_class = teethDiagnozis.tooth11.channel_top_sealed ? 'channel-top-sealed' : '';
                            // setDiagnozeClass(teethDiagnozis.tooth11.channel_top_sealed ? 'channel-top-sealed' : '');
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth11.channel_part_sealed = !teethDiagnozis.tooth11.channel_part_sealed;
                            teethDiagnozis.tooth11.channel_class = teethDiagnozis.tooth11.channel_part_sealed ? 'channel-part-sealed' : '';
                            // setDiagnozeClass(teethDiagnozis.tooth11.channel_part_sealed ? 'channel-part-sealed' : '');
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth11.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth11.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth11.periodontit = true;
                            } else {
                                teethDiagnozis.tooth11.periodontit = !teethDiagnozis.tooth11.periodontit;
                            }
                            teethDiagnozis.tooth11.channel_class = teethDiagnozis.tooth11.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth11.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth11.seal = !teethDiagnozis.tooth11.seal;
                            setDiagnozeClass(teethDiagnozis.tooth11.channel_part_sealed ? 'channel-part-sealed' : '');
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth11.seal_cervical && teethDiagnozis.tooth11.seal_cervical_color === "") {
                                teethDiagnozis.tooth11.seal_cervical = true;
                                teethDiagnozis.tooth11.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth11.seal_cervical && teethDiagnozis.tooth11.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth11.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth11.seal_cervical = false;
                                teethDiagnozis.tooth11.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth11.vinir && teethDiagnozis.tooth11.vinir_color === "") {
                                teethDiagnozis.tooth11.vinir = true;
                                teethDiagnozis.tooth11.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth11.vinir && teethDiagnozis.tooth11.vinir_color != vinirColor) {
                                teethDiagnozis.tooth11.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth11.vinir = false;
                                teethDiagnozis.tooth11.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth11.temporary_crown = !teethDiagnozis.tooth11.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth11.ceramic_crown && teethDiagnozis.tooth11.ceramic_crown_color === "") {
                                teethDiagnozis.tooth11.ceramic_crown = true;
                                teethDiagnozis.tooth11.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth11.ceramic_crown && teethDiagnozis.tooth11.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth11.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth11.ceramic_crown = false;
                                teethDiagnozis.tooth11.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth11.mceramic_crown && teethDiagnozis.tooth11.mceramic_crown_color === "") {
                                teethDiagnozis.tooth11.mceramic_crown = true;
                                teethDiagnozis.tooth11.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth11.mceramic_crown && teethDiagnozis.tooth11.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth11.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth11.mceramic_crown = false;
                                teethDiagnozis.tooth11.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth11.metalic_crown && teethDiagnozis.tooth11.metalic_crown_color === "") {
                                teethDiagnozis.tooth11.metalic_crown = true;
                                teethDiagnozis.tooth11.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth11.metalic_crown && teethDiagnozis.tooth11.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth11.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth11.metalic_crown = false;
                                teethDiagnozis.tooth11.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth11.zirconia_crown && teethDiagnozis.tooth11.zirconia_crown_color === "") {
                                teethDiagnozis.tooth11.zirconia_crown = true;
                                teethDiagnozis.tooth11.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth11.zirconia_crown && teethDiagnozis.tooth11.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth11.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth11.zirconia_crown = false;
                                teethDiagnozis.tooth11.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth11.pin = !teethDiagnozis.tooth11.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth11.culttab = !teethDiagnozis.tooth11.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth11.abutment = !teethDiagnozis.tooth11.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth11.shaper = !teethDiagnozis.tooth11.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth11.implant = !teethDiagnozis.tooth11.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth11.apex = !teethDiagnozis.tooth11.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth11.absent = !teethDiagnozis.tooth11.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth11.cervical_caries = !teethDiagnozis.tooth11.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth11.caries = !teethDiagnozis.tooth11.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth11.parodontit) {
                                if (teethDiagnozis.tooth11.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth11.parodontit = false;
                                    teethDiagnozis.tooth11.active = false;
                                } else {
                                    teethDiagnozis.tooth11.parodontit = true;
                                    teethDiagnozis.tooth11.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth11.parodontit = true;
                                teethDiagnozis.tooth11.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth11.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_11_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin" >
                        <g className="hEmpty hRoot hImplant" style={{visibility: !tooth11Diagnozis.culttab && !tooth11Diagnozis.implant && !tooth11Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        <g className={`hIntact hImplant hEmpty`} style={{visibility: tooth11Diagnozis?.apex || tooth11Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth11Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth11Diagnozis?.apex ? 'apex' : ''}`} 
                    ...
                    <g className="pulp">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" style={{visibility: 'hidden'}}>
                            <path className="st22 target " d="M989.706 604.016C989.801 605.739 991.258 606.641 993.868 608.969C995.774 610.67 996.42 612.996 998.833 613.014C1001.43 613.033 1002.11 610.273 1003.77 608.421C1005.76 606.198 1007.5 605.623 1007.39 603.47C1007.27 601.317 1003.87 600.785 998.154 600.743C992.438 600.701 989.575 601.65 989.706 604.016Z" style={{fill: 'rgb(254, 246, 249)'}}></path>
                        </g>
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth11Diagnozis.implant || tooth11Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="998.5" cy="604.5" r="23.5" />
                        <g className="st27">
                            <mask id="implant_11" className="st49">
                                <path className="st50" d="M986.388 590.223L983.317 589.223C980.707 591.85 978.766 595.141 977.769 598.821L980.172 600.981C979.957 602.121 
                            ...
                            <path className="st50 st51" d="M986.388 590.223L983.317 589.223C980.707 591.85 978.766 595.141 977.769 598.821L980.172 600.981C979.957 602.121 979.844 603.298 979.844 
                            ...
                            />
                            <path className="st52" d="M983.317 589.223L983.936 587.322L982.766 586.941L981.899 587.814L983.317 589.223ZM986.388 590.223L985.769 592.125L986.84 592.474L987.694 591.738L986.388 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth11Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth11Diagnozis.abutment ? 1 : 0}}>
                        <path className="st47" d="M961.349 595.139C959.407 587.917 965.818 582.811 974.366 580.695C983.4 578.453 993.794 578.951 1004.19 579.325C1012.83 579.698 1021.48 580.197 1028.47 583.309C1032.26 585.053 1035.37 
                        ...
                        <path className="st47" d="M971.257 598.243C969.826 592.764 974.55 588.891 980.849 587.286C987.505 585.585 995.164 585.963 1002.82 586.246C1009.19 586.53 1015.56 586.908 1020.72 589.269C1023.51 
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth11Diagnozis.pin ? 1 : 0}}>
                        ...
                        <circle className="st57" id="Ellipse_48" cx="998" cy="605" r="12.25" style={{fill: 'black', opacity: tooth11Diagnozis.pin ? 1 : 0}} />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth11Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth11Diagnozis.culttab ? 0 : 1}}>
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment && !tooth11Diagnozis.implant && !tooth11Diagnozis.apex && !tooth11Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth11.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment && !tooth11Diagnozis.implant && !tooth11Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        <g id="s_header_11_3" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_11_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        {/*КАРИЕС TOP*/}
                        <g id="s_header_11_1" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_left && !tooth11Diagnozis.seal_bottom && !tooth11Diagnozis.seal_center) ||
                                        (tooth11Diagnozis.seal_left && !tooth11Diagnozis.seal_bottom && !tooth11Diagnozis.seal_center) ||
                                        (!tooth11Diagnozis.seal_left && tooth11Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_left && tooth11Diagnozis.seal_top && !tooth11Diagnozis.seal_bottom) ||
                                        (!tooth11Diagnozis.seal_left && tooth11Diagnozis.seal_top && tooth11Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_right && !tooth11Diagnozis.seal_bottom) ||
                                        (!tooth11Diagnozis.seal_right && tooth11Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className="st55" d="M954.015 581.875C957.215 579.075 961.915 576.975 967.315 575.775C979.115 573.075 992.715 573.575 1006.31 574.175C1017.41 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth11Diagnozis.temporary_crown || tooth11Diagnozis.ceramic_crown || tooth11Diagnozis.mceramic_crown || tooth11Diagnozis.metalic_crown || tooth11Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth11Diagnozis.temporary_crown || tooth11Diagnozis.ceramic_crown || tooth11Diagnozis.mceramic_crown || tooth11Diagnozis.metalic_crown || tooth11Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                ...
                <g id="T_11" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g id="dentin_v_11" className="hRoot hImplant hEmpty" style={{visibility: !tooth11Diagnozis.implant && !tooth11Diagnozis.apex && !tooth11Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        <g id="dentin_n_11" className="hImplant hEmpty" style={{visibility: !tooth11Diagnozis.implant && !tooth11Diagnozis.abutment && !tooth11Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_11" className={`st10 change-color ${tooth11Diagnozis.change_color ? 'diagnoze' : ''}`}
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth11Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact" d="M954.1 447.499C954.6 461.699 956.5 475.899 959.6 489.799L961.1 491.499L963.6 493.099C966.6 493.399 969.6 493.699 972.6 493.899C974.8 494.099 977 
                        ...
                        />
                        <path className="st57" d="M981.8 301.9L984.7 494.9H984.8C994.3 495.5 1003.8 495.9 1013.2 496L989.4 301.2C989.2 300.3 988.8 299.5 988.1 298.9C987.4 
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth11Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth11Diagnozis.abutment ? 1 : 0}}>
                        ...
                        />
                        <line className="st19" x1="1021.9" y1="373.6" x2="968.4" y2="384.7" />
                        <line className="st19" x1="1019.8" y1="345.4" x2="966.3" y2="356.4" />
                        <line className="st19" x1="1016.5" y1="317.1" x2="963" y2="328.1" />
                        <line className="st19" x1="1014.4" y1="288.8" x2="960.9" y2="299.8" />
                        <line className="st19" x1="1012.2" y1="260.5" x2="958.7" y2="271.6" />
                    </g>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty" style={{visibility: !tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth11Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}   
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth11.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment && !tooth11Diagnozis.implant && !tooth11Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            `} 
                                ...
                                c-1.6-17.3-5.9-62.7-6.5-65.6c-0.5-2.5-9.7-9.5-14.8-13.2c-1.6,6.6-2.7,13.4-3.6,20.2C949.2,478.7,948.6,490.1,950,501.4z" 
                                style={{
                                    fill: teethDiagnozis.tooth11.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth11.seal_left ? teethDiagnozis.tooth11.seal_left_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                C1026.8,458.9,1028.4,511.2,1029,527.6z" 
                                style={{
                                    fill: teethDiagnozis.tooth11.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth11.seal_right ? teethDiagnozis.tooth11.seal_right_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                C957.6,434.9,955.7,441,954.2,447.1z" 
                                style={{
                                    fill: teethDiagnozis.tooth11.caries_top ? '#606c80' : 
                                    teethDiagnozis.tooth11.seal_top ? teethDiagnozis.tooth11.seal_top_color : 'transparent',
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_left && !tooth11Diagnozis.seal_top && !tooth11Diagnozis.seal_center) ||
                                        (!tooth11Diagnozis.seal_left && tooth11Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_right && !tooth11Diagnozis.seal_top) ||
                                        (!tooth11Diagnozis.seal_right && tooth11Diagnozis.seal_top && !tooth11Diagnozis.seal_center) ||
                                        (!tooth11Diagnozis.seal_right && tooth11Diagnozis.seal_top && tooth11Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth11Diagnozis.seal_right && !tooth11Diagnozis.seal_top) ||
                                        (tooth11Diagnozis.seal_right && tooth11Diagnozis.seal_left && tooth11Diagnozis.seal_center && !tooth11Diagnozis.seal_top) ||
                                        (!tooth11Diagnozis.seal_right && tooth11Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
