        ...
        <>
            ...
            >
                ...
                <g id="T_26_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth26Diagnozis.culttab && !tooth26Diagnozis.abutment && !tooth26Diagnozis.implant && !tooth26Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g id="s_header_26_5" 
