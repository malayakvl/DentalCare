            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55,  -212, 31)'}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        ...
                        <g className="with">
                            ...
                            <path className="st54" areas="65_2 65_5" d="M1741 618C1746.67 611.667 1753.4 594.2 1735 575" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_2 65_1" d="M1735 575C1738 570.5 1746.5 560 1756.5 554" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_1 65_5" d="M1735 575C1715.33 570.834 1675.1 565.9 1671.5 579.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_4 65_1" d="M1671.5 579.5C1669.33 576.167 1659.8 567.5 1639 559.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_4 65_5" d="M1671.5 579.5C1671.83 588 1674.5 607.3 1682.5 616.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_4 65_3" d="M1682.5 616.5C1681 620.5 1674.9 630.3 1662.5 637.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                ...
                c0.1-2.1,0.2-4.1,0.2-6.2C1770.2,404.3,1770.5,398.7,1768.7,393.4z"
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="65_5">
                ...
                c-1.3-2.5-2.4-5.1-3.1-7.8l-1.9-0.1c1.2,2.2,2.1,4.5,2.8,6.9c0.9,3.4,1.3,7,0,10.2c-3.6,8.8-15.5,9.1-21.6,15.8
                c-4-7.5-13.4-24.8-20.7-38.1c3.4-3.4,8.2-7.6,13.2-10.1c12.9-6.5,36.7-12.3,58.7-7.1C1743.9,424,1749.8,442.5,1752.6,451.1z" style={{fill: 'none', strokeWidth: 0}} ></path>
                        </g>
                        <g className="caries-filling" dataposition="65_4">
                ...
                c-9.1-3.6-17.6-9-23.4-16.9c-1-1.3-1.9-2.7-2.7-4.1c-2-6.5-3-13.2-3.2-20c-0.1-5.8,0.5-11.6,0.9-17.4c0.4-5.3,0.7-10.7,0.9-16.1
                c6,4.7,16.5,13.1,18.7,16.3c1,1.5,4.9,8.3,9.5,16.8C1674.2,438,1683.5,455.3,1687.6,462.8z" style={{fill: 'none', strokeWidth: 0}} ></path>
                        </g>
                        <g className="caries-filling" dataposition="65_2">
                ...
                c-5.1-16.1-9.4-30.3-9.4-31.4c0-1.9,4.4-14.8,6.8-21.7c9.4,8.5,18,17.7,25.8,27.7c2.7,3.5,5.4,7.1,6.8,11.3
                C1770.5,398.7,1770.2,404.3,1770,409.8z" style={{fill: 'none', strokeWidth: 0}} ></path>
                        </g>
                        <g className="caries-filling" dataposition="65_1">
                ...
                c-2.2-3.2-12.7-11.6-18.7-16.3c0-0.4,0-0.8,0-1.2c2.8-5.6,6.3-10.8,10.7-15.3c6.7-6.9,14.8-12.1,23.8-15.6
                c9-3.5,18.6-5.1,28.2-5.8c11.5-0.9,23.1-0.7,34.6,0.7c0.1,0,0.1,0.1,0.1,0.1c-2.4,6.9-6.8,19.7-6.8,21.7
                C1729.3,377.3,1733.7,391.5,1738.8,407.6z" style={{fill: 'none', strokeWidth: 0}} ></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="65_2 65_5" d="M1739.5 407L1751.5 446" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_1 65_2" d="M1739.5 407C1730.5 379.5 1726.6 377.9 1735 359.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_1 65_5" d="M1739.5 407C1722.5 402.999 1683.5 411 1667.5 425" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_1 65_4" d="M1667.5 425C1656.39 405.109 1657.04 402.656 1644 395.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="65_4 65_5" d="M1667.5 425L1685.5 457.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
