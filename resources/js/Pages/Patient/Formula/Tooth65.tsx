...
export default function tooth65() {
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && teethDiagnozis.tooth25.show) {
                document.getElementById('TH-65').classList.add('f-tooth-active');
                document.getElementById('TH-25').classList.remove('f-tooth-active');
            }
            if (teethType === 'adult' && teethDiagnozis.tooth65.show) {
                document.getElementById('TH-65').classList.remove('f-tooth-active');
                document.getElementById('TH-25').classList.add('f-tooth-active');
            }
        }
    ...
    return (
        <>
            <g id="65" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1425 716)" className={`st3 st4 st5 ${selectedTooth === 65 ? 'num-active' : ''}`}>65</text>
            </g>
            <g id="TH-65" className={`f-tooth-init-milk ${((teethDiagnozis.tooth65.show || allTeeth) && !teethDiagnozis.tooth65.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
                    teethDiagnozis.tooth65.show = !teethDiagnozis.tooth65.show;
                    teethDiagnozis.tooth25.show = false;
            ...
            >
                <g 
                    ...
                    className={`underlay ${selectedTooth === 65 ? 'selected' : ''}`} 
                ...
                >
                    ...
                    <g className="dentin">
                        <g className={`d-ch-color`} style={{visibility: !tooth65Diagnozis.culttab && !tooth65Diagnozis.implant && !tooth65Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth65Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth65Diagnozis?.apex ? 'apex' : ''}`}   
                                d="M1762.6,607c-1-3.9-3.3-7.6-4.4-11.5c-2.8-9.6,1.1-20.5-5.2-29.3
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility: "hidden"}}>
                            <path className={`st24 ${tooth65Diagnozis.apex ? 'apex' : ''}`}  
                            ...
                            <path className={`st24 ${tooth65Diagnozis.apex ? 'apex' : ''}`}  
                                d="M1733.38 595.522C1732.45 610.7 1725.5 618.5 1717.5 618.5C1707 618.5 1674 606.5 1674 591C1674 584 1677.08 579.022 1701.38 579.022C1725.69 579.022 1734.32 580.345 1733.38 595.522Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                        </g>
                    </g>
                    {/*PULPIT/CHANNEL NOT SEALED/PART SALED*/}
                    <g className="pulp" style={{visibility: tooth65Diagnozis.apex || tooth65Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling"  style={{visibility: tooth65Diagnozis.apex || tooth65Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth65Diagnozis.implant || tooth65Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth65Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth65Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth65.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth65Diagnozis.culttab && !tooth65Diagnozis.abutment && !tooth65Diagnozis.implant && !tooth65Diagnozis.shaper && !tooth65Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth65.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth65.seal_center ? `seal-fill ${teethDiagnozis.tooth65.seal_center_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth65.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth65.seal_left ? `seal-fill ${teethDiagnozis.tooth65.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth65.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth65.seal_bottom ? `seal-fill ${teethDiagnozis.tooth65.seal_bottom_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth65.seal_right ? `seal-fill ${teethDiagnozis.tooth65.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth65.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth65.seal_top ? `seal-fill ${teethDiagnozis.tooth65.seal_top_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_right && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_right && !tooth65Diagnozis.seal_center) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_right && !tooth65Diagnozis.seal_top) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_center && !tooth65Diagnozis.seal_top) ||
                                        (!tooth65Diagnozis.seal_center && tooth65Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_left && !tooth65Diagnozis.seal_top) ||
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_center) ||
                                        (tooth65Diagnozis.seal_left && !tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_left && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_center && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_center && tooth65Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth65Diagnozis.temporary_crown || tooth65Diagnozis.ceramic_crown || tooth65Diagnozis.mceramic_crown || tooth65Diagnozis.metalic_crown || tooth65Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth65Diagnozis.temporary_crown || tooth65Diagnozis.ceramic_crown || tooth65Diagnozis.mceramic_crown || tooth65Diagnozis.metalic_crown || tooth65Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth65Diagnozis.ceramic_crown_color}
                                ${tooth65Diagnozis.mceramic_crown_color}
                                ${tooth65Diagnozis.metalic_crown_color}
                                ${tooth65Diagnozis.zirconia_crown_color}
                            `} 
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth65Diagnozis.fissure ? 'diagnoze' : tooth65Diagnozis.fissure ? 'hidden' : ''}`}  
                    ...
                    {/* FISSURES */}
                    <g  style={{visibility: (!tooth65Diagnozis.culttab && !tooth65Diagnozis.abutment && !tooth65Diagnozis.implant && !tooth65Diagnozis.apex && !tooth65Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth65Diagnozis.fissure ? 'diagnoze' : ''}`}   
                            d="M1746.7,592.7c-0.6-0.7-1.3-1.5-1.7-2.3c-1-2-0.5-4.4,1.2-5.8l-0.7-0.8c-2.2,1.8-2.8,4.7-1.5,7.2
                            c0.5,0.9,1.2,1.7,1.8,2.5c1.5,1.8,2.4,3,1.6,4.5c-0.8,1.5-2.7,1.5-4.8,1.5l-0.2,0c-4.2-0.1-8.7,0.9-13.1,1.9
                            c-0.8,0.2-1.5,0.3-2.3,0.5c-3.4,0.8-6.9,1.6-10.2,2.5c-1.4,0.3-2.8,0.7-4.1,1c-2.2-2.7-4.7-5.1-7.4-7.3l-1-0.8
                            c-4-3.1-8.2-6.3-7.4-11c0.5-2.9,3-4.7,5.6-6.6c0.9-0.6,1.8-1.3,2.6-2c5-4.3,7.3-10.5,6.1-16.8l-1.1,0.2
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth65Diagnozis.implant && !tooth65Diagnozis.apex && !tooth65Diagnozis.shaper && !tooth65Diagnozis.apex ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth65Diagnozis.change_color ? 'diagnoze' : ''}`}
                        ...
                        <g style={{visibility: !tooth65Diagnozis.implant && !tooth65Diagnozis.abutment && !tooth65Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth65Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g className="pulpitis-pfilling" style={{visibility: 'inherit'}}>
                            <path className={`st22 target top ${tooth65Diagnozis.channel_class} ${tooth65Diagnozis.channel_class} ${tooth65Diagnozis.pulpit ? 'pulpit' : ''} ${tooth65Diagnozis.periodontit ? 'periodontit' : ''}`}  
                        ...
                        <g className="pulpitis-pfilling" style={{visibility: 'inherit'}}>
                            <path className={`st22 target middle ${tooth65Diagnozis.channel_class} ${tooth65Diagnozis.channel_class} ${tooth65Diagnozis.pulpit ? 'pulpit' : ''} ${tooth65Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="pin hEmpty hImplant" style={{
                        visibility: 'inherit', opacity: tooth65Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" style={{fill: tooth65Diagnozis.pin ? '#dbd9d3' : 'none'}} 
                    ...
                    {/* CULT TAB */}
                    <g className="stump" style={{visibility: tooth65Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth65Diagnozis.culttab ? 1 : 0}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth65Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth65Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth65Diagnozis.abutment || tooth65Diagnozis.implant || tooth65Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth65Diagnozis.culttab && !tooth65Diagnozis.abutment && !tooth65Diagnozis.implant && !tooth65Diagnozis.shaper && !tooth65Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth65Diagnozis.culttab && !tooth65Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth65Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  
                        ...
                        <path className={
                                `st60
                                    ${(tooth65Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth65Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth65Diagnozis.seal_cervical_color}
                                `
                            }  
                            d="M1676.73 363.261C1684.44 360.327 1692.66 358.946 1700.89 358.256C1711.9 357.388 1721.37 358.836 1727.92 360.962C1735.18 363.321 1739.56 367.049 1746.77 375.537C1747.77 376.713 1747.09 378.523 1745.57 378.773L1649.44 394.598C1648.19 394.805 1647.05 393.797 1647.24 392.537C1648.18 386.118 1651.54 381.783 1656.34 376.724C1661.99 370.77 1669.02 366.282 1676.73 363.261Z" style={{opacity: 0, stroke: 'rgb(156, 156, 156)', strokeWidth: 2}}></path>
                    </g>
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth65.tartar ? 1 : 0}}>
                        ...
                        <g className="with">
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_right && !tooth65Diagnozis.seal_top && !tooth65Diagnozis.seal_center) ||
                                        (tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_top && !tooth65Diagnozis.seal_center) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_right && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_bottom && !tooth65Diagnozis.seal_center) ||
                                        (!tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_bottom && tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_bottom && !tooth65Diagnozis.seal_center) ||
                                        (tooth65Diagnozis.seal_right && tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_center && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_bottom && !tooth65Diagnozis.seal_top && tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_left && !tooth65Diagnozis.seal_bottom) ||
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_bottom && !tooth65Diagnozis.seal_center) ||
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_bottom && tooth65Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth65Diagnozis.seal_left && !tooth65Diagnozis.seal_top && !tooth65Diagnozis.seal_center) ||
                                        (tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_top && !tooth65Diagnozis.seal_center) ||
                                        (!tooth65Diagnozis.seal_left && tooth65Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
