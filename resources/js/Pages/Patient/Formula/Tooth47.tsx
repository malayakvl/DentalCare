        ...
        <>
            ...
            >
                ...
                <g id="T_47_up" className="top-view" style={{visibility: tooth47Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth47Diagnozis.culttab && !tooth47Diagnozis.abutment && !tooth47Diagnozis.implant && !tooth47Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g
                ...
                <g id="T_47" className="common-view" style={{visibility: tooth47Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    <g className="dentin">
                        ...
                        <g id="dentin_n_47" style={{visibility: !tooth47Diagnozis.culttab && !tooth47Diagnozis.abutment && !tooth47Diagnozis.implant && !tooth47Diagnozis.shaper && !tooth47Diagnozis.apex  ? 'inherit' : 'hidden'}}>
