...
export default function Tooth73() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth73.caries_bottom = !teethDiagnozis.tooth73.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth73.caries_center = !teethDiagnozis.tooth73.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth73.caries_left = !teethDiagnozis.tooth73.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth73.caries_right = !teethDiagnozis.tooth73.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth73.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth73.seal_center_color = sealColor1;
                    teethDiagnozis.tooth73.seal_center = true;
                } else if (teethDiagnozis.tooth73.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth73.seal_center_color = sealColor2;
                    teethDiagnozis.tooth73.seal_center = true;
                } else if (teethDiagnozis.tooth73.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth73.seal_center_color = sealColor3;
                    teethDiagnozis.tooth73.seal_center = true;
                } else {
                    teethDiagnozis.tooth73.seal_center = !teethDiagnozis.tooth73.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth73.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth73.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth73.seal_bottom = true;
                } else if (teethDiagnozis.tooth73.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth73.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth73.seal_bottom = true;
                } else if (teethDiagnozis.tooth73.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth73.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth73.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth73.seal_bottom = !teethDiagnozis.tooth73.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth73.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth73.seal_left_color = sealColor1;
                    teethDiagnozis.tooth73.seal_left = true;
                } else if (teethDiagnozis.tooth73.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth73.seal_left_color = sealColor2;
                    teethDiagnozis.tooth73.seal_left = true;
                } else if (teethDiagnozis.tooth73.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth73.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth73.seal_right_color = sealColor1;
                    teethDiagnozis.tooth73.seal_right = true;
                } else if (teethDiagnozis.tooth73.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth73.seal_right_color = sealColor2;
                    teethDiagnozis.tooth73.seal_right = true;
                } else if (teethDiagnozis.tooth73.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth73.seal_right_color = sealColor3;
                    teethDiagnozis.tooth73.seal_right = true;
                } else {
                    teethDiagnozis.tooth73.seal_right = !teethDiagnozis.tooth73.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth73.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth73.seal_top_color = sealColor1;
                    teethDiagnozis.tooth73.seal_top = true;
                } else if (teethDiagnozis.tooth73.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth73.seal_top_color = sealColor2;
                    teethDiagnozis.tooth73.seal_top = true;
                } else if (teethDiagnozis.tooth73.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth73.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth73.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth73.wedge_shaped_defect_color = !teethDiagnozis.tooth73.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            ...
            >
                <text transform="matrix(1 0 0 1 1205 842)" className="st3 st4 st5">73</text>
            </g>
                ...
                onClick={() => {
                    ...
                    if (diagnozis) {
                        ...
                        if (diagnozis === 'change_color')
                            ...
                            teethDiagnozis.tooth73.fissure = !teethDiagnozis.tooth73.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth73.caries = !teethDiagnozis.tooth73.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth73.cervical_caries = !teethDiagnozis.tooth73.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth73.wedge_shaped_defect = !teethDiagnozis.tooth73.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth73.tartar = !teethDiagnozis.tooth73.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth73.pulpit = !teethDiagnozis.tooth73.pulpit;
                            teethDiagnozis.tooth73.channel_class = teethDiagnozis.tooth73.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth73.channel_not_sealed = !teethDiagnozis.tooth73.channel_not_sealed;
                            teethDiagnozis.tooth73.channel_class = teethDiagnozis.tooth73.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth73.channel_top_sealed = !teethDiagnozis.tooth73.channel_top_sealed;
                            teethDiagnozis.tooth73.channel_class = teethDiagnozis.tooth73.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth73.channel_part_sealed = !teethDiagnozis.tooth73.channel_part_sealed;
                            teethDiagnozis.tooth73.channel_class = teethDiagnozis.tooth73.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth73.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth73.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth73.periodontit = true;
                            } else {
                                teethDiagnozis.tooth73.periodontit = !teethDiagnozis.tooth73.periodontit;
                            }
                            teethDiagnozis.tooth73.channel_class = teethDiagnozis.tooth73.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth73.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth73.seal = !teethDiagnozis.tooth73.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth73.seal_cervical && teethDiagnozis.tooth73.seal_cervical_color === "") {
                                teethDiagnozis.tooth73.seal_cervical = true;
                                teethDiagnozis.tooth73.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth73.seal_cervical && teethDiagnozis.tooth73.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth73.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth73.seal_cervical = false;
                                teethDiagnozis.tooth73.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth73.vinir && teethDiagnozis.tooth73.vinir_color === "") {
                                teethDiagnozis.tooth73.vinir = true;
                                teethDiagnozis.tooth73.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth73.vinir && teethDiagnozis.tooth73.vinir_color != vinirColor) {
                                teethDiagnozis.tooth73.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth73.vinir = false;
                                teethDiagnozis.tooth73.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth73.temporary_crown = !teethDiagnozis.tooth73.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth73.ceramic_crown && teethDiagnozis.tooth73.ceramic_crown_color === "") {
                                teethDiagnozis.tooth73.ceramic_crown = true;
                                teethDiagnozis.tooth73.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth73.ceramic_crown && teethDiagnozis.tooth73.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth73.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth73.ceramic_crown = false;
                                teethDiagnozis.tooth73.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth73.mceramic_crown && teethDiagnozis.tooth73.mceramic_crown_color === "") {
                                teethDiagnozis.tooth73.mceramic_crown = true;
                                teethDiagnozis.tooth73.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth73.mceramic_crown && teethDiagnozis.tooth73.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth73.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth73.mceramic_crown = false;
                                teethDiagnozis.tooth73.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth73.metalic_crown && teethDiagnozis.tooth73.metalic_crown_color === "") {
                                teethDiagnozis.tooth73.metalic_crown = true;
                                teethDiagnozis.tooth73.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth73.metalic_crown && teethDiagnozis.tooth73.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth73.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth73.metalic_crown = false;
                                teethDiagnozis.tooth73.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth73.zirconia_crown && teethDiagnozis.tooth73.zirconia_crown_color === "") {
                                teethDiagnozis.tooth73.zirconia_crown = true;
                                teethDiagnozis.tooth73.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth73.zirconia_crown && teethDiagnozis.tooth73.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth73.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth73.zirconia_crown = false;
                                teethDiagnozis.tooth73.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth73.pin = !teethDiagnozis.tooth73.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth73.culttab = !teethDiagnozis.tooth73.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth73.abutment = !teethDiagnozis.tooth73.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth73.shaper = !teethDiagnozis.tooth73.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth73.implant = !teethDiagnozis.tooth73.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth73.apex = !teethDiagnozis.tooth73.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth73.absent = !teethDiagnozis.tooth73.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth73.cervical_caries = !teethDiagnozis.tooth73.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth73.caries = !teethDiagnozis.tooth73.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth73.parodontit) {
                                if (teethDiagnozis.tooth73.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth73.parodontit = false;
                                    teethDiagnozis.tooth73.active = false;
                                } else {
                                    teethDiagnozis.tooth73.parodontit = true;
                                    teethDiagnozis.tooth73.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth73.parodontit = true;
                                teethDiagnozis.tooth73.parodontit_stage = subDiagnozis;
            ...
            >
                <g className={`underlay ${selectedTooth === 73 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 20, 11)'}}>
                    <g className="dentin">
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility: 'hidden'}}>
                            <path className="st6" d="M1261.6 978.6C1263.9 984 1262.9 989.6 1260 994.7C1257.6 998.9 1253.8 1002.6 1249.9 1005.9C1243.4 1011.3 1235.7 1016.2 1226.6 1016.1C1222.7 1016.1 1218.9 1015.1 1215.5 1013.6C1211.5 1011.9 1207.9 1009.7 1204.4 1007.3C1198.9 1003.6 1193.4 999.6 1191.5 993.9C1190.4 990.6 1190.6 987.1 1191.7 983.7C1194.3 975.9 1201.1 969.8 1205.8 962.8C1207.5 960.2 1209 957.5 1210.9 954.9C1214.3 950.4 1219.5 946.6 1226 946C1230.2 945.6 1234.3 946.6 1237.6 948.6C1241 950.6 1243.4 953.5 1245.5 956.4C1248 960 1250 963.7 1252.8 967.2C1255.8 971 1259.8 974.2 1261.6 978.6Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                        </g>
                    </g>
                    <g className="pulp">
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_crown_73_2" className="caries-filling" dataposition="73_2">
                            <path className="st7" d="M1182.12 998.8C1183.02 1002.1 1184.72 1005 1186.72 1007.7C1202.32 1004 1215.83 989 1215.82 979.5C1213.32 967.5 1200.32 964 1198.92 954C1193.12 963.9 1185.32 972.7 1182.32 983.7C1181.02 988.7 1180.72 993.9 1182.12 998.8Z"
                            />
                            <path className="st8 target" d="M1182.12 998.8C1183.02 1002.1 1184.72 1005 1186.72 1007.7C1202.32 1004 1215.83 989 1215.82 979.5C1213.32 967.5 1200.32 964 1198.92 954C1193.12 963.9 1185.32 972.7 1182.32 983.7C1181.02 988.7 1180.72 993.9 1182.12 998.8Z" 
                            />
                        </g>
                        <g id="s_crown_73_3" className="caries-filling" dataposition="73_3">
                            ...
                            />
                            <path className="st8 target" d="M1199.62 952.7C1199.42 953.1 1199.22 953.6 1198.92 954C1200.22 961.492 1206.71 965.237 1211.32 970.5C1213.49 972.964 1215.03 976.152 1215.82 979.5C1233.42 983.1 1250.82 965.5 1254.82 954.5C1252.82 950.9 1251.02 947.2 1248.92 943.6C1246.32 939.2 1243.32 934.9 1239.02 931.9C1234.92 929 1229.82 927.5 1224.62 928C1216.52 928.9 1210.12 934.4 1205.92 941.1C1203.52 944.8 1201.72 948.9 1199.62 952.7Z" 
                            />
                        </g>
                        <g id="s_crown_73_4" className="caries-filling" dataposition="73_4">
                            <path className="st7" d="M1259.72 1011.8C1262.62 1008.3 1265.22 1004.6 1267.22 1000.5C1270.72 993 1272.02 984.7 1269.12 976.6C1266.82 970.1 1261.92 965.3 1258.12 959.7C1256.92 958 1255.92 956.3 1254.92 954.5C1250.2 966.1 1239.56 973.667 1234.82 976C1230.32 984 1241.32 993 1259.72 1011.8Z"
                            />
                            <path className="st8 target" d="M1259.72 1011.8C1262.62 1008.3 1265.22 1004.6 1267.22 1000.5C1270.72 993 1272.02 984.7 1269.12 976.6C1266.82 970.1 1261.92 965.3 1258.12 959.7C1256.92 958 1255.92 956.3 1254.92 954.5C1250.2 966.1 1239.56 973.667 1234.82 976C1230.32 984 1241.32 993 1259.72 1011.8Z" 
                            />
                        </g>
                        <g id="s_crown_73_1" className="caries-filling" dataposition="73_1">
                            ...
                            />
                            <path className="st8 target" d="M1259.62 1011.7L1259.62 1011.7C1247.32 998 1229.22 984.8 1234.82 976C1230.82 978 1223.02 981.1 1215.82 979.5C1215.82 987.9 1203.82 1004 1186.62 1007.7C1189.82 1011.9 1193.92 1015.5 1198.12 1018.8C1202.52 1022.3 1206.92 1025.7 1211.92 1028.2C1216.32 1030.4 1220.92 1031.9 1225.82 1032C1237.12 1032.2 1246.72 1025 1254.72 1017C1256.42 1015.3 1258.02 1013.5 1259.62 1011.7Z" 
                            />
                        </g>
                        <g className="with">
                            <path className="st54" areas="73_4 73_1" d="M1235 976C1230.5 986 1241 995 1257 1008.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_3 73_4" d="M1235 976C1238.78 974.229 1247.47 968.35 1252 959" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_3 73_1" d="M1236.5 975C1233 976.333 1224.2 978.8 1217 978" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_3 73_2" d="M1217 978C1214.5 973 1203.7 965.4 1202.5 959" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_2 73_1" d="M1216 979C1214.4 984.396 1207.17 997.151 1191 1005" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    ...
                    <g className="crown" style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M1269.3,976.6c-2.3-6.5-7.3-11.4-11-16.9c-1.1-1.7-2.2-3.4-3.2-5.2c-2-3.6-3.9-7.3-6-10.9
                            c-2.6-4.4-5.6-8.7-9.9-11.7c-4.2-2.9-9.2-4.5-14.4-3.9c-8.1,0.8-14.4,6.4-18.7,13.1c-2.4,3.7-4.2,7.8-6.3,11.6
                            c-0.2,0.4-0.5,0.9-0.7,1.3c-5.7,9.9-13.6,18.6-16.6,29.7c-1.3,5-1.6,10.2-0.2,15.1c1,3.3,2.6,6.2,4.6,8.9
                            c3.2,4.2,7.3,7.7,11.5,11.1c4.4,3.5,8.8,6.9,13.8,9.4c4.3,2.2,9,3.7,13.9,3.8c11.3,0.2,20.9-7,28.9-15c1.7-1.7,3.3-3.4,4.9-5.3
                            c2.9-3.5,5.6-7.2,7.5-11.3C1271,993,1272.2,984.7,1269.3,976.6z"
                        />
                        <path className="st3 fissure" d="M1223.6,981.3c-4.9,0-9.7-0.8-14.4-2.3l0.3-1c5.4,1.7,11,2.5,16.5,2.2c5.3-0.3,10.6-1.5,15.5-3.7l0.4,1
                ...
                <g className="common-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 18, -12)'}}>
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        ...
                        <g className="hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st10" d="M1259.6,1210.3c-0.3,1.9-0.6,3.9-0.8,5.9c-1.2,10-1.2,20.1-1.3,30.2
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" dataposition="73" style={{visibility: 'inherit'}}>
                        ...
                        <g className="hEmpty hImplant pulpitis-pfilling" dataposition="73" style={{visibility: 'inherit'}}>
                        ...
                        <g className="level hEmpty hImplant periodontitis"  dataposition="73"  style={{visibility: 'inherit', opacity: 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="73_2">
                        ...
                        <g className="caries-filling" dataposition="73_1">
                        ...
                        <g className="caries-filling" dataposition="73_4">
                        ...
                        <g className="with">
                            <path className="st54" areas="73_4 73_1" d="M1250.5 1171L1246.5 1130.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_4 73_1" d="M1250.5 1171C1252 1188 1252 1192.1 1258 1198.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_2 73_1" d="M1205.5 1173.5C1205.5 1192.5 1207 1197.5 1200 1203" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="73_2 73_1" d="M1205.5 1173.5L1203.5 1123" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
