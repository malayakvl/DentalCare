            ...
            >
                ...
                >
                    ...
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth73Diagnozis.pin ? 1 : 0}}>
                        ...
                        <circle className="st57" r="12.25" transform="matrix(-1 0 0 1 1225.36 983)" style={{fill: 'black', opacity: tooth73Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                ...
                >
                    ...
                    <g className="pin" style={{
                        ...
                        />
                        <path className="st57" style={{fill: tooth73Diagnozis.pin ? '#dbd9d3' : 'none'}}
