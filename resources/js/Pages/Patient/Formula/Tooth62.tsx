...
export default function Tooth62() {
    ...
    return (
        <>
            ...
            <g id="TH-62" className={`f-tooth-init-milk ${((teethDiagnozis.tooth62.show || allTeeth) && !teethDiagnozis.tooth62.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
