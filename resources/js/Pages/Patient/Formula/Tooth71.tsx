...
import PeriodontitStage71 from './periodontit71';
...
export default function Tooth71() {
    ...
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth71.show && !teethDiagnozis.tooth31.show) {
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && teethDiagnozis.tooth31.show) {
                document.getElementById('TH-71').classList.add('f-tooth-active');
                document.getElementById('TH-31').classList.remove('f-tooth-active');
            }
            if (teethType === 'adult' && teethDiagnozis.tooth71.show) {
                document.getElementById('TH-71').classList.remove('f-tooth-active');
                document.getElementById('TH-31').classList.add('f-tooth-active');
            }
        }
        ...
        <>
            ...
            <g id="TH-71" className={`f-tooth-init-milk ${(teethDiagnozis.tooth71.show && !teethDiagnozis.tooth71.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
                    ...
                    teethDiagnozis.tooth31.show = false;
            ...
            >
                ...
                >
                    <g className="dentin">
                        <g style={{visibility: !tooth71Diagnozis.culttab && !tooth71Diagnozis.implant && !tooth71Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth71Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth71Diagnozis?.apex ? 'apex' : ''}`} 
                        ...
                        <g style={{visibility: tooth71Diagnozis?.apex || tooth71Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth71Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth71Diagnozis?.apex ? 'apex' : ''}`} 
                    ...
                    <g className="pulp" style={{visibility: tooth71Diagnozis.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth71Diagnozis.implant || tooth71Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth71Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth71Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth71Diagnozis.pin ? 1 : 0}}>
                        ...
                        <path className="st56 hIntact" d="M1064.93 983.571L1064.93 983.571L1064.92 983.58C1063.91 985.054 1063.89 986.797 1064.73 988.406C1065.96 990.546 1068.48 991.929 1071.36 992.991C1075.22 994.35 1079.36 994.918 1083.61 995C1088.59 994.999 1093.63 994.268 1098.07 992.586C1100.54 991.604 1102.64 990.393 1103.63 988.588C1104.3 987.238 1104.32 985.678 1103.54 984.134C1102.8 982.731 1101.58 981.511 1100.25 980.271L1100.24 980.266L1100.24 980.26C1097.63 977.751 1095.08 974.975 1092.95 972.017L1092.95 972.01L1092.94 972.002C1092.91 971.962 1092.89 971.921 1092.86 971.88C1091.95 970.562 1091.06 969.285 1089.93 968.437C1088.38 967.343 1086.46 966.829 1084.46 967.05C1081.78 967.345 1079.49 968.903 1077.56 970.814C1076.43 971.964 1075.43 973.19 1074.41 974.451C1074.1 974.823 1073.8 975.199 1073.48 975.576C1072.13 977.208 1070.68 978.847 1068.89 980.239C1068.45 980.601 1067.93 980.972 1067.44 981.319C1067.15 981.527 1066.87 981.726 1066.63 981.909C1065.92 982.447 1065.34 982.966 1064.93 983.571Z" 
                            style={{visibility: 'inherit'}}
                        />
                        <circle className="st57" r="12.25" transform="matrix(-1 0 0 1 1085.13 983)" style={{fill: 'black', opacity: tooth71Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth71Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth71Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1060.86 983.854L1060.86 983.854L1060.85 983.863C1059.59 985.719 1059.56 987.914 1060.61 989.922C1062.12 992.58 1065.21 994.273 1068.67 995.56C1073.34 997.211 1078.32 997.9 1083.44 998C1089.44 997.999 1095.51 997.112 1100.86 995.068C1103.83 993.88 1106.42 992.392 1107.64 990.139C1108.48 988.441 1108.5 986.482 1107.54 984.556C1106.62 982.825 1105.14 981.328 1103.54 979.829L1103.54 979.824L1103.53 979.818C1100.4 976.79 1097.36 973.444 1094.81 969.881L1094.81 969.874L1094.8 969.866C1094.77 969.813 1094.73 969.759 1094.69 969.706C1093.61 968.122 1092.53 966.553 1091.14 965.507C1089.24 964.155 1086.89 963.521 1084.44 963.794C1081.17 964.157 1078.37 966.076 1076.04 968.402C1074.68 969.8 1073.47 971.292 1072.24 972.818C1071.88 973.267 1071.51 973.719 1071.14 974.172C1069.52 976.144 1067.79 978.111 1065.65 979.78C1065.12 980.215 1064.51 980.655 1063.94 981.07C1063.58 981.323 1063.25 981.567 1062.95 981.796C1062.09 982.45 1061.37 983.094 1060.86 983.854Z"></path>
                        <path className="st47" d="M1064.93 983.571L1064.93 983.571L1064.92 983.58C1063.91 985.054 1063.89 986.797 1064.73 988.406C1065.96 990.546 1068.48 991.929 1071.35 992.991C1075.22 994.35 1079.35 994.918 1083.61 995C1088.59 994.999 1093.63 994.268 1098.07 992.586C1100.54 991.604 1102.64 990.393 1103.63 988.588C1104.3 987.238 1104.32 985.678 1103.54 984.134C1102.79 982.731 1101.58 981.511 1100.25 980.271L1100.24 980.266L1100.24 980.26C1097.62 977.751 1095.08 974.975 1092.95 972.017L1092.95 972.01L1092.94 972.002C1092.91 971.962 1092.88 971.921 1092.86 971.88C1091.94 970.562 1091.06 969.285 1089.93 968.437C1088.38 967.343 1086.46 966.829 1084.46 967.05C1081.78 967.345 1079.48 968.903 1077.56 970.814C1076.43 971.964 1075.43 973.19 1074.4 974.451C1074.1 974.823 1073.8 975.199 1073.48 975.576C1072.13 977.208 1070.68 978.847 1068.89 980.239C1068.44 980.601 1067.93 980.972 1067.44 981.319C1067.15 981.527 1066.87 981.726 1066.63 981.909C1065.92 982.447 1065.34 982.966 1064.93 983.571Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment && !tooth71Diagnozis.implant && !tooth71Diagnozis.apex && !tooth71Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth71.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment && !tooth71Diagnozis.implant && !tooth71Diagnozis.shaper && !tooth71Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g dataposition="71_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth71.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth71.seal_left ? `seal-fill ${teethDiagnozis.tooth71.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth71.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth71.seal_top ? `seal-fill ${teethDiagnozis.tooth71.seal_top_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth71.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth71.seal_center ? `seal-fill ${teethDiagnozis.tooth71.seal_center_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth71.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth71.seal_right ? `seal-fill ${teethDiagnozis.tooth71.seal_right_color}` : ''}
                                `}  
                        ...
                        <g className="with">
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_right && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_right && !tooth71Diagnozis.seal_top) ||
                                        (!tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_center && !tooth71Diagnozis.seal_top) ||
                                        (!tooth71Diagnozis.seal_center && tooth71Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_top && !tooth71Diagnozis.seal_left) ||
                                        (!tooth71Diagnozis.seal_top && tooth71Diagnozis.seal_left)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_left && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_left && tooth71Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        <g className="vinir"  style={
                            {
                                visibility: tooth71Diagnozis.vinir ? 'inherit' : 'hidden',
                                opacity: tooth71Diagnozis.vinir ? 1 : 0
                            }}
                        >
                    ...
                    <g className="crown" style={{
                        visibility: (tooth71Diagnozis.temporary_crown || tooth71Diagnozis.ceramic_crown || tooth71Diagnozis.mceramic_crown || tooth71Diagnozis.metalic_crown || tooth71Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth71Diagnozis.temporary_crown || tooth71Diagnozis.ceramic_crown || tooth71Diagnozis.mceramic_crown || tooth71Diagnozis.metalic_crown || tooth71Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth71Diagnozis.ceramic_crown_color}
                                ${tooth71Diagnozis.mceramic_crown_color}
                                ${tooth71Diagnozis.metalic_crown_color}
                                ${tooth71Diagnozis.zirconia_crown_color}
                            `} 
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth71Diagnozis.implant && !tooth71Diagnozis.apex && !tooth71Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth71Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth71Diagnozis.channel_class} ${tooth71Diagnozis.channel_class} ${tooth71Diagnozis.pulpit ? 'pulpit' : ''} ${tooth71Diagnozis.periodontit ? 'periodontit' : ''}`}
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth71Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" style={{fill: tooth71Diagnozis.pin ? '#dbd9d3' : 'none'}}
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth71Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth71Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth71Diagnozis.abutment || tooth71Diagnozis.implant || tooth71Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment && !tooth71Diagnozis.implant && !tooth71Diagnozis.shaper && !tooth71Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth71Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} d="M1065.31 1200.34C1065.38 1200.56 1065.45 1200.86 1065.53 1201.16L1065.53 1201.16C1067.67 1207.83 1070.62 1214.42 1076.6 1217.87C1081.7 1220.79 1087.9 1220.72 1092.84 1217.57C1096.68 1215.1 1099.04 1211.2 1100.82 1207C1101.7 1204.98 1102.37 1202.88 1102.96 1200.71C1103.65 1198.29 1104.18 1195.84 1104.61 1193.36C1104.83 1192.13 1103.85 1191.03 1102.6 1191.07L1065.49 1192.11C1064.21 1192.14 1063.3 1193.35 1063.63 1194.59C1064.15 1196.52 1064.71 1198.43 1065.31 1200.34Z"
                        />
                        <path className={
                                `st60
                                    ${(tooth71Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth71Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth71Diagnozis.seal_cervical_color}
                                `
                            } 
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth71.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment && !tooth71Diagnozis.implant && !tooth71Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_right && !tooth71Diagnozis.seal_top && !tooth71Diagnozis.seal_center) ||
                                        (tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_top && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_right && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_right && !tooth71Diagnozis.seal_bottom && tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_bottom && tooth71Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_left && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_left && tooth71Diagnozis.seal_center) ||
                                        (tooth71Diagnozis.seal_right && tooth71Diagnozis.seal_left && !tooth71Diagnozis.seal_center && !tooth71Diagnozis.seal_top) ||
                                        (!tooth71Diagnozis.seal_top && !tooth71Diagnozis.seal_bottom && tooth71Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth71Diagnozis.seal_left && !tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_left && !tooth71Diagnozis.seal_bottom && tooth71Diagnozis.seal_center) ||
                                        (!tooth71Diagnozis.seal_left && tooth71Diagnozis.seal_bottom && tooth71Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
