...
export default function Tooth71() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth71.caries_bottom = !teethDiagnozis.tooth71.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth71.caries_center = !teethDiagnozis.tooth71.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth71.caries_left = !teethDiagnozis.tooth71.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth71.caries_right = !teethDiagnozis.tooth71.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth71.caries_top = !teethDiagnozis.tooth71.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth71.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth71.seal_center_color = sealColor1;
                    teethDiagnozis.tooth71.seal_center = true;
                } else if (teethDiagnozis.tooth71.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth71.seal_center_color = sealColor2;
                    teethDiagnozis.tooth71.seal_center = true;
                } else if (teethDiagnozis.tooth71.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth71.seal_center_color = sealColor3;
                    teethDiagnozis.tooth71.seal_center = true;
                } else {
                    teethDiagnozis.tooth71.seal_center = !teethDiagnozis.tooth71.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth71.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth71.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth71.seal_bottom = true;
                } else if (teethDiagnozis.tooth71.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth71.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth71.seal_bottom = true;
                } else if (teethDiagnozis.tooth71.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth71.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth71.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth71.seal_bottom = !teethDiagnozis.tooth71.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth71.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth71.seal_left_color = sealColor1;
                    teethDiagnozis.tooth71.seal_left = true;
                } else if (teethDiagnozis.tooth71.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth71.seal_left_color = sealColor2;
                    teethDiagnozis.tooth71.seal_left = true;
                } else if (teethDiagnozis.tooth71.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth71.seal_left_color = sealColor3;
                    teethDiagnozis.tooth71.seal_left = true;
                } else {
                    teethDiagnozis.tooth71.seal_left = !teethDiagnozis.tooth71.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth71.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth71.seal_right_color = sealColor1;
                    teethDiagnozis.tooth71.seal_right = true;
                } else if (teethDiagnozis.tooth71.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth71.seal_right_color = sealColor2;
                    teethDiagnozis.tooth71.seal_right = true;
                } else if (teethDiagnozis.tooth71.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth71.seal_right_color = sealColor3;
                    teethDiagnozis.tooth71.seal_right = true;
                } else {
                    teethDiagnozis.tooth71.seal_right = !teethDiagnozis.tooth71.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth71.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth71.seal_top_color = sealColor1;
                    teethDiagnozis.tooth71.seal_top = true;
                } else if (teethDiagnozis.tooth71.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth71.seal_top_color = sealColor2;
                    teethDiagnozis.tooth71.seal_top = true;
                } else if (teethDiagnozis.tooth71.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth71.seal_top_color = sealColor3;
                    teethDiagnozis.tooth71.seal_top = true;
                } else {
                    teethDiagnozis.tooth71.seal_top = !teethDiagnozis.tooth71.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth71.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth71.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth71.wedge_shaped_defect_color = !teethDiagnozis.tooth71.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            ...
            >
                <text transform="matrix(1 0 0 1 1060 842)" className="st3 st4 st5">71</text>
            </g>
            <g id="TH-71" className={`f-tooth-init-milk ${(teethDiagnozis.tooth71.show && !teethDiagnozis.tooth71.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    ...
                    (!toothActive && !allTeeth) && document.getElementById('71').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth71.show) {
                        document.getElementById('TH-71').style.opacity = 0
                ...
                onClick={() => {
                    ...
                    if (diagnozis) {
                        ...
                        if (diagnozis === 'change_color')
                            ...
                            teethDiagnozis.tooth71.fissure = !teethDiagnozis.tooth71.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth71.caries = !teethDiagnozis.tooth71.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth71.cervical_caries = !teethDiagnozis.tooth71.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth71.wedge_shaped_defect = !teethDiagnozis.tooth71.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth71.tartar = !teethDiagnozis.tooth71.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth71.pulpit = !teethDiagnozis.tooth71.pulpit;
                            teethDiagnozis.tooth71.channel_class = teethDiagnozis.tooth71.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth71.channel_not_sealed = !teethDiagnozis.tooth71.channel_not_sealed;
                            teethDiagnozis.tooth71.channel_class = teethDiagnozis.tooth71.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth71.channel_top_sealed = !teethDiagnozis.tooth71.channel_top_sealed;
                            teethDiagnozis.tooth71.channel_class = teethDiagnozis.tooth71.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth71.channel_part_sealed = !teethDiagnozis.tooth71.channel_part_sealed;
                            teethDiagnozis.tooth71.channel_class = teethDiagnozis.tooth71.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth71.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth71.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth71.periodontit = true;
                            } else {
                                teethDiagnozis.tooth71.periodontit = !teethDiagnozis.tooth71.periodontit;
                            }
                            teethDiagnozis.tooth71.channel_class = teethDiagnozis.tooth71.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth71.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth71.seal = !teethDiagnozis.tooth71.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth71.seal_cervical && teethDiagnozis.tooth71.seal_cervical_color === "") {
                                teethDiagnozis.tooth71.seal_cervical = true;
                                teethDiagnozis.tooth71.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth71.seal_cervical && teethDiagnozis.tooth71.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth71.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth71.seal_cervical = false;
                                teethDiagnozis.tooth71.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth71.vinir && teethDiagnozis.tooth71.vinir_color === "") {
                                teethDiagnozis.tooth71.vinir = true;
                                teethDiagnozis.tooth71.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth71.vinir && teethDiagnozis.tooth71.vinir_color != vinirColor) {
                                teethDiagnozis.tooth71.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth71.vinir = false;
                                teethDiagnozis.tooth71.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth71.temporary_crown = !teethDiagnozis.tooth71.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth71.ceramic_crown && teethDiagnozis.tooth71.ceramic_crown_color === "") {
                                teethDiagnozis.tooth71.ceramic_crown = true;
                                teethDiagnozis.tooth71.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth71.ceramic_crown && teethDiagnozis.tooth71.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth71.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth71.ceramic_crown = false;
                                teethDiagnozis.tooth71.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth71.mceramic_crown && teethDiagnozis.tooth71.mceramic_crown_color === "") {
                                teethDiagnozis.tooth71.mceramic_crown = true;
                                teethDiagnozis.tooth71.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth71.mceramic_crown && teethDiagnozis.tooth71.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth71.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth71.mceramic_crown = false;
                                teethDiagnozis.tooth71.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth71.metalic_crown && teethDiagnozis.tooth71.metalic_crown_color === "") {
                                teethDiagnozis.tooth71.metalic_crown = true;
                                teethDiagnozis.tooth71.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth71.metalic_crown && teethDiagnozis.tooth71.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth71.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth71.metalic_crown = false;
                                teethDiagnozis.tooth71.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth71.zirconia_crown && teethDiagnozis.tooth71.zirconia_crown_color === "") {
                                teethDiagnozis.tooth71.zirconia_crown = true;
                                teethDiagnozis.tooth71.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth71.zirconia_crown && teethDiagnozis.tooth71.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth71.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth71.zirconia_crown = false;
                                teethDiagnozis.tooth71.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth71.pin = !teethDiagnozis.tooth71.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth71.culttab = !teethDiagnozis.tooth71.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth71.abutment = !teethDiagnozis.tooth71.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth71.shaper = !teethDiagnozis.tooth71.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth71.implant = !teethDiagnozis.tooth71.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth71.apex = !teethDiagnozis.tooth71.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth71.absent = !teethDiagnozis.tooth71.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth71.cervical_caries = !teethDiagnozis.tooth71.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth71.caries = !teethDiagnozis.tooth71.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth71.parodontit) {
                                if (teethDiagnozis.tooth71.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth71.parodontit = false;
                                    teethDiagnozis.tooth71.active = false;
                                } else {
                                    teethDiagnozis.tooth71.parodontit = true;
                                    teethDiagnozis.tooth71.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth71.parodontit = true;
                                teethDiagnozis.tooth71.parodontit_stage = subDiagnozis;
            ...
            >
                <g className={`underlay ${selectedTooth === 71 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 15, -7)'}}>
                    <g className="dentin">
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <path className="st46" d="M1114.9,983.6c-1.2-3-3.3-5.5-5.3-7.9c-2.4-2.9-4.8-5.9-6.9-9c-1.5-2.1-2.9-4.3-4.2-6.6
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_header_71_2" className="caries-filling" dataposition="71_2">
                            ...
                            />
                            <path className="st8 target" d="M1069.8,988.5c-1.4,2.1-8.2,8-13,11.9c-2.3-1.7-4.2-3.8-5.4-6.5c-1.6-3.6-1.5-7.8,0.4-11.3
                                c1.6-2.8,4.3-4.7,6.6-6.9c2.6-2.5,4.8-5.5,6.9-8.5c1.1,2.4,3.3,7.3,4.5,10.1c0.5,1.2,1,2.5,1.2,3.7
                                C1071.6,983.7,1071.3,986.3,1069.8,988.5z"
                            />
                        </g>
                        <g id="s_header_71_3" className="caries-filling" dataposition="71_3">
                            <path className="st7" d="M1102.6,966.7c-2.8,4.3-8.2,12.9-8.3,15.7c-6.9,0-17.4-0.8-23.3-1.3c-0.2-1.2-0.7-2.5-1.2-3.7
                            ...
                            />
                            <path className="st8 target" d="M1102.6,966.7c-2.8,4.3-8.2,12.9-8.3,15.7c-6.9,0-17.4-0.8-23.3-1.3c-0.2-1.2-0.7-2.5-1.2-3.7
                                c-1.2-2.8-3.4-7.7-4.5-10.1c2.2-3.2,4.3-6.5,6.7-9.5c3.2-3.9,7-7.2,11.7-7.9c3.6-0.5,6.9,0.5,9.6,3c2.1,1.9,3.6,4.7,5.1,7.3
                                C1099.7,962.4,1101.1,964.6,1102.6,966.7z"
                            />
                        </g>
                        <g id="s_header_71_1" className="caries-filling" dataposition="71_1">
                            <path className="st7" d="M1110.6,999.3c-1.6,1.3-3.4,2.3-5.3,3.2c-7.2,3.4-15.2,4.9-23.2,4.9c-6.7,0-13.4-1.2-19.6-3.8
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 15, -20)'}}>
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        ...
                        <g className="hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st10" d="M1107,1236.9c0,10.3,0.3,20.7,0.4,31c0,11-0.3,22-0.6,33
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" dataposition="71" style={{visibility: 'inherit'}}>
                        ...
                        <g className="hEmpty hImplant pulpitis-pfilling" dataposition="71" style={{visibility: 'inherit'}}>
                        ...
                        <g className="level hEmpty hImplant periodontitis"  dataposition="71"  style={{visibility: 'inherit', opacity: 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="71_4">
                        ...
                        <g className="caries-filling" dataposition="71_2">
                        ...
                        <g className="caries-filling" dataposition="71_1">
                        ...
                        <g className="with">
                            <path className="st54" areas="71_4 71_1" d="M1100 1164L1097.5 1128" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="71_4 71_1" d="M1100 1164C1101.5 1188 1102 1191 1105.5 1196.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="71_2 71_1" d="M1065 1165.5V1128.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="71_2 71_1" d="M1065 1165.5C1065 1182 1066 1190.5 1063 1196" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
