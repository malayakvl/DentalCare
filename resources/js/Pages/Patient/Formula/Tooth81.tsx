...
import PeriodontitStage81 from './periodontit81';
...
export default function Tooth81() {
    ...
    const tooth81Diagnozis = teethDiagnozis.tooth81;
    ...
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth81.show && !teethDiagnozis.tooth41.show) {
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            ...
            if (teethType === 'adult' && teethDiagnozis.tooth81.show) {
                document.getElementById('TH-81').classList.remove('f-tooth-active');
                document.getElementById('TH-41').classList.add('f-tooth-active');
            }
        }
    ...
    return (
        <>
            ...
            <g id="TH-81" className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth81.show && !teethDiagnozis.tooth81.absent)  ? 'f-tooth-active' : ''}`}
                onClick={() => {
            ...
            >
                <g className={`underlay ${selectedTooth === 81 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}
                    onMouseOver={() => {
                ...
                >
                    <g className="dentin">
                        <g style={{visibility: !tooth81Diagnozis.culttab && !tooth81Diagnozis.implant && !tooth81Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth81Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth81Diagnozis?.apex ? 'apex' : ''}`} 
                        ...
                        <g style={{visibility: tooth81Diagnozis?.apex || tooth81Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth81Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth81Diagnozis?.apex ? 'apex' : ''}`}
                    ...
                    <g className="pulp" style={{visibility: tooth81Diagnozis.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth81Diagnozis.implant || tooth81Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth81Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth81Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth81Diagnozis.pin ? 1 : 0}}>
                        ...
                        <circle className="st57" cx="1013" cy="983" r="12.25" style={{fill: 'black', opacity: tooth81Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth81Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth81Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1037.27 983.855L1037.27 983.855L1037.27 983.864C1038.54 985.72 1038.56 987.915 1037.52 989.923C1036.01 992.581 1032.92 994.274 1029.46 995.561C1024.79 997.212 1019.81 997.901 1014.69 998.001C1008.69 998 1002.62 997.113 997.264 995.069C994.294 993.881 991.708 992.393 990.488 990.14C989.644 988.442 989.63 986.483 990.59 984.557C991.504 982.826 992.985 981.329 994.584 979.83L994.59 979.825L994.595 979.819C997.725 976.791 1000.77 973.445 1003.31 969.882L1003.32 969.875L1003.32 969.867C1003.36 969.814 1003.4 969.76 1003.43 969.707C1004.52 968.123 1005.6 966.554 1006.99 965.508C1008.89 964.156 1011.24 963.522 1013.69 963.794C1016.96 964.158 1019.76 966.077 1022.09 968.403C1023.45 969.801 1024.65 971.293 1025.89 972.819C1026.25 973.268 1026.62 973.72 1026.99 974.173C1028.61 976.145 1030.34 978.112 1032.47 979.781C1033 980.216 1033.61 980.656 1034.19 981.071C1034.54 981.324 1034.88 981.568 1035.18 981.797C1036.04 982.451 1036.76 983.095 1037.27 983.855Z"></path>
                        <path className="st47" d="M1033.2 983.571L1033.2 983.571L1033.2 983.58C1034.22 985.054 1034.24 986.797 1033.4 988.406C1032.17 990.546 1029.65 991.929 1026.77 992.991C1022.91 994.35 1018.77 994.918 1014.52 995C1009.53 994.999 1004.5 994.268 1000.06 992.586C997.589 991.604 995.487 990.393 994.501 988.588C993.826 987.238 993.812 985.678 994.587 984.134C995.333 982.731 996.547 981.511 997.879 980.271L997.885 980.266L997.891 980.26C1000.5 977.751 1003.05 974.975 1005.18 972.017L1005.18 972.01L1005.19 972.002C1005.21 971.962 1005.24 971.921 1005.27 971.88C1006.18 970.562 1007.07 969.285 1008.2 968.437C1009.75 967.343 1011.67 966.829 1013.67 967.05C1016.34 967.345 1018.64 968.903 1020.57 970.814C1021.7 971.964 1022.7 973.19 1023.72 974.451C1024.03 974.823 1024.33 975.199 1024.64 975.576C1026 977.208 1027.45 978.847 1029.24 980.239C1029.68 980.601 1030.2 980.972 1030.69 981.319C1030.98 981.527 1031.26 981.726 1031.5 981.909C1032.21 982.447 1032.79 982.966 1033.2 983.571Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment && !tooth81Diagnozis.implant && !tooth81Diagnozis.apex && !tooth81Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth81.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment && !tooth81Diagnozis.implant && !tooth81Diagnozis.shaper && !tooth81Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        <g
                            dataposition="81_4"
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth81.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth81.seal_right ? `seal-fill ${teethDiagnozis.tooth81.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth81.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth81.seal_top ? `seal-fill ${teethDiagnozis.tooth81.seal_top_color}` : ''}
                                `} 
                        ...
                        <g dataposition="81_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth81.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth81.seal_left ? `seal-fill ${teethDiagnozis.tooth81.seal_left_color}` : ''}
                                `} 
                                d="M983.2,993.8c1,2.2,2.5,4,4.3,5.5c6-5.8,15.1-14.8,16.1-16.3c0.1-0.1,0.1-0.4,0.1-0.6
                                c-0.1-2.8-5.5-11.4-8.3-15.7c-2.2,3.1-4.5,6.1-6.9,9c-2,2.4-4.2,4.9-5.3,7.9C981.9,986.9,981.8,990.6,983.2,993.8z"
                            />
                        </g>
                        <g dataposition="81_1" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth81.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth81.seal_center ? `seal-fill ${teethDiagnozis.tooth81.seal_center_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_left && tooth81Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_top) ||
                                        (!tooth81Diagnozis.seal_left && tooth81Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_center && !tooth81Diagnozis.seal_top) ||
                                        (!tooth81Diagnozis.seal_center && tooth81Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_top && !tooth81Diagnozis.seal_right) ||
                                        (!tooth81Diagnozis.seal_top && tooth81Diagnozis.seal_right)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_right && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_right && tooth81Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                        ...
                        <g className="vinir"  style={
                            {
                                ...
                                opacity: tooth81Diagnozis.vinir ? 1 : 0
                            }}
                        >
                    ...
                    <g className="crown" style={{
                        visibility: (tooth81Diagnozis.temporary_crown || tooth81Diagnozis.ceramic_crown || tooth81Diagnozis.mceramic_crown || tooth81Diagnozis.metalic_crown || tooth81Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth81Diagnozis.temporary_crown || tooth81Diagnozis.ceramic_crown || tooth81Diagnozis.mceramic_crown || tooth81Diagnozis.metalic_crown || tooth81Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth81Diagnozis.ceramic_crown_color}
                                ${tooth81Diagnozis.mceramic_crown_color}
                                ${tooth81Diagnozis.metalic_crown_color}
                                ${tooth81Diagnozis.zirconia_crown_color}
                            `} 
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 21, 14)'}}
                    onMouseOver={() => {
                        showHideTopCommonView('over')
                    }}
                    onMouseLeave={() => {
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth81Diagnozis.implant && !tooth81Diagnozis.apex && !tooth81Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth81Diagnozis.change_color ? 'diagnoze' : ''}`}  
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth81Diagnozis.channel_class} ${tooth81Diagnozis.channel_class} ${tooth81Diagnozis.pulpit ? 'pulpit' : ''} ${tooth81Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth81Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" style={{fill: tooth81Diagnozis.pin ? '#dbd9d3' : 'none'}}  
                            d="M1029.1 1146.9L1020 1225.1L1012.2 1292.2L1009.9 1311.9C1009.8 1312.9 1008.9 1313.7 1007.9 1313.7C1006.8 1313.7 1005.9 1312.8 1005.9 1311.6L1006.5 1286.3L1008 1225.3L1009.9 1146.9H1029.1Z"></path>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth81Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth81Diagnozis.culttab ? 0 : 1}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth81Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth81Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth81Diagnozis.abutment || tooth81Diagnozis.implant || tooth81Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment && !tooth81Diagnozis.implant && !tooth81Diagnozis.shaper && !tooth81Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth81.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment && !tooth81Diagnozis.implant && !tooth81Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_top && !tooth81Diagnozis.seal_center) ||
                                        (tooth81Diagnozis.seal_left && tooth81Diagnozis.seal_top && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_left && tooth81Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_bottom && tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_left && tooth81Diagnozis.seal_bottom && tooth81Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_right && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_right && tooth81Diagnozis.seal_center) ||
                                        (tooth81Diagnozis.seal_right && tooth81Diagnozis.seal_left && !tooth81Diagnozis.seal_center && !tooth81Diagnozis.seal_top) ||
                                        (!tooth81Diagnozis.seal_top && !tooth81Diagnozis.seal_bottom && tooth81Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth81Diagnozis.seal_right && !tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_right && !tooth81Diagnozis.seal_bottom && tooth81Diagnozis.seal_center) ||
                                        (!tooth81Diagnozis.seal_right && tooth81Diagnozis.seal_bottom && tooth81Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
