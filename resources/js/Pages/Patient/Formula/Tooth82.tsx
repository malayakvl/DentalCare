...
export default function Tooth82() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth82.caries_bottom = !teethDiagnozis.tooth82.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth82.caries_center = !teethDiagnozis.tooth82.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth82.caries_left = !teethDiagnozis.tooth82.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth82.caries_right = !teethDiagnozis.tooth82.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth82.caries_top = !teethDiagnozis.tooth82.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth82.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth82.seal_center_color = sealColor1;
                    teethDiagnozis.tooth82.seal_center = true;
                } else if (teethDiagnozis.tooth82.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth82.seal_center_color = sealColor2;
                    teethDiagnozis.tooth82.seal_center = true;
                } else if (teethDiagnozis.tooth82.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth82.seal_center_color = sealColor3;
                    teethDiagnozis.tooth82.seal_center = true;
                } else {
                    teethDiagnozis.tooth82.seal_center = !teethDiagnozis.tooth82.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth82.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth82.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth82.seal_bottom = true;
                } else if (teethDiagnozis.tooth82.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth82.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth82.seal_bottom = true;
                } else if (teethDiagnozis.tooth82.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth82.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth82.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth82.seal_bottom = !teethDiagnozis.tooth82.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth82.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth82.seal_left_color = sealColor1;
                    teethDiagnozis.tooth82.seal_left = true;
                } else if (teethDiagnozis.tooth82.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth82.seal_left_color = sealColor2;
                    teethDiagnozis.tooth82.seal_left = true;
                } else if (teethDiagnozis.tooth82.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth82.seal_left_color = sealColor3;
                    teethDiagnozis.tooth82.seal_left = true;
                } else {
                    teethDiagnozis.tooth82.seal_left = !teethDiagnozis.tooth82.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth82.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth82.seal_right_color = sealColor1;
                    teethDiagnozis.tooth82.seal_right = true;
                } else if (teethDiagnozis.tooth82.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth82.seal_right_color = sealColor2;
                    teethDiagnozis.tooth82.seal_right = true;
                } else if (teethDiagnozis.tooth82.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth82.seal_right_color = sealColor3;
                    teethDiagnozis.tooth82.seal_right = true;
                } else {
                    teethDiagnozis.tooth82.seal_right = !teethDiagnozis.tooth82.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth82.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth82.seal_top_color = sealColor1;
                    teethDiagnozis.tooth82.seal_top = true;
                } else if (teethDiagnozis.tooth82.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth82.seal_top_color = sealColor2;
                    teethDiagnozis.tooth82.seal_top = true;
                } else if (teethDiagnozis.tooth82.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth82.seal_top_color = sealColor3;
                    teethDiagnozis.tooth82.seal_top = true;
                } else {
                    teethDiagnozis.tooth82.seal_top = !teethDiagnozis.tooth82.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth82.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth82.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth82.wedge_shaped_defect_color = !teethDiagnozis.tooth82.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="82" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 932.5898 842.0025)" className="st3 st4 st5">82</text>
            </g>
            <g id="TH-82" className={`f-tooth-init-milk ${(teethDiagnozis.tooth82.show && !teethDiagnozis.tooth82.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (teethType === 'child') {
                        document.getElementById('TH-85').style.opacity = 1
                    } else {
                        if (!teethDiagnozis.tooth82.show) {
                            document.getElementById('TH-42').style.visibility = 'inherit'
                            document.getElementById('TH-82').style.visibility = 'hidden'
                        } else {
                            document.getElementById('TH-42').style.visibility = 'inherit'
                            document.getElementById('TH-82').style.visibility = 'hidden'
                        }
                    }
                    (!toothActive && !allTeeth) && document.getElementById('82').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth82.show) {
                        document.getElementById('TH-82').style.opacity = 0
                    }
                    if (teethDiagnozis.tooth82.show && teethType === 'adult') {
                        document.getElementById('TH-42').style.visibility = 'hidden'
                        document.getElementById('TH-82').style.visibility = 'inherit'
                    }
                    if (teethDiagnozis.tooth42.show && !teethDiagnozis.tooth42.absent && teethType === 'child') {
                        document.getElementById('TH-42').style.visibility = 'inherit'
                        document.getElementById('TH-82').style.visibility = 'hidden'
                    }
                    (!toothActive && !allTeeth) && document.getElementById('82').classList.remove('tooth-number-hover')
                }}
                onClick={() => {
                    dispatch(setSelectedToothNumber(85));
                    // effects block
                    if (teethType === 'child' && teethDiagnozis.tooth42.show) {
                        teethDiagnozis.tooth42.show = false;
                        teethDiagnozis.tooth82.show = true;
                    } else if (teethType === 'child' && !teethDiagnozis.tooth42.show) {
                        teethDiagnozis.tooth42.show = false;
                        teethDiagnozis.tooth82.show = true;
                    } else {
                        teethDiagnozis.tooth42.show = true;
                        teethDiagnozis.tooth82.show = false;
                    }
                    dispatch(setToothDiagnoze(teethDiagnozis));
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth82.change_color = !teethDiagnozis.tooth82.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth82.fissure = !teethDiagnozis.tooth82.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth82.caries = !teethDiagnozis.tooth82.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth82.cervical_caries = !teethDiagnozis.tooth82.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth82.wedge_shaped_defect = !teethDiagnozis.tooth82.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth82.tartar = !teethDiagnozis.tooth82.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth82.pulpit = !teethDiagnozis.tooth82.pulpit;
                            teethDiagnozis.tooth82.channel_class = teethDiagnozis.tooth82.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth82.channel_not_sealed = !teethDiagnozis.tooth82.channel_not_sealed;
                            teethDiagnozis.tooth82.channel_class = teethDiagnozis.tooth82.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth82.channel_top_sealed = !teethDiagnozis.tooth82.channel_top_sealed;
                            teethDiagnozis.tooth82.channel_class = teethDiagnozis.tooth82.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth82.channel_part_sealed = !teethDiagnozis.tooth82.channel_part_sealed;
                            teethDiagnozis.tooth82.channel_class = teethDiagnozis.tooth82.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth82.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth82.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth82.periodontit = true;
                            } else {
                                teethDiagnozis.tooth82.periodontit = !teethDiagnozis.tooth82.periodontit;
                            }
                            teethDiagnozis.tooth82.channel_class = teethDiagnozis.tooth82.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth82.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth82.seal = !teethDiagnozis.tooth82.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth82.seal_cervical && teethDiagnozis.tooth82.seal_cervical_color === "") {
                                teethDiagnozis.tooth82.seal_cervical = true;
                                teethDiagnozis.tooth82.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth82.seal_cervical && teethDiagnozis.tooth82.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth82.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth82.seal_cervical = false;
                                teethDiagnozis.tooth82.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth82.vinir && teethDiagnozis.tooth82.vinir_color === "") {
                                teethDiagnozis.tooth82.vinir = true;
                                teethDiagnozis.tooth82.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth82.vinir && teethDiagnozis.tooth82.vinir_color != vinirColor) {
                                teethDiagnozis.tooth82.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth82.vinir = false;
                                teethDiagnozis.tooth82.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth82.temporary_crown = !teethDiagnozis.tooth82.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth82.ceramic_crown && teethDiagnozis.tooth82.ceramic_crown_color === "") {
                                teethDiagnozis.tooth82.ceramic_crown = true;
                                teethDiagnozis.tooth82.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth82.ceramic_crown && teethDiagnozis.tooth82.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth82.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth82.ceramic_crown = false;
                                teethDiagnozis.tooth82.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth82.mceramic_crown && teethDiagnozis.tooth82.mceramic_crown_color === "") {
                                teethDiagnozis.tooth82.mceramic_crown = true;
                                teethDiagnozis.tooth82.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth82.mceramic_crown && teethDiagnozis.tooth82.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth82.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth82.mceramic_crown = false;
                                teethDiagnozis.tooth82.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth82.metalic_crown && teethDiagnozis.tooth82.metalic_crown_color === "") {
                                teethDiagnozis.tooth82.metalic_crown = true;
                                teethDiagnozis.tooth82.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth82.metalic_crown && teethDiagnozis.tooth82.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth82.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth82.metalic_crown = false;
                                teethDiagnozis.tooth82.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth82.zirconia_crown && teethDiagnozis.tooth82.zirconia_crown_color === "") {
                                teethDiagnozis.tooth82.zirconia_crown = true;
                                teethDiagnozis.tooth82.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth82.zirconia_crown && teethDiagnozis.tooth82.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth82.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth82.zirconia_crown = false;
                                teethDiagnozis.tooth82.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth82.pin = !teethDiagnozis.tooth82.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth82.culttab = !teethDiagnozis.tooth82.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth82.abutment = !teethDiagnozis.tooth82.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth82.shaper = !teethDiagnozis.tooth82.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth82.implant = !teethDiagnozis.tooth82.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth82.apex = !teethDiagnozis.tooth82.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth82.absent = !teethDiagnozis.tooth82.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth82.cervical_caries = !teethDiagnozis.tooth82.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth82.caries = !teethDiagnozis.tooth82.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth82.parodontit) {
                                if (teethDiagnozis.tooth82.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth82.parodontit = false;
                                    teethDiagnozis.tooth82.active = false;
                                } else {
                                    teethDiagnozis.tooth82.parodontit = true;
                                    teethDiagnozis.tooth82.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth82.parodontit = true;
                                teethDiagnozis.tooth82.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth82.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 3, 0)'}}>
                    <g className="dentin">
                        <g className="hEmpty hRoot hImplant" style={{visibility: 'inherit'}}>
                            <path className="st6" d="M924.6,990.6c1.4,2.6,4.3,4.2,7.3,5.4c5.5,2.1,11.7,3,17.8,3c5.2-0.1,10.3-0.8,15.1-2.5
                    ...
                    <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <path className="st46" d="M981.1,982.7c-1.6-2.8-4.3-4.7-6.6-6.9c-3.2-3-5.7-6.8-8.3-10.6c-1.7-2.6-3.4-5.1-5.3-7.5
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_header_82_4" className="caries-filling" dataposition="82_4">
                            ...
                            />
                            <path className="st8 target" d="M960.8,980.3c0,1.9,0.4,3.7,1.4,5.3c1.7,2.5,10.8,10.2,15.3,13.8c1.7-1.5,3.1-3.2,4.1-5.4
                                c1.6-3.6,1.5-7.8-0.4-11.3c-1.6-2.8-4.3-4.7-6.6-6.9c-3.2-3-5.7-6.8-8.3-10.6c-1.2,2.6-3,6.7-4.1,9.1
                                C961.4,976.3,960.8,978.3,960.8,980.3z"
                            />
                        </g>
                        <g id="s_header_82_3" className="caries-filling" dataposition="82_3">
                            <path className="st7" d="M931.2,965.4c2.7,4.2,8.4,13.2,8.5,16c6.1,0,15-0.6,21-1.1c0-2,0.6-4,1.4-5.9c1.1-2.5,2.9-6.5,4.1-9.1
                            ...
                            />
                            <path className="st8 target" d="M931.2,965.4c2.7,4.2,8.4,13.2,8.5,16c6.1,0,15-0.6,21-1.1c0-2,0.6-4,1.4-5.9c1.1-2.5,2.9-6.5,4.1-9.1
                                c-1.7-2.6-3.4-5.1-5.3-7.5c-3.2-3.9-7-7.2-11.7-7.9c-3.5-0.5-6.9,0.5-9.6,3c-2.1,1.9-3.6,4.7-5.1,7.3
                                C933.5,961.9,932.4,963.7,931.2,965.4z" 
                            />
                        </g>
                        <g id="s_header_82_2" className="caries-filling" dataposition="82_2">
                            <path className="st7" d="M918.1,993.8c1,2.3,2.5,4,4.3,5.5c5.9-5.7,16.1-15.7,17.2-17.3c0.1-0.1,0.1-0.4,0.1-0.6
                                c-0.1-2.8-5.8-11.8-8.5-16c-2.4,3.6-5.1,7-7.8,10.3c-2,2.4-4.2,4.9-5.3,7.9C916.8,986.9,916.7,990.6,918.1,993.8z"
                            />
                            <path className="st8 target" d="M918.1,993.8c1,2.3,2.5,4,4.3,5.5c5.9-5.7,16.1-15.7,17.2-17.3c0.1-0.1,0.1-0.4,0.1-0.6
                                c-0.1-2.8-5.8-11.8-8.5-16c-2.4,3.6-5.1,7-7.8,10.3c-2,2.4-4.2,4.9-5.3,7.9C916.8,986.9,916.7,990.6,918.1,993.8z" 
                            />
                        </g>
                        <g id="s_header_82_1" className="caries-filling" dataposition="82_1">
                            <path className="st7" d="M922.4,999.3c1.6,1.3,3.4,2.3,5.2,3.2c7.2,3.4,15.2,4.9,23.2,4.9c6.7,0,13.4-1.2,19.6-3.8
                            ...
                            />
                            <path className="st8 target" d="M922.4,999.3c1.6,1.3,3.4,2.3,5.2,3.2c7.2,3.4,15.2,4.9,23.2,4.9c6.7,0,13.4-1.2,19.6-3.8
                                c2.5-1.1,5-2.4,7-4.2c-4.4-3.7-13.6-11.3-15.3-13.8c-1.1-1.6-1.5-3.4-1.4-5.3c-6.1,0.5-14.9,1.1-21,1.1c0,0.3,0,0.5-0.1,0.6
                                C938.6,983.6,928.4,993.6,922.4,999.3z"
                            />
                        </g>
                        <g className="with">
                            <path className="st54" areas="82_2 82_1" d="M940 981.5C937.167 985.167 930.3 993.3 925.5 996.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_3 82_2" d="M940 981.5C939.667 979.667 938 974.8 934 970" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_3 82_1" d="M940 981.5C943 982.167 951.3 982.9 960.5 980.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_3 82_4" d="M960.5 980.5C961.333 979.5 963.2 976 964 970" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_4 82_1" d="M960.5 980.5C961.167 983.167 964.6 989.9 973 995.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
                            <path className="st55" d="M977.402 999.4C979.102 998 980.602 996.2 981.502 994C982.148 992.546 982.517 990.978 982.602 989.401C979.807 989.567 973.329 990.685 969.002 993.82C968.828 993.947 968.657 994.076 968.49 994.209C967.279 995.082 965.897 995.767 964.515 996.367C960.158 998.169 955.52 999 950.741 999C945.119 999 939.497 997.961 934.437 995.604C933.555 995.169 932.638 994.701 931.807 994.151C931.721 994.092 931.634 994.033 931.548 993.975C925.401 989.846 919.373 988.935 917.102 989C917.231 991.18 917.511 992.325 918.102 993.8C919.002 996.1 920.602 997.8 922.402 999.3C923.902 1000.6 925.802 1001.6 927.602 1002.5C934.802 1005.9 942.802 1007.4 950.802 1007.4C957.602 1007.4 964.202 1006.2 970.402 1003.6C972.902 1002.5 975.402 1001.2 977.402 999.4Z"></path>
                            <path className="st55" d="M969.434 993.456C969.134 993.722 968.818 993.973 968.49 994.209M930.783 993.387C931.102 993.659 931.446 993.913 931.807 994.151M931.807 994.151C932.638 994.701 933.555 995.169 934.437 995.604C939.497 997.961 945.119 999 950.741 999C955.52 999 960.158 998.169 964.515 996.367C965.897 995.767 967.279 995.082 968.49 994.209M931.807 994.151C925.571 989.872 919.405 988.934 917.102 989C917.231 991.18 917.511 992.325 918.102 993.8C919.002 996.1 920.602 997.8 922.402 999.3C923.902 1000.6 925.802 1001.6 927.602 1002.5C934.802 1005.9 942.802 1007.4 950.802 1007.4C957.602 1007.4 964.202 1006.2 970.402 1003.6C972.902 1002.5 975.402 1001.2 977.402 999.4C979.102 998 980.602 996.2 981.502 994C982.148 992.546 982.517 990.978 982.602 989.401C979.694 989.573 972.8 990.777 968.49 994.209"></path>
                        </g>
                    </g>
                    <g className="crown"  style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M981.1,982.7c-1.6-2.8-4.3-4.7-6.6-6.9c-3.2-3-5.7-6.8-8.3-10.6c-1.7-2.6-3.4-5.1-5.3-7.5
                            c-3.2-3.9-7-7.2-11.7-7.9c-3.5-0.5-6.9,0.5-9.6,3c-2.1,1.9-3.6,4.7-5.1,7.3c-1,1.8-2.2,3.6-3.3,5.3c-2.4,3.6-5.1,7-7.8,10.3
                            c-2,2.4-4.2,4.9-5.3,7.9c-1.3,3.3-1.4,7,0,10.2c1,2.3,2.5,4,4.3,5.5c1.6,1.3,3.4,2.3,5.2,3.2c7.2,3.4,15.2,4.9,23.2,4.9
                            c6.7,0,13.4-1.2,19.6-3.8c2.5-1.1,5-2.4,7-4.2c1.7-1.5,3.1-3.2,4.1-5.4C983.1,990.3,983.1,986.1,981.1,982.7z"
                        />
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 3, -15)'}}>
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st9" d="M975.2,1172.7c0,5.2-0.1,10.4-0.3,15.6c-0.7,18.5-2.5,37.1-4.5,55.6
                        ...
                        <g className="hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st10" d="M974.4,1197.5c-0.9,15.4-2.4,30.9-4,46.3c-2.1,19.9-4.6,39.7-7.2,59.5
                    ...
                    <g className="pulp">
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" dataposition="82" style={{visibility: 'inherit'}}>
                        ...
                        <g className="hEmpty hImplant pulpitis-pfilling" dataposition="82" style={{visibility: 'inherit'}}>
                        ...
                        <g className="level hEmpty hImplant periodontitis"  dataposition="82"  style={{visibility: 'inherit', opacity: 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="82_4">
                        ...
                        <g className="caries-filling" dataposition="82_2">
                        ...
                        <g className="caries-filling" dataposition="82_1">
                        ...
                        <g className="with">
                            <path className="st54" areas="82_2 82_1" d="M935.5 1162.5C936.5 1157.17 938.6 1142.4 939 1128" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_2 82_1" d="M935.5 1162.5C932 1181.5 932 1186.6 926 1195" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_4 82_1" d="M967 1164.5C967 1181.5 965.5 1192 969 1198" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="82_4 82_1" d="M967 1164.5L968.5 1128.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
