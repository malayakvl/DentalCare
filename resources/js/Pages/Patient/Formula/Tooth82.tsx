            ...
            >
                ...
                >
                    ...
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth82Diagnozis.pin ? 1 : 0}}>
                        ...
                        <circle className="st57" cx="947.999" cy="983" r="12.25" style={{fill: 'black', opacity: tooth82Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper && !tooth82Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g id="s_header_82_2" className="caries-filling" 
                            onClick={() => {
                        ...
                        <g id="s_header_82_1" className="caries-filling" 
                            onClick={() => {
                ...
                >
                    ...
                    <g className="pin" style={{
                        ...
                        />
                        <path style={{fill: tooth82Diagnozis.pin ? '#dbd9d3' : 'none'}}  
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="with">
                            ...
                            />
                            <path className="st54" areas="82_4 82_1" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_right && !tooth82Diagnozis.seal_center) ||
