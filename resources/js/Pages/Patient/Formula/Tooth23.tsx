...
export default function Tooth23() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth23.caries_bottom = !teethDiagnozis.tooth23.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth23.caries_center = !teethDiagnozis.tooth23.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth23.caries_left = !teethDiagnozis.tooth23.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth23.caries_right = !teethDiagnozis.tooth23.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth23.caries_top = !teethDiagnozis.tooth23.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth23.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth23.seal_center_color = sealColor1;
                    teethDiagnozis.tooth23.seal_center = true;
                } else if (teethDiagnozis.tooth23.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth23.seal_center_color = sealColor2;
                    teethDiagnozis.tooth23.seal_center = true;
                } else if (teethDiagnozis.tooth23.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth23.seal_center_color = sealColor3;
                    teethDiagnozis.tooth23.seal_center = true;
                } else {
                    teethDiagnozis.tooth23.seal_center = !teethDiagnozis.tooth23.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth23.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth23.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth23.seal_bottom = true;
                } else if (teethDiagnozis.tooth23.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth23.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth23.seal_bottom = true;
                } else if (teethDiagnozis.tooth23.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth23.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth23.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth23.seal_bottom = !teethDiagnozis.tooth23.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth23.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth23.seal_left_color = sealColor1;
                    teethDiagnozis.tooth23.seal_left = true;
                } else if (teethDiagnozis.tooth23.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth23.seal_left_color = sealColor2;
                    teethDiagnozis.tooth23.seal_left = true;
                } else if (teethDiagnozis.tooth23.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth23.seal_left_color = sealColor3;
                    teethDiagnozis.tooth23.seal_left = true;
                } else {
                    teethDiagnozis.tooth23.seal_left = !teethDiagnozis.tooth23.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth23.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth23.seal_right_color = sealColor1;
                    teethDiagnozis.tooth23.seal_right = true;
                } else if (teethDiagnozis.tooth23.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth23.seal_right_color = sealColor2;
                    teethDiagnozis.tooth23.seal_right = true;
                } else if (teethDiagnozis.tooth23.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth23.seal_right_color = sealColor3;
                    teethDiagnozis.tooth23.seal_right = true;
                } else {
                    teethDiagnozis.tooth23.seal_right = !teethDiagnozis.tooth23.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth23.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth23.seal_top_color = sealColor1;
                    teethDiagnozis.tooth23.seal_top = true;
                } else if (teethDiagnozis.tooth23.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth23.seal_top_color = sealColor2;
                    teethDiagnozis.tooth23.seal_top = true;
                } else if (teethDiagnozis.tooth23.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth23.seal_top_color = sealColor3;
                    teethDiagnozis.tooth23.seal_top = true;
                } else {
                    teethDiagnozis.tooth23.seal_top = !teethDiagnozis.tooth23.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth23.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth23.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth23.wedge_shaped_defect_color = !teethDiagnozis.tooth23.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="23" className={`tooth-number-active ${teethType === 'child' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1250.251 716.1968)" className={`st3 st4 st5 ${toothActive.tooth23.active ? 'num-active' : ''}`}>23</text>
            </g>
            <g id="TH-23" className={`f-tooth-init ${(teethDiagnozis.tooth23.show && !teethDiagnozis.tooth23.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (!teethDiagnozis.tooth23.show) {
                        if (teethType === 'child') {
                            document.getElementById('TH-23').style.visibility = 'hidden'
                            document.getElementById('TH-63').style.visibility = 'inherit'
                        }
                        if (teethType === 'adult') {
                            document.getElementById('TH-23').style.visibility = 'inherit'
                            document.getElementById('TH-63').style.visibility = 'hidden'
                        }
                    } 
                    if (teethDiagnozis.tooth23.show && !teethDiagnozis.tooth23.absent && teethType === 'child') {
                        document.getElementById('TH-23').style.visibility = 'hidden'
                        document.getElementById('TH-63').style.visibility = 'inherit'
                    }
                    (!toothActive && !allTeeth) && document.getElementById('23').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethDiagnozis.tooth63.show && !teethDiagnozis.tooth63.absent && teethType === 'adult') {
                        document.getElementById('TH-23').style.visibility = 'hidden'
                        document.getElementById('TH-63').style.visibility = 'inherit'
                    }
                ...
                onClick={() => {
                    // effects block
                    if (teethType === 'adult' && !teethDiagnozis.tooth23.show) {
                        teethDiagnozis.tooth23.show = true;
                        teethDiagnozis.tooth63.show = false;
                    }
                    if (toothActive.tooth23.active) {
                        dispatch(setNewToothActive({tooth23: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth23.change_color = !teethDiagnozis.tooth23.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth23.fissure = !teethDiagnozis.tooth23.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth23.caries = !teethDiagnozis.tooth23.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth23.cervical_caries = !teethDiagnozis.tooth23.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth23.wedge_shaped_defect = !teethDiagnozis.tooth23.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth23.tartar = !teethDiagnozis.tooth23.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth23.pulpit = !teethDiagnozis.tooth23.pulpit;
                            teethDiagnozis.tooth23.channel_class = teethDiagnozis.tooth23.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth23.channel_not_sealed = !teethDiagnozis.tooth23.channel_not_sealed;
                            teethDiagnozis.tooth23.channel_class = teethDiagnozis.tooth23.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth23.channel_top_sealed = !teethDiagnozis.tooth23.channel_top_sealed;
                            teethDiagnozis.tooth23.channel_class = teethDiagnozis.tooth23.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth23.channel_part_sealed = !teethDiagnozis.tooth23.channel_part_sealed;
                            teethDiagnozis.tooth23.channel_class = teethDiagnozis.tooth23.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth23.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth23.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth23.periodontit = true;
                            } else {
                                teethDiagnozis.tooth23.periodontit = !teethDiagnozis.tooth23.periodontit;
                            }
                            teethDiagnozis.tooth23.channel_class = teethDiagnozis.tooth23.periodontit ? 'periodontit' : '';
                            ...
                            if (!teethDiagnozis.tooth23.seal_cervical && teethDiagnozis.tooth23.seal_cervical_color === "") {
                                ...
                                teethDiagnozis.tooth23.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth23.seal_cervical && teethDiagnozis.tooth23.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth23.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth23.seal_cervical = false;
                                teethDiagnozis.tooth23.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth23.vinir && teethDiagnozis.tooth23.vinir_color === "") {
                                teethDiagnozis.tooth23.vinir = true;
                                teethDiagnozis.tooth23.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth23.vinir && teethDiagnozis.tooth23.vinir_color != vinirColor) {
                                teethDiagnozis.tooth23.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth23.vinir = false;
                                teethDiagnozis.tooth23.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth23.temporary_crown = !teethDiagnozis.tooth23.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth23.ceramic_crown && teethDiagnozis.tooth23.ceramic_crown_color === "") {
                                teethDiagnozis.tooth23.ceramic_crown = true;
                                teethDiagnozis.tooth23.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth23.ceramic_crown && teethDiagnozis.tooth23.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth23.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth23.ceramic_crown = false;
                                teethDiagnozis.tooth23.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth23.mceramic_crown && teethDiagnozis.tooth23.mceramic_crown_color === "") {
                                teethDiagnozis.tooth23.mceramic_crown = true;
                                teethDiagnozis.tooth23.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth23.mceramic_crown && teethDiagnozis.tooth23.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth23.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth23.mceramic_crown = false;
                                teethDiagnozis.tooth23.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth23.metalic_crown && teethDiagnozis.tooth23.metalic_crown_color === "") {
                                teethDiagnozis.tooth23.metalic_crown = true;
                                teethDiagnozis.tooth23.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth23.metalic_crown && teethDiagnozis.tooth23.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth23.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth23.metalic_crown = false;
                                teethDiagnozis.tooth23.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth23.zirconia_crown && teethDiagnozis.tooth23.zirconia_crown_color === "") {
                                teethDiagnozis.tooth23.zirconia_crown = true;
                                teethDiagnozis.tooth23.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth23.zirconia_crown && teethDiagnozis.tooth23.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth23.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth23.zirconia_crown = false;
                                teethDiagnozis.tooth23.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth23.pin = !teethDiagnozis.tooth23.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth23.culttab = !teethDiagnozis.tooth23.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth23.abutment = !teethDiagnozis.tooth23.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth23.shaper = !teethDiagnozis.tooth23.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth23.implant = !teethDiagnozis.tooth23.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth23.apex = !teethDiagnozis.tooth23.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth23.absent = !teethDiagnozis.tooth23.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth23.cervical_caries = !teethDiagnozis.tooth23.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth23.caries = !teethDiagnozis.tooth23.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth23.parodontit) {
                                if (teethDiagnozis.tooth23.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth23.parodontit = false;
                                    teethDiagnozis.tooth23.active = false;
                                } else {
                                    teethDiagnozis.tooth23.parodontit = true;
                                    teethDiagnozis.tooth23.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth23.parodontit = true;
                                teethDiagnozis.tooth23.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth23.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_23_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g className="hEmpty hRoot hImplant" style={{visibility: !tooth23Diagnozis.culttab && !tooth23Diagnozis.implant && !tooth23Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 ${tooth23Diagnozis.apex ? 'apex' : ''}`} d="M1306.6,598.3c0.7-5.4-0.9-10.5-3.2-15.3c-2.2-4.5-5.1-8.9-9-12.4
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility: tooth23Diagnozis?.apex || tooth23Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth23Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth23Diagnozis?.apex ? 'apex' : ''}`} 
                                d="M1306.6 598.3C1307.3 592.9 1305.7 587.8 1303.4 583C1301.2 578.5 1298.3 574.1 1294.4 570.6C1287.8 564.6 1278.8 560.1 1268.6 560.2C1259.1 560.3 1250.8 564.4 1244.6 569.9C1240.1 573.8 1236.7 578.8 1233.6 583.8C1231.5 587.1 1229.5 590.6 1229.3 594.8C1229 599.9 1232 604.3 1235.1 
                                608C1238.5 612 1242.3 615.6 1245.6 619.9C1247.4 622.3 1249.2 624.8 1251.5 626.9C1255.4 630.4 1260.6 632.7 1266.2 633.5C1273.4 634.5 1280.8 633 1286.1 629C1289.1 626.7 1291 623.8 1293.1 621C1295.5 617.7 1298.1 614.4 1300.4 611C1303.2 607.1 1306 603.2 1306.6 598.3Z" 
                            />
                        </g>
                    </g>
                    <g className="pulp" style={{visibility: tooth23Diagnozis.apex ? 'inherit' : 'hidden'}}>
                        <g className="pulpitis-pfilling" style={{visibility: tooth23Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth23Diagnozis.implant || tooth23Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="1270.5" cy="596.5" r="26.5" />
                        <g className="st27">
                            <mask id="implant_23" className="st49">
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth23Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth23Diagnozis.abutment ? 1 : 0}}>
                        ...
                        <circle className="st45" r="13" transform="matrix(-1 0 0 1 1269.15 596)" />
                    </g>
                    {/* PIN */}
                    <g className="pin hEmpty hImplant" style={{visibility: 'inherit', opacity: tooth23Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact" d="M1306.65 598.3C1307.35 592.9 1305.75 587.8 1303.45 583C1301.25 578.5 1298.35 574.1 1294.45 570.6C1287.85 564.6 1278.85 560.1 1268.65 560.2C1259.15 560.3 1250.85 564.4 1244.65 569.9C1240.15 573.8 1236.75 578.8 1233.65 583.8C1231.55 587.1 1229.55 590.6 1229.35 594.8C1229.05 599.9 1232.05 604.3 1235.15 608C1238.55 612 1242.35 615.6 1245.65 619.9C1247.45 622.3 1249.25 624.8 1251.55 626.9C1255.45 630.4 1260.65 632.7 1266.25 633.5C1273.45 634.5 1280.85 633 1286.15 629C1289.15 626.7 1291.05 623.8 1293.15 621C1295.55 617.7 1298.15 614.4 1300.45 611C1303.35 
                            607.1 1306.05 603.2 1306.65 598.3Z" 
                        ...
                        <path className="st56 hIntact" d="M1293.05 597.848C1293.5 594.327 1292.46 591.001 1290.98 587.87C1289.56 584.936 1287.69 582.066 1285.17 579.784C1280.91 575.871 1275.11 572.936 1268.52 573.001C1262.39 573.066 1257.04 575.74 1253.04 579.327C1250.13 581.87 1247.94 585.131 1245.94 588.392C1244.59 590.544 1243.29 592.827 1243.17 595.566C1242.97 598.892 1244.91 601.761 
                            1246.91 604.174C1249.1 606.783 1251.55 609.131 1253.68 611.935C1254.85 613.5 1256.01 615.131 1257.49 616.5C1260.01 618.783 1263.36 620.283 1266.98 620.804C1271.62 621.457 1276.4 620.478 1279.82 617.87C1281.75 616.37 1282.98 614.478 1284.33 612.652C1285.88 610.5 1287.56 608.348 1289.04 606.131C1290.92 603.587 1292.66 601.044 1293.05 597.848Z" 
                            style={{visibility: 'hidden'}}
                        />
                        <circle className="st57" r="12.25" transform="matrix(-1 0 0 1 1269.15 596)" style={{fill: 'black', opacity: tooth23Diagnozis.pin ? 1 : 0}} />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth23Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth23Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1306.65 598.3C1307.35 592.9 1305.75 587.8 1303.45 583C1301.25 578.5 1298.35 574.1 1294.45 570.6C1287.85 564.6 1278.85 560.1 1268.65 560.2C1259.15 560.3 1250.85 564.4 1244.65 569.9C1240.15 573.8 1236.75 578.8 1233.65 583.8C1231.55 587.1 1229.55 590.6 1229.35 594.8C1229.05 599.9 1232.05 604.3 1235.15 608C1238.55 612 1242.35 615.6 1245.65 619.9C1247.45 622.3 1249.25 624.8 1251.55 626.9C1255.45 630.4 1260.65 632.7 1266.25 633.5C1273.45 634.5 1280.85 633 1286.15 629C1289.15 626.7 1291.05 623.8 1293.15 621C1295.55 617.7 1298.15 614.4 1300.45 611C1303.35 607.1 1306.05 603.2 1306.65 598.3Z"></path>
                        <path className="st47" d="M1293.05 597.848C1293.5 594.327 1292.47 591.001 1290.98 587.87C1289.56 584.936 1287.69 582.066 1285.18 579.784C1280.92 575.871 1275.11 572.936 1268.53 573.001C1262.4 573.066 1257.04 575.74 1253.04 579.327C1250.14 581.87 1247.94 585.131 1245.94 588.392C1244.59 590.544 1243.3 592.827 1243.17 595.566C1242.97 598.892 1244.91 601.761 1246.91 604.174C1249.1 606.783 1251.56 609.131 1253.69 611.935C1254.85 613.5 1256.01 615.131 1257.49 616.5C1260.01 618.783 1263.37 620.283 1266.98 620.804C1271.62 621.457 1276.4 620.478 1279.82 617.87C1281.76 616.37 1282.98 614.478 1284.34 612.652C1285.89 610.5 1287.56 608.348 1289.05 606.131C1290.92 603.587 1292.66 601.044 1293.05 597.848Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment && !tooth23Diagnozis.implant && !tooth23Diagnozis.apex && !tooth23Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth23.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment && !tooth23Diagnozis.implant && !tooth23Diagnozis.shaper && !tooth23Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth23.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth23.seal_left ? `seal-fill ${teethDiagnozis.tooth23.seal_left_color}` : ''}
                                `}  
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth23.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth23.seal_bottom ? `seal-fill ${teethDiagnozis.tooth23.seal_bottom_color}` : ''}
                                `}  
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth23.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth23.seal_right ? `seal-fill ${teethDiagnozis.tooth23.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth23.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth23.seal_top ? `seal-fill ${teethDiagnozis.tooth23.seal_top_color}` : ''}
                                `} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        ...
                        >
                            <path className="st55" d="M1312.3 575.5C1311.6 574 1310.9 572.5 1310.1 571C1307.7 566.5 1304.8 562.3 1301.3 558.7C1293.3 550.6 1282.1 544.6 1269.6 544.8C1257.9 545 1247.7 550.6 1240 558C1234.5 563.4 1230.3 570 1226.5 576.8C1225.6 578.4 1224.7 580 1223.9 581.7C1222.4 584.8 1221.3 588.1 1221.1 591.7C1221.07 592.16 1221.06 592.615 1221.07 593.065C1223.78 592.841 1229.52 591.614 
                                1230.75 588.5C1231.14 587.155 1231.67 585.861 1232.28 584.608C1232.93 583.244 1233.65 581.96 1234.38 580.677C1237.45 575.221 1240.84 569.926 1245.28 565.594C1251.5 559.657 1259.74 555.164 1269.18 
                                555.004C1279.28 554.843 1288.32 559.657 1294.78 566.156C1297.61 569.044 1299.95 572.413 1301.89 576.024C1302.53 577.227 1303.1 578.43 1303.67 579.634C1304.95 582.493 1305.99 585.448 1306.55 588.5C1308.86 592.1 1314.09 593 1316.42 
                                593C1316.51 586.876 1314.77 581.042 1312.3 575.5Z" />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
                    <g className="crown" style={{
                        visibility: (tooth23Diagnozis.temporary_crown || tooth23Diagnozis.ceramic_crown || tooth23Diagnozis.mceramic_crown || tooth23Diagnozis.metalic_crown || tooth23Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth23Diagnozis.temporary_crown || tooth23Diagnozis.ceramic_crown || tooth23Diagnozis.mceramic_crown || tooth23Diagnozis.metalic_crown || tooth23Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth23Diagnozis.ceramic_crown_color}
                                ${tooth23Diagnozis.mceramic_crown_color}
                                ${tooth23Diagnozis.metalic_crown_color}
                                ${tooth23Diagnozis.zirconia_crown_color}
                            `} 
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth23Diagnozis.fissure ? 'diagnoze' : tooth23Diagnozis.fissure ? 'hidden' : ''}`} 
                            d="M1254.4,610.4l-0.4-1c4.7-2,9.8-3.2,15.1-3.7c5-0.5,10.1-0.2,15.1,0.7l-0.2,1.1c-4.9-0.9-9.8-1.1-14.8-0.7
                            C1264.1,607.2,1259.1,608.5,1254.4,610.4z"
                        />
                    </g>
                    {/* FISSURES */}
                    <g className={`st3 fissure ${tooth23Diagnozis.fissure ? 'diagnoze' : ''}`} style={{visibility: (!tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment && !tooth23Diagnozis.implant && !tooth23Diagnozis.apex && !tooth23Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                ...
                <g id="T_23" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g id="dentin_n_23" style={{visibility: !tooth23Diagnozis.implant && !tooth23Diagnozis.abutment && !tooth23Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_23" className={`st10 change-color ${tooth23Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth23Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" d="M1294.1 293.299L1284.3 485.299C1282.1 487.299 1279.7 488.999 1277 490.299C1275.7 490.899 1274.4 491.399 1273 491.799C1271.6 491.399 1270.3 490.799 1269 490.199C1266.3 488.799 1263.9 486.799 1261.8 484.799L1288.5 294.299C1288.6 
                            292.199 1290.8 290.799 1292.7 291.699C1293.4 291.799 1293.9 292.499 1294.1 293.299Z"
                            style={{fill: tooth23Diagnozis.pin ? '#dbd9d3' : 'none'}}
                        />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth23Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth23Diagnozis.culttab ? 0 : 1}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth23Diagnozis.abutment || tooth23Diagnozis.implant || tooth23Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <path className="st18" d="M1255.7,376l49.4,6.4c3.2-26.2,5.8-52.5,7.9-78.8c2-25.5,3.3-51,4.2-76.5c-3.4-5.1-8.6-8.5-14.6-9.3
                            c-6.3-0.9-12.8,1.1-18.1,5.6c-5.5,26.3-10.7,52.5-15.7,78.8C1264.2,326.8,1259.8,351.4,1255.7,376z"
                        />
                        <line className="st19" x1="1254.3" y1="354" x2="1310.7" y2="368.8" />
                        <line className="st19" x1="1258.2" y1="324" x2="1314.6" y2="338.8" />
                        <line className="st19" x1="1263.2" y1="294.1" x2="1319.6" y2="308.8" />
                        <line className="st19" x1="1267.1" y1="264.1" x2="1323.5" y2="278.8" />
                        <line className="st19" x1="1271" y1="234" x2="1327.3" y2="248.8" />
                    </g>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty" style={{visibility: !tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth23Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
                        ...
                        <path className={
                            ...
                            428.471C1301.73 426.881 1301.2 425.292 1300.7 423.703Z" 
                        />
                    </g>
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth23.tartar ? 1 : 0}}>
                        <path className="st61 level2" d="M1223.5 451L1225 449.5L1226 448L1227 445.5L1228.5 443V440.5L1229.5 437.5L1231.5 435.5V434L1233.5 430.5L1234.5 427L1235.5 425L1237.5 421.5V420L1239 418.5L1240.5 416.5L1242 415.5L1243 413.5L1244 412L1246 409L1249.5 407L1252 403.5L1255.5 401L1257 399L1258.5 398L1261.5 396.5L1265 395L1266.5 393.5H1270L1274 392.5L1277 393.5H1281L1284.5 395L1286.5 396.5L1289.5 398L1292.5 400L1293.5 401L1295 403.5L1297.5 405L1299.5 409L1301 410L1303 413.5V415.5L1304.5 416.5L1305.5 418.5V420V423L1306.5 425L1308 427V429L1309 433L1311 435.5V439.5L1313 442L1315.5 444V440.5V438.5L1314.5 435.5V433L1313 430.5L1313.5 427.5L1313 426V424L1313.5 421.5L1314.5 418.5L1313.5 416.5L1314.5 414.5V412L1315.5 410L1314.5 407L1315.5 403.5V400L1316 396L1313.5 392.5H1312L1311 390L1308 387.5L1306.5 385L1304.5 382.5L1301.5 380.5L1300 381L1298.5 378.5L1296.5 377.5L1293.5 374.5L1291 373.5L1288 371L1284.5 370.5L1281 372L1278.5 370.5H1276L1274 371H1271.5L1269 370.5L1265 371L1261.5 373.5L1259 374L1255.5 376H1253L1252 378.5L1249 380L1246 381L1244 384L1243.5 386.5L1242 389V392.5V395L1240.5 396.5V399L1239 401V403.5L1237.5 405V407L1236.5 409L1234.5 412L1233.5 413.5L1232.5 
                            416.5L1231.5 420L1230.5 423L1228.5 426L1227 429L1226.5 432.5L1225 436.5V439.5L1224.5 442.5L1223.5 446.5L1223 449L1223.5 451Z" />
                        <path className="st61 level1" d="M1223.5 451L1225 449.5L1226 448L1227 445.5L1228.5 443V440.5L1229.5 437.5L1231.5 435.5V434L1233.5 430.5L1234.5 427L1235.5 425L1237.5 421.5V420L1239 418.5L1240.5 416.5L1242 415.5L1243 413.5L1244 412L1246 409L1249.5 407L1252 403.5L1255.5 401L1257 399L1258.5 398L1261.5 396.5L1265 395L1266.5 393.5H1270L1274 392.5L1277 393.5H1281L1284.5 395L1286.5 396.5L1289.5 398L1292.5 400L1293.5 401L1295 403.5L1297.5 405L1299.5 409L1301 410L1303 413.5V415.5L1304.5 416.5L1305.5 418.5V420V423L1306.5 425L1308 427V429L1309 433L1311 435.5V439.5L1313 442L1315.5 444V442L1315 439.5V438L1314 435L1313 432V429L1312.5 427.5L1313 425L1312 423V420V416.5L1311 413.5L1312 410L1311 409V406L1309 404.5L1308 402L1306.5 401L1305.5 399L1304 397.5L1302 396.5L1299.5 393.5L1298.5 392H1296.5L1294 390.5L1292.5 389L1289 387.5L1286.5 386H1284.5L1282 384.5L1280 383.5L1278 384.5L1275.5 383.5H1272L1268.5 384.5L1266.5 386H1265L1262.5 387H1261L1258.5 387.5L1257 390L1254.5 392H1252.5L1251 395H1249.5L1246 398V399L1244 400L1242 402L1241 404.5L1239 407V409L1237.5 411L1236.5 413.5L1235.5 415.5L1233 419L1231.5 421.5L1230.5 425L1229.5 426.5L1228.5 429L1227.5 431L1227 434L1226 437.5V439.5L1225 442L1223.5 445.5V448V451Z" />
                    </g>
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment && !tooth23Diagnozis.implant && !tooth23Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            `} 
                                ...
                                C1245.5,440.6,1240.6,477.6,1237.7,498.4z" 
                                style={{
                                    fill: teethDiagnozis.tooth23.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth23.seal_left ? teethDiagnozis.tooth23.seal_left_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                c3.3-19.6,10.2-59.8,11.2-61.5c0.9-1.6,8.9-9.7,13.2-13.9c0.7,2.3,1.2,4.6,1.7,7C1316.6,450.1,1316.7,457.5,1315.6,464.9z" 
                                style={{
                                    fill: teethDiagnozis.tooth23.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth23.seal_right ? teethDiagnozis.tooth23.seal_right_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                c3,5.3,4.8,11.2,6.6,17C1311,428.2,1312.3,432,1313.4,435.8z" 
                                style={{
                                    fill: teethDiagnozis.tooth23.caries_top ? '#606c80' : 
                                    teethDiagnozis.tooth23.seal_top ? teethDiagnozis.tooth23.seal_top_color : 'transparent',
