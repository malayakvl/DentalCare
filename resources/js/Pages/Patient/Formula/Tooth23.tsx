        ...
        <>
            ...
            >
                ...
                <g id="T_23_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/* FISSURES */}
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment && !tooth23Diagnozis.implant && !tooth23Diagnozis.apex && !tooth23Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
