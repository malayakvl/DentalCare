...
export default function Tooth23() {
    ...
    return (
        <>
            <g id="23" className="df-tooth-text" style={{opacity: 1}}>
                ...
                onClick={() => {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth23.pulpit ? 'pulpit' : '');
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth23.channel_not_sealed ? 'channel-not-sealed' : '');
                            ...
                            // setDiagnozeClass(teethDiagnozis.tooth23.channel_top_sealed ? 'channel-top-sealed' : '');
            ...
            c-3-38-9-52-19-56C1294.2,187.8,1286.2,200.3,1281.4,213.1z"></path>
                ...
                <g id="T_23_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    <g className="dentin" >
                        <g className="hEmpty hRoot hImplant" style={{visibility: 'inherit'}}>
                            <path className="st24" d="M1306.6,598.3c0.7-5.4-0.9-10.5-3.2-15.3c-2.2-4.5-5.1-8.9-9-12.4
                    ...
                    <g className="pin hEmpty hImplant"  style={{visibility: 'inherit', opacity:0}}>
                        <path className="st56 hIntact" d="M1306.65 598.3C1307.35 592.9 1305.75 587.8 1303.45 583C1301.25 578.5 1298.35 574.1 1294.45 570.6C1287.85 564.6 1278.85 560.1 1268.65 560.2C1259.15 560.3 1250.85 564.4 1244.65 569.9C1240.15 573.8 1236.75 578.8 1233.65 583.8C1231.55 587.1 1229.55 590.6 1229.35 594.8C1229.05 599.9 1232.05 604.3 1235.15 608C1238.55 612 1242.35 615.6 1245.65 619.9C1247.45 622.3 1249.25 624.8 1251.55 626.9C1255.45 630.4 1260.65 632.7 1266.25 633.5C1273.45 634.5 1280.85 633 1286.15 629C1289.15 626.7 1291.05 623.8 1293.15 621C1295.55 617.7 1298.15 614.4 1300.45 611C1303.35 607.1 1306.05 603.2 1306.65 598.3Z" style={{visibility: 'hidden'}}></path>
                ...
                c3.6-5.5,7-10.8,7.8-17.4C1317.1,588.9,1315.2,582,1312.3,575.5z"></path>
                    </g>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <g id="s_header_23_4" className="caries-filling" dataposition="23_4">
                    ...
                    C1251,599.5,1258,606,1258,606.7z"></path>
                            <path className="st8 target" d="M1258,606.7c0,0.1-0.1,0.2-0.2,0.5c-1.3,2-7.8,9.8-9.4,12.8c-1.3,2.4-2.7,7.3-2.8,12.1
                    c-1.6-2.1-3.1-4.3-4.5-6.4c-4.1-5.8-8.7-10.6-12.9-16.1c-3.8-5-7.4-10.9-7-17.9c0.2-3.6,1.3-6.9,2.8-10c6.4,4.1,19,12.2,22.4,14.5
                    C1251,599.5,1258,606,1258,606.7z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_23_3" className="caries-filling" dataposition="23_3">
                    ...
                    c3.1,0.1,6.3,0.6,9.5,1.4C1291.1,609.3,1300.4,614.8,1303.6,620.9z"></path>
                            <path className="st8 target" d="M1303.6,620.9c-1.4,2.1-2.8,4.2-4.2,6.2c-2.5,3.8-4.9,7.7-8.6,10.8c-6.5,5.4-15.6,7.6-24.4,6.2
                    c-6.8-1.1-13.2-4.2-18-8.9c-1-1-1.9-2-2.8-3.1c0.1-4.8,1.5-9.7,2.8-12.1c1.6-3,8.1-10.8,9.4-12.8c3.4-1,8.1-1.9,14.2-1.8
                    c3.1,0.1,6.3,0.6,9.5,1.4C1291.1,609.3,1300.4,614.8,1303.6,620.9z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_23_2" className="caries-filling" dataposition="23_2">
                            <path className="st7" d="M1316.2,596.2c-0.8,6.6-4.2,12-7.8,17.4c-1.6,2.4-3.2,4.8-4.9,7.3c-3.2-6-12.4-11.6-22.2-14.1
                    c-5-7.5,4.4-13.8,9.2-18.3c5.1-4.8,14.8-13.3,19.5-17.5c0.8,1.5,1.5,3,2.2,4.5C1315.2,582,1317.1,588.9,1316.2,596.2z"></path>
                            <path className="st8 target" d="M1316.2,596.2c-0.8,6.6-4.2,12-7.8,17.4c-1.6,2.4-3.2,4.8-4.9,7.3c-3.2-6-12.4-11.6-22.2-14.1
                    c-5-7.5,4.4-13.8,9.2-18.3c5.1-4.8,14.8-13.3,19.5-17.5c0.8,1.5,1.5,3,2.2,4.5C1315.2,582,1317.1,588.9,1316.2,596.2z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g id="s_header_23_1" className="caries-filling" dataposition="23_1">
                    ...
                    c3.8-6.8,8-13.5,13.5-18.8c7.7-7.4,17.9-13,29.6-13.2c12.5-0.2,23.7,5.8,31.7,13.9C1304.9,562.3,1307.8,566.6,1310.1,571z"></path>
                            <path className="st8 target" d="M1310.1,571c-4.7,4.1-14.5,12.7-19.5,17.5c-4.8,4.5-14.2,10.8-9.2,18.3c-3.2-0.8-6.4-1.3-9.5-1.4
                    c-6.1-0.2-10.8,0.7-14.2,1.8c0.2-0.2,0.2-0.4,0.2-0.5c0-0.7-7-7.2-11.7-10.3c-3.4-2.3-16-10.4-22.4-14.5c0.8-1.7,1.7-3.3,2.6-4.9
                    c3.8-6.8,8-13.5,13.5-18.8c7.7-7.4,17.9-13,29.6-13.2c12.5-0.2,23.7,5.8,31.7,13.9C1304.9,562.3,1307.8,566.6,1310.1,571z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="23_2 23_3" d="M1281.5 607.5C1285 607.833 1293.8 610.3 1301 617.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_1 23_2" d="M1282 607C1284 593.286 1300 581.095 1307 575" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_1 23_3" d="M1282 607.5C1277.83 606.167 1267.8 603.7 1259 608.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_1 23_4" d="M1259 608.5C1256.83 604.167 1247.8 593.5 1229 585.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_4 23_3" d="M1259 608.5C1255.83 610.333 1249.5 614.7 1247.5 625.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    ...
                    <g className="crown"  style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M1312.3,575.5c-0.7-1.5-1.4-3-2.2-4.5c-2.4-4.5-5.3-8.7-8.8-12.3
                c-8-8.1-19.2-14.1-31.7-13.9c-11.7,0.2-21.9,5.8-29.6,13.2c-5.5,5.4-9.7,12-13.5,18.8c-0.9,1.6-1.8,3.2-2.6,4.9
                c-1.5,3.1-2.6,6.4-2.8,10c-0.4,7,3.2,12.9,7,17.9c4.2,5.5,8.8,10.3,12.9,16.1c1.5,2.1,2.9,4.3,4.5,6.4c0.9,1.1,1.8,2.1,2.8,3.1
                c4.8,4.7,11.2,7.8,18,8.9c8.8,1.4,18-0.8,24.4-6.2c3.7-3.1,6.1-7,8.6-10.8c1.4-2.1,2.8-4.2,4.2-6.2c1.7-2.4,3.3-4.9,4.9-7.3
                c3.6-5.5,7-10.8,7.8-17.4C1317.1,588.9,1315.2,582,1312.3,575.5z"></path>
                ...
                C1264.1,607.2,1259.1,608.5,1254.4,610.4z"></path>
                    </g>
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: 'inherit'}} >
                        <path className="st3 fissure" d="M1254.4,610.4l-0.4-1c4.7-2,9.8-3.2,15.1-3.7c5-0.5,10.1-0.2,15.1,0.7l-0.2,1.1c-4.9-0.9-9.8-1.1-14.8-0.7
                C1264.1,607.2,1259.1,608.5,1254.4,610.4z" style={{stroke: 'none'}}></path>
                    </g>
                </g>
                ...
                c5.9,3.2,10.9,8.2,14.4,14.3c3,5.3,4.8,11.2,6.6,17c1,3.2,2.1,6.3,3,9.5C1312.9,433,1312.9,432.2,1312.9,431.4z" style={{fill: 'rgb(253,222,136)'}}></path>
                        </g>
                ...
                c0.3,6.2,1.2,12.3,2.1,18.5c0.9,6.1,1.9,12.3,2.6,18.4C1318.9,273.6,1319.2,288.3,1319.1,302.9z" style={{fill: 'rgb(253,222,136)'}}></path>
                        </g>
                    </g>
                    <g className="pulp"  >
                        <g className="hEmpty hRoot hImplant pulpitis-pfilling" dataposition="23" style={{visibility: 'inherit'}}>
                ...
                c0.3,0.1,0.6,0.2,0.9,0.3c0.8,0.3,1.6,0.6,2.4,1c0.3,0.1,0.5,0.2,0.8,0.4C1287.5,392.4,1287.8,392.5,1288,392.6z" style={{fill: 'rgb(254, 246, 249)'}}></path>
                        </g>
                        <g className="hEmpty hImplant pulpitis-pfilling" dataposition="23" style={{visibility: 'inherit'}}>
                ...
                C1294.2,298.8,1294.6,298.9,1295,299z" style={{fill: 'rgb(254, 246, 249)'}}></path>
                        </g>
                        <g className="hEmpty hImplant pulpitis-pfilling" dataposition="23" style={{visibility: 'inherit'}}>
                            <path className="st22 target part" d="M1303,202.8c0,0.3-0.1,0.7-0.1,1c-3.2,31.6-5.8,63.4-7.9,95.2
                c-0.4-0.1-0.9-0.2-1.3-0.3c-1.6-0.3-3.4-0.5-5.2-0.4c5.8-31.4,10.6-62.9,14.4-94.5C1302.9,203.5,1303,203.1,1303,202.8z" style={{fill: 'rgb(254, 246, 249)'}}></path>
                        </g>
            ...
            c11.8,0.7,22.1,7.9,27.9,18.2c3,5.3,4.8,11.2,6.6,17C1310.8,427.5,1311.9,430.7,1312.8,433.8z"></path>
                ...
                c2.1-4.6,3.6-9.5,4.7-14.4C1316.7,457.5,1316.6,450.1,1315.1,442.8z"></path>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <g className="caries-filling" dataposition="23_4">
                ...
                c0.7-4.8,1.9-9.5,2.9-14.3c0.7-3.5,1.4-7,2.3-10.4c2-7,5.3-13.5,9.4-19.4c2.9,6.8,7.8,18.8,8.5,21.5
                C1245.5,440.6,1240.6,477.6,1237.7,498.4z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" dataposition="23_2">
                ...
                c3.3-19.6,10.2-59.8,11.2-61.5c0.9-1.6,8.9-9.7,13.2-13.9c0.7,2.3,1.2,4.6,1.7,7C1316.6,450.1,1316.7,457.5,1315.6,464.9z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="caries-filling" dataposition="23_1">
                ...
                c-3.4,4-6.7,7.8-12.1,8.5c-5.2,0.7-10-2.2-14.1-5.5c-5.3-4.3-10-9.2-15.7-13c-2.5-1.7-5.2-3.2-7.8-4.7c2.9-20.9,7.8-57.9,7.1-60.7
                c-0.7-2.8-5.6-14.7-8.5-21.5c4.8-6.9,10.8-13,17.4-18.5c3.7-3.1,7.6-6,12.2-7.5c3-1,6.2-1.3,9.3-1.1c11.8,0.7,22.1,7.9,27.9,18.2
                c3,5.3,4.8,11.2,6.6,17C1311,428.2,1312.3,432,1313.4,435.8z"  style={{fill: 'none', strokeWidth: 0}}></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="23_2 23_1" d="M1290.5 501.5L1297 464" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_2 23_1" d="M1297 464C1300.5 446.5 1302.7 442.7 1309.5 439.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_4 23_1" d="M1243.5 457C1246.5 433.5 1242.9 431.2 1238.5 422" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="23_4 23_1" d="M1243.5 457L1238.5 492.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
