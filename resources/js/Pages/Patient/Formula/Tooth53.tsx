...
import PeriodontitStage53 from './periodontit53';
...
export default function Tooth53() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth53.caries_bottom = !teethDiagnozis.tooth53.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth53.caries_center = !teethDiagnozis.tooth53.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth53.caries_left = !teethDiagnozis.tooth53.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth53.caries_right = !teethDiagnozis.tooth53.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth53.caries_top = !teethDiagnozis.tooth53.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth53.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth53.seal_center_color = sealColor1;
                    teethDiagnozis.tooth53.seal_center = true;
                } else if (teethDiagnozis.tooth53.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth53.seal_center_color = sealColor2;
                    teethDiagnozis.tooth53.seal_center = true;
                } else if (teethDiagnozis.tooth53.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth53.seal_center_color = sealColor3;
                    teethDiagnozis.tooth53.seal_center = true;
                } else {
                    teethDiagnozis.tooth53.seal_center = !teethDiagnozis.tooth53.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth53.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth53.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth53.seal_bottom = true;
                } else if (teethDiagnozis.tooth53.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth53.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth53.seal_bottom = true;
                } else if (teethDiagnozis.tooth53.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth53.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth53.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth53.seal_bottom = !teethDiagnozis.tooth53.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth53.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth53.seal_left_color = sealColor1;
                    teethDiagnozis.tooth53.seal_left = true;
                } else if (teethDiagnozis.tooth53.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth53.seal_left_color = sealColor2;
                    teethDiagnozis.tooth53.seal_left = true;
                } else if (teethDiagnozis.tooth53.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth53.seal_left_color = sealColor3;
                    teethDiagnozis.tooth53.seal_left = true;
                } else {
                    teethDiagnozis.tooth53.seal_left = !teethDiagnozis.tooth53.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth53.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth53.seal_right_color = sealColor1;
                    teethDiagnozis.tooth53.seal_right = true;
                } else if (teethDiagnozis.tooth53.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth53.seal_right_color = sealColor2;
                    teethDiagnozis.tooth53.seal_right = true;
                } else if (teethDiagnozis.tooth53.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth53.seal_right_color = sealColor3;
                    teethDiagnozis.tooth53.seal_right = true;
                } else {
                    teethDiagnozis.tooth53.seal_right = !teethDiagnozis.tooth53.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth53.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth53.seal_top_color = sealColor1;
                    teethDiagnozis.tooth53.seal_top = true;
                } else if (teethDiagnozis.tooth53.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth53.seal_top_color = sealColor2;
                    teethDiagnozis.tooth53.seal_top = true;
                } else if (teethDiagnozis.tooth53.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth53.seal_top_color = sealColor3;
                    teethDiagnozis.tooth53.seal_top = true;
                } else {
                    teethDiagnozis.tooth53.seal_top = !teethDiagnozis.tooth53.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth53.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth53.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth53.wedge_shaped_defect_color = !teethDiagnozis.tooth53.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            ...
            <g id="TH-53" className={`f-tooth-init-milk ${((teethDiagnozis.tooth53.show || allTeeth) && !teethDiagnozis.tooth53.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onClick={() => {
            ...
            >
                ...
                >
                    ...
                    <g className="dentin">
                        <g style={{visibility: !tooth53Diagnozis.culttab && !tooth53Diagnozis.implant && !tooth53Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 ${tooth53Diagnozis.apex ? 'apex' : ''}`} 
                        ...
                        <g style={{visibility: tooth53Diagnozis?.apex || tooth53Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth53Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth53Diagnozis?.apex ? 'apex' : ''}`} 
                                d="M791.5 598.3C790.8 592.9 792.4 587.8 794.7 583C796.9 578.5 799.8 574.1 803.7 570.6C810.3 564.6 819.3 560.1 829.5 560.2C839 560.3 847.3 564.4 853.5 569.9C858 573.8 861.4 578.8 864.5 583.8C866.6 587.1 868.6 590.6 868.8 594.8C869.1 599.9 866.1 604.3 863 608C859.6 612 855.8 615.6 852.5 
                                619.9C850.7 622.3 848.9 624.8 846.6 626.9C842.7 630.4 837.5 632.7 831.9 633.5C824.7 634.5 817.3 633 812 629C809 626.7 807.1 623.8 805 621C802.6 617.7 800 614.4 797.7 611C794.8 607.1 792.1 603.2 791.5 598.3Z"
                            />
                        </g>
                    </g>
                    <g className="pulp" style={{visibility: tooth53Diagnozis.apex ? 'inherit' : 'hidden'}}>
                        <g className="pulpitis-pfilling" style={{visibility: tooth53Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                            <path className="st22 target" style={{fill: '#e80808'}}
                                d="M829.435 608.01C825.812 608.119 820.799 604.647 820.617 598.549C820.435 592.45 825.152 586.035 828.775 585.926C832.398 585.818 836.139 590.655 836.321 596.753C836.503 602.851 833.058 607.902 829.435 608.01Z"
                            />
                        </g>
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth53Diagnozis.implant || tooth53Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="828.5" cy="596.5" r="26.5"></circle>
                        <g className="st27">
                            <mask className="st49">
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth53Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth53Diagnozis.abutment ? 1 : 0}}>
                        ...
                        <circle className="st45" cx="829" cy="596" r="13"></circle>
                    </g>
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth53Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact" d="M791.5 598.301C790.8 592.901 792.4 587.801 794.7 583.001C796.9 578.501 799.8 574.101 803.7 570.601C810.3 564.601 819.3 560.101 829.5 560.201C839 560.301 847.3 564.401 853.5 569.901C858 573.801 861.4 578.801 864.5 583.801C866.6 587.101 868.6 590.601 868.8 594.801C869.1 599.901 866.1 604.301 863 608.001C859.6 612.001 855.8 615.601 852.5 619.901C850.7 622.301 848.9 624.801 846.6 626.901C842.7 630.401 837.5 632.701 831.9 633.501C824.7 634.501 817.3 633.001 812 629.001C809 626.701 
                            807.1 623.801 805 621.001C802.6 617.701 800 614.401 797.7 611.001C794.8 607.101 792.1 603.201 791.5 598.301Z"
                            style={{visibility: "hidden"}}
                        />
                        <path className="st56 hIntact" d="M805.107 597.849C804.655 594.328 805.688 591.002 807.172 587.871C808.592 584.937 810.463 582.067 812.979 579.784C817.238 575.872 823.046 572.937 829.627 573.002C835.757 573.067 841.113 575.741 845.114 579.328C848.018 581.871 850.212 585.132 852.212 588.393C853.567 590.545 854.858 592.828 854.987 595.567C855.18 598.893 853.244 601.762 851.244 
                            604.175C849.05 606.784 846.598 609.132 844.469 611.936C843.307 613.501 842.146 615.132 840.662 616.501C838.145 618.784 834.79 620.284 831.176 620.805C826.53 621.457 821.755 620.479 818.335 617.871C816.399 616.371 815.173 614.479 813.818 612.653C812.27 610.501 810.592 608.349 809.108 606.132C807.236 603.588 805.494 601.045 805.107 597.849Z"
                            style={{visibility: "hidden"}}
                        />
                        <circle className="st57" cx="829" cy="596.001" r="12.25" style={{fill: 'black', opacity: tooth53Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump" style={{visibility: !tooth53Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth53Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M791.5 598.3C790.8 592.9 792.4 587.8 794.7 583C796.9 578.5 799.8 574.1 803.7 570.6C810.3 564.6 819.3 560.1 829.5 560.2C839 560.3 847.3 564.4 853.5 569.9C858 573.8 861.4 578.8 864.5 583.8C866.6 587.1 868.6 590.6 868.8 594.8C869.1 599.9 866.1 604.3 863 608C859.6 612 855.8 615.6 852.5 619.9C850.7 622.3 848.9 624.8 846.6 626.9C842.7 630.4 837.5 632.7 831.9 633.5C824.7 634.5 817.3 633 812 629C809 626.7 807.1 623.8 805 621C802.6 617.7 800 614.4 797.7 611C794.8 607.1 792.1 603.2 791.5 598.3Z"></path>
                        <path className="st47" d="M805.107 597.848C804.655 594.327 805.688 591.001 807.172 587.87C808.592 584.936 810.463 582.066 812.979 579.784C817.238 575.871 823.046 572.936 829.627 573.001C835.757 573.066 841.113 575.74 845.114 579.327C848.018 581.87 850.212 585.131 852.212 588.392C853.567 590.544 854.858 592.827 854.987 595.566C855.18 598.892 853.244 601.761 851.244 604.174C849.05 606.783 846.598 609.131 844.469 611.935C843.307 613.5 842.146 615.131 840.662 616.5C838.145 618.783 834.79 620.283 831.176 620.804C826.53 621.457 821.755 620.478 818.335 617.87C816.399 616.37 815.173 614.478 813.818 612.652C812.27 610.5 810.592 608.348 809.108 606.131C807.236 603.587 805.494 601.044 805.107 597.848Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment && !tooth53Diagnozis.implant && !tooth53Diagnozis.apex && !tooth53Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className="st46" 
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: teethDiagnozis.tooth53.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment && !tooth53Diagnozis.implant && !tooth53Diagnozis.shaper && !tooth53Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth53.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth53.seal_left ? `seal-fill ${teethDiagnozis.tooth53.seal_left_color}` : ''}
                                `}  
                                d="M781.8,596.2c0.8,6.6,4.2,12,7.8,17.4c1.6,2.4,3.2,4.8,4.9,7.3c3.2-6,12.4-11.6,22.2-14.1
                                c5-7.5-4.4-13.8-9.2-18.3c-5.1-4.8-14.8-13.3-19.5-17.5c-0.8,1.5-1.5,3-2.2,4.5C782.9,582,781,588.9,781.8,596.2z"
                            />
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth53.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth53.seal_bottom ? `seal-fill ${teethDiagnozis.tooth53.seal_bottom_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth53.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth53.seal_right ? `seal-fill ${teethDiagnozis.tooth53.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth53.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth53.seal_top ? `seal-fill ${teethDiagnozis.tooth53.seal_top_color}` : ''}
                                `}
                        ...
                        <g className="with">
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_bottom && !tooth53Diagnozis.seal_center) ||
                                        (tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_bottom && !tooth53Diagnozis.seal_center) ||
                                        (!tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_top) ||
                                        (!tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54"
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_top && !tooth53Diagnozis.seal_bottom) ||
                                        (!tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_top && tooth53Diagnozis.seal_bottom) ||
                                        (!tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_right && tooth53Diagnozis.seal_top && !tooth53Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_right && !tooth53Diagnozis.seal_top) ||
                                        (!tooth53Diagnozis.seal_right && tooth53Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_right && !tooth53Diagnozis.seal_bottom) ||
                                        (!tooth53Diagnozis.seal_right && tooth53Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        <g className="vinir" style={
                            {
                                visibility: tooth53Diagnozis.vinir ? 'inherit' : 'hidden',
                    ...
                    <g className="crown" style={{
                        visibility: (tooth53Diagnozis.temporary_crown || tooth53Diagnozis.ceramic_crown || tooth53Diagnozis.mceramic_crown || tooth53Diagnozis.metalic_crown || tooth53Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth53Diagnozis.temporary_crown || tooth53Diagnozis.ceramic_crown || tooth53Diagnozis.mceramic_crown || tooth53Diagnozis.metalic_crown || tooth53Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                                `st46 target temporary-crown crown-fill ${diagnozis}
                                ${tooth53Diagnozis.ceramic_crown_color}
                                ${tooth53Diagnozis.mceramic_crown_color}
                                ${tooth53Diagnozis.metalic_crown_color}
                                ${tooth53Diagnozis.zirconia_crown_color}
                            `} 
                            d="M877,591.8c-0.2-3.6-1.3-6.9-2.8-10c-0.8-1.7-1.7-3.3-2.6-4.9
                            c-3.8-6.8-8-13.5-13.5-18.8c-7.7-7.4-17.9-13-29.6-13.2c-12.5-0.2-23.7,5.8-31.7,13.9c-3.5,3.6-6.5,7.8-8.8,12.3
                            c-0.8,1.5-1.5,3-2.2,4.5c-2.9,6.5-4.8,13.4-3.9,20.7c0.8,6.6,4.2,12,7.8,17.4c1.6,2.4,3.2,4.8,4.9,7.3c1.4,2.1,2.8,4.2,4.2,6.2
                            ...
                            c4.1-5.8,8.7-10.6,12.9-16.1C873.7,604.7,877.3,598.8,877,591.8z"
                        />
                        <path className={`st3 fissure ${tooth53Diagnozis.fissure ? 'diagnoze' : tooth53Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    {/*FISSURE*/}
                    <g className={`st3 fissure ${tooth53Diagnozis.fissure ? 'diagnoze' : ''}`} style={{visibility: (!tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment && !tooth53Diagnozis.implant && !tooth53Diagnozis.apex && !tooth53Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                ...
                >
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g style={{visibility: !tooth53Diagnozis.implant && !tooth53Diagnozis.apex && !tooth53Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth53Diagnozis.change_color ? 'diagnoze' : ''}`}
                        ...
                        <g className="hImplant hEmpty" style={{visibility: !tooth53Diagnozis.implant && !tooth53Diagnozis.abutment && !tooth53Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth53Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth53Diagnozis.channel_class} ${tooth53Diagnozis.channel_class} ${tooth53Diagnozis.pulpit ? 'pulpit' : ''} ${tooth53Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth53Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact" d="M862.2 463.1C857.8 469.2 850 472.3 844 477.1C838.8 481.3 834.9 486.9 828.8 490.1C827.5 490.8 826.2 491.3 824.8 491.7C823.4 491.3 822 490.8 820.8 490.2C813.8 486.9 809.2 480.9 804.4 475.3C797.8 467.5 790.5 459.9 787.4 450.5C785.6 445.1 785.3 439.5 785.1 433.9C786.1 430.7 787.1 427.6 788.1 424.4C790 
                            418.6 791.7 412.7 794.7 407.4C800.6 397.1 810.8 389.9 822.6 389.2C825.8 389 828.9 389.3 831.9 390.3C836.5 391.8 840.4 394.7 844.1 397.8C850.4 403 856.2 408.9 860.9 415.4C861.2 416.6 861.5 417.7 861.7 418.9C863.5 426.7 865 434.6 865.8 442.5C866.6 449.7 866.7 456.8 862.2 463.1Z"
                            style={{visibility: "hidden"}}
                        />
                        <path className="st57" d="M803.8 293.5L813.6 485.5C815.8 487.5 818.1 489.2 820.9 490.5C822.2 491.1 823.5 491.6 824.9 492C826.3 491.6 827.6 491 828.9 490.4C831.6 489 833.9 487 836.1 485L809.4 294.5C809.3 292.4 807.1 291 805.2 291.9C804.5 292 804 
                            292.7 803.8 293.5Z"
                            style={{fill: tooth53Diagnozis.pin ? '#dbd9d3' : 'none'}}
                        />
                    </g>
                    {/* CULTTAB */}
                    <g className="stump" style={{visibility: !tooth53Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth53Diagnozis.culttab ? 0 : 1}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth53Diagnozis.abutment || tooth53Diagnozis.implant || tooth53Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="845.3" y1="354" x2="789" y2="368.8"></line>
                        <line className="st19" x1="841.5" y1="324" x2="785.1" y2="338.8"></line>
                        <line className="st19" x1="836.4" y1="294.1" x2="780" y2="308.8"></line>
                        <line className="st19" x1="832.6" y1="264.1" x2="776.2" y2="278.8"></line>
                        <line className="st19" x1="828.7" y1="234" x2="772.3" y2="248.8"></line>
                    </g>
                    <g className="toutline" style={{visibility: !tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment && !tooth53Diagnozis.implant && !tooth53Diagnozis.shaper && !tooth53Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        <path className="st7 st59" d="M783.257 442.182C783.213 442.389 783.168 442.595 783.124 442.8C781.624 450.1 781.524 457.5 782.724 464.9C783.824 469.8 785.323 474.7 787.423 479.3C790.223 485.6 793.923 491.6 797.923 497.2C800.839 501.316 804.27 505.359 807.585 509.266C808.135 509.914 808.682 510.559 809.224 511.2C809.563 511.675 809.948 512.104 810.349 512.55C810.538 512.761 810.731 512.975 810.923 513.2C814.223 517.2 817.623 521 822.923 521.7C828.123 522.5 832.924 519.5 837.024 516.2C839.114 514.543 841.126 512.763 843.141 510.98C846.234 508.243 849.332 505.501 852.724 503.2C854.838 501.762 857.096 500.467 859.315 499.194C859.719 498.962 860.123 498.731 860.524 498.5C863.324 496.8 866.023 495.1 868.423 493C871.823 490 874.424 486.3 876.124 482.2C877.424 475 877.524 467.6 876.524 460.4C876.033 457.033 875.295 453.715 874.554 450.377C874.238 448.957 873.922 447.533 873.624 446.1C873.489 445.426 873.358 444.753 873.227 444.08C872.678 441.256 872.131 438.446 871.324 435.7C869.324 428.6 866.023 422.2 861.923 416.3C857.023 409.4 851.024 403.3 844.524 397.8C840.824 394.7 836.924 391.8 832.324 390.3C829.224 389.4 826.123 389 822.923 389.2C811.123 389.9 800.924 397.1 795.024 407.4C792.427 411.987 790.804 417.023 789.183 422.055C788.931 422.837 788.679 423.62 788.423 424.4C788.024 425.666 787.612 426.933 787.201 428.2C786.379 430.733 785.557 433.266 784.824 435.8C784.186 437.895 783.714 440.073 783.257 442.182ZM798.118 421.861C797.92 422.475 797.722 423.09 797.522 423.703C797.208 424.698 796.885 425.694 796.563 426.689C796.37 427.283 796.178 427.877 795.987 428.471C795.591 429.703 796.468 430.97 797.761 431.048L860.546 434.838C861.882 434.919 862.918 433.69 862.54 432.407C860.954 427.02 858.425 421.963 855.215 417.337C851.369 411.915 846.659 407.121 841.557 402.798C838.653 400.362 835.591 398.083 831.981 396.904C829.547 396.197 827.114 395.882 824.602 396.04C815.34 396.59 807.334 402.248 802.702 410.343C800.664 413.948 799.391 417.906 798.118 421.861Z"></path>
                        <path className={`st7 ${tooth53Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}    
                            d="M797.302 423.703C798.793 419.145 800.128 414.508 802.483 410.343C807.114 402.248 815.12 396.59 824.382 396.04C826.894 395.882 829.328 396.197 831.761 396.904C835.372 398.083 838.433 400.362 841.337 402.798C846.439 407.121 851.149 411.915 854.995 417.337C858.205 421.963 860.734 427.02 862.32 432.407C862.698 433.69 861.662 434.919 860.327 434.838L797.541 431.048C796.248 430.97 795.371 429.703 795.767 428.471C796.277 
                            426.881 796.801 425.292 797.302 423.703Z"
                        />
                        <path className={
                                `st60
                                    ${(tooth53Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth53Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth53Diagnozis.seal_cervical_color}
                                `
                            }  
                            d="M797.302 423.703C798.793 419.145 800.128 414.508 802.483 410.343C807.114 402.248 815.12 396.59 824.382 396.04C826.894 395.882 829.328 396.197 831.761 396.904C835.372 398.083 838.433 400.362 841.337 402.798C846.439 407.121 851.149 411.915 854.995 417.337C858.205 421.963 860.734 427.02 862.32 432.407C862.698 433.69 861.662 434.919 860.327 434.838L797.541 431.048C796.248 430.97 795.371 429.703 795.767 428.471C796.277 
                            426.881 796.801 425.292 797.302 423.703Z"
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth53.tartar ? 1 : 0}}>
                        <path className="st61 level2" d="M874.5 451L873 449.5L872 448L871 445.5L869.5 443V440.5L868.5 437.5L866.5 435.5V434L864.5 430.5L863.5 427L862.5 425L860.5 421.5V420L859 418.5L857.5 416.5L856 415.5L855 413.5L854 412L852 409L848.5 407L846 403.5L842.5 401L841 399L839.5 398L836.5 396.5L833 395L831.5 393.5H828L824 392.5L821 393.5H817L813.5 395L811.5 396.5L808.5 398L805.5 400L804.5 401L803 403.5L800.5 405L798.5 409L797 410L795 413.5V415.5L793.5 416.5L792.5 418.5V420V423L791.5 425L790 427V429L789 433L787 435.5V439.5L785 442L782.5 
                            444V440.5V438.5L783.5 435.5V433L785 430.5L784.5 427.5L785 426V424L784.5 421.5L783.5 418.5L784.5 416.5L783.5 414.5V412L782.5 410L783.5 407L782.5 403.5V400L782 396L784.5 392.5H786L787 390L790 387.5L791.5 385L793.5 382.5L796.5 380.5L798 381L799.5 378.5L801.5 377.5L804.5 374.5L807 373.5L810 371L813.5 370.5L817 372L819.5 370.5H822L824 371H826.5L829 370.5L833 371L836.5 373.5L839 374L842.5 376H845L846 378.5L849 380L852 381L854 384L854.5 386.5L856 389V392.5V395L857.5 396.5V399L859 401V403.5L860.5 405V407L861.5 409L863.5 412L864.5 413.5L865.5 416.5L866.5 
                            420L867.5 423L869.5 426L871 429L871.5 432.5L873 436.5V439.5L873.5 442.5L874.5 446.5L875 449L874.5 451Z"
                        />
                        <path className="st61 level1" d="M875 451L873.5 449.5L872.5 448L871.5 445.5L870 443V440.5L869 437.5L867 435.5V434L865 430.5L864 427L863 425L861 421.5V420L859.5 418.5L858 416.5L856.5 415.5L855.5 413.5L854.5 412L852.5 409L849 407L846.5 403.5L843 401L841.5 399L840 398L837 396.5L833.5 395L832 393.5H828.5L824.5 392.5L821.5 393.5H817.5L814 395L812 396.5L809 398L806 400L805 401L803.5 403.5L801 405L799 409L797.5 410L795.5 413.5V415.5L794 416.5L793 418.5V420V423L792 425L790.5 427V429L789.5 433L787.5 435.5V439.5L785.5 442L783 444V442L783.5 439.5V438L784.5 435L785.5 432V429L786 427.5L785.5 425L786.5 423V420V416.5L787.5 413.5L786.5 
                            410L787.5 409V406L789.5 404.5L790.5 402L792 401L793 399L794.5 397.5L796.5 396.5L799 393.5L800 392H802L804.5 390.5L806 389L809.5 387.5L812 386H814L816.5 384.5L818.5 383.5L820.5 384.5L823 383.5H826.5L830 384.5L832 386H833.5L836 387H837.5L840 387.5L841.5 390L844 392H846L847.5 395H849L852.5 398V399L854.5 400L856.5 402L857.5 404.5L859.5 407V409L861 411L862 413.5L863 415.5L865.5 419L867 421.5L868 425L869 426.5L870 429L871 431L871.5 434L872.5 437.5V439.5L873.5 442L875 445.5V448V451Z"
                        />
                    </g>
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment && !tooth53Diagnozis.implant && !tooth53Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling" 
                            onClick={() => {
                                setColordedPart(diagnozis, 'left');
                            }}
                        >
                            ...
                            `}
                                ...
                                c-3.3-19.6-10.2-59.8-11.2-61.5c-0.9-1.6-8.9-9.7-13.2-13.9c-0.7,2.3-1.2,4.6-1.7,7C781.5,450,781.3,457.5,782.4,464.9z" 
                                style={{
                                    fill: teethDiagnozis.tooth53.caries_left ? '#606c80' : 
                                    teethDiagnozis.tooth53.seal_left ? teethDiagnozis.tooth53.seal_left_color : 'transparent',
                                }}
                            />
                        </g>
                        <g
                        ...
                        >
                            ...
                            `} 
                                ...
                                C852.6,440.5,857.5,477.6,860.3,498.4z" 
                                style={{
                                    fill: teethDiagnozis.tooth53.caries_right ? '#606c80' : 
                                    teethDiagnozis.tooth53.seal_right ? teethDiagnozis.tooth53.seal_right_color : 'transparent',
                        ...
                        >
                            ...
                            `} 
                                ...
                                c-11.8,0.7-22.1,7.9-27.9,18.2c-3,5.3-4.8,11.2-6.6,17C787,428.2,785.7,431.9,784.6,435.8z" 
                                style={{
                                    fill: teethDiagnozis.tooth53.caries_top ? '#606c80' : 
                                    teethDiagnozis.tooth53.seal_top ? teethDiagnozis.tooth53.seal_top_color : 'transparent',
                        ...
                        <g className="with">
                            <path className="st54" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_left && !tooth53Diagnozis.seal_top && !tooth53Diagnozis.seal_center) ||
                                        (!tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" 
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth53Diagnozis.seal_right && !tooth53Diagnozis.seal_top) ||
                                        (!tooth53Diagnozis.seal_right && !tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_top && tooth53Diagnozis.seal_bottom) ||
                                        (tooth53Diagnozis.seal_right && tooth53Diagnozis.seal_left && tooth53Diagnozis.seal_center && !tooth53Diagnozis.seal_top) ||
                                        (!tooth53Diagnozis.seal_center && !tooth53Diagnozis.seal_bottom && tooth53Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth53Diagnozis.vinir_color}`}
                                d="M876.3 460.299C875.6 455.499 874.4 450.799 873.4 445.999C872.7 442.499 872 439 871.1 435.6C869.1 428.6 865.8 422.1 861.7 416.2C856.9 409.3 850.9 403.2 844.3 397.7C840.6 394.6 836.7 391.7 832.1 390.2C829.1 389.2 825.9 388.9 822.8 389.1C811 389.8 800.7 396.999 794.9 407.299C791.9 412.599 790.1 418.499 788.3 424.299C787.1 428.099 785.8 431.9 784.7 435.7C784 438 783.5 440.3 783 442.7C781.6 450 781.4 457.499 782.5 464.799C783.5 469.699 785.1 474.6 787.2 479.2C790 485.6 793.7 491.5 797.7 497.1C801.2 501.9 805.2 506.6 809 
                                511.1C809.6 511.8 810.2 512.499 810.7 513.099C814.1 517.099 817.4 520.899 822.7 521.599C827.9 522.299 832.7 519.399 836.8 516.099C842.1 511.799 846.8 506.9 852.5 503.1C855 501.4 857.7 499.899 860.3 498.399C863.1 496.699 865.8 494.999 868.2 492.899C871.6 489.899 874.2 486.2 875.9 482.1C877.2 474.9 877.4 467.499 876.3 460.299Z"
                            />
                        </g>
                    </g>
                    {/* ТИМЧАСОВА КОРОНКА/КЕРАМІЧНА КОРОНКА */}
