                ...
                >
                    ...
                    <g className="dentin">
                        <g className={`d-ch-color`} style={{visibility: !tooth55Diagnozis.culttab && !tooth55Diagnozis.implant && !tooth55Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth55Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth55Diagnozis?.apex ? 'apex' : ''}`} 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth55Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth55Diagnozis.abutment ? 1 : 0}}>
