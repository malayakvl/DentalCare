...
export default function Tooth55() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth55.caries_bottom = !teethDiagnozis.tooth55.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth55.caries_center = !teethDiagnozis.tooth55.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth55.caries_left = !teethDiagnozis.tooth55.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth55.caries_right = !teethDiagnozis.tooth55.caries_right;
            }
            if (toothPart === 'top') {
        ...
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth55.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth55.seal_center_color = sealColor1;
                    teethDiagnozis.tooth55.seal_center = true;
                } else if (teethDiagnozis.tooth55.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth55.seal_center_color = sealColor2;
                    teethDiagnozis.tooth55.seal_center = true;
                } else if (teethDiagnozis.tooth55.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth55.seal_center_color = sealColor3;
                    teethDiagnozis.tooth55.seal_center = true;
                } else {
                    teethDiagnozis.tooth55.seal_center = !teethDiagnozis.tooth55.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth55.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth55.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth55.seal_bottom = true;
                } else if (teethDiagnozis.tooth55.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth55.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth55.seal_bottom = true;
                } else if (teethDiagnozis.tooth55.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth55.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth55.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth55.seal_bottom = !teethDiagnozis.tooth55.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth55.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth55.seal_left_color = sealColor1;
                    teethDiagnozis.tooth55.seal_left = true;
                } else if (teethDiagnozis.tooth55.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth55.seal_left_color = sealColor2;
                    teethDiagnozis.tooth55.seal_left = true;
                } else if (teethDiagnozis.tooth55.seal_left_color != sealColor3 && sealColor3 != '') {
            ...
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth55.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth55.seal_right_color = sealColor1;
                    teethDiagnozis.tooth55.seal_right = true;
                } else if (teethDiagnozis.tooth55.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth55.seal_right_color = sealColor2;
                    teethDiagnozis.tooth55.seal_right = true;
                } else if (teethDiagnozis.tooth55.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth55.seal_right_color = sealColor3;
                    teethDiagnozis.tooth55.seal_right = true;
                } else {
                    teethDiagnozis.tooth55.seal_right = !teethDiagnozis.tooth55.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth55.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth55.seal_top_color = sealColor1;
                    teethDiagnozis.tooth55.seal_top = true;
                } else if (teethDiagnozis.tooth55.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth55.seal_top_color = sealColor2;
                    teethDiagnozis.tooth55.seal_top = true;
                } else if (teethDiagnozis.tooth55.seal_top_color != sealColor3 && sealColor3 != '') {
        ...
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth55.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth55.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth55.wedge_shaped_defect_color = !teethDiagnozis.tooth55.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <g className="pulp" style={{visibility: tooth55Diagnozis.apex || tooth55Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling"  style={{visibility: tooth55Diagnozis.apex || tooth55Diagnozis.pulpit ? 'inherit' : 'hidden'}}>
                            <ellipse className="st22 target" rx="8.62899" ry="5.75303" transform="matrix(0.0172822 -0.999851 -0.999851 -0.0172822 415.901 591.728)" style={{fill: "#e80808"}}></ellipse>
                            <ellipse className="st22 target" rx="7.75725" ry="7.03431" transform="matrix(0.643274 -0.765636 -0.765636 -0.643274 373.376 590.464)" style={{fill: "#e80808"}}></ellipse>
                            <ellipse className="st22 target" rx="8.72166" ry="7.94529" transform="matrix(-0.99786 -0.0653869 -0.0653869 0.99786 381.223 609.499)" style={{fill: "#e80808"}}></ellipse>
                        </g>
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth55Diagnozis.implant || tooth55Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth55Diagnozis.pin ? 1 : 0}}>
                    ...
                    <g className="pin hEmpty hImplant" status="0" style={{opacity:0, visibility:"inherit"}}>
                        ...
                        />
                        <circle className="st57" cx="392" cy="598" r="12.25" style={{fill: 'black', opacity: tooth55Diagnozis.pin ? 1 : 0}}></circle>
                    </g>
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth55Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth55Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M335.5 607C336.5 603.1 338.8 599.401 339.9 595.5C342.7 585.9 338.8 575.001 345.1 566.201C349.9 559.401 358.8 555.801 368.9 554.401C378.4 553.101 388.2 553.901 397.8 552.701C403.9 551.901 410 550.5 416 550.1C422.4 549.6 428.7 550.301 434.4 551.901C438.3 553.001 442 554.6 445.2 556.8C450.6 560.6 453.6 565.901 454.7 571.401C456 577.801 454.8 584.3 452.2 590.5C448.4 599.8 441.7 608.301 437.1 617.401C434.3 623.001 432.2 628.901 427.6 633.901C423.6 638.301 417.7 641.7 410.8 642.6C405.7 643.3 400.5 642.6 395.3 642.1C388.8 641.5 382.3 641.4 375.8 641C370.1 640.7 364.4 640.2 359.1 638.6C342.3 633.9 331.9 620.701 335.5 607Z"></path>
                        <path className="st47" d="M352.508 604.127C353.222 601.316 354.864 598.649 355.65 595.838C357.649 588.919 354.864 581.062 359.363 574.719C362.79 569.818 369.145 567.223 376.357 566.214C383.141 565.277 390.138 565.854 396.993 564.989C401.349 564.412 405.705 563.403 409.989 563.115C414.559 562.754 419.057 563.259 423.128 564.412C425.912 565.205 428.554 566.358 430.839 567.944C434.695 570.683 436.837 574.503 437.623 578.467C438.551 583.08 437.694 587.765 435.838 592.234C433.124 598.938 428.34 605.064 425.056 611.623C423.056 615.66 421.557 619.912 418.272 623.516C415.416 626.688 411.203 629.139 406.276 629.787C402.634 630.292 398.921 629.787 395.208 629.427C390.567 628.994 385.926 628.922 381.284 628.634C377.214 628.418 373.144 628.057 369.36 626.904C357.363 623.516 349.937 614.002 352.508 604.127Z"></path>
                    </g>
                    <g style={{visibility: (!tooth55Diagnozis.culttab && !tooth55Diagnozis.abutment && !tooth55Diagnozis.implant && !tooth55Diagnozis.apex && !tooth55Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth55.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth55Diagnozis.culttab && !tooth55Diagnozis.abutment && !tooth55Diagnozis.implant && !tooth55Diagnozis.shaper && !tooth55Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g
                        ...
                        <g className="with">
                            <path className="st54" 
                                ...
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_left && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" 
                                ...
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_left && !tooth55Diagnozis.seal_center) ||
                                        (!tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            ...
                            <path className="st54" areas="55_2 55_5" 
                                ...
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_center) ||
                                        (tooth55Diagnozis.seal_right && !tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" areas="55_2 55_3" 
                                ...
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_right && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" areas="55_3 55_5" 
                                ...
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_center && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_center && tooth55Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }}
                            />
                    ...
                    <g className="crown" style={{
                        visibility: (tooth55Diagnozis.temporary_crown || tooth55Diagnozis.ceramic_crown || tooth55Diagnozis.mceramic_crown || tooth55Diagnozis.metalic_crown || tooth55Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth55Diagnozis.temporary_crown || tooth55Diagnozis.ceramic_crown || tooth55Diagnozis.mceramic_crown || tooth55Diagnozis.metalic_crown || tooth55Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                        ...
                        />
                        {/*FISSURE*/}
                        <path className={`st3 fissure ${tooth55Diagnozis.fissure ? 'diagnoze' : tooth55Diagnozis.fissure ? 'hidden' : ''}`} 
                    ...
                    {/* FISSURES */}
                    <g  style={{visibility: (!tooth55Diagnozis.culttab && !tooth55Diagnozis.abutment && !tooth55Diagnozis.implant && !tooth55Diagnozis.apex && !tooth55Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth55Diagnozis.fissure ? 'diagnoze' : ''}`} 
                            d="M385.6,606.5l-0.3-0.1c-1.5-0.4-3-0.7-4.5-1.1c-3.3-0.8-6.8-1.7-10.2-2.4c-0.7-0.2-1.5-0.3-2.3-0.5
                            c-4.3-1-8.7-2-12.8-1.9l-0.2,0c-2.2,0-4.6,0.1-5.7-2c-1.2-2.2,0.4-4.1,1.8-5.7c0.6-0.7,1.3-1.5,1.7-2.3c1-2,0.5-4.4-1.2-5.8
                            l0.7-0.8c2.2,1.8,2.8,4.7,1.5,7.2c-0.5,0.9-1.2,1.7-1.8,2.5c-1.5,1.8-2.4,3-1.6,4.5c0.8,1.5,2.7,1.5,4.8,1.5l0.2,0
                            c4.3-0.1,8.7,0.9,13.1,1.9c0.8,0.2,1.5,0.3,2.3,0.5c3.4,0.8,6.9,1.6,10.2,2.5c1.4,0.3,2.8,0.7,4.1,1c2.2-2.7,4.7-5.1,7.4-7.3
                ...
                >
                    ...
                    <g className="pin hEmpty hImplant" style={{
                        visibility: 'inherit', opacity: tooth55Diagnozis.pin ? 1 : 0
                    }}>
                        <path className="st56 hIntact" 
                            ...
                            391.999 338.3 401.699Z" style={{visibility:"hidden"}}
                        />
                        <path className="st57" 
                    ...
                    {/* CULT TAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: tooth55Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth55Diagnozis.culttab ? 1 : 0}}>
                        <path className="st14" 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth55Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth55Diagnozis.abutment ? 1 : 0}}>
                        <path className="st16" 
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth55Diagnozis.abutment || tooth55Diagnozis.implant || tooth55Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth55Diagnozis.culttab && !tooth55Diagnozis.abutment && !tooth55Diagnozis.implant && !tooth55Diagnozis.shaper && !tooth55Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                        <path className="st46" 
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth55Diagnozis.culttab && !tooth55Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth55Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} 
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility: 'inherit', opacity: teethDiagnozis.tooth55.tartar ? 1 : 0}}>
                        ...
                        <g className="with">
                            <path className="st54" d="M359 407L347 446" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_left && !tooth55Diagnozis.seal_top && !tooth55Diagnozis.seal_center) ||
                                        (tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_top && !tooth55Diagnozis.seal_center) ||
                                        (!tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" d="M359 407C368 379.5 371.9 377.9 363.5 359.5" 
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_left && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_bottom && !tooth55Diagnozis.seal_center) ||
                                        (!tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_bottom && tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M359 407C376 402.999 415 411 431 425" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_bottom && !tooth55Diagnozis.seal_center) ||
                                        (tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_left && tooth55Diagnozis.seal_center && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_bottom && !tooth55Diagnozis.seal_top && tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            />
                            <path className="st54" d="M431 425C442.115 405.109 441.456 402.656 454.5 395.5"
                                style={{
                                    ...
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_right && !tooth55Diagnozis.seal_bottom) ||
                                        (!tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_bottom && !tooth55Diagnozis.seal_center) ||
                                        (!tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_bottom && tooth55Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
                            ...
                            <path className="st54" d="M431 425L413 457.5" 
                                style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth55Diagnozis.seal_right && !tooth55Diagnozis.seal_top && !tooth55Diagnozis.seal_center) ||
                                        (tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_top && !tooth55Diagnozis.seal_center) ||
                                        (!tooth55Diagnozis.seal_right && tooth55Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
