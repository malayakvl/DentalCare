    ...
    return (
        <>
            <g id="55" className={`tooth-number-active ${teethType === 'adult' ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 621.4678 716.1968)" className={`st3 st4 st5 ${toothActive.tooth55.active ? 'num-active' : ''}`}>55</text>
            </g>
            <g id="TH-55" className={`f-tooth-init-milk ${(teethDiagnozis.tooth55.show && !teethDiagnozis.tooth55.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    ...
                    (!toothActive && !allTeeth) && document.getElementById('55').classList.add('tooth-number-hover')
                }}
                onMouseLeave={() => {
                    if (teethType === 'child' && !teethDiagnozis.tooth55.show) {
                        document.getElementById('TH-55').style.opacity = 0
                    }
                    if (teethDiagnozis.tooth55.show && teethType === 'adult') {
                ...
                onClick={() => { 
                    ...
                    //         teethDiagnozis.tooth55.fissure = !teethDiagnozis.tooth55.fissure;
                    //     else if (diagnozis === 'caries')
                    //         teethDiagnozis.tooth55.caries = !teethDiagnozis.tooth55.caries;
                    //     else if (diagnozis === 'cervical_caries')
                    //         teethDiagnozis.tooth55.cervical_caries = !teethDiagnozis.tooth55.cervical_caries;
                    //     else if (diagnozis === 'wedge_shaped_defect')
                    //         teethDiagnozis.tooth55.wedge_shaped_defect = !teethDiagnozis.tooth55.wedge_shaped_defect;
                    //     else if (diagnozis === 'tartar')
                    //         teethDiagnozis.tooth55.tartar = !teethDiagnozis.tooth55.tartar;
                    //     else if (diagnozis === 'pulpit') {
                    //         teethDiagnozis.tooth55.pulpit = !teethDiagnozis.tooth55.pulpit;
                    //         teethDiagnozis.tooth55.channel_class = teethDiagnozis.tooth55.pulpit ? 'pulpit' : ''
                    //     } else if (diagnozis === 'channel_not_sealed') {
                    //         teethDiagnozis.tooth55.channel_not_sealed = !teethDiagnozis.tooth55.channel_not_sealed;
                    //         teethDiagnozis.tooth55.channel_class = teethDiagnozis.tooth55.channel_not_sealed ? 'channel-not-sealed' : '';
                    //     } else if (diagnozis === 'channel_top_sealed') {
                    //         teethDiagnozis.tooth55.channel_top_sealed = !teethDiagnozis.tooth55.channel_top_sealed;
                    //         teethDiagnozis.tooth55.channel_class = teethDiagnozis.tooth55.channel_top_sealed ? 'channel-top-sealed' : '';
                    //     } else if (diagnozis === 'channel_part_sealed') {
                    //         teethDiagnozis.tooth55.channel_part_sealed = !teethDiagnozis.tooth55.channel_part_sealed;
                    //         teethDiagnozis.tooth55.channel_class = teethDiagnozis.tooth55.channel_part_sealed ? 'channel-part-sealed' : '';
                    //     } else if (diagnozis === 'periodontit') {
                    //         if (teethDiagnozis.tooth55.periodontit_stage !== subDiagnozis) {
                    //             teethDiagnozis.tooth55.periodontit_stage = subDiagnozis
                    //             teethDiagnozis.tooth55.periodontit = true;
                    //         } else {
                    //             teethDiagnozis.tooth55.periodontit = !teethDiagnozis.tooth55.periodontit;
                    //         }
                    //         teethDiagnozis.tooth55.channel_class = teethDiagnozis.tooth55.periodontit ? 'periodontit' : '';
                    //         if (!teethDiagnozis.tooth55.periodontit) dispatch(setSubDiagnosis(''));
                    //     } else if (diagnozis === 'seal') {
                    //         teethDiagnozis.tooth55.seal = !teethDiagnozis.tooth55.seal;
                    //     } else if (diagnozis === 'seal_cervical') {
                    //         if (!teethDiagnozis.tooth55.seal_cervical && teethDiagnozis.tooth55.seal_cervical_color === "") {
                    //             teethDiagnozis.tooth55.seal_cervical = true;
                    //             teethDiagnozis.tooth55.seal_cervical_color = wsDefectColor;
                    //         } else if (teethDiagnozis.tooth55.seal_cervical && teethDiagnozis.tooth55.seal_cervical_color != wsDefectColor) {
                    //             teethDiagnozis.tooth55.seal_cervical_color = wsDefectColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.seal_cervical = false;
                    //             teethDiagnozis.tooth55.seal_cervical_color = "";
                    //         }
                    //     } else if (diagnozis === 'vinir') {
                    //         if (!teethDiagnozis.tooth55.vinir && teethDiagnozis.tooth55.vinir_color === "") {
                    //             teethDiagnozis.tooth55.vinir = true;
                    //             teethDiagnozis.tooth55.vinir_color = vinirColor;
                    //         } else if (teethDiagnozis.tooth55.vinir && teethDiagnozis.tooth55.vinir_color != vinirColor) {
                    //             teethDiagnozis.tooth55.vinir_color = vinirColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.vinir = false;
                    //             teethDiagnozis.tooth55.vinir_color = "";
                    //         }
                    //     } else if (diagnozis === 'temporary_crown') {
                    //         teethDiagnozis.tooth55.temporary_crown = !teethDiagnozis.tooth55.temporary_crown;
                    //     } else if (diagnozis === 'ceramic_crown') {
                    //         if (!teethDiagnozis.tooth55.ceramic_crown && teethDiagnozis.tooth55.ceramic_crown_color === "") {
                    //             teethDiagnozis.tooth55.ceramic_crown = true;
                    //             teethDiagnozis.tooth55.ceramic_crown_color = ceramicCrownColor;
                    //         } else if (teethDiagnozis.tooth55.ceramic_crown && teethDiagnozis.tooth55.ceramic_crown_color != ceramicCrownColor) {
                    //             teethDiagnozis.tooth55.ceramic_crown_color = ceramicCrownColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.ceramic_crown = false;
                    //             teethDiagnozis.tooth55.ceramic_crown_color = "";
                    //         }
                    //     } else if (diagnozis === 'mceramic_crown') {
                    //         if (!teethDiagnozis.tooth55.mceramic_crown && teethDiagnozis.tooth55.mceramic_crown_color === "") {
                    //             teethDiagnozis.tooth55.mceramic_crown = true;
                    //             teethDiagnozis.tooth55.mceramic_crown_color = mceramicCrownColor;
                    //         } else if (teethDiagnozis.tooth55.mceramic_crown && teethDiagnozis.tooth55.mceramic_crown_color != mceramicCrownColor) {
                    //             teethDiagnozis.tooth55.mceramic_crown_color = mceramicCrownColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.mceramic_crown = false;
                    //             teethDiagnozis.tooth55.mceramic_crown_color = "";
                    //         }
                    //     } else if (diagnozis === 'metalic_crown') {
                    //         if (!teethDiagnozis.tooth55.metalic_crown && teethDiagnozis.tooth55.metalic_crown_color === "") {
                    //             teethDiagnozis.tooth55.metalic_crown = true;
                    //             teethDiagnozis.tooth55.metalic_crown_color = metalicCrownColor;
                    //         } else if (teethDiagnozis.tooth55.metalic_crown && teethDiagnozis.tooth55.metalic_crown_color != metalicCrownColor) {
                    //             teethDiagnozis.tooth55.mceramic_crown_color = metalicCrownColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.metalic_crown = false;
                    //             teethDiagnozis.tooth55.metalic_crown_color = "";
                    //         }
                    //     } else if (diagnozis === 'zirconia_crown') {
                    //         if (!teethDiagnozis.tooth55.zirconia_crown && teethDiagnozis.tooth55.zirconia_crown_color === "") {
                    //             teethDiagnozis.tooth55.zirconia_crown = true;
                    //             teethDiagnozis.tooth55.zirconia_crown_color = zirconiaCrownColor;
                    //         } else if (teethDiagnozis.tooth55.zirconia_crown && teethDiagnozis.tooth55.zirconia_crown_color != zirconiaCrownColor) {
                    //             teethDiagnozis.tooth55.zirconia_crown_color = zirconiaCrownColor;
                    //         } else {
                    //             teethDiagnozis.tooth55.zirconia_crown = false;
                    //             teethDiagnozis.tooth55.zirconia_crown_color = "";
                    //         }
                    //     } else if (diagnozis === 'pin') {
                    //         teethDiagnozis.tooth55.pin = !teethDiagnozis.tooth55.pin;
                    //     } else if (diagnozis === 'culttab') {
                    //         teethDiagnozis.tooth55.culttab = !teethDiagnozis.tooth55.culttab;
                    //     } else if (diagnozis === 'abutment') {
                    //         teethDiagnozis.tooth55.abutment = !teethDiagnozis.tooth55.abutment;
                    //     } else if (diagnozis === 'shaper') {
                    //         teethDiagnozis.tooth55.shaper = !teethDiagnozis.tooth55.shaper;
                    //     } else if (diagnozis === 'implant') {
                    //         teethDiagnozis.tooth55.implant = !teethDiagnozis.tooth55.implant;
                    //     } else if (diagnozis === 'apex') {
                    //         teethDiagnozis.tooth55.apex = !teethDiagnozis.tooth55.apex;
                    //     } else if (diagnozis === 'absent') {
                    //         teethDiagnozis.tooth55.absent = !teethDiagnozis.tooth55.absent;
                    //     } else if (diagnozis === 'cervical_caries') {
                    //         teethDiagnozis.tooth55.cervical_caries = !teethDiagnozis.tooth55.cervical_caries;
                    //     } else if (diagnozis === 'caries') {
                    //         teethDiagnozis.tooth55.caries = !teethDiagnozis.tooth55.caries;
                    //     } else if (diagnozis === 'parodontit') {
                    //         if (teethDiagnozis.tooth55.parodontit) {
                    //             if (teethDiagnozis.tooth55.parodontit_stage === subDiagnozis) {
                    //                 teethDiagnozis.tooth55.parodontit = false;
                    //                 teethDiagnozis.tooth55.active = false;
                    //             } else {
                    //                 teethDiagnozis.tooth55.parodontit = true;
                    //                 teethDiagnozis.tooth55.parodontit_stage = subDiagnozis
                    //             }
                    //         } else {
                    //             teethDiagnozis.tooth55.parodontit = true;
                    //             teethDiagnozis.tooth55.parodontit_stage = subDiagnozis;
                    //             teethDiagnozis.tooth55.active = true;
                    //         }
                    //     }
            ...
            >
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 282, 35)'}}>
                    ...
                    <g className="dentin">
                        <g className={`d-ch-color`} style={{visibility: !tooth55Diagnozis.culttab && !tooth55Diagnozis.implant && !tooth55Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st24 change-color ${tooth55Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth55Diagnozis?.apex ? 'apex' : ''}`} d="M335.5,607c1-3.9,3.3-7.6,4.4-11.5c2.8-9.6-1.1-20.5,5.2-29.3c4.8-6.8,13.7-10.4,23.8-11.8
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility:"hidden"}}>
                            <path className={`st24 ${tooth55Diagnozis.apex ? 'apex' : ''}`} 
                            ...
                            />
                            <path className={`st53 ${tooth55Diagnozis.apex ? 'apex' : ''}`} 
                    ...
                    <g className="pulp" type="none" level="0">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling"  style={{visibility:"hidden"}}>
                            <ellipse className="st22 target" rx="8.62899" ry="5.75303" transform="matrix(0.0172822 -0.999851 -0.999851 -0.0172822 415.901 591.728)" style={{fill: "rgb(254, 246, 249)"}}></ellipse>
                            <ellipse className="st22 target" rx="7.75725" ry="7.03431" transform="matrix(0.643274 -0.765636 -0.765636 -0.643274 373.376 590.464)" style={{fill: "rgb(254, 246, 249)"}}></ellipse>
                            <ellipse className="st22 target" rx="8.72166" ry="7.94529" transform="matrix(-0.99786 -0.0653869 -0.0653869 0.99786 381.223 609.499)" style={{fill: "rgb(254, 246, 249)"}}></ellipse>
                        </g>
                    </g>
                    ...
                    <g className="abutment hEmpty hIntact hRoot" status="0" style={{opacity:0, visibility:"hidden"}}>
                        <path className="st47" d="M335.5 607C336.5 603.1 338.8 599.401 339.9 595.5C342.7 585.9 338.8 575.001 345.1 566.201C349.9 559.401 358.8 555.801 368.9 554.401C378.4 553.101 388.2 553.901 397.8 552.701C403.9 551.901 410 550.5 416 550.1C422.4 549.6 428.7 550.301 434.4 551.901C438.3 553.001 442 554.6 445.2 556.8C450.6 560.6 453.6 565.901 454.7 571.401C456 577.801 454.8 584.3 452.2 590.5C448.4 599.8 441.7 608.301 437.1 617.401C434.3 623.001 432.2 628.901 427.6 633.901C423.6 638.301 417.7 641.7 410.8 642.6C405.7 643.3 400.5 642.6 395.3 642.1C388.8 641.5 382.3 641.4 375.8 641C370.1 640.7 364.4 640.2 359.1 638.6C342.3 633.9 331.9 620.701 335.5 607Z"></path>
                        <path className="st47" d="M352.508 604.127C353.222 601.316 354.864 598.649 355.65 595.838C357.649 588.919 354.864 581.062 359.363 574.719C362.79 569.818 369.145 567.223 376.357 566.214C383.141 565.277 390.138 565.854 396.993 564.989C401.349 564.412 405.705 563.403 409.989 563.115C414.559 562.754 419.057 563.259 423.128 564.412C425.912 565.205 428.554 566.358 430.839 567.944C434.695 570.683 436.837 574.503 437.623 578.467C438.551 583.08 437.694 587.765 435.838 592.234C433.124 598.938 428.34 605.064 425.056 611.623C423.056 615.66 421.557 619.912 418.272 623.516C415.416 626.688 411.203 629.139 406.276 629.787C402.634 630.292 398.921 629.787 395.208 629.427C390.567 628.994 385.926 628.922 381.284 628.634C377.214 628.418 373.144 628.057 369.36 626.904C357.363 623.516 349.937 614.002 352.508 604.127Z"></path>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        <g className="caries-filling">
                            ...
                            c-10.6,0.6-19.3,2.5-25.6,7c-1.9,1.3-3.6,2.9-5.1,4.7C351.4,587.6,348.5,599.2,350.5,608.4z"></path>
                            <path className="st8 target" d="M350.5,608.4c0.6,2.8,1.7,5.8,3.5,8.6c4.2,6.6,12.3,12.4,27.7,12.4c21.1,0,27.9-7.4,33.1-13.3
                            c0.2-0.2,0.4-0.4,0.6-0.6c5.2-6.1,6.8-19.6,9.9-28.7c0.9-2.5,1.3-4.8,1.3-7c-0.1-5.9-3.4-10.4-11-11.7c-10.4-1.8-27.1,0-27.1,0
                            c-10.6,0.6-19.3,2.5-25.6,7c-1.9,1.3-3.6,2.9-5.1,4.7C351.4,587.6,348.5,599.2,350.5,608.4z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                            <path className="st7" d="M335,640.3c10.7-10.7,16.3-18.6,19.1-23.2c-1.8-2.8-2.9-5.8-3.5-8.6c-2-9.2,0.9-20.8,7.2-28.7
                            c1.5-1.8,3.2-3.4,5.1-4.7c-9.6-11.7-19.5-19.8-24.7-23.8c-0.2,0.3-0.3,0.5-0.5,0.8c-7.1,12.4-2.5,27.6-5.7,41.1
                            c-1.3,5.5-3.9,10.6-5,16.1C324.6,620.5,327.9,631.6,335,640.3z"></path>
                            <path className="st8 target" d="M335,640.3c10.7-10.7,16.3-18.6,19.1-23.2c-1.8-2.8-2.9-5.8-3.5-8.6c-2-9.2,0.9-20.8,7.2-28.7
                            c1.5-1.8,3.2-3.4,5.1-4.7c-9.6-11.7-19.5-19.8-24.7-23.8c-0.2,0.3-0.3,0.5-0.5,0.8c-7.1,12.4-2.5,27.6-5.7,41.1
                            c-1.3,5.5-3.9,10.6-5,16.1C324.6,620.5,327.9,631.6,335,640.3z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                            <path className="st7" d="M335,640.3c4.9,6,11.7,10.8,19.8,13.6c6.2,2.2,12.8,2.9,19.3,3.4c7.5,0.6,15,0.9,22.5,1.8
                            ...
                            c-15.3,0-23.5-5.8-27.7-12.4C351.2,621.7,345.7,629.5,335,640.3z"></path>
                            <path className="st8 target" d="M335,640.3c4.9,6,11.7,10.8,19.8,13.6c6.2,2.2,12.8,2.9,19.3,3.4c7.5,0.6,15,0.9,22.5,1.8
                            c6,0.7,12,1.8,17.9,0.8c7.9-1.3,14.6-6,19.2-12.1c1.8-2.4,3.3-5,4.5-7.6c-12-9.4-19.6-18.8-23.4-24.1c-5.1,6-11.9,13.3-33.1,13.3
                            c-15.3,0-23.5-5.8-27.7-12.4C351.2,621.7,345.7,629.5,335,640.3z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                            <path className="st7" d="M414.7,616.1c3.8,5.3,11.4,14.7,23.4,24.1c2.4-5,4.2-10.3,6.3-15.5c5.2-12.7,12.8-24.5,17.2-37.6
                            ...
                            C415.1,615.6,414.9,615.8,414.7,616.1z"></path>
                            <path className="st8 target" d="M414.7,616.1c3.8,5.3,11.4,14.7,23.4,24.1c2.4-5,4.2-10.3,6.3-15.5c5.2-12.7,12.8-24.5,17.2-37.6
                            c2.9-8.7,4.3-17.8,2.7-26.8c-0.2-1.2-0.5-2.4-0.8-3.5c-7.8,4.2-26.2,14.3-37,23.1c0,2.2-0.4,4.6-1.3,7c-3.2,9-4.7,22.6-9.9,28.7
                            C415.1,615.6,414.9,615.8,414.7,616.1z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                            <path className="st7" d="M338.2,551.2c5.2,3.9,15,12.1,24.7,23.8c6.3-4.4,15-6.4,25.6-7c0,0,16.7-1.8,27.1,0c7.5,1.3,10.9,5.9,11,11.7
                            ...
                            c-11.1,1.6-22.4,0.4-33.3,2.2C353.7,537.5,343.7,542.2,338.2,551.2z"></path>
                            <path className="st8 target" d="M338.2,551.2c5.2,3.9,15,12.1,24.7,23.8c6.3-4.4,15-6.4,25.6-7c0,0,16.7-1.8,27.1,0c7.5,1.3,10.9,5.9,11,11.7
                            c10.8-8.7,29.2-18.9,37-23.1c-1.7-6.5-5.1-12.6-10.4-17.1c-3.7-3.2-8-5.4-12.5-7c-6.7-2.3-14-3.3-21.3-2.7c-7,0.6-14,2.5-21,3.5
                            c-11.1,1.6-22.4,0.4-33.3,2.2C353.7,537.5,343.7,542.2,338.2,551.2z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="55_4 55_3" d="M338 636C342.709 632.893 353.492 622.629 357 618" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_4 55_5" d="M357 618C351.333 611.667 344.6 594.2 363 575" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_4 55_1" d="M363 575C360 570.5 351.5 560 341.5 554" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_1 55_5" d="M363 575C382.667 570.834 422.9 565.9 426.5 579.5" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_2 55_1" d="M426.5 579.5C428.667 576.167 438.2 567.5 459 559.5" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_2 55_5" d="M426.5 579.5C426.167 588 423.5 607.3 415.5 616.5" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_2 55_3" d="M415.5 616.5C417 620.5 423.1 630.3 435.5 637.5" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                            <path className="st54" areas="55_3 55_5" d="M356.5 618.5C365.5 627 400.3 629.7 415.5 616.5" style={{strokeWidth:0, stroke:"rgb(81, 79, 72)"}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir" status="0" style={{opacity:0, visibility:"hidden"}}>
                            <path className="st55" d="M337.115 551.975C337.215 551.675 337.415 551.475 337.615 551.175C343.215 542.175 353.215 537.375 364.415 535.575C375.315 533.775 386.614 534.975 397.714 533.375C404.714 532.375 411.714 530.475 418.714 529.875C426.014 529.275 433.315 530.275 440.015 532.575C444.615 534.175 448.815 536.375 452.515 539.575C457.815 544.075 461.115 550.175 462.915 556.675C463.215 557.875 463.514 559.075 463.714 560.175C465.314 569.175 463.915 578.275 461.015 586.975C460.345 588.999 459.595 590.997 458.787 592.976C455.988 592.777 450.419 591.638 450.531 588.677C450.578 588.538 450.624 588.399 450.67 588.26C453.116 580.925 454.297 573.253 452.948 565.665C452.779 564.738 452.526 563.726 452.273 562.714C450.755 557.234 447.971 552.091 443.5 548.298C440.38 545.6 436.837 543.745 432.957 542.396C427.305 540.457 421.148 539.614 414.99 540.12C409.086 540.625 403.182 542.227 397.277 543.07C387.914 544.419 378.383 543.408 369.189 544.925C359.742 546.443 351.307 550.49 346.583 558.077C346.415 558.33 346.246 558.499 346.162 558.752C341.024 567.721 343.15 578.427 342.153 588.476C341.064 591.676 334.554 592.816 331.436 592.986C334.594 579.508 330.03 564.348 337.115 551.975Z"></path>
                            <path className="st55" d="M331.415 593.075C331.422 593.045 331.429 593.015 331.436 592.986M331.436 592.986C334.594 579.508 330.03 564.348 337.115 551.975C337.215 551.675 337.415 551.475 337.615 551.175C343.215 542.175 353.215 537.375 364.415 535.575C375.315 533.775 386.614 534.975 397.714 533.375C404.714 532.375 411.714 530.475 418.714 529.875C426.014 529.275 433.315 530.275 440.015 532.575C444.615 534.175 448.815 536.375 452.515 539.575C457.815 544.075 461.115 550.175 462.915 556.675C463.215 557.875 463.514 559.075 463.714 560.175C465.314 569.175 463.915 578.275 461.015 586.975C460.345 588.999 459.595 590.997 458.787 592.976C455.988 592.777 450.419 591.638 450.531 588.677C450.578 588.538 450.624 588.399 450.67 588.26C453.116 580.925 454.297 573.253 452.948 565.665C452.779 564.738 452.526 563.726 452.273 562.714C450.755 557.234 447.971 552.091 443.5 548.298C440.38 545.6 436.837 543.745 432.957 542.396C427.305 540.457 421.148 539.614 414.99 540.12C409.086 540.625 403.182 542.227 397.277 543.07C387.914 544.419 378.383 543.408 369.189 544.925C359.742 546.443 351.307 550.49 346.583 558.077C346.415 558.33 346.246 558.499 346.162 558.752C341.024 567.721 343.15 578.427 342.153 588.476C341.064 591.676 334.554 592.816 331.436 592.986Z"></path>
                        </g>
                    </g>
                    <g className="crown" status="0" style={{opacity:0, visibility:"hidden"}}>
                        <path className="st46 target" d="M464.3,560.2c-0.2-1.2-0.5-2.4-0.8-3.5c-1.7-6.5-5.1-12.6-10.4-17.1c-3.7-3.2-8-5.4-12.5-7
                        c-6.7-2.3-14-3.3-21.3-2.7c-7,0.6-14,2.5-21,3.5c-11.1,1.6-22.4,0.4-33.3,2.2c-11.3,1.9-21.3,6.6-26.8,15.6
                        c-0.2,0.3-0.3,0.5-0.5,0.8c-7.1,12.4-2.5,27.6-5.7,41.1c-1.3,5.5-3.9,10.6-5,16.1c-2.4,11.3,0.9,22.4,8,31
                        c4.9,6,11.7,10.8,19.8,13.6c6.2,2.2,12.8,2.9,19.3,3.4c7.5,0.6,15,0.9,22.5,1.8c6,0.7,12,1.8,17.9,0.8c7.9-1.3,14.6-6,19.2-12.1
                        c1.8-2.4,3.3-5,4.5-7.6c2.4-5,4.2-10.3,6.3-15.5c5.2-12.7,12.8-24.5,17.2-37.6C464.5,578.3,465.8,569.2,464.3,560.2z"></path>
                        <path className="st3 fissure" d="M385.6,606.5l-0.3-0.1c-1.5-0.4-3-0.7-4.5-1.1c-3.3-0.8-6.8-1.7-10.2-2.4c-0.7-0.2-1.5-0.3-2.3-0.5
                        ...
                        c-2.8,2.2-5.3,4.7-7.5,7.4L385.6,606.5z"></path>
                        <path className="st3 fissure" d="M397.3,631.3c-1.8-8.7-5.9-17.1-11.7-24.1c-0.5-0.6-1.1-1.2-1.6-1.9l0.8-0.7c0.6,0.6,1.1,1.2,1.6,1.9
                        c6,7.2,10.1,15.7,11.9,24.6L397.3,631.3z"></path>
                        <path className="st3 fissure" d="M431.4,599.1c-2.8,0-5.4-1.2-8-2.4l-0.4-0.2c-3.4-1.6-7.1-3-11.3-4.3l0.3-1c4.2,1.3,8,2.8,11.5,4.4l0.4,0.2
                        c3,1.4,6.1,2.8,9.3,2.1c2-0.4,3.5-1.7,5.2-2.9c1.7-1.3,3.4-2.7,5.7-3.1l0.2,1.1c-2,0.4-3.6,1.7-5.2,2.9
                        c-1.7,1.3-3.4,2.6-5.6,3.1C432.7,599.1,432.1,599.1,431.4,599.1z"></path>
                    </g>
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: 'inherit'}} pigmentation="0">
                        <path className="st3 fissure" d="M385.6,606.5l-0.3-0.1c-1.5-0.4-3-0.7-4.5-1.1c-3.3-0.8-6.8-1.7-10.2-2.4c-0.7-0.2-1.5-0.3-2.3-0.5
                        c-4.3-1-8.7-2-12.8-1.9l-0.2,0c-2.2,0-4.6,0.1-5.7-2c-1.2-2.2,0.4-4.1,1.8-5.7c0.6-0.7,1.3-1.5,1.7-2.3c1-2,0.5-4.4-1.2-5.8
                        l0.7-0.8c2.2,1.8,2.8,4.7,1.5,7.2c-0.5,0.9-1.2,1.7-1.8,2.5c-1.5,1.8-2.4,3-1.6,4.5c0.8,1.5,2.7,1.5,4.8,1.5l0.2,0
                        c4.3-0.1,8.7,0.9,13.1,1.9c0.8,0.2,1.5,0.3,2.3,0.5c3.4,0.8,6.9,1.6,10.2,2.5c1.4,0.3,2.8,0.7,4.1,1c2.2-2.7,4.7-5.1,7.4-7.3
                        l1-0.8c4-3.1,8.2-6.3,7.4-11c-0.5-2.9-3-4.7-5.6-6.6c-0.9-0.6-1.8-1.3-2.6-2c-5-4.3-7.3-10.5-6.1-16.8l1.1,0.2
                        c-1.1,5.8,1.1,11.7,5.8,15.7c0.8,0.7,1.7,1.3,2.6,2c2.7,2,5.5,4,6.1,7.3c0.9,5.3-3.7,8.9-7.8,12l-1,0.8
                        c-2.8,2.2-5.3,4.7-7.5,7.4L385.6,606.5z" style={{stroke:"none"}}></path>
                        <path className="st3 fissure" d="M397.3,631.3c-1.8-8.7-5.9-17.1-11.7-24.1c-0.5-0.6-1.1-1.2-1.6-1.9l0.8-0.7c0.6,0.6,1.1,1.2,1.6,1.9
                        c6,7.2,10.1,15.7,11.9,24.6L397.3,631.3z" style={{stroke:"none"}}></path>
                        <path className="st3 fissure" d="M431.4,599.1c-2.8,0-5.4-1.2-8-2.4l-0.4-0.2c-3.4-1.6-7.1-3-11.3-4.3l0.3-1c4.2,1.3,8,2.8,11.5,4.4l0.4,0.2
                        c3,1.4,6.1,2.8,9.3,2.1c2-0.4,3.5-1.7,5.2-2.9c1.7-1.3,3.4-2.7,5.7-3.1l0.2,1.1c-2,0.4-3.6,1.7-5.2,2.9
                        c-1.7,1.3-3.4,2.6-5.6,3.1C432.7,599.1,432.1,599.1,431.4,599.1z" style={{stroke:"none"}}></path>
                    </g>
                </g>
                <g id="T_55" className="common-view"
                    style={{visibility: tooth55Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 282, 119)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g id="d-55" className="hRoot hImplant hEmpty" style={{visibility: !tooth55Diagnozis.implant && !tooth55Diagnozis.apex && !tooth55Diagnozis.shaper && !tooth55Diagnozis.apex ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth55Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp" type="none" level="0">
                        ...
                        c9.6,0.8,19.2,2.4,28.2,5.8c0.2,0.1,0.5,0.2,0.7,0.3c-0.8,3.2-1.5,6.4-1.7,9.7C423.3,377.2,424.8,384.9,424.2,392.7z" style={{fill:"rgb(254, 246, 249)"}}></path>
                        </g>
                        ...
                        c0.6,5.9,1.2,11.8,1.9,17.6c1.9-2.2,3.5-4.9,4.8-7.6c7.2-15.4,11.2-31.7,12.2-48.1H443.5z" style={{fill:"rgb(254, 246, 249)"}}></path>
                        </g>
                        <g className="hEmpty hImplant pulpitis-pfilling"  style={{visibility: 'inherit'}}>
                        ...
                        C384.3,282,382.1,274.4,379.4,266.9z" style={{fill:"rgb(254, 246, 249)"}}></path>
                        ...
                        C417.9,265.8,416.9,243.9,416.4,222z" style={{fill:"rgb(254, 246, 249)"}}></path>
                            <path className="st22 target part" d="M436.7,247.3c4.1,14.3,5.8,29,5,43.6h1.8c0-0.9,0-1.8,0-2.8C443.5,274.3,441.2,260.5,436.7,247.3z" style={{fill:"rgb(254, 246, 249)"}}></path>
                        </g>
                    ...
                    <g className="wedge-shaped hRoot hImplant hEmpty" style={{visibility: 'inherit'}} type="" status="0">
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'inherit'}}>
                        ...
                        c1.3-2.5,2.4-5.1,3.1-7.8l1.9-0.1c-1.2,2.2-2.1,4.5-2.8,6.9c-0.9,3.4-1.3,7,0,10.2c3.6,8.8,15.5,9.1,21.6,15.8
                        c4-7.5,13.4-24.8,20.7-38.1c-3.4-3.4-8.2-7.6-13.2-10.1c-12.9-6.5-36.7-12.3-58.7-7.1C354.1,424,348.2,442.5,345.5,451.1z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                        ...
                        c5.1-16.1,9.4-30.3,9.4-31.4c0-1.9-4.4-14.8-6.8-21.7c-9.4,8.5-18,17.7-25.8,27.7c-2.7,3.5-5.4,7.1-6.8,11.3
                        C327.6,398.7,327.9,404.3,328,409.8z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                        ...
                        c9.1-3.6,17.5-9,23.4-16.9c1-1.3,1.9-2.7,2.7-4.1c2-6.5,3-13.2,3.2-20c0.1-5.8-0.5-11.6-0.9-17.4c-0.4-5.3-0.7-10.7-0.9-16.1
                        c-6,4.7-16.5,13.1-18.7,16.3c-1,1.5-4.9,8.3-9.5,16.8C423.9,438,414.5,455.3,410.5,462.8z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="caries-filling">
                        ...
                        c2.2-3.2,12.7-11.6,18.7-16.3c0-0.4,0-0.8,0-1.2c-2.8-5.6-6.3-10.8-10.7-15.3c-6.7-6.9-14.8-12.1-23.8-15.6
                        c-9-3.5-18.6-5.1-28.2-5.8c-11.5-0.9-23.1-0.7-34.6,0.7c-0.1,0-0.1,0.1-0.1,0.1c2.4,6.9,6.8,19.7,6.8,21.7
                        C368.7,377.3,364.4,391.5,359.3,407.6z" style={{strokeWidth: 0, fill: 'none'}} type="none"></path>
                        </g>
                        <g className="with">
                            <path className="st54" areas="55_4 55_5" d="M359 407L347 446" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="55_1 55_4" d="M359 407C368 379.5 371.9 377.9 363.5 359.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="55_1 55_5" d="M359 407C376 402.999 415 411 431 425" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="55_1 55_2" d="M431 425C442.115 405.109 441.456 402.656 454.5 395.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                            <path className="st54" areas="55_2 55_5" d="M431 425L413 457.5" style={{strokeWidth: 0, stroke: 'rgb(81, 79, 72)'}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir" status="0" style={{opacity:0, visibility:"hidden"}}>
