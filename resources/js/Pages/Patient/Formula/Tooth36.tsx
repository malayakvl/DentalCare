...
export default function Tooth36() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth36.caries_bottom = !teethDiagnozis.tooth36.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth36.caries_center = !teethDiagnozis.tooth36.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth36.caries_left = !teethDiagnozis.tooth36.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth36.caries_right = !teethDiagnozis.tooth36.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth36.caries_top = !teethDiagnozis.tooth36.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth36.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth36.seal_center_color = sealColor1;
                    teethDiagnozis.tooth36.seal_center = true;
                } else if (teethDiagnozis.tooth36.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth36.seal_center_color = sealColor2;
                    teethDiagnozis.tooth36.seal_center = true;
                } else if (teethDiagnozis.tooth36.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth36.seal_center_color = sealColor3;
                    teethDiagnozis.tooth36.seal_center = true;
                } else {
                    teethDiagnozis.tooth36.seal_center = !teethDiagnozis.tooth36.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth36.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth36.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth36.seal_bottom = true;
                } else if (teethDiagnozis.tooth36.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth36.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth36.seal_bottom = true;
                } else if (teethDiagnozis.tooth36.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth36.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth36.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth36.seal_bottom = !teethDiagnozis.tooth36.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth36.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth36.seal_left_color = sealColor1;
                    teethDiagnozis.tooth36.seal_left = true;
                } else if (teethDiagnozis.tooth36.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth36.seal_left_color = sealColor2;
                    teethDiagnozis.tooth36.seal_left = true;
                } else if (teethDiagnozis.tooth36.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth36.seal_left_color = sealColor3;
                    teethDiagnozis.tooth36.seal_left = true;
                } else {
                    teethDiagnozis.tooth36.seal_left = !teethDiagnozis.tooth36.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth36.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth36.seal_right_color = sealColor1;
                    teethDiagnozis.tooth36.seal_right = true;
                } else if (teethDiagnozis.tooth36.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth36.seal_right_color = sealColor2;
                    teethDiagnozis.tooth36.seal_right = true;
                } else if (teethDiagnozis.tooth36.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth36.seal_right_color = sealColor3;
                    teethDiagnozis.tooth36.seal_right = true;
                } else {
                    teethDiagnozis.tooth36.seal_right = !teethDiagnozis.tooth36.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth36.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth36.seal_top_color = sealColor1;
                    teethDiagnozis.tooth36.seal_top = true;
                } else if (teethDiagnozis.tooth36.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth36.seal_top_color = sealColor2;
                    teethDiagnozis.tooth36.seal_top = true;
                } else if (teethDiagnozis.tooth36.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth36.seal_top_color = sealColor3;
                    teethDiagnozis.tooth36.seal_top = true;
                } else {
                    teethDiagnozis.tooth36.seal_top = !teethDiagnozis.tooth36.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth36.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth36.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth36.wedge_shaped_defect_color = !teethDiagnozis.tooth36.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="36" className={`tooth-number-active ${teethType === 'child' ? 'hide-number' : ''}`}>
            ...
            <g id="TH-36" className={`f-tooth-init ${(teethDiagnozis.tooth36.show && !teethDiagnozis.tooth36.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth36.active) {
                        dispatch(setNewToothActive({tooth36: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth36.change_color = !teethDiagnozis.tooth36.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth36.fissure = !teethDiagnozis.tooth36.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth36.caries = !teethDiagnozis.tooth36.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth36.cervical_caries = !teethDiagnozis.tooth36.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth36.wedge_shaped_defect = !teethDiagnozis.tooth36.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth36.tartar = !teethDiagnozis.tooth36.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth36.pulpit = !teethDiagnozis.tooth36.pulpit;
                            teethDiagnozis.tooth36.channel_class = teethDiagnozis.tooth36.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth36.channel_not_sealed = !teethDiagnozis.tooth36.channel_not_sealed;
                            teethDiagnozis.tooth36.channel_class = teethDiagnozis.tooth36.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth36.channel_top_sealed = !teethDiagnozis.tooth36.channel_top_sealed;
                            teethDiagnozis.tooth36.channel_class = teethDiagnozis.tooth36.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth36.channel_part_sealed = !teethDiagnozis.tooth36.channel_part_sealed;
                            teethDiagnozis.tooth36.channel_class = teethDiagnozis.tooth36.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth36.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth36.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth36.periodontit = true;
                            } else {
                                teethDiagnozis.tooth36.periodontit = !teethDiagnozis.tooth36.periodontit;
                            }
                            teethDiagnozis.tooth36.channel_class = teethDiagnozis.tooth36.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth36.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth36.seal_cervical && teethDiagnozis.tooth36.seal_cervical_color === "") {
                                teethDiagnozis.tooth36.seal_cervical = true;
                                teethDiagnozis.tooth36.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth36.seal_cervical && teethDiagnozis.tooth36.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth36.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth36.seal_cervical = false;
                                teethDiagnozis.tooth36.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth36.vinir && teethDiagnozis.tooth36.vinir_color === "") {
                                teethDiagnozis.tooth36.vinir = true;
                                teethDiagnozis.tooth36.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth36.vinir && teethDiagnozis.tooth36.vinir_color != vinirColor) {
                                teethDiagnozis.tooth36.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth36.vinir = false;
                                teethDiagnozis.tooth36.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth36.temporary_crown = !teethDiagnozis.tooth36.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth36.ceramic_crown && teethDiagnozis.tooth36.ceramic_crown_color === "") {
                                teethDiagnozis.tooth36.ceramic_crown = true;
                                teethDiagnozis.tooth36.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth36.ceramic_crown && teethDiagnozis.tooth36.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth36.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth36.ceramic_crown = false;
                                teethDiagnozis.tooth36.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth36.mceramic_crown && teethDiagnozis.tooth36.mceramic_crown_color === "") {
                                teethDiagnozis.tooth36.mceramic_crown = true;
                                teethDiagnozis.tooth36.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth36.mceramic_crown && teethDiagnozis.tooth36.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth36.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth36.mceramic_crown = false;
                                teethDiagnozis.tooth36.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth36.metalic_crown && teethDiagnozis.tooth36.metalic_crown_color === "") {
                                teethDiagnozis.tooth36.metalic_crown = true;
                                teethDiagnozis.tooth36.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth36.metalic_crown && teethDiagnozis.tooth36.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth36.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth36.metalic_crown = false;
                                teethDiagnozis.tooth36.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth36.zirconia_crown && teethDiagnozis.tooth36.zirconia_crown_color === "") {
                                teethDiagnozis.tooth36.zirconia_crown = true;
                                teethDiagnozis.tooth36.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth36.zirconia_crown && teethDiagnozis.tooth36.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth36.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth36.zirconia_crown = false;
                                teethDiagnozis.tooth36.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth36.pin = !teethDiagnozis.tooth36.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth36.culttab = !teethDiagnozis.tooth36.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth36.abutment = !teethDiagnozis.tooth36.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth36.shaper = !teethDiagnozis.tooth36.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth36.implant = !teethDiagnozis.tooth36.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth36.apex = !teethDiagnozis.tooth36.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth36.absent = !teethDiagnozis.tooth36.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth36.cervical_caries = !teethDiagnozis.tooth36.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth36.caries = !teethDiagnozis.tooth36.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth36.parodontit) {
                                if (teethDiagnozis.tooth36.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth36.parodontit = false;
                                    teethDiagnozis.tooth36.active = false;
                                } else {
                                    teethDiagnozis.tooth36.parodontit = true;
                                    teethDiagnozis.tooth36.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth36.parodontit = true;
                                teethDiagnozis.tooth36.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth36.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_36_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g style={{visibility: !tooth36Diagnozis.implant && !tooth36Diagnozis.apex && !tooth36Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`}  
                        ...
                        <g className={`st9 change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`} style={{visibility: 'hidden'}}>
                            <path className="st6" d="M1608.9 969.7C1611.4 976 1614.2 982.5 1613 989.1C1612.1 994 1608.9 998.5 1604.9 1002.4C1601.6 1005.6 1597.6 1008.5 1592.7 1009.8C1587.6 1011.2 1581.8 1010.7 1576.8 1012.4C1570.9 1014.3 1567.1 1018.6 1562.1 1021.8C1554.7 1026.4 1545.2 1028.2 1535.7 1027.9C1530.2 1027.7 1524.6 1026.7 1520.2 1024.2C1518 1022.9 1516.1 1021.3 1513.7 1020.3C1507.7 1017.9 1500.8 1019.6 1494.1 1019.4C1488.1 1019.2 1482.6 1017.5 1478.2 1014.3C1474.6 1011.6 1472.2 1008.2 1470.3 1004.6C1468.5 1001.2 1467.1 997.7 1466.5 994.1C1465.3 986.9 1467.3 979.6 1469.1 972.4C1470.8 965.6 1472.5 958.7 1475.3 952.1C1478.6 944.3 1483.7 936.8 1492.8 932.6C1501.5 928.6 1512 928.6 1522 930.2C1526.1 930.8 1530.2 931.7 1534.4 931.5C1538.3 931.3 1541.9 930.2 1545.7 929.5C1550.8 928.6 1556 928.5 1561.1 928.8C1566.2 929.1 1571.3 929.6 1576.2 930.8C1581.7 932.1 1586.9 934.1 1591.1 937.2C1596.8 941.4 1599.9 947.2 1602.3 952.7C1604.7 958.2 1606.6 963.9 1608.9 969.7Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                            <path className="st53" d="M1508.82 972.325C1509.81 988.262 1504.49 997 1539.24 997C1577.68 997 1571.36 983.851 1571.36 967.576C1571.36 960.226 1568.12 955 1542.52 955C1516.93 955 1507.83 956.388 1508.82 972.325Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                        </g>
                    </g>
                    {/*PULPIT/CHANNEL NOT SEALED/PART SALED*/}
                    <g className="pulpitis-filling" style={{visibility: tooth36Diagnozis.change_color ? 'hidden' : 'inherit'}}>
                        <g className={`st22 target top ${tooth36Diagnozis.channel_class} ${tooth36Diagnozis.channel_class} ${tooth36Diagnozis.pulpit ? 'pulpit' : ''} ${tooth36Diagnozis.periodontit ? 'periodontit' : ''}`}>
                            <ellipse className="st22 target" rx="10.0437" ry="6.63376" transform="matrix(0.0172822 -0.999851 -0.999851 -0.0172822 1563.95 976.158)" />
                            <ellipse className="st22 target" rx="8.41967" ry="7.78385" transform="matrix(0.643274 -0.765636 -0.765636 -0.643274 1519.38 966.454)" />
                            <ellipse className="st22 target" rx="8.72166" ry="7.94529" transform="matrix(-0.99786 -0.0653869 -0.0653869 0.99786 1519.53 986.499)" />
                        </g>
                    </g>
                    {/* IMPLANT */}
                    <g style={{visibility: tooth36Diagnozis.implant || tooth36Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="1539.5" cy="979.5" r="26.5"></circle>
                        <g className="st27">
                            <mask id="implant_36" className="st49">
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth36Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth36Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility : 'inherit', opacity: teethDiagnozis.tooth36.tartar ? 1 : 0}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth36Diagnozis.culttab && !tooth36Diagnozis.abutment && !tooth36Diagnozis.implant && !tooth36Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС R*/}
                        <g
                        ...
                        >                            
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth36.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth36.seal_center ? `seal-fill ${teethDiagnozis.tooth36.seal_center_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth36.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth36.seal_right ? `seal-fill ${teethDiagnozis.tooth36.seal_right_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth36.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth36.seal_top ? `seal-fill ${teethDiagnozis.tooth36.seal_top_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth36.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth36.seal_left ? `seal-fill ${teethDiagnozis.tooth36.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth36.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth36.seal_bottom ? `seal-fill ${teethDiagnozis.tooth36.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g className="with up">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_right && !tooth36Diagnozis.seal_bottom) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_right && !tooth36Diagnozis.seal_center) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_right && !tooth36Diagnozis.seal_top) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_center && !tooth36Diagnozis.seal_top) ||
                                        (!tooth36Diagnozis.seal_center && tooth36Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_left && !tooth36Diagnozis.seal_top) ||
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_center) ||
                                        (tooth36Diagnozis.seal_left && !tooth36Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_left && !tooth36Diagnozis.seal_bottom) ||
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth36Diagnozis.seal_center && tooth36Diagnozis.seal_bottom) ||
                                        (tooth36Diagnozis.seal_center && !tooth36Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    >                       
                        <path className={
                            ...
                            c1.1-1.1,2.1-2.3,3.1-3.5c4.3-5.4,7.7-11.6,8.6-18.5C1620.2,987.2,1617,978.2,1614.3,969.3z"
                        />
                        <path className="st3 fissure" style={{visibility: tooth36Diagnozis.temporary_crown || tooth36Diagnozis.ceramic_crown || tooth36Diagnozis.mceramic_crown || tooth36Diagnozis.metalic_crown || tooth36Diagnozis.zirconia_crown || tooth36Diagnozis.culttab || tooth36Diagnozis.abutment || tooth36Diagnozis.implant ? 'hidden' : 'inherit'}} 
                    ...
                    {/*FISSURES*/}
                    <g className="fissures" style={{visibility: (!tooth36Diagnozis.culttab && !tooth36Diagnozis.abutment && !tooth36Diagnozis.implant && !tooth36Diagnozis.apex && !tooth36Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth36Diagnozis.fissure ? 'diagnoze' : ''}`} 
                            d="M1573.3,1010.1c0.1-2.1,0.2-4.2-0.6-6.2c-1.1-3-3.6-4.9-6.1-6.7c-0.8-0.6-1.7-1.3-2.5-1.9
                            c-2.4-2-4.3-4.6-5.6-7.5c2.6-0.4,4.7-2.1,6.7-3.9c5.4-4.7,11.1-9,17-12.9l-0.6-0.9c-5.9,4-11.7,8.3-17.2,13.1
                            c-1.9,1.6-3.9,3.3-6.3,3.6c-2.7,0.3-5.3-1.3-7.7-2.9l-0.5-0.3c-5.6-3.6-11.7-6.3-18.1-8.1l-0.1,0c0.3-3.3-0.1-6.1-1.2-8.4
                            c-0.3-0.7-0.7-1.3-1-1.9c-0.9-1.6-1.7-3-1.6-4.8c0.2-1.8,1.4-3.1,2.7-4.5c0.9-1,1.9-2,2.5-3.3c1.7-3.4,0.5-7-0.6-10.5
                ...
                <g id="T_36" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g id="dentin_v_46" style={{visibility: !tooth36Diagnozis.implant && !tooth36Diagnozis.apex && !tooth36Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_v_36" className={`change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`}   
                        ...
                        <g id="dentin_n_36" style={{visibility: !tooth36Diagnozis.culttab && !tooth36Diagnozis.abutment && !tooth36Diagnozis.implant && !tooth36Diagnozis.shaper && !tooth36Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_46" className={`change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth36Diagnozis.pin ? 1 : 0
                    }}>                        
                        ...
                        <path className="st57" d="M1524.8 1141.3L1617.3 1267.7C1618.1 1269 1619.8 1269.6 1621.2 1269C1622.7 1268.4 1623.5 1266.8 1623.1 1265.2L1614.7 1249.3L1613.8 1247.6L1551 1128.1L1524.8 1141.3Z"
                            style={{fill: tooth36Diagnozis.pin ? '#dbd9d3' : 'none'}} 
                        />
                    </g>
                    {/* CULT TAB */}
                    <g style={{visibility: tooth36Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth36Diagnozis.culttab ? 1 : 0}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth36Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth36Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth36Diagnozis.abutment || tooth36Diagnozis.implant || tooth36Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped " style={{visibility: !tooth36Diagnozis.culttab && !tooth36Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth36Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} 
                        ...
                        <path className={
                                `st60
                                    ${(tooth36Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth36Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth36Diagnozis.seal_cervical_color}
                                `
                            } 
                            d="M1488.96 1181.97C1497.58 1189.35 1507.72 1194.53 1518.69 1196.99C1528.24 1199.19 1538.04 1199.28 1547.75 1198.69C1557.47 1198.09 1567.18 1196.9 1576.65 1194.27C1585.44 1191.9 1593.82 1188.25 1601.1 1182.65C1610.52 1175.23 1611.56 1169.91 1610.8 1159.16C1610.71 1158 1609.63 1157.17 1608.47 1157.36C1564.36 1164.69 1536.38 1168.17 1485.19 1172.21C1483.72 1172.33 1482.87 1173.94 1483.67 1175.18C1485.25 1177.58 1487 1179.88 1488.96 1181.97Z" />
                    </g>
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth36.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling " style={{ visibility: 'inherit' }}>
                        ...
                        <g className="with down">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_right && !tooth36Diagnozis.seal_top && !tooth36Diagnozis.seal_center) ||
                                        (tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_top && !tooth36Diagnozis.seal_center) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_right && !tooth36Diagnozis.seal_bottom) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_bottom && !tooth36Diagnozis.seal_center) ||
                                        (!tooth36Diagnozis.seal_right && tooth36Diagnozis.seal_bottom && tooth36Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_left && !tooth36Diagnozis.seal_bottom) ||
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_bottom && !tooth36Diagnozis.seal_center) ||
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_bottom && tooth36Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth36Diagnozis.seal_left && !tooth36Diagnozis.seal_top && !tooth36Diagnozis.seal_center) ||
                                        (tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_top && !tooth36Diagnozis.seal_center) ||
                                        (!tooth36Diagnozis.seal_left && tooth36Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
