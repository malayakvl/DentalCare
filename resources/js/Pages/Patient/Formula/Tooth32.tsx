...
export default function Tooth32() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth32.caries_bottom = !teethDiagnozis.tooth32.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth32.caries_center = !teethDiagnozis.tooth32.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth32.caries_left = !teethDiagnozis.tooth32.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth32.caries_right = !teethDiagnozis.tooth32.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth32.caries_top = !teethDiagnozis.tooth32.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth32.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth32.seal_center_color = sealColor1;
                    teethDiagnozis.tooth32.seal_center = true;
                } else if (teethDiagnozis.tooth32.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth32.seal_center_color = sealColor2;
                    teethDiagnozis.tooth32.seal_center = true;
                } else if (teethDiagnozis.tooth32.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth32.seal_center_color = sealColor3;
                    teethDiagnozis.tooth32.seal_center = true;
                } else {
                    teethDiagnozis.tooth32.seal_center = !teethDiagnozis.tooth32.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth32.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth32.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth32.seal_bottom = true;
                } else if (teethDiagnozis.tooth32.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth32.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth32.seal_bottom = true;
                } else if (teethDiagnozis.tooth32.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth32.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth32.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth32.seal_bottom = !teethDiagnozis.tooth32.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth32.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth32.seal_left_color = sealColor1;
                    teethDiagnozis.tooth32.seal_left = true;
                } else if (teethDiagnozis.tooth32.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth32.seal_left_color = sealColor2;
                    teethDiagnozis.tooth32.seal_left = true;
                } else if (teethDiagnozis.tooth32.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth32.seal_left_color = sealColor3;
                    teethDiagnozis.tooth32.seal_left = true;
                } else {
                    teethDiagnozis.tooth32.seal_left = !teethDiagnozis.tooth32.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth32.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth32.seal_right_color = sealColor1;
                    teethDiagnozis.tooth32.seal_right = true;
                } else if (teethDiagnozis.tooth32.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth32.seal_right_color = sealColor2;
                    teethDiagnozis.tooth32.seal_right = true;
                } else if (teethDiagnozis.tooth32.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth32.seal_right_color = sealColor3;
                    teethDiagnozis.tooth32.seal_right = true;
                } else {
                    teethDiagnozis.tooth32.seal_right = !teethDiagnozis.tooth32.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth32.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth32.seal_top_color = sealColor1;
                    teethDiagnozis.tooth32.seal_top = true;
                } else if (teethDiagnozis.tooth32.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth32.seal_top_color = sealColor2;
                    teethDiagnozis.tooth32.seal_top = true;
                } else if (teethDiagnozis.tooth32.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth32.seal_top_color = sealColor3;
                    teethDiagnozis.tooth32.seal_top = true;
                } else {
                    teethDiagnozis.tooth32.seal_top = !teethDiagnozis.tooth32.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth32.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth32.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth32.wedge_shaped_defect_color = !teethDiagnozis.tooth32.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    return (
        <>
                ...
                onClick={() => {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth32.change_color = !teethDiagnozis.tooth32.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth32.fissure = !teethDiagnozis.tooth32.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth32.caries = !teethDiagnozis.tooth32.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth32.cervical_caries = !teethDiagnozis.tooth32.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth32.wedge_shaped_defect = !teethDiagnozis.tooth32.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth32.tartar = !teethDiagnozis.tooth32.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth32.pulpit = !teethDiagnozis.tooth32.pulpit;
                            teethDiagnozis.tooth32.channel_class = teethDiagnozis.tooth32.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth32.channel_not_sealed = !teethDiagnozis.tooth32.channel_not_sealed;
                            teethDiagnozis.tooth32.channel_class = teethDiagnozis.tooth32.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth32.channel_top_sealed = !teethDiagnozis.tooth32.channel_top_sealed;
                            teethDiagnozis.tooth32.channel_class = teethDiagnozis.tooth32.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth32.channel_part_sealed = !teethDiagnozis.tooth32.channel_part_sealed;
                            teethDiagnozis.tooth32.channel_class = teethDiagnozis.tooth32.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth32.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth32.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth32.periodontit = true;
                            } else {
                                teethDiagnozis.tooth32.periodontit = !teethDiagnozis.tooth32.periodontit;
                            }
                            teethDiagnozis.tooth32.channel_class = teethDiagnozis.tooth32.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth32.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth32.seal_cervical && teethDiagnozis.tooth32.seal_cervical_color === "") {
                                teethDiagnozis.tooth32.seal_cervical = true;
                                teethDiagnozis.tooth32.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth32.seal_cervical && teethDiagnozis.tooth32.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth32.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth32.seal_cervical = false;
                                teethDiagnozis.tooth32.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth32.vinir && teethDiagnozis.tooth32.vinir_color === "") {
                                teethDiagnozis.tooth32.vinir = true;
                                teethDiagnozis.tooth32.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth32.vinir && teethDiagnozis.tooth32.vinir_color != vinirColor) {
                                teethDiagnozis.tooth32.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth32.vinir = false;
                                teethDiagnozis.tooth32.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth32.temporary_crown = !teethDiagnozis.tooth32.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth32.ceramic_crown && teethDiagnozis.tooth32.ceramic_crown_color === "") {
                                teethDiagnozis.tooth32.ceramic_crown = true;
                                teethDiagnozis.tooth32.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth32.ceramic_crown && teethDiagnozis.tooth32.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth32.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth32.ceramic_crown = false;
                                teethDiagnozis.tooth32.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth32.mceramic_crown && teethDiagnozis.tooth32.mceramic_crown_color === "") {
                                teethDiagnozis.tooth32.mceramic_crown = true;
                                teethDiagnozis.tooth32.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth32.mceramic_crown && teethDiagnozis.tooth32.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth32.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth32.mceramic_crown = false;
                                teethDiagnozis.tooth32.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth32.metalic_crown && teethDiagnozis.tooth32.metalic_crown_color === "") {
                                teethDiagnozis.tooth32.metalic_crown = true;
                                teethDiagnozis.tooth32.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth32.metalic_crown && teethDiagnozis.tooth32.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth32.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth32.metalic_crown = false;
                                teethDiagnozis.tooth32.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth32.zirconia_crown && teethDiagnozis.tooth32.zirconia_crown_color === "") {
                                teethDiagnozis.tooth32.zirconia_crown = true;
                                teethDiagnozis.tooth32.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth32.zirconia_crown && teethDiagnozis.tooth32.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth32.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth32.zirconia_crown = false;
                                teethDiagnozis.tooth32.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth32.pin = !teethDiagnozis.tooth32.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth32.culttab = !teethDiagnozis.tooth32.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth32.abutment = !teethDiagnozis.tooth32.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth32.shaper = !teethDiagnozis.tooth32.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth32.implant = !teethDiagnozis.tooth32.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth32.apex = !teethDiagnozis.tooth32.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth32.absent = !teethDiagnozis.tooth32.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth32.cervical_caries = !teethDiagnozis.tooth32.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth32.caries = !teethDiagnozis.tooth32.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth32.parodontit) {
                                if (teethDiagnozis.tooth32.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth32.parodontit = false;
                                    teethDiagnozis.tooth32.active = false;
                                } else {
                                    teethDiagnozis.tooth32.parodontit = true;
                                    teethDiagnozis.tooth32.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth32.parodontit = true;
                                teethDiagnozis.tooth32.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth32.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_32_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR/APEX/CULTTAB */}
                    <g className="dentin">
                        <g style={{visibility: !tooth32Diagnozis.implant && !tooth32Diagnozis.apex && !tooth32Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth32Diagnozis.change_color ? 'diagnoze' : ''}`} 
                        ...
                        <g style={{visibility: tooth32Diagnozis?.apex || tooth32Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth32Diagnozis.change_color ? 'diagnoze' : ''}`}   
                    ...
                    <g className="pulp">
                        <g style={{visibility: tooth32Diagnozis.apex ? 'inherit' : 'hidden'}}>
                            <path className="st22 target" 
                                d="M1154.25 985.525C1154.25 985.127 1154.67 984.097 1152.65 981.941C1151.15 980.568 1150.64 978.146 1148.72 978.108C1146.65 978.068 1146.08 980.258 1144.74 981.717C1143.13 983.468 1142.91 984.752 1143.1 985.525C1143.5 987.117 1144.59 987.147 1148.72 987.172C1152.84 987.197 1154.25 985.923 1154.25 
                                985.525Z"
                            />
                        </g>
                    </g>
                    {/* IMPLANT/CULTTAB */}
                    <g style={{visibility: tooth32Diagnozis.implant || tooth32Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        <circle className="st48" cx="1149.5" cy="983.5" r="14.5" />
                        <g className="st27">
                            <mask id="implant_32" className="st49">
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth32Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth32Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth32Diagnozis.pin ? 1 : 0}}>
                        <path className="st56 hIntact" d="M1125.86 983.854L1125.86 983.854L1125.85 983.863C1124.59 985.719 1124.56 987.914 1125.61 989.922C1127.12 992.58 1130.21 994.273 1133.67 995.56C1138.34 997.211 1143.32 997.9 1148.44 998C1154.44 997.999 1160.51 997.112 1165.86 995.068C1168.83 993.88 1171.42 992.392 1172.64 990.139C1173.48 988.441 1173.5 986.482 1172.54 984.556C1171.62 982.825 1170.14 981.328 1168.54 979.829L1168.54 979.824L1168.53 979.818C1165.4 976.79 1162.36 973.444 1159.81 969.881L1159.81 969.874L1159.8 969.866C1159.77 969.813 1159.73 969.759 1159.69 969.706C1158.61 968.122 1157.53 966.553 1156.14 965.507C1154.24 964.155 1151.89 963.521 1149.44 963.794C1146.17 964.157 1143.37 966.076 1141.04 968.402C1139.68 969.8 1138.47 971.292 1137.24 972.818C1136.88 973.267 1136.51 973.719 1136.14 974.172C1134.52 976.144 1132.79 978.111 1130.65 979.78C1130.12 980.215 1129.51 980.655 1128.94 981.07C1128.58 981.323 1128.25 981.567 1127.95 981.796C1127.09 982.45 1126.37 983.094 1125.86 983.854Z" style={{visibility: 'hidden'}}></path>
                        <path className="st56 hIntact" d="M1129.93 983.571L1129.93 983.571L1129.92 983.58C1128.91 985.054 1128.89 986.797 1129.73 988.406C1130.96 990.546 1133.48 991.929 1136.35 992.991C1140.22 994.35 1144.35 994.918 1148.61 995C1153.59 994.999 1158.63 994.268 1163.07 992.586C1165.54 991.604 1167.64 990.393 1168.63 988.588C1169.3 987.238 1169.32 985.678 1168.54 984.134C1167.79 982.731 1166.58 981.511 1165.25 980.271L1165.24 980.266L1165.24 980.26C1162.62 977.751 1160.08 974.975 1157.95 972.017L1157.95 972.01L1157.94 972.002C1157.91 971.962 1157.89 971.921 1157.86 971.88C1156.94 970.562 1156.06 969.285 1154.93 968.437C1153.38 967.343 1151.46 966.829 1149.46 967.05C1146.78 967.345 1144.48 968.903 1142.56 970.814C1141.43 971.964 1140.43 973.19 1139.4 974.451C1139.1 974.823 1138.8 975.199 1138.48 975.576C1137.13 977.208 1135.68 978.847 1133.89 980.239C1133.44 980.601 1132.93 980.972 1132.44 981.319C1132.15 981.527 1131.87 981.726 1131.63 981.909C1130.92 982.447 1130.34 982.966 1129.93 983.571Z" style={{visibility: 'hidden'}}></path>
                        <circle className="st57" r="12.25" transform="matrix(-1 0 0 1 1150.13 983)" style={{fill: 'black', opacity: tooth32Diagnozis.pin ? 1 : 0}} />
                    </g>
                    <g className="stump" style={{visibility: !tooth32Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth32Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1125.86 983.854L1125.86 983.854L1125.85 983.863C1124.59 985.719 1124.56 987.914 1125.61 989.922C1127.12 992.58 1130.21 994.273 1133.67 995.56C1138.34 997.211 1143.32 997.9 1148.44 998C1154.44 997.999 1160.51 997.112 1165.86 995.068C1168.83 993.88 1171.42 992.392 1172.64 990.139C1173.48 988.441 1173.5 986.482 1172.54 984.556C1171.62 982.825 1170.14 981.328 1168.54 979.829L1168.54 979.824L1168.53 979.818C1165.4 976.79 1162.36 973.444 1159.81 969.881L1159.81 969.874L1159.8 969.866C1159.77 969.813 1159.73 969.759 1159.69 969.706C1158.61 968.122 1157.53 966.553 1156.14 965.507C1154.24 964.155 1151.89 963.521 1149.44 963.794C1146.17 964.157 1143.37 966.076 1141.04 968.402C1139.68 969.8 1138.47 971.292 1137.24 972.818C1136.88 973.267 1136.51 973.719 1136.14 974.172C1134.52 976.144 1132.79 978.111 1130.65 979.78C1130.12 980.215 1129.51 980.655 1128.94 981.07C1128.58 981.323 1128.25 981.567 1127.95 981.796C1127.09 982.45 1126.37 983.094 1125.86 983.854Z"></path>
                        <path className="st47" d="M1129.93 983.571L1129.93 983.571L1129.92 983.58C1128.91 985.054 1128.89 986.797 1129.73 988.406C1130.96 990.546 1133.48 991.929 1136.35 992.991C1140.22 994.35 1144.35 994.918 1148.61 995C1153.59 994.999 1158.63 994.268 1163.07 992.586C1165.54 991.604 1167.64 990.393 1168.63 988.588C1169.3 987.238 1169.32 985.678 1168.54 984.134C1167.79 982.731 1166.58 981.511 1165.25 980.271L1165.24 980.266L1165.24 980.26C1162.62 977.751 1160.08 974.975 1157.95 972.017L1157.95 972.01L1157.94 972.002C1157.91 971.962 1157.88 971.921 1157.86 971.88C1156.94 970.562 1156.06 969.285 1154.93 968.437C1153.38 967.343 1151.46 966.829 1149.46 967.05C1146.78 967.345 1144.48 968.903 1142.56 970.814C1141.43 971.964 1140.43 973.19 1139.4 974.451C1139.1 974.823 1138.8 975.199 1138.48 975.576C1137.13 977.208 1135.68 978.847 1133.89 980.239C1133.44 980.601 1132.93 980.972 1132.44 981.319C1132.15 981.527 1131.87 981.726 1131.63 981.909C1130.92 982.447 1130.34 982.966 1129.93 983.571Z"></path>
                    </g>
                    <g style={{visibility: (!tooth32Diagnozis.culttab && !tooth32Diagnozis.abutment && !tooth32Diagnozis.implant && !tooth32Diagnozis.apex && !tooth32Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{opacity: teethDiagnozis.tooth32.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth32Diagnozis.culttab && !tooth32Diagnozis.abutment && !tooth32Diagnozis.implant && !tooth32Diagnozis.shaper && !tooth32Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС C*/}
                        <g id="s_header_14_5" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth32.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth32.seal_right ? `seal-fill ${teethDiagnozis.tooth32.seal_right_color}` : ''}
                                `} 
                        ...
                        {/*КАРИЕС RIGHT*/}
                        <g id="s_header_32_4" className="caries-filling" 
                            onClick={() => {
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth32.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth32.seal_bottom ? `seal-fill ${teethDiagnozis.tooth32.seal_bottom_color}` : ''}
                                `}  
                        ...
                        >
                            ...
                            <path className={`
                                    ...
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth32.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth32.seal_left ? `seal-fill ${teethDiagnozis.tooth32.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            ...
                            <path className={`
                                    ...
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth32.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth32.seal_center ? `seal-fill ${teethDiagnozis.tooth32.seal_center_color}` : ''}
                                `} 
                        ...
                        <g className="with up">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth32Diagnozis.seal_bottom && !tooth32Diagnozis.seal_center) ||
                                        (!tooth32Diagnozis.seal_bottom && tooth32Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                ...
                <g id="T_32" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="dentin">
                        ...
                        <g id="dentin_n_32" style={{visibility: !tooth32Diagnozis.implant && !tooth32Diagnozis.abutment && !tooth32Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path id="dentin_n_x5F_32_1_" className={`st10 change-color ${tooth32Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage32 />
                        {/* <g className="level hEmpty hImplant periodontitis"  dataposition="32"  style={{visibility: 'inherit', opacity:0}}>
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth32Diagnozis.pin ? 1 : 0
                    }}>

                        <path className="st56 hIntact" d="M1172.59 1211.6C1170.19 1217 1167.09 1222 1162.09 1225.2C1160.29 1226.3 1158.39 1227.2 1156.49 1227.7C1156.19 1227.8 1155.89 1227.9 1155.59 1227.9C1151.99 1228.8 1148.09 1228.6 1144.49 1227.5C1144.39 1227.5 1144.29 1227.4 1144.19 1227.4C1142.79 1226.9 1141.39 1226.3 1140.09 1225.6C1131.69 1220.7 1127.69 1211.1 1124.79 1201.7C1124.39 1200.3 1123.99 1198.9 1123.59 1197.6C1123.39 1194.5 1123.29 1191.4 1123.09 1188.3C1122.89 1183.1 1122.79 1177.9 1122.79 1172.7C1122.79 1165.2 1123.09 1157.8 1123.79 1150.3L1125.19 1147.8L1126.89 1146.8L1164.79 1146.9L1166.39 1148.3L1167.29 1149.8C1169.09 1158.4 1170.49 1167.1 1171.39 1175.8C1171.89 1180.8 1172.29 1185.9 1172.49 1191C1172.79 1197.8 1172.79 1204.7 1172.59 1211.6Z" style={{visibility: 'hidden'}}></path>
                        <path className="st57" style={{fill: tooth32Diagnozis.pin ? '#dbd9d3' : 'none'}}
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth32Diagnozis.abutment || tooth32Diagnozis.implant || tooth32Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="1170.3" y1="1246.5" x2="1131.2" y2="1254.6" />
                        <line className="st19" x1="1172.3" y1="1269.5" x2="1133.2" y2="1277.6" />
                        <line className="st19" x1="1174.3" y1="1293.5" x2="1135.2" y2="1301.6" />
                        <line className="st19" x1="1175.4" y1="1317.1" x2="1136.1" y2="1324" />
                        <line className="st19" x1="1177.4" y1="1340.1" x2="1138.1" y2="1347" />
                    </g>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth32Diagnozis.culttab && !tooth32Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling" style={{visibility: (!tooth32Diagnozis.culttab && !tooth32Diagnozis.abutment && !tooth32Diagnozis.implant && !tooth32Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС R*/}
