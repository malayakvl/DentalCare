...
export default function Bone35({
  className = '',
    ...
    return (
        <g id="bone_35" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                <path className="st0" d="M1370.7,1206.3c6.3,40.9,14.5,83.3,24.5,123.3c10.6,42.2,25.3,91.9,40.2,133.4
                            ...
                            C1377.5,1207.8,1374.2,1206.6,1370.7,1206.3z" style={{strokeWidth: 2}}/>
                <path className="st43" d="M1468.3,1202.1c-0.4,0-0.9,0-1.3,0c-2.9,0.2-5.4,1.8-7.8,3.4c-10.2,6.7-21.3,12.8-34,13.9
                            c-15.6,1.4-30.2-4.9-44.5-10.3c-3.3-1.2-6.6-2.5-10-2.7" style={{strokeWidth: 2}}/>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M1472.5,1227.6c-0.4,0-0.8,0-1.2,0.1c-7.9,1.7-22.7,17.3-51.8,17.2
                        c-30.3-0.1-38.6-12.6-44.5-12.5" style={{strokeWidth: 2}}/>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                <path className="st0" d="M1385.3,1286.4c3.1,14.6,6.4,29.1,10,43.2c10.6,42.2,25.3,91.9,40.2,133.4
                ...
                <path className="st43" d="M1483.7,1280.9c-0.1,0-0.1,0-0.2,0c-8.1,1.5-21.6,18.4-50.7,18.4
                        c-29.8-0.1-41.3-12.4-47.5-12.9" style={{strokeWidth: 2}}/>
            </g>
        </g>
    )
}
