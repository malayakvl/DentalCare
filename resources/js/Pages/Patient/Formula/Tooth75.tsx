...
export default function Tooth75() {
    ...
    return (
        <>
            ...
            <g id="TH-73" className={`f-tooth-init-milk ${(teethDiagnozis.tooth75.show && !teethDiagnozis.tooth75.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (teethType === 'child') {
                ...
                onClick={() => {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            ...
                            teethDiagnozis.tooth75.fissure = !teethDiagnozis.tooth75.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth75.caries = !teethDiagnozis.tooth75.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth75.cervical_caries = !teethDiagnozis.tooth75.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth75.wedge_shaped_defect = !teethDiagnozis.tooth75.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth75.tartar = !teethDiagnozis.tooth75.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth75.pulpit = !teethDiagnozis.tooth75.pulpit;
                            teethDiagnozis.tooth75.channel_class = teethDiagnozis.tooth75.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth75.channel_not_sealed = !teethDiagnozis.tooth75.channel_not_sealed;
                            teethDiagnozis.tooth75.channel_class = teethDiagnozis.tooth75.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth75.channel_top_sealed = !teethDiagnozis.tooth75.channel_top_sealed;
                            teethDiagnozis.tooth75.channel_class = teethDiagnozis.tooth75.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth75.channel_part_sealed = !teethDiagnozis.tooth75.channel_part_sealed;
                            teethDiagnozis.tooth75.channel_class = teethDiagnozis.tooth75.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth75.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth75.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth75.periodontit = true;
                            } else {
                                teethDiagnozis.tooth75.periodontit = !teethDiagnozis.tooth75.periodontit;
                            }
                            teethDiagnozis.tooth75.channel_class = teethDiagnozis.tooth75.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth75.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal') {
                            teethDiagnozis.tooth75.seal = !teethDiagnozis.tooth75.seal;
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth75.seal_cervical && teethDiagnozis.tooth75.seal_cervical_color === "") {
                                teethDiagnozis.tooth75.seal_cervical = true;
                                teethDiagnozis.tooth75.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth75.seal_cervical && teethDiagnozis.tooth75.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth75.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth75.seal_cervical = false;
                                teethDiagnozis.tooth75.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth75.vinir && teethDiagnozis.tooth75.vinir_color === "") {
                                teethDiagnozis.tooth75.vinir = true;
                                teethDiagnozis.tooth75.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth75.vinir && teethDiagnozis.tooth75.vinir_color != vinirColor) {
                                teethDiagnozis.tooth75.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth75.vinir = false;
                                teethDiagnozis.tooth75.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth75.temporary_crown = !teethDiagnozis.tooth75.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth75.ceramic_crown && teethDiagnozis.tooth75.ceramic_crown_color === "") {
                                teethDiagnozis.tooth75.ceramic_crown = true;
                                teethDiagnozis.tooth75.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth75.ceramic_crown && teethDiagnozis.tooth75.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth75.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth75.ceramic_crown = false;
                                teethDiagnozis.tooth75.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth75.mceramic_crown && teethDiagnozis.tooth75.mceramic_crown_color === "") {
                                teethDiagnozis.tooth75.mceramic_crown = true;
                                teethDiagnozis.tooth75.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth75.mceramic_crown && teethDiagnozis.tooth75.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth75.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth75.mceramic_crown = false;
                                teethDiagnozis.tooth75.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth75.metalic_crown && teethDiagnozis.tooth75.metalic_crown_color === "") {
                                teethDiagnozis.tooth75.metalic_crown = true;
                                teethDiagnozis.tooth75.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth75.metalic_crown && teethDiagnozis.tooth75.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth75.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth75.metalic_crown = false;
                                teethDiagnozis.tooth75.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth75.zirconia_crown && teethDiagnozis.tooth75.zirconia_crown_color === "") {
                                teethDiagnozis.tooth75.zirconia_crown = true;
                                teethDiagnozis.tooth75.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth75.zirconia_crown && teethDiagnozis.tooth75.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth75.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth75.zirconia_crown = false;
                                teethDiagnozis.tooth75.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth75.pin = !teethDiagnozis.tooth75.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth75.culttab = !teethDiagnozis.tooth75.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth75.abutment = !teethDiagnozis.tooth75.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth75.shaper = !teethDiagnozis.tooth75.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth75.implant = !teethDiagnozis.tooth75.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth75.apex = !teethDiagnozis.tooth75.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth75.absent = !teethDiagnozis.tooth75.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth75.cervical_caries = !teethDiagnozis.tooth75.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth75.caries = !teethDiagnozis.tooth75.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth75.parodontit) {
                                if (teethDiagnozis.tooth75.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth75.parodontit = false;
                                    teethDiagnozis.tooth75.active = false;
                                } else {
                                    teethDiagnozis.tooth75.parodontit = true;
                                    teethDiagnozis.tooth75.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth75.parodontit = true;
                                teethDiagnozis.tooth75.parodontit_stage = subDiagnozis;
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, -218, 0)'}}>
                    <g className="dentin">
                        ...
                        <g className="hIntact hImplant hEmpty" style={{visibility: 'hidden'}}>
                            <path className="st6" d="M1762.3 962.7C1762.9 966.7 1763.8 970.7 1764 974.8C1764.4 982.4 1762.5 990.1 1758.5 997.1C1755.6 1002.1 1751.7 1006.9 1746.2 1010.4C1742.3 1012.9 1737.9 1014.6 1733.3 1016.3C1726.8 1018.6 1720.1 1020.7 1713 1021.7C1705.8 1022.7 1698.5 1022.4 1691.3 1022.1C1684.9 1021.8 1678.5 1021.5 1672.2 1020.6C1667.5 1019.9 1662.8 1018.8 1658.5 1017.2C1654.5 1015.7 1650.9 1013.8 1647.4 1011.8C1642.4 1008.8 1637.9 1005.4 1634.6 1001.2C1631.1 996.9 1629.2 991.9 1627.8 986.9C1625.3 978.5 1623.9 969.8 1624.9 961.1C1625.6 955 1627.4 948.9 1630.9 943.3C1634.7 937.3 1640.3 932.1 1647.7 928.5C1655.3 924.8 1664.3 923.1 1673.3 922.5C1677.9 922.2 1682.6 922.1 1687 923C1690.4 923.7 1693.5 925 1697.1 925.1C1699.7 925.1 1702.2 924.4 1704.7 923.8C1709.6 922.6 1714.7 921.9 1719.8 921.6C1724.8 921.3 1729.9 921.2 1734.8 921.9C1740.5 922.7 1745.9 924.5 1750.4 927.3C1753.9 929.6 1756.6 932.3 1758.2 935.6C1759.7 938.6 1760.1 941.9 1760.5 945.1C1761 950.8 1761.3 956.7 1762.3 962.7Z" 
                            />
                            <path className="st53" d="M1664.16 966.325C1665.15 982.262 1659.83 991 1694.58 991C1729.34 991 1726.71 972 1726.71 961.576C1726.71 954.226 1723.46 949 1697.87 949C1672.27 949 1663.18 950.388 1664.16 966.325Z" 
                            />
                        </g>
                    </g>
                    <g className="pulp">
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: "inherit"}}>
                        <g id="s_header_75_5" className="caries-filling" dataposition="75_5">
                            ...
                            />
                            <path className="st8 target" d="M1735.6,987.9c-2.3,3.3-5.3,6.1-9,8.6c-12,8.2-30.7,11.1-43,9.2c-8.1-1.3-16.8-8.7-22.9-17
                                c-3.2-4.3-5.6-8.8-6.9-12.8c-2.9-8.8-2.1-19.7,3.8-27.3c2-2.6,4.5-4.8,7.7-6.4c8.9-4.5,18.6-4.5,28.3-4.1c3.5,0.1,7,0.4,10.4,0.5
                                c11.1,0.5,22.7,3.6,29.6,12c1.9,2.4,3.5,5.2,4.6,8.5C1742.1,971,1740.8,980.4,1735.6,987.9z" 
                            />
                        </g>
                        <g id="s_header_75_4" className="caries-filling" dataposition="75_4">
                            ...
                            />
                            <path className="st8 target" d="M1764.1,1006.8c-0.5,1.3-1.1,2.5-1.8,3.8c-8.2-12.9-19.7-19.6-26.7-22.7c5.2-7.4,6.4-16.9,2.5-28.9
                                c-1.1-3.3-2.6-6.1-4.6-8.5c3-6.6,6.9-13.5,10.6-19c4.2-6.4,11-15.5,14.5-20.1c1.8,2.2,3.2,4.7,4.2,7.4c1.7,4.3,2.2,9,2.6,13.5
                                c0.8,8.5,1.3,16.9,2.3,25.4c0.7,5.8,1.8,11.5,2,17.3C1770.4,985.9,1768.4,996.7,1764.1,1006.8z" 
                            />
                        </g>
                        <g id="s_header_75_3" className="caries-filling" dataposition="75_3">
                            ...
                            />
                            <path className="st8 target" d="M1758.6,911.4c-3.4,4.5-10.2,13.6-14.5,20.1c-3.7,5.6-7.6,12.4-10.6,19c-6.9-8.4-18.5-11.5-29.6-12
                                c-3.4-0.1-6.9-0.3-10.4-0.5c-9.7-0.4-19.3-0.3-28.3,4.1c-3.2,1.6-5.8,3.8-7.7,6.4c-4.4-2.2-11.2-5.8-18.7-10.7
                                c-6.3-4.1-10.8-8.4-13.9-11.8c4-7.5,9.7-14.1,17-18.7c8.3-5.2,18.1-7.5,27.9-8.3c5-0.4,10.1-0.5,15,0.9c3.7,1.1,7.2,3,11,3.1
                                c2.9,0,5.6-1,8.3-1.8c5.4-1.6,10.9-2.5,16.5-3c5.5-0.4,11-0.4,16.4,0.6c6.3,1.2,12.2,3.8,17.1,7.9
                                C1755.8,908.3,1757.3,909.8,1758.6,911.4z"
                        ...
                        <g id="s_header_75_2" className="caries-filling" dataposition="75_2">
                            ...
                            />
                            <path className="st8 target" d="M1660.7,988.7c-2.3,2.4-6.3,6.9-10.9,14.3c-4.3,6.9-8,15-10.3,20.6c-4.2-3.7-8-7.8-10.9-12.5
                                c-3.8-6.2-6-13.3-7.7-20.4c-2.8-12.1-4.4-24.5-3.5-36.8c0.7-8.8,2.6-17.4,6.4-25.4c0.4-0.8,0.8-1.5,1.2-2.3
                                c3,3.4,7.6,7.7,13.9,11.8c7.5,4.9,14.2,8.5,18.7,10.7c-5.8,7.6-6.6,18.5-3.8,27.3C1655.1,979.9,1657.6,984.4,1660.7,988.7z" 
                            />
                        </g>
                        <g id="s_header_75_1" className="caries-filling" dataposition="75_1">
                            ...
                            ></path>
                            <path className="st8 target" d="M1762.3,1010.5c-2.9,5.7-6.6,11-11.6,15c-4.2,3.5-9.1,6-14,8.2c-7.1,3.3-14.4,6.2-22.1,7.4
                                c-7.8,1.3-15.8,0.8-23.8,0.3c-7-0.5-14-0.9-20.9-2.4c-5.2-1.1-10.3-2.7-15-5c-4.3-2.1-8.4-4.9-12.2-7.9c-1.1-0.9-2.2-1.8-3.3-2.7
                                c2.3-5.6,6-13.7,10.3-20.6c4.6-7.4,8.6-11.9,10.9-14.3c6.1,8.3,14.8,15.8,22.9,17c12.3,1.9,31-1,43-9.2c3.7-2.5,6.7-5.4,9-8.6
                                C1742.6,990.9,1754.1,997.6,1762.3,1010.5z" 
                            />
                        ...
                        <g className="with">
                            <path className="st54" areas="75_4 75_1" d="M1735.5 988C1740.67 989.333 1752.6 994.8 1759 1006" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_4 75_5" d="M1735.5 988C1744 979.5 1741.9 957.7 1733.5 950.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_4 75_3" d="M1733.5 950.5C1735 944.667 1741.4 929.6 1755 916" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_3 75_5" d="M1733.5 950.5C1721 936.001 1669.5 933.7 1657.5 948.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_2 75_3" d="M1657.5 948.5C1653 947 1641 941.3 1629 930.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_2 75_5" d="M1657.5 948.5C1650.5 956 1653.3 973.3 1660.5 988.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_2 75_1" d="M1660 989C1651.73 997.947 1647.06 1006.79 1642 1019" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_1 75_5" d="M1660.5 988.5C1676.5 1011 1722.7 1003.9 1735.5 987.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    ...
                    <g className="crown" style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M1769.8,975c-0.3-5.8-1.3-11.5-2-17.3c-1.1-8.5-1.6-16.9-2.3-25.4c-0.4-4.5-0.9-9.2-2.6-13.5
                            c-1-2.7-2.5-5.1-4.2-7.4c-1.3-1.6-2.8-3.1-4.4-4.5c-4.9-4.1-10.8-6.7-17.1-7.9c-5.4-1-10.9-1.1-16.4-0.6c-5.6,0.4-11.1,1.4-16.5,3
                            c-2.7,0.8-5.5,1.8-8.4,1.8c-3.8-0.1-7.3-2-11-3.1c-4.8-1.4-9.9-1.3-15-0.9c-9.8,0.8-19.6,3.1-27.9,8.3c-7.3,4.6-13,11.2-17,18.7
                            c-0.4,0.8-0.8,1.5-1.2,2.3c-3.8,7.9-5.7,16.6-6.4,25.4c-0.9,12.4,0.6,24.8,3.5,36.8c1.7,7.1,3.8,14.2,7.7,20.4
                            c2.9,4.7,6.7,8.8,10.9,12.5c1.1,0.9,2.2,1.8,3.3,2.7c3.8,3,7.8,5.7,12.2,7.9c4.8,2.3,9.8,3.9,15,5c6.9,1.4,13.9,1.9,20.9,2.3
                    ...
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: 'inherit'}} >
                        <path className="st3 fissure" d="M1742.7,946.3c-1.5,2.6-2.9,5.3-4.1,8.1l-0.2,0.4c-1,2.3-2,4.7-4.1,5.9
                            c-2.4,1.3-4.9,0.8-7.7,0.2c-0.5-0.1-1.1-0.2-1.6-0.3c-5.9-1.1-12.3-0.1-17.7,1c-5,1-10,2.4-14.8,4.2c-0.2-1.9-0.1-3.8,0-5.5
                            c0.1-0.9,0.2-1.9,0.3-2.8c0.3-2.2,0.5-4.4,0.5-6.6c0-2.7-0.5-5.5-0.9-8.1c-0.5-3.2-1.1-6.5-0.8-9.8c0.4-5,2.5-9.8,6.1-13.4
                            l-0.8-0.8c-3.7,3.8-6,8.8-6.4,14c-0.3,3.4,0.3,6.8,0.8,10c0.4,2.6,0.9,5.3,0.9,8c0,2.2-0.3,4.4-0.5,6.5c-0.1,0.9-0.2,1.9-0.3,2.8
                            c-0.2,1.8-0.3,3.9,0,6c0,0,0,0,0,0c-4,1.8-8.5,2-12.7,0.5c-1.8-0.6-3.6-1.6-5.4-2.7l-0.4-0.3c-1.7-1.2-3.5-2.4-5.8-1.9
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, -218, 17)'}}>
                    <g className="dentin">
                        ...
                        <g className="hImplant hEmpty" style={{visibility: 'inherit'}}>
                            <path className="st10" d="M1810,1264.3c-1.3,5.8-3.9,11.9-10,13.3c-4.8,1.1-9.5-1.3-13.2-4.5
                    ...
                    <g className="pin hEmpty hImplant"  style={{visibility: 'hidden', opacity: 0}}>
                        ...
                        />
                        <path className="st57" d="M1684.4 1109.3L1765.3 1211.1L1766.5 1212.6L1780.4 1230.1C1781.1 1231 1782.4 1231.2 1783.3 1230.6C1784.3 1230 1784.6 1228.7 1784 1227.7L1771.4 1205.5L1745.6 1160.4L1713.4 1104.1L1702 1111.2L1684.4 1109.3Z"
                        />
                    </g>
                    <g className="stump hEmpty hIntact hImplant"  style={{visibility: 'hidden', opacity: 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: 'hidden'}}>
                        <g className="caries-filling" dataposition="75_5">
                        ...
                        <g className="caries-filling" dataposition="75_4">
                        ...
                        <g className="caries-filling" dataposition="75_2">
                        ...
                        <g className="caries-filling" dataposition="75_1">
                        ...
                        <g className="with">
                            <path className="st54" areas="75_4 75_5" d="M1739.5 1108L1731.5 1071.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_1 75_4" d="M1739.5 1108C1742.5 1120 1742.9 1129.3 1770.5 1128.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_1 75_5" d="M1739.5 1108C1728.67 1118.5 1694.6 1137.4 1645 1129" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_1 75_2" d="M1645 1129C1646.5 1141.5 1653.9 1147.8 1637.5 1163" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                            <path className="st54" areas="75_2 75_5" d="M1645 1129C1642.5 1119.5 1640.1 1098.1 1640.5 1086.5" style={{stroke: 'rgb(81, 79, 72)', strokeWidth: 0}}></path>
                        </g>
                    </g>
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'hidden'}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
