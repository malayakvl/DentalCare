        ...
        <>
            ...
            >
                ...
                <g id="T_27_up" className="top-view" style={{visibility: tooth27Diagnozis.absent ? 'hidden' : 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling" style={{visibility: (!tooth27Diagnozis.culttab && !tooth27Diagnozis.abutment && !tooth27Diagnozis.implant && !tooth27Diagnozis.shaper && !tooth27Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС ЦЕНТР*/}
                        <g
