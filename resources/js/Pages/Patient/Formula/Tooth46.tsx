...
export default function Tooth46() {
    ...
    const setColordedPart = (diagnozis, toothPart = '') => {
        if (diagnozis === 'caries') {
            if (toothPart === 'bottom') {
                teethDiagnozis.tooth46.caries_bottom = !teethDiagnozis.tooth46.caries_bottom;
            }
            if (toothPart === 'center') {
                teethDiagnozis.tooth46.caries_center = !teethDiagnozis.tooth46.caries_center;
            }
            if (toothPart === 'left') {
                teethDiagnozis.tooth46.caries_left = !teethDiagnozis.tooth46.caries_left;
            }
            if (toothPart === 'right') {
                teethDiagnozis.tooth46.caries_right = !teethDiagnozis.tooth46.caries_right;
            }
            if (toothPart === 'top') {
                teethDiagnozis.tooth46.caries_top = !teethDiagnozis.tooth46.caries_top;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'seal') {
            if (toothPart === 'center') {
                if (teethDiagnozis.tooth46.seal_center_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth46.seal_center_color = sealColor1;
                    teethDiagnozis.tooth46.seal_center = true;
                } else if (teethDiagnozis.tooth46.seal_center_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth46.seal_center_color = sealColor2;
                    teethDiagnozis.tooth46.seal_center = true;
                } else if (teethDiagnozis.tooth46.seal_center_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth46.seal_center_color = sealColor3;
                    teethDiagnozis.tooth46.seal_center = true;
                } else {
                    teethDiagnozis.tooth46.seal_center = !teethDiagnozis.tooth46.seal_center;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'bottom') {
                if (teethDiagnozis.tooth46.seal_bottom_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth46.seal_bottom_color = sealColor1;
                    teethDiagnozis.tooth46.seal_bottom = true;
                } else if (teethDiagnozis.tooth46.seal_bottom_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth46.seal_bottom_color = sealColor2;
                    teethDiagnozis.tooth46.seal_bottom = true;
                } else if (teethDiagnozis.tooth46.seal_bottom_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth46.seal_bottom_color = sealColor3;
                    teethDiagnozis.tooth46.seal_bottom = true;
                } else {
                    teethDiagnozis.tooth46.seal_bottom = !teethDiagnozis.tooth46.seal_bottom;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'left') {
                if (teethDiagnozis.tooth46.seal_left_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth46.seal_left_color = sealColor1;
                    teethDiagnozis.tooth46.seal_left = true;
                } else if (teethDiagnozis.tooth46.seal_left_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth46.seal_left_color = sealColor2;
                    teethDiagnozis.tooth46.seal_left = true;
                } else if (teethDiagnozis.tooth46.seal_left_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth46.seal_left_color = sealColor3;
                    teethDiagnozis.tooth46.seal_left = true;
                } else {
                    teethDiagnozis.tooth46.seal_left = !teethDiagnozis.tooth46.seal_left;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'right') {
                if (teethDiagnozis.tooth46.seal_right_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth46.seal_right_color = sealColor1;
                    teethDiagnozis.tooth46.seal_right = true;
                } else if (teethDiagnozis.tooth46.seal_right_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth46.seal_right_color = sealColor2;
                    teethDiagnozis.tooth46.seal_right = true;
                } else if (teethDiagnozis.tooth46.seal_right_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth46.seal_right_color = sealColor3;
                    teethDiagnozis.tooth46.seal_right = true;
                } else {
                    teethDiagnozis.tooth46.seal_right = !teethDiagnozis.tooth46.seal_right;
                }
                dispatch(setToothDiagnoze(teethDiagnozis));
            }
            if (toothPart === 'top') {
                if (teethDiagnozis.tooth46.seal_top_color != sealColor1 && sealColor1 != '') {
                    teethDiagnozis.tooth46.seal_top_color = sealColor1;
                    teethDiagnozis.tooth46.seal_top = true;
                } else if (teethDiagnozis.tooth46.seal_top_color != sealColor2 && sealColor2 != '') {
                    teethDiagnozis.tooth46.seal_top_color = sealColor2;
                    teethDiagnozis.tooth46.seal_top = true;
                } else if (teethDiagnozis.tooth46.seal_top_color != sealColor3 && sealColor3 != '') {
                    teethDiagnozis.tooth46.seal_top_color = sealColor3;
                    teethDiagnozis.tooth46.seal_top = true;
                } else {
                    teethDiagnozis.tooth46.seal_top = !teethDiagnozis.tooth46.seal_top;
                }
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
        if (diagnozis === 'wedge_shaped_defect') {
            if (teethDiagnozis.tooth46.wedge_shaped_defect_color != wsDefectColor && wsDefectColor != '') {
                teethDiagnozis.tooth46.wedge_shaped_defect_color = wsDefectColor;
            } else {
                teethDiagnozis.tooth46.wedge_shaped_defect_color = !teethDiagnozis.tooth46.wedge_shaped_defect_color;
            }
            dispatch(setToothDiagnoze(teethDiagnozis));
        }
    }
    ...
    return (
        <>
            <g id="46" className="df-tooth-text" style={{opacity: 1}}>
            ...
            <g id="TH-46" className={`f-tooth-init ${(teethDiagnozis.tooth46.show && !teethDiagnozis.tooth46.absent)  ? 'f-tooth-active' : ''} ${teethType}`}
                onMouseOver={() => {
                    if (!teethDiagnozis.tooth46.show) {
                        if (teethType === 'adult') {
                            document.getElementById('TH-46').style.visibility = 'inherit'
                        }
                    } 
                    if (teethDiagnozis.tooth46.show && !teethDiagnozis.tooth46.absent && teethType === 'child') {
                        document.getElementById('TH-46').style.visibility = 'hidden'
                    }
                ...
                onClick={() => {
                    ...
                    if (toothActive.tooth46.active) {
                        dispatch(setNewToothActive({tooth46: {active: true}}))
                    } else {
                    ...
                    if (diagnozis) {
                        if (diagnozis === 'change_color')
                            teethDiagnozis.tooth46.change_color = !teethDiagnozis.tooth46.change_color;
                        else if (diagnozis === 'fissure')
                            teethDiagnozis.tooth46.fissure = !teethDiagnozis.tooth46.fissure;
                        else if (diagnozis === 'caries')
                            teethDiagnozis.tooth46.caries = !teethDiagnozis.tooth46.caries;
                        else if (diagnozis === 'cervical_caries')
                            teethDiagnozis.tooth46.cervical_caries = !teethDiagnozis.tooth46.cervical_caries;
                        else if (diagnozis === 'wedge_shaped_defect')
                            teethDiagnozis.tooth46.wedge_shaped_defect = !teethDiagnozis.tooth46.wedge_shaped_defect;
                        else if (diagnozis === 'tartar')
                            teethDiagnozis.tooth46.tartar = !teethDiagnozis.tooth46.tartar;
                        else if (diagnozis === 'pulpit') {
                            teethDiagnozis.tooth46.pulpit = !teethDiagnozis.tooth46.pulpit;
                            teethDiagnozis.tooth46.channel_class = teethDiagnozis.tooth46.pulpit ? 'pulpit' : ''
                        } else if (diagnozis === 'channel_not_sealed') {
                            teethDiagnozis.tooth46.channel_not_sealed = !teethDiagnozis.tooth46.channel_not_sealed;
                            teethDiagnozis.tooth46.channel_class = teethDiagnozis.tooth46.channel_not_sealed ? 'channel-not-sealed' : '';
                        } else if (diagnozis === 'channel_top_sealed') {
                            teethDiagnozis.tooth46.channel_top_sealed = !teethDiagnozis.tooth46.channel_top_sealed;
                            teethDiagnozis.tooth46.channel_class = teethDiagnozis.tooth46.channel_top_sealed ? 'channel-top-sealed' : '';
                        } else if (diagnozis === 'channel_part_sealed') {
                            teethDiagnozis.tooth46.channel_part_sealed = !teethDiagnozis.tooth46.channel_part_sealed;
                            teethDiagnozis.tooth46.channel_class = teethDiagnozis.tooth46.channel_part_sealed ? 'channel-part-sealed' : '';
                        } else if (diagnozis === 'periodontit') {
                            if (teethDiagnozis.tooth46.periodontit_stage !== subDiagnozis) {
                                teethDiagnozis.tooth46.periodontit_stage = subDiagnozis
                                teethDiagnozis.tooth46.periodontit = true;
                            } else {
                                teethDiagnozis.tooth46.periodontit = !teethDiagnozis.tooth46.periodontit;
                            }
                            teethDiagnozis.tooth46.channel_class = teethDiagnozis.tooth46.periodontit ? 'periodontit' : '';
                            if (!teethDiagnozis.tooth46.periodontit) dispatch(setSubDiagnosis(''));
                        } else if (diagnozis === 'seal_cervical') {
                            if (!teethDiagnozis.tooth46.seal_cervical && teethDiagnozis.tooth46.seal_cervical_color === "") {
                                teethDiagnozis.tooth46.seal_cervical = true;
                                teethDiagnozis.tooth46.seal_cervical_color = wsDefectColor;
                            } else if (teethDiagnozis.tooth46.seal_cervical && teethDiagnozis.tooth46.seal_cervical_color != wsDefectColor) {
                                teethDiagnozis.tooth46.seal_cervical_color = wsDefectColor;
                            } else {
                                teethDiagnozis.tooth46.seal_cervical = false;
                                teethDiagnozis.tooth46.seal_cervical_color = "";
                            }
                        } else if (diagnozis === 'vinir') {
                            if (!teethDiagnozis.tooth46.vinir && teethDiagnozis.tooth46.vinir_color === "") {
                                teethDiagnozis.tooth46.vinir = true;
                                teethDiagnozis.tooth46.vinir_color = vinirColor;
                            } else if (teethDiagnozis.tooth46.vinir && teethDiagnozis.tooth46.vinir_color != vinirColor) {
                                teethDiagnozis.tooth46.vinir_color = vinirColor;
                            } else {
                                teethDiagnozis.tooth46.vinir = false;
                                teethDiagnozis.tooth46.vinir_color = "";
                            }
                        } else if (diagnozis === 'temporary_crown') {
                            teethDiagnozis.tooth46.temporary_crown = !teethDiagnozis.tooth46.temporary_crown;
                        } else if (diagnozis === 'ceramic_crown') {
                            if (!teethDiagnozis.tooth46.ceramic_crown && teethDiagnozis.tooth46.ceramic_crown_color === "") {
                                teethDiagnozis.tooth46.ceramic_crown = true;
                                teethDiagnozis.tooth46.ceramic_crown_color = ceramicCrownColor;
                            } else if (teethDiagnozis.tooth46.ceramic_crown && teethDiagnozis.tooth46.ceramic_crown_color != ceramicCrownColor) {
                                teethDiagnozis.tooth46.ceramic_crown_color = ceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth46.ceramic_crown = false;
                                teethDiagnozis.tooth46.ceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'mceramic_crown') {
                            if (!teethDiagnozis.tooth46.mceramic_crown && teethDiagnozis.tooth46.mceramic_crown_color === "") {
                                teethDiagnozis.tooth46.mceramic_crown = true;
                                teethDiagnozis.tooth46.mceramic_crown_color = mceramicCrownColor;
                            } else if (teethDiagnozis.tooth46.mceramic_crown && teethDiagnozis.tooth46.mceramic_crown_color != mceramicCrownColor) {
                                teethDiagnozis.tooth46.mceramic_crown_color = mceramicCrownColor;
                            } else {
                                teethDiagnozis.tooth46.mceramic_crown = false;
                                teethDiagnozis.tooth46.mceramic_crown_color = "";
                            }
                        } else if (diagnozis === 'metalic_crown') {
                            if (!teethDiagnozis.tooth46.metalic_crown && teethDiagnozis.tooth46.metalic_crown_color === "") {
                                teethDiagnozis.tooth46.metalic_crown = true;
                                teethDiagnozis.tooth46.metalic_crown_color = metalicCrownColor;
                            } else if (teethDiagnozis.tooth46.metalic_crown && teethDiagnozis.tooth46.metalic_crown_color != metalicCrownColor) {
                                teethDiagnozis.tooth46.mceramic_crown_color = metalicCrownColor;
                            } else {
                                teethDiagnozis.tooth46.metalic_crown = false;
                                teethDiagnozis.tooth46.metalic_crown_color = "";
                            }
                        } else if (diagnozis === 'zirconia_crown') {
                            if (!teethDiagnozis.tooth46.zirconia_crown && teethDiagnozis.tooth46.zirconia_crown_color === "") {
                                teethDiagnozis.tooth46.zirconia_crown = true;
                                teethDiagnozis.tooth46.zirconia_crown_color = zirconiaCrownColor;
                            } else if (teethDiagnozis.tooth46.zirconia_crown && teethDiagnozis.tooth46.zirconia_crown_color != zirconiaCrownColor) {
                                teethDiagnozis.tooth46.zirconia_crown_color = zirconiaCrownColor;
                            } else {
                                teethDiagnozis.tooth46.zirconia_crown = false;
                                teethDiagnozis.tooth46.zirconia_crown_color = "";
                            }
                        } else if (diagnozis === 'pin') {
                            teethDiagnozis.tooth46.pin = !teethDiagnozis.tooth46.pin;
                        } else if (diagnozis === 'culttab') {
                            teethDiagnozis.tooth46.culttab = !teethDiagnozis.tooth46.culttab;
                        } else if (diagnozis === 'abutment') {
                            teethDiagnozis.tooth46.abutment = !teethDiagnozis.tooth46.abutment;
                        } else if (diagnozis === 'shaper') {
                            teethDiagnozis.tooth46.shaper = !teethDiagnozis.tooth46.shaper;
                        } else if (diagnozis === 'implant') {
                            teethDiagnozis.tooth46.implant = !teethDiagnozis.tooth46.implant;
                        } else if (diagnozis === 'apex') {
                            teethDiagnozis.tooth46.apex = !teethDiagnozis.tooth46.apex;
                        } else if (diagnozis === 'absent') {
                            teethDiagnozis.tooth46.absent = !teethDiagnozis.tooth46.absent;
                        } else if (diagnozis === 'cervical_caries') {
                            teethDiagnozis.tooth46.cervical_caries = !teethDiagnozis.tooth46.cervical_caries;
                        } else if (diagnozis === 'caries') {
                            teethDiagnozis.tooth46.caries = !teethDiagnozis.tooth46.caries;
                        } else if (diagnozis === 'parodontit') {
                            if (teethDiagnozis.tooth46.parodontit) {
                                if (teethDiagnozis.tooth46.parodontit_stage === subDiagnozis) {
                                    teethDiagnozis.tooth46.parodontit = false;
                                    teethDiagnozis.tooth46.active = false;
                                } else {
                                    teethDiagnozis.tooth46.parodontit = true;
                                    teethDiagnozis.tooth46.parodontit_stage = subDiagnozis
                                }
                            } else {
                                teethDiagnozis.tooth46.parodontit = true;
                                teethDiagnozis.tooth46.parodontit_stage = subDiagnozis;
                                teethDiagnozis.tooth46.active = true;
                            }
                        }
                        dispatch(setToothDiagnoze(teethDiagnozis))
                    }
            ...
            >
                ...
                <g id="T_46_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    {/* CHANGE COLOR */}
                    <g className="dentin">
                        <g style={{visibility: !tooth46Diagnozis.culttab && !tooth46Diagnozis.implant && !tooth46Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st9 change-color ${tooth46Diagnozis.change_color ? 'diagnoze' : ''}`} 
                        ...
                        <g className={`st9 change-color ${tooth46Diagnozis.change_color ? 'diagnoze' : ''}`} style={{visibility: 'hidden'}}>
                            <path className="st6" d="M489.2 969.7C486.7 976 483.9 982.5 485.1 989.1C486 994 489.2 998.5 493.2 1002.4C496.5 1005.6 500.5 1008.5 505.4 1009.8C510.5 1011.2 516.3 1010.7 521.3 1012.4C527.2 1014.3 531 1018.6 536 1021.8C543.4 1026.4 552.9 1028.2 562.4 1027.9C567.9 1027.7 573.5 1026.7 577.9 1024.2C580.1 1022.9 582 1021.3 584.4 1020.3C590.4 1017.9 597.3 1019.6 604 1019.4C610 1019.2 615.5 1017.5 619.9 1014.3C623.5 1011.6 625.9 1008.2 627.8 1004.6C629.6 1001.2 631 997.7 631.6 994.1C632.8 986.9 630.8 979.6 629 972.4C627.3 965.6 625.6 958.7 622.8 952.1C619.5 944.3 614.4 936.8 605.3 932.6C596.6 928.6 586.1 928.6 576.1 930.2C572 930.8 567.9 931.7 563.7 931.5C559.8 931.3 556.2 930.2 552.4 929.5C547.3 928.6 542.1 928.5 537 928.8C531.9 929.1 526.8 929.6 521.9 930.8C516.4 932.1 511.2 934.1 507 937.2C501.3 941.4 498.2 947.2 495.8 952.7C493.3 958.2 491.4 963.9 489.2 969.7Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                            <path className="st53" d="M589.928 972.325C588.939 988.262 594.262 997 559.508 997C521.068 997 527.387 983.851 527.387 967.576C527.387 960.226 530.635 955 556.227 955C581.819 955 590.917 956.388 589.928 972.325Z" style={{fill: 'rgb(248, 223, 168)'}}></path>
                        </g>
                    </g>
                    ...
                    <g className="header caries-filling" style={{visibility: (!tooth46Diagnozis.culttab && !tooth46Diagnozis.abutment && !tooth46Diagnozis.implant && !tooth46Diagnozis.shaper && !tooth46Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        >
                            <path className="st7" d="M602.5,962.8c2.7,12,3.6,26.6,0,33.9c1.6,3.2,4.6,8.1,10.1,14.9c5.3,6.6,10.9,12.1,15.5,16
                        ...
                        >
                            <path className="st7" d="M496.7,932.6c5.4,4.5,15.1,13.4,20.4,22.8c1.9-2.8,4.2-5.1,6.9-6.4c9-4.2,25-6.7,36-7.1c0,0,11.6-0.8,20,0
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth46.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth46.seal_top ? `seal-fill ${teethDiagnozis.tooth46.seal_top_color}` : ''}
                                `} 
                        ...
                        >
                            <path className="st7" d="M479.1,996.5c1,6.9,4.3,13.1,8.6,18.5c1,1.2,2,2.4,3.1,3.5c3.3-1.8,8.2-4.9,13.9-9.9
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth46.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth46.seal_left ? `seal-fill ${teethDiagnozis.tooth46.seal_left_color}` : ''}
                                `} 
                        ...
                        >
                            <path className="st7" d="M490.8,1018.5c2.9,3,6.2,5.4,10.1,6.7c5.6,1.9,11.8,1.2,17.3,3.4c6.4,2.6,10.5,8.6,15.9,12.9
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth46.caries_bottom ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth46.seal_bottom ? `seal-fill ${teethDiagnozis.tooth46.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g
                            ...
                            className="caries-filling"
                        >
                            <path className="st7" d="M514.5,998.4c1.4,2.7,3.2,5.3,5.5,7.8c8.8,9.7,30.1,16.9,49,13.5c18.9-3.4,29.9-15.8,33.5-23.1c0,0,0,0,0,0
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth46.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth46.seal_center ? `seal-fill ${teethDiagnozis.tooth46.seal_center_color}` : ''}
                                `} 
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_left && !tooth46Diagnozis.seal_bottom) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_left && !tooth46Diagnozis.seal_center) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_left && !tooth46Diagnozis.seal_top) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_center && !tooth46Diagnozis.seal_top) ||
                                        (!tooth46Diagnozis.seal_center && tooth46Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_right && !tooth46Diagnozis.seal_top) ||
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_center) ||
                                        (tooth46Diagnozis.seal_right && !tooth46Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_right && !tooth46Diagnozis.seal_bottom) ||
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (!tooth46Diagnozis.seal_center && tooth46Diagnozis.seal_bottom) ||
                                        (tooth46Diagnozis.seal_center && !tooth46Diagnozis.seal_bottom)
                                    ) ? 5 : 0
                                }} 
                    ...
                    >                        
                        <path className={
                            ...
                            c5.6,1.9,11.8,1.2,17.3,3.4c6.4,2.6,10.5,8.6,15.9,12.9c8,6.4,18.4,8.8,28.6,8.2c6-0.3,12.1-1.8,17-5.3c2.4-1.8,4.5-4,7.2-5.5
                            c6.5-3.5,14-1.1,21.3-1.4c6.5-0.3,12.6-2.7,17.4-7.3c0.9-0.8,1.7-1.7,2.5-2.7c2.7-3.3,4.6-7.1,6.3-11c2-4.8,3.5-9.7,4.2-14.8
                            C639.9,991.7,637.9,981.6,635.9,971.6z"></path>
                        <path className="st3 fissure" style={{visibility: tooth46Diagnozis.temporary_crown || tooth46Diagnozis.ceramic_crown || tooth46Diagnozis.mceramic_crown || tooth46Diagnozis.metalic_crown || tooth46Diagnozis.zirconia_crown || tooth46Diagnozis.culttab || tooth46Diagnozis.abutment || tooth46Diagnozis.implant ? 'hidden' : 'inherit'}}
                ...
                <g id="T_46" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth46Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        <path className="st57" d="M547 1128.2L484.2 1247.7L483.3 1249.4L474.9 1265.3C474.5 1266.9 475.3 1268.5 476.8 1269.1C478.3 1269.7 
                            479.9 1269.1 480.7 1267.8L573.2 1141.4L547 1128.2Z"
                            style={{fill: tooth46Diagnozis.pin ? '#dbd9d3' : 'none'}}
                        />
                    </g>
                    {/* CULT TAB */}
                    <g style={{visibility: tooth46Diagnozis.culttab ? 'inherit' : 'hidden', opacity: tooth46Diagnozis.culttab ? 1 : 0}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth46Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth46Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant" style={{visibility: tooth46Diagnozis.abutment || tooth46Diagnozis.implant || tooth46Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                        ...
                        />
                        <line className="st19" x1="507.7" y1="1217.4" x2="569.3" y2="1240.9" />
                        <line className="st19" x1="503.7" y1="1236.4" x2="565.3" y2="1259.9" />
                        <line className="st19" x1="499.7" y1="1255.4" x2="561.3" y2="1278.9" />
                    ...
                    <g className="wedge-shaped " style={{visibility: !tooth46Diagnozis.culttab && !tooth46Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth46Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`} 
                        ...
                        <path className={
                                `st60
                                    ${(tooth46Diagnozis?.wedge_shaped_defect) ? `shaped-defect-stroke` : ""}
                                    ${(tooth46Diagnozis?.seal_cervical) ? `seal-cervical-stroke` : ""}
                                    ${tooth46Diagnozis.seal_cervical_color}
                                `
                            }
                            d="M609.047 1181.97C600.42 1189.35 590.286 1194.53 579.314 1196.99C569.766 1199.19 559.967 1199.28 550.252 1198.69C540.537 1198.09 530.821 1196.9 521.357 1194.27C512.563 1191.9 504.188 1188.25 496.901 1182.65C487.488 1175.23 486.441 1169.91 487.208 1159.16C487.291 1158 488.378 1157.17 489.53 1157.36C533.645 1164.69 561.629 1168.17 612.812 1172.21C614.282 1172.33 615.139 1173.94 614.332 1175.18C612.757 1177.58 611.001 1179.88 609.047 1181.97Z" />
                    </g>
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth46.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling " style={{ visibility: 'inherit' }}>
                        ...
                        <g className="with">
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_left && !tooth46Diagnozis.seal_top && !tooth46Diagnozis.seal_center) ||
                                        (tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_top && !tooth46Diagnozis.seal_center) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_left && !tooth46Diagnozis.seal_bottom) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_bottom && !tooth46Diagnozis.seal_center) ||
                                        (!tooth46Diagnozis.seal_left && tooth46Diagnozis.seal_bottom && tooth46Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_right && !tooth46Diagnozis.seal_bottom) ||
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_bottom && !tooth46Diagnozis.seal_center) ||
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_bottom && tooth46Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth46Diagnozis.seal_right && !tooth46Diagnozis.seal_top && !tooth46Diagnozis.seal_center) ||
                                        (tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_top && !tooth46Diagnozis.seal_center) ||
                                        (!tooth46Diagnozis.seal_right && tooth46Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
