...
import { setSubDiagnosis, setTooth16Active, setToothDiagnoze } from '../../../Redux/Formula';
import {
    allTeethSelector,
...
export default function Tooth16({
  className = '',
    ...
    const toothActive = useSelector(tooth16Selector);
...
console.log('here we are')
        if (diagnozis === 'caries') {
            ...
            console.log(teethDiagnozis.tooth16)
    ...
    return ( 
        <>
            <g id="16" className="df-tooth-text" style={{opacity: 1}}>
                <text transform="matrix(1 0 0 1 507.4561 716.1968)" className="st3 st4 st5">16</text>
            </g>
            <g className={`f-tooth-active`}
                ...
                onClick={() => {
                    teethDiagnozis.tooth16.active = !teethDiagnozis.tooth16.active;
            ...
            >
                ...
                <g id="T_16_up" className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/* PULPIT */}
                    <g className="pulp">
                        <g className="hIntact hEmpty hImplant pulpitis-pfilling" dataposition="16" style={{visibility: 'hidden'}}>
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: 'inherit'}}>
                        <g className="vinir"  style={{visibility: 'hidden', opacity: 0}}>
                            <path className="st55" d="M471.31 555.476C473.009 552.076 475.008 548.976 477.207 546.076C482.704 539.076 489.8 533.876 499.195 531.576C509.989 528.976 521.283 531.976 532.476 531.476C538.273 531.176 544.27 530.276 549.867 529.376C569.456 526.376 589.545 527.176 600.339 543.176C601.039 544.276 601.739 545.376 602.338 546.576C604.137 550.176 605.137 554.176 605.936 558.176C607.835 568.376 607.636 578.476 606.636 588.576C606.486 590.043 606.322 591.51 606.141 592.976C603.425 592.876 597.594 591.856 596.004 588.576C596.749 580.364 596.823 572.148 595.274 563.855C594.586 560.425 593.726 556.995 592.177 553.907C591.661 552.878 591.059 551.935 590.457 550.991C581.169 537.27 563.881 536.584 547.024 539.157C542.207 539.928 537.047 540.7 532.058 540.958C522.426 541.386 512.707 538.814 503.418 541.043C495.334 543.016 489.227 547.475 484.497 553.478C482.604 555.965 480.884 558.624 479.422 561.54C475.148 569.854 472.929 579.419 470.207 588.476C469.043 592.476 462.026 593.142 458.664 592.976C462.85 580.728 465.375 567.06 471.31 555.476Z"></path>
                        </g>
                    </g>
                    <g className="crown"  style={{visibility: 'hidden', opacity: 0}}>
                        <path className="st46 target" d="M606.1,558.1c-0.7-4-1.8-7.9-3.6-11.6c-0.6-1.2-1.2-2.3-2-3.4
                c-10.8-16-30.9-16.9-50.5-13.8c-5.6,0.9-11.6,1.9-17.4,2.1c-11.2,0.5-22.5-2.4-33.3,0.1c-9.4,2.2-16.5,7.5-22,14.5
                c-2.2,2.9-4.2,6-6,9.4c-6.1,12-8.6,26.1-13,38.5c-1.7,4.9-3.7,9.6-5.4,14.5c-4.2,12.6-5.5,26.1,0.3,37.9c0,0,0,0,0,0.1
                c3.2,6.4,8.3,11.6,14.4,15.3c5.5,3.3,11.6,5.4,18,6.5c6,1.1,12.2,1.3,18.2,0.1c9.5-1.8,18.2-7,28-7.1c5.6,0,11,1.6,16.6,2.4
                c9.9,1.3,20-0.4,28.1-5.6c2.9-1.8,5.4-4,7.7-6.4c5.3-5.7,9.1-12.7,12.1-20c5.7-13.7,8.7-28.4,10.2-43
                C607.8,578.4,608,568.3,606.1,558.1z"></path>
                        <path className="st3 fissure" d="M596.6,579.3l-19.1,13.1c-6.9-0.2-13.8,0-20.6,0.7c-8.2,0.9-14.7,2.2-20.5,4.3c-8.6,3.2-16.4,8.4-22.6,15.1
                ...
                L596.6,579.3z"></path>
                        <path className="st3 fissure" d="M532.9,563.4l9.1,31l1-0.3l-8.1-27.5l0.2,0c0.5-2.7,1.5-5.4,2.8-7.9c2.7-4.9,7.1-9.2,11.2-11l-0.4-1
                c-4.3,1.9-8.9,6.4-11.7,11.5c-1.2,2.1-2,4.4-2.6,6.7l-0.5-1.7c-0.8-3.8-2.2-7.4-4.3-10.6c-1.2-2-2.7-3.8-4.3-5.4l-0.8,0.8
                c1.6,1.6,3,3.4,4.1,5.3C530.8,556.2,532.1,559.7,532.9,563.4z"></path>
                    </g>
                ...
                c0.2,1.5,0.4,3,0.7,4.5c1.3,6.9,4.5,13.4,9.2,18.7l0.8-0.7c-4.6-5.2-7.7-11.5-9-18.2c-0.3-1.5-0.5-3-0.7-4.4
                c-0.5-4.1-1.1-8.2-3.3-11.8c6.1-6.7,13.8-11.8,22.4-15c5.6-2.1,12.1-3.4,20.2-4.3c6.8-0.7,13.8-1,20.6-0.7l0.2,0l19.4-13.3
                L596.6,579.3z" style={{stroke: 'none'}}></path>
                        <path className="st3 fissure" d="M532.9,563.4l9.1,31l1-0.3l-8.1-27.5l0.2,0c0.5-2.7,1.5-5.4,2.8-7.9c2.7-4.9,7.1-9.2,11.2-11l-0.4-1
                c-4.3,1.9-8.9,6.4-11.7,11.5c-1.2,2.1-2,4.4-2.6,6.7l-0.5-1.7c-0.8-3.8-2.2-7.4-4.3-10.6c-1.2-2-2.7-3.8-4.3-5.4l-0.8,0.8
                c1.6,1.6,3,3.4,4.1,5.3C530.8,556.2,532.1,559.7,532.9,563.4z" style={{stroke: 'none'}}></path>
                    </g>
                </g>
                <g id="T_16" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pulp">
                        ...
                        <g style={{
                                visibility: 'inherit',
                                opacity: ((tooth16Diagnozis.periodontit && subDiagnozis === 'st1') ? 1 : 0)
                            }}
                        >
                        ...
                        <g style={{
                                visibility: 'inherit',
                                opacity: ((tooth16Diagnozis.periodontit && subDiagnozis === 'st2') ? 1 : 0)
                            }}
                        >
                    ...
                    <g className="pin hEmpty hImplant" style={{
                        ...
                        <path className="st56 hIntact" d="M491.7 449.2L519.7 441.1L549 453.1L570.6 450.3L588.9 463.4C594.6 453.7 599 
                            ...
                            style={{visibility: tooth16Diagnozis.pin ? 'inherit' : 'hidden'}}
                        />
