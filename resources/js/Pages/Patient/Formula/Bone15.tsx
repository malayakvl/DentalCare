...
export default function Bone15({
  className = '',
    ...
    return (
        <g id="bone_15" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                ...
                C699.1,405.8,699.1,405.9,699.1,405.9z" style={{strokeWidth: 2}} />
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c0.2,1.6,0.4,3.3,0.6,5c1.6,13.9,3.5,30.9,5.8,50.7c0.5,3.9,0.9,8,1.3,12.2C695,357.6,696.1,371.4,697,382.7z"
                      style={{strokeWidth: 2}} />
                <path className="st43" d="M697,382.7c-6.9-1.4-14.5-21.7-38.2-24.6c-24-3-31,15.1-38.1,14.9c0,0,0,0,0,0"
                      style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c0.2,1.6,0.4,3.3,0.6,5c1.6,13.9,3.5,30.9,5.8,50.7c0.5,3.9,0.9,8,1.3,12.2C693.7,344.9,693.7,345.3,693.8,345.7z"
                      style={{strokeWidth: 2}} />
                <path className="st43" d="M693.8,345.7c-6-2.2-9.2-15.6-35.6-15.8c-24-0.1-27.8,12.5-35,12.8"
                      style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c1.7-9,0.9-19.3,2.8-29c0.2-0.9,0.4-1.8,0.7-2.6c1.6-4.7,5-9,11.8-9.7c9.3-0.9,16.6,3.8,19.6,10.1c1.4,2.9,2.7,6,3.7,8.9
                c1.2,3.5,2.5,7.2,3.3,10.6c0.8,3,1.4,5.8,4.3,8.3c3,2.6,6.1,4.2,9,4.7c0.6,5.4,1.3,11.7,2.2,19.2c0.1,0.5,0.1,1,0.2,1.5
                c0.2,1.6,0.4,3.3,0.6,5C687.4,289.6,688.5,298.8,689.6,309z" style={{strokeWidth: 2}} />
                <path className="st43" d="M689.6,309c-3.6-1.7-9.2-18.3-33.1-18.3c-22.9,0-28.2,13-33.2,14.3"
                      style={{strokeWidth: 2}} />
            </g>
        </g>
    )
