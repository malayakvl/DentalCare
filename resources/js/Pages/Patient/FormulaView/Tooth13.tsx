...
export default function Tooth13({formulaToothData}) {
    const tooth13Diagnozis = formulaToothData;

    return (
        <>
            <g id="13" className={`tooth-number-active ${!tooth13Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 806.7852 716.1968)" className={`st3 st4 st5`}>13</text>
            </g>
            <g id="TH-13" className={`f-tooth-init ${(tooth13Diagnozis.show && !tooth13Diagnozis.absent)  ? 'f-tooth-active' : ''} adult`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: tooth13Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth13Diagnozis.culttab && !tooth13Diagnozis.abutment && !tooth13Diagnozis.implant && !tooth13Diagnozis.shaper && !tooth13Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${tooth13Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth13Diagnozis.seal_left ? `seal-fill ${tooth13Diagnozis.seal_left_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${tooth13Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth13Diagnozis.seal_bottom ? `seal-fill ${tooth13Diagnozis.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${tooth13Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth13Diagnozis.seal_right ? `seal-fill ${tooth13Diagnozis.seal_right_color}` : ''}
                                `}  
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${tooth13Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth13Diagnozis.seal_top ? `seal-fill ${tooth13Diagnozis.seal_top_color}` : ''}
                                `} 
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: tooth13Diagnozis.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth13Diagnozis.culttab && !tooth13Diagnozis.abutment && !tooth13Diagnozis.implant && !tooth13Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling">
                            ...
                            `} d="M782.4,464.9c1,4.9,2.6,9.8,4.7,14.4c2.8,6.4,6.5,12.3,10.5,17.9c3.5,4.8,7.5,9.5,11.3,14
                                c-3.3-19.6-10.2-59.8-11.2-61.5c-0.9-1.6-8.9-9.7-13.2-13.9c-0.7,2.3-1.2,4.6-1.7,7C781.5,450,781.3,457.5,782.4,464.9z" 
                                style={{
                                    fill: tooth13Diagnozis.caries_left ? '#606c80' : 
                                    tooth13Diagnozis.seal_left ? tooth13Diagnozis.seal_left_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C852.6,440.5,857.5,477.6,860.3,498.4z" 
                                style={{
                                    fill: tooth13Diagnozis.caries_right ? '#606c80' : 
                                    tooth13Diagnozis.seal_right ? tooth13Diagnozis.seal_right_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                c-11.8,0.7-22.1,7.9-27.9,18.2c-3,5.3-4.8,11.2-6.6,17C787,428.2,785.7,431.9,784.6,435.8z"  
                                style={{
                                    fill: tooth13Diagnozis.caries_top ? '#606c80' : 
                                    tooth13Diagnozis.seal_top ? tooth13Diagnozis.seal_top_color : 'transparent',
