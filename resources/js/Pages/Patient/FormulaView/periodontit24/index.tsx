...
export default function PeriodontitStage24() {
    ...
    return ( 
        <>
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth24Diagnozis.periodontit_stage === 'st1'  ? 1 : 0),
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth24Diagnozis.periodontit_stage === 'st2'  ? 1 : 0),
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth24Diagnozis.periodontit_stage === 'st3'  ? 1 : 0),
