...
export default function Tooth61({formulaToothData}) {
    const tooth61Diagnozis = formulaToothData;

    return (
        <>
            <g id="61" className={`tooth-number-active ${!tooth61Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1075 716)" className={`st3 st4 st5`}>61</text>
            </g>
            <g id="TH-61" className={`f-tooth-init-milk ${(tooth61Diagnozis.show && !tooth61Diagnozis.absent)  ? 'f-tooth-active' : ''} child`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 24, 17)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: tooth61Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth61Diagnozis.culttab && !tooth61Diagnozis.abutment && !tooth61Diagnozis.implant && !tooth61Diagnozis.shaper && !tooth61Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${'caries-stroke'}
                                    ${tooth61Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth61Diagnozis.seal_left ? `seal-fill ${tooth61Diagnozis.seal_left_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${tooth61Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth61Diagnozis.seal_bottom ? `seal-fill ${tooth61Diagnozis.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${tooth61Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth61Diagnozis.seal_right ? `seal-fill ${tooth61Diagnozis.seal_right_color}` : ''}
                                `}
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${tooth61Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth61Diagnozis.seal_top ? `seal-fill ${tooth61Diagnozis.seal_top_color}` : ''}
                                `} 
                    ...
                    <g className="crown" style={{
                        ...
                        <path className={
                                `st46 target temporary-crown crown-fill child
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 25, 101)'}}>
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage61 toothData={tooth61Diagnozis} />
                    </g>
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: tooth61Diagnozis.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth61Diagnozis.culttab && !tooth61Diagnozis.abutment && !tooth61Diagnozis.implant && !tooth61Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C1071.2,458.9,1069.6,511.2,1069.1,527.6z" 
                                style={{
                                    fill: tooth61Diagnozis.caries_left ? '#606c80' : 
                                    tooth61Diagnozis.seal_left ? tooth61Diagnozis.seal_left_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C1148.8,478.7,1149.5,490.1,1148,501.4z" 
                                style={{
                                    fill: tooth61Diagnozis.caries_right ? '#606c80' : 
                                    tooth61Diagnozis.seal_right ? tooth61Diagnozis.seal_right_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `}  
                                ...
                                C1140.4,434.9,1142.4,441,1143.8,447.1z" 
                                style={{
                                    fill: tooth61Diagnozis.caries_top ? '#606c80' : 
                                    tooth61Diagnozis.seal_top ? tooth61Diagnozis.seal_top_color : 'transparent',
                                }} 
                            />
                        </g>
                        <g className="with">
