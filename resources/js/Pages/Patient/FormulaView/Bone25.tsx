...
export default function Bone25({
  className = '',
    ...
    return (
        <g id="bone_25" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-0.2,1.6-0.4,3.3-0.6,5c-1.6,13.9-3.5,30.9-5.8,50.7c-0.5,3.9-0.9,8-1.3,12.2C1403,357.8,1401.9,371.6,1401,382.9z"
                      style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1401,382.9c6.9-1.4,14.5-21.7,38.2-24.6c24-3,31,16.1,38.1,15.9"
                      style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-0.2,1.6-0.4,3.3-0.6,5c-1.6,13.9-3.5,30.9-5.8,50.7c-0.5,3.9-0.9,8-1.3,12.2C1404.3,345.1,1404.3,345.5,1404.2,345.9z"
                      style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1404.2,345.9c6-2.2,9.2-15.6,35.6-15.8c24-0.1,27.8,13.5,35,13.8"
                      style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M1408.4,309.2c3.6-1.7,9.2-18.3,33.1-18.3c22.9,0,28.2,14,33.2,15.3"
                      style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
