...
export default function Bone45({
  className = '',
    ...
    return (
        <g id="bone_45" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                ...
                C721.4,1207.8,724.7,1206.6,728.2,1206.3z" style={{strokeWidth: 2}} />
                <path className="st43" d="M630.6,1202.1c0.4,0,0.9,0,1.3,0c2.9,0.2,5.4,1.8,7.8,3.4c10.2,6.7,21.3,12.8,34,13.9
                c15.6,1.4,30.2-4.9,44.5-10.3c3.3-1.2,6.6-2.5,10-2.7" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c30.3-0.1,38.6-12.6,44.5-12.5" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c30.3-0.1,39.2-14.5,46.1-14.5" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c29.8-0.1,41.3-12.4,47.5-12.9" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
