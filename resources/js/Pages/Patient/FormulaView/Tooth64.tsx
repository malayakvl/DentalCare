...
import { getActiveToothNumberSelector } from "../../../Redux/Formula/selectors";
...
export default function Tooth64({formulaToothData}) {
    ...
    return (
        <>
            <g id="64" className={`tooth-number-active`}>
                <text transform="matrix(1 0 0 1 1340 716)" className={`st3 st4 st5`}>64</text>
            </g>
            <g id="TH-64" className={`f-tooth-init-milk ${(tooth64Diagnozis.show && !tooth64Diagnozis.absent)  ? 'f-tooth-active' : ''} child`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 500, 274)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: tooth64Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling" style={{visibility: (!tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment && !tooth64Diagnozis.implant && !tooth64Diagnozis.shaper && !tooth64Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${tooth64Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth64Diagnozis.seal_left ? `seal-fill ${tooth64Diagnozis.seal_left_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    ...
                                    ${tooth64Diagnozis.seal_bottom ? `seal-fill ${tooth64Diagnozis.seal_bottom_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${tooth64Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth64Diagnozis.seal_right ? `seal-fill ${tooth64Diagnozis.seal_right_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${tooth64Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth64Diagnozis.seal_top ? `seal-fill ${tooth64Diagnozis.seal_top_color}` : ''}
                                `} 
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, -165, 99)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{visibility: 'inherit', opacity: tooth64Diagnozis.tartar ? 1 : 0}}>
