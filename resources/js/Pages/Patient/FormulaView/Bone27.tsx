...
export default function Bone27({
  className = '',
    ...
    return (
        <g id="bone_27" className="df-bone top"  opacity="0" style={{opacity: 0, transition: 'opacity'}}   >
            <g className="periodontal level"  style={{visibility: 'inherit'}}>
                ...
                c0,1-0.1,2.1-0.1,3.1c0,1.4-0.1,2.7-0.1,4.1C1619.9,310.2,1619.8,317.4,1619.9,324.9z" style={{strokeWidth: 2}} />
                ...
                c0.2,0,0.4-0.1,0.7-0.1c0,0,0.1,0,0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                ...
                c0,0.6-0.1,1.2-0.1,1.8c0,1-0.1,2.1-0.1,3.1c0,1.4-0.1,2.7-0.1,4.1C1619.9,310.2,1619.8,317.4,1619.9,324.9z" style={{strokeWidth: 2}} />
                <path className="st43" d="M1621.5,359.8c14.6,0.7,10.9-22.3,62.4-28.1c42.7-4.9,62.9,10.9,73.2,9.8
                c0.1,0,0.1,0,0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                ...
                c-3,0.2-5.2,1.8-6.8,3.5c-2.9,3.2-4.4,7-6.9,10.4c-4.4,6-11.7,10.7-21.3,11.1c-0.9,7.3-2.2,19.5-2.9,35.2c0,0.6-0.1,1.2-0.1,1.8
                c0,1-0.1,2.1-0.1,3.1c0,1.4-0.1,2.7-0.1,4.1C1619.9,310.2,1619.8,317.4,1619.9,324.9z" style={{strokeWidth: 2}} />
                <path className="st43" d="M1620.1,333c8.7-2,16-19.5,61.6-25.4c53.1-5.7,58.3,11.9,70.9,10.6c0.1,0,0.2,0,0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                ...
                C1620.2,299.7,1620.2,300.1,1620.2,300.5z" style={{strokeWidth: 2}} />
                <path className="st43" d="M1620.2,301.5c0.3,0,0.6,0,0.8,0c9.3-0.1,17.9-18.8,67.1-19.6
                c42.4-0.7,50.3,13,62.3,13.1" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
