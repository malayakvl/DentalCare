...
export default function Tooth11({formulaToothData}) {
    const tooth11Diagnozis = formulaToothData;

    return (
        <>
            <g id="11" className={`tooth-number-active ${!tooth11Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 980 716)" className={`st3 st4 st5`}>11</text>
            </g>
            <g id="TH-11" className={`f-tooth-init-milk ${(tooth11Diagnozis.show && !tooth11Diagnozis.absent)  ? 'f-tooth-active' : ''} adult`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: tooth11Diagnozis.tartar ? 1 : 0, visibility:"inherit"}}>
                    ...
                    <g className="header caries-filling" style={{visibility: (!tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment && !tooth11Diagnozis.implant && !tooth11Diagnozis.shaper && !tooth11Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${tooth11Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth11Diagnozis.seal_left ? `seal-fill ${tooth11Diagnozis.seal_left_color}` : ''}
                                `}  
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${tooth11Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth11Diagnozis.seal_bottom ? `seal-fill ${tooth11Diagnozis.seal_bottom_color}` : ''}
                                `}  
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${tooth11Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth11Diagnozis.seal_right ? `seal-fill ${tooth11Diagnozis.seal_right_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${tooth11Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth11Diagnozis.seal_top ? `seal-fill ${tooth11Diagnozis.seal_top_color}` : ''}
                                `} 
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage11 toothData={tooth11Diagnozis} />
                    </g>
                    {/*PIN*/}
                    ...
                    {/* TARTAR */}
                    <g className="tartar" style={{visibility: 'inherit', opacity: tooth11Diagnozis.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling" style={{visibility: (!tooth11Diagnozis.culttab && !tooth11Diagnozis.abutment && !tooth11Diagnozis.implant && !tooth11Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                c-1.6-17.3-5.9-62.7-6.5-65.6c-0.5-2.5-9.7-9.5-14.8-13.2c-1.6,6.6-2.7,13.4-3.6,20.2C949.2,478.7,948.6,490.1,950,501.4z" 
                                style={{
                                    fill: tooth11Diagnozis.caries_left ? '#606c80' : 
                                    tooth11Diagnozis.seal_left ? tooth11Diagnozis.seal_left_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C1026.8,458.9,1028.4,511.2,1029,527.6z" 
                                style={{
                                    fill: tooth11Diagnozis.caries_right ? '#606c80' : 
                                    tooth11Diagnozis.seal_right ? tooth11Diagnozis.seal_right_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C957.6,434.9,955.7,441,954.2,447.1z" 
                                style={{
                                    fill: tooth11Diagnozis.caries_top ? '#606c80' : 
                                    tooth11Diagnozis.seal_top ? tooth11Diagnozis.seal_top_color : 'transparent',
