...
export default function PeriodontitStage46() {
    ...
    return ( 
        <>
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth46Diagnozis.periodontit_stage === 'st1'  ? 1 : 0),
                }}
            >
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth46Diagnozis.periodontit_stage === 'st2'  ? 1 : 0)
            }}
            >
            ...
            <g style={{
                    visibility: 'inherit',
                    opacity: (tooth46Diagnozis.periodontit_stage === 'st3'  ? 1 : 0),
                }}
            >
