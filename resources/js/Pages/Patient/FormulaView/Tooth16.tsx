...
export default function Tooth16({formulaToothData}) {
    const tooth16Diagnozis = formulaToothData;

    return (
        <>
            <g id="16" className={`tooth-number-active ${!tooth16Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 507.4561 716.1968)" className={`st3 st4 st5`}>16</text>
            </g>
            <g id="TH-16" className={`f-tooth-init ${(tooth16Diagnozis.show && !tooth16Diagnozis.absent)  ? 'f-tooth-active' : ''} adult`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    <g className="pulp" style={{visibility: tooth16Diagnozis.apex ? 'inherit' : 'hidden'}}>
                        <g className="pulpitis-pfilling" style={{visibility: tooth16Diagnozis?.apex ? 'inherit' : 'hidden'}}>
                            <ellipse className="st22 target" rx="8.35891" ry="8.89013" transform="matrix(-0.200896 0.979613 0.979613 0.200896 511.388 615.974)" style={{fill: '#e80808'}}></ellipse>
                            <ellipse className="st22 target" rx="7.49883" ry="8.49434" transform="matrix(-0.462677 -0.886527 -0.886527 0.462677 510 592.578)" style={{fill: '#e80808'}}></ellipse>
                            <ellipse className="st22 target" rx="7.52721" ry="9.0078" transform="matrix(-0.639739 0.768592 0.768592 0.639739 557.109 592.522)" style={{fill: '#e80808'}}></ellipse>
                        </g>
                    </g>
                    {/* IMPLANT */}
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: tooth16Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth16Diagnozis.culttab && !tooth16Diagnozis.abutment && !tooth16Diagnozis.implant && !tooth16Diagnozis.shaper && !tooth16Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        ...
                        <g className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${tooth16Diagnozis.caries_center ? 'caries-fill' : ''}
                                    ${tooth16Diagnozis.seal_center ? `seal-fill ${tooth16Diagnozis.seal_center_color}` : ''}
                                `}
                                d="M486.1,612.3c0.3,3.3,1.1,6,2.4,8.4c3.6,6.5,11.8,9.4,29.3,10.8c20.6,1.6,32.6-2,42.5-8.1
                                c1.5-0.9,2.9-1.9,4.4-2.9c10.9-7.8,11.7-30,11.7-35.6c0-3.1-1.1-6.3-3.4-9c-1.8-2.1-4.4-3.9-7.8-5.3c-7.7-3-31.4-3.9-31.4-3.9
                                c-20.7-0.9-31.9,2.4-37.7,6.8c-2.7,2.1-4.3,4.4-5.2,6.6C488.2,587,484.8,599.8,486.1,612.3z"
                        ...
                        <g className="caries-filling">
                            ...
                            <path 
                                className={
                                    `st8 caries-left
                                    ${tooth16Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth16Diagnozis.seal_left ? `seal-fill ${tooth16Diagnozis.seal_left_color}` : ''}
                                `}
                        ...
                        <g className="caries-filling">
                            ...
                            <path 
                                className={
                                    `st8 caries-bottom
                                    ${tooth16Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth16Diagnozis.seal_bottom ? `seal-fill ${tooth16Diagnozis.seal_bottom_color}` : ''}
                                `}
                        ...
                        <g className="caries-filling">
                            ...
                            <path 
                                className={`
                                    ...
                                    ${tooth16Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth16Diagnozis.seal_right ? `seal-fill ${tooth16Diagnozis.seal_right_color}` : ''}
                                `} 
                        ...
                        <g className="caries-filling">
                            ...
                            <path 
                                className={`
                                    ...
                                    ${tooth16Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth16Diagnozis.seal_top ? `seal-fill ${tooth16Diagnozis.seal_top_color}` : ''}
                                `}
                ...
                <g id="T_16" className="common-view" style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: tooth16Diagnozis.tartar ? 1 : 0}}>
