...
export default function Tooth63({formulaToothData}) {
    const tooth63Diagnozis = formulaToothData;

    return (
        <>
            <g id="63" className={`tooth-number-active ${!tooth63Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1250 716)" className={`st3 st4 st5`}>63</text>
            </g>
            <g id="TH-63" className={`f-tooth-init-milk ${(tooth63Diagnozis.show && !tooth63Diagnozis.absent)  ? 'f-tooth-active' : ''} child`}>
                ...
                <g className="top-view"  style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 19, 26)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: tooth63Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth63Diagnozis.culttab && !tooth63Diagnozis.abutment && !tooth63Diagnozis.implant && !tooth63Diagnozis.shaper && !tooth63Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_63_4" className="caries-filling">
                            ...
                            <path className={
                                `st8 caries-left
                                    ${'caries-stroke'}
                                    ${tooth63Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth63Diagnozis.seal_left ? `seal-fill ${tooth63Diagnozis.seal_left_color}` : ''}
                                `}
                        ...
                        <g id="s_header_63_3" className="caries-filling">
                            ...
                            <path className={
                                `st8 caries-bottom
                                    ${tooth63Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth63Diagnozis.seal_bottom ? `seal-fill ${tooth63Diagnozis.seal_bottom_color}` : ''}
                                `}
                        ...
                        <g id="s_header_63_2" className="caries-filling">
                            ...
                            <path className={
                                `st8 caries-right
                                    ${tooth63Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth63Diagnozis.seal_right ? `seal-fill ${tooth63Diagnozis.seal_right_color}` : ''}
                                `}
                        ...
                        <g id="s_header_63_1" className="caries-filling">
                            ...
                            <path className={
                                `st8 caries-top
                                    ${tooth63Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth63Diagnozis.seal_top ? `seal-fill ${tooth63Diagnozis.seal_top_color}` : ''}
                                `}
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 39, 95)'}}>
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage63 toothData={tooth63Diagnozis} />
                    </g>
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: tooth63Diagnozis.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth63Diagnozis.culttab && !tooth63Diagnozis.abutment && !tooth63Diagnozis.implant && !tooth63Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling">
                            ...
                            `}
                                ...
                                C1245.5,440.6,1240.6,477.6,1237.7,498.4z"
                                  style={{
                                      fill: tooth63Diagnozis.caries_left ? '#606c80' :
                                          tooth63Diagnozis.seal_left ? tooth63Diagnozis.seal_left_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `}
                                ...
                                c3.3-19.6,10.2-59.8,11.2-61.5c0.9-1.6,8.9-9.7,13.2-13.9c0.7,2.3,1.2,4.6,1.7,7C1316.6,450.1,1316.7,457.5,1315.6,464.9z"
                                  style={{
                                      fill: tooth63Diagnozis.caries_right ? '#606c80' :
                                          tooth63Diagnozis.seal_right ? tooth63Diagnozis.seal_right_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `}
                                ...
                                c3,5.3,4.8,11.2,6.6,17C1311,428.2,1312.3,432,1313.4,435.8z"
                                  style={{
                                      fill: tooth63Diagnozis.caries_top ? '#606c80' :
                                          tooth63Diagnozis.seal_top ? tooth63Diagnozis.seal_top_color : 'transparent',
                                  }}
                            />
                        </g>
                        <g className="with">
