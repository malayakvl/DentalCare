...
export default function Bone28({
  className = '',
    ...
    return (
        <g id="bone_28" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}   >
            <g className="periodontal level"  style={{visibility: 'inherit'}}>
                <path className="st0" d="M1931.5,258.5c-1.3,1.7-2.5,3.3-3.7,5c-1.2,1.7-2.4,3.4-3.5,5.2c0,0,0,0,0,0c-0.7,1.1-1.4,2.3-2.1,3.4
                ...
                c2.6-8.1,5-16.3,7.2-24.5c4.5-16.2,9-32.5,9.8-48.9c0.1-2.9,0.2-5.9,0.1-8.8h0.8l129.6-0.1l0.1,112.5L1931.5,258.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1931.5,258.8c-1.3,1.7-2.5,3.3-3.7,5c-1.2,1.7-2.4,3.4-3.5,5.2c0,0,0,0,0,0
                ...
                c0,0-0.1,0-0.1,0c-10.7,3.5-21.1,9.4-30,15.9c-2.1,1.5-4,3-5.9,4.6c-0.3,0.2-0.5,0.4-0.8,0.7c-3.6,3.2-7.2,6.5-12,7.4" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                <path className="st0" d="M1931.5,245.3c-20.4,19.5-24.3,42.1-29.5,60.3c-5.6,19.5-14.6,20.6-22.4,17.6
                ...
                c0.1-2.2,0.2-4.4,0.1-6.6l129.6-0.1L1931.5,245.3z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1931.5,245.3c-20.4,19.5-24.3,42.1-29.5,60.3c-5.6,19.5-14.6,20.6-22.4,17.6
                c-9.7-3.8-24.9-14.1-62.7-9.7c-44.1,5.1-50.3,26.7-59.4,27.9h0" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                <path className="st0" d="M1931.5,230.7c-14.1,11.4-22.8,29.4-28.3,48.3c-6.1,20.9-12.1,28.6-20.3,26.9
                ...
                c2.6-8.1,5-16.3,7.2-24.5c4.5-16.2,9-32.5,9.8-48.9c0.1-2.2,0.2-4.4,0.1-6.6l129.6-0.1L1931.5,230.7z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1931.5,230.7c-14.1,11.4-22.8,29.4-28.3,48.3c-6.1,20.9-12.1,28.6-20.3,26.9
                c-11.8-2.5-26.7-15.8-65.2-12.3c-41.5,4.7-53.9,23.1-64.8,24.4" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level"  style={{visibility: 'hidden'}}>
                <path className="st0" d="M1931.5,212.7c-10.6,8.2-29.5,40.4-34.2,58.4c-4.6,17.9-6.8,21.5-20.6,15.1
                ...
                c2.6-8.1,5-16.3,7.2-24.5c4.5-16.2,9-32.5,9.8-48.9c0.1-2.2,0.2-4.4,0.1-6.6l129.6-0.1L1931.5,212.7z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1931.5,212.7c-10.6,8.2-29.5,40.4-34.2,58.4c-4.6,17.9-6.8,21.5-20.6,15.1
                c-8.6-4-18.5-12-57.1-11.3c-49.8,0.9-60.2,19.6-68.7,19.8c-0.2,0-0.3,0-0.5,0" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
