...
export default function Bone13({
  className = '',
    ...
    return (
        <g id="bone_13" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-0.2-0.1-0.3-0.1-0.5-0.2" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                l-21.5-218.5h0.2l68.5-0.2l15.3,0l0.3,2.2v0c0,3.8,0.5,7.6,1.5,11.3c0,0.1,0,0.2,0.1,0.3L863.2,352.8z"
                      style={{strokeWidth: 2}} />
                <path className="st43" d="M863.2,353c-7.1-2.4-12-26.8-46.5-26.8c-32.9,0.1-39.3,24.7-45.8,24.8h-0.1"
                      style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-31.9-0.1-36.5,24-41.9,28.2" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
