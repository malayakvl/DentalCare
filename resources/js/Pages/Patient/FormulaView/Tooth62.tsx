...
export default function Tooth62({formulaToothData}) {
    const tooth62Diagnozis = formulaToothData;

    return (
        <>
            <g id="62" className={`tooth-number-active ${!tooth62Diagnozis.show ? 'hide-number' : ''}`}>
                <text transform="matrix(1 0 0 1 1170 716)" className={`st3 st4 st5`}>62</text>
            </g>
            <g id="TH-62" className={`f-tooth-init-milk ${(tooth62Diagnozis.show && !tooth62Diagnozis.absent)  ? 'f-tooth-active' : ''} child`}>
                ...
                <g className="top-view" style={{visibility: 'inherit', transform:'matrix(0.55, 0, 0, 0.55, 14, 10)'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar hImplant hEmpty" style={{opacity: tooth62Diagnozis.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth62Diagnozis.culttab && !tooth62Diagnozis.abutment && !tooth62Diagnozis.implant && !tooth62Diagnozis.shaper && !tooth62Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС LEFT*/}
                        <g id="s_header_62_4" className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${tooth62Diagnozis.caries_left ? 'caries-fill' : ''}
                                    ${tooth62Diagnozis.seal_left ? `seal-fill ${tooth62Diagnozis.seal_left_color}` : ''}
                                `}  
                        ...
                        <g id="s_header_62_3" className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-bottom
                                    ${tooth62Diagnozis.caries_bottom ? 'caries-fill' : ''}
                                    ${tooth62Diagnozis.seal_bottom ? `seal-fill ${tooth62Diagnozis.seal_bottom_color}` : ''}
                                `}
                        ...
                        <g id="s_header_62_2" className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${tooth62Diagnozis.caries_right ? 'caries-fill' : ''}
                                    ${tooth62Diagnozis.seal_right ? `seal-fill ${tooth62Diagnozis.seal_right_color}` : ''}
                                `} 
                        ...
                        <g id="s_header_62_1" className="caries-filling">
                            ...
                            <path className={
                                    `st8 caries-top
                                    ${tooth62Diagnozis.caries_top ? 'caries-fill' : ''}
                                    ${tooth62Diagnozis.seal_top ? `seal-fill ${tooth62Diagnozis.seal_top_color}` : ''}
                                `}  
                ...
                <g className="common-view" style={{visibility: 'inherit', transform: 'matrix(0.55, 0, 0, 0.55, 19, 85)'}}>
                    ...
                    <g className="pulp">
                        ...
                        <PeriodontitStage62 toothData={tooth62Diagnozis} />
                    </g>
                    ...
                    {/* TARTAR */}
                    <g className="tartar hImplant hEmpty" style={{visibility: 'inherit', opacity: tooth62Diagnozis.tartar ? 1 : 0}}>
                    ...
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth62Diagnozis.culttab && !tooth62Diagnozis.abutment && !tooth62Diagnozis.implant && !tooth62Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                c2.9,5.1,7,12.6,7.7,15.5C1170,455,1164.3,490.4,1161.3,508.2z"
                                style={{
                                    fill: tooth62Diagnozis.caries_left ? '#606c80' : 
                                    tooth62Diagnozis.seal_left ? tooth62Diagnozis.seal_left_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `} 
                                ...
                                C1221.3,448.8,1221.1,455.4,1221,462z"
                                style={{
                                    fill: tooth62Diagnozis.caries_right ? '#606c80' : 
                                    tooth62Diagnozis.seal_right ? tooth62Diagnozis.seal_right_color : 'transparent',
                        ...
                        <g className="caries-filling">
                            ...
                            `}
                                ...
                                C1219.6,436.7,1220.1,439.5,1220.5,442.4z"
                                style={{
                                    fill: tooth62Diagnozis.caries_top ? '#606c80' : 
                                    tooth62Diagnozis.seal_top ? tooth62Diagnozis.seal_top_color : 'transparent',
                                }} 
                            />
                        </g>
                        <g className="with">
