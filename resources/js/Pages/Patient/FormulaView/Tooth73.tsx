...
export default function Tooth73() {
    ...
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth73.show && !teethDiagnozis.tooth33.show) {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <g className="dentin">
                        <g style={{visibility: !tooth73Diagnozis.culttab && !tooth73Diagnozis.implant && !tooth73Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth73Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth73Diagnozis?.apex ? 'apex' : ''}`}  
                        ...
                        <g style={{visibility: tooth73Diagnozis?.apex || tooth73Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth73Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth73Diagnozis?.apex ? 'apex' : ''}`}   
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth73Diagnozis.implant || tooth73Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth73Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth73Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth73Diagnozis.pin ? 1 : 0}}>
                    ...
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth73Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth73Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M1226.96 1015.1L1226.97 1015.1C1235.7 1015.2 1243.16 1010.5 1249.62 1005.13C1253.5 1001.85 1257.18 998.246 1259.49 994.204C1262.29 989.292 1263.19 984.026 1261.04 978.994C1260.15 976.938 1258.79 975.131 1257.22 973.331C1256.68 972.707 1256.1 972.071 1255.51 971.424C1254.45 970.257 1253.35 969.055 1252.38 967.822C1250.95 966.031 1249.73 964.197 1248.56 962.377C1248.27 961.927 1247.98 961.479 1247.7 961.033C1246.83 959.667 1245.98 958.318 1245.05 956.979C1242.97 954.108 1240.67 951.352 1237.46 949.462L1237.46 949.462L1237.44 949.455C1234.33 947.566 1230.44 946.616 1226.46 946.996L1226.45 946.996C1220.31 947.563 1215.34 951.161 1212.07 955.496C1210.87 957.128 1209.87 958.761 1208.84 960.421C1208.25 961.386 1207.65 962.36 1207 963.347L1207 963.347L1206.99 963.357C1205.39 965.749 1203.52 968.064 1201.69 970.335C1200.81 971.419 1199.94 972.494 1199.12 973.562C1196.52 976.914 1194.26 980.279 1193.01 984.012C1191.96 987.255 1191.79 990.53 1192.81 993.584C1194.59 998.909 1199.77 1002.74 1205.32 1006.47L1205.32 1006.47L1205.33 1006.48C1208.8 1008.86 1212.34 1011.02 1216.25 1012.68L1216.25 1012.68L1216.27 1012.69C1219.57 1014.14 1223.23 1015.1 1226.96 1015.1Z"></path>
                        <path className="st47" d="M1226.72 1003V1003L1226.73 1003C1232.29 1003.06 1237.07 1000.05 1241.26 996.55C1243.78 994.406 1246.15 992.074 1247.62 989.481C1249.41 986.325 1249.96 982.988 1248.62 979.815C1248.06 978.516 1247.19 977.364 1246.18 976.193C1245.84 975.797 1245.46 975.386 1245.08 974.965C1244.38 974.193 1243.66 973.387 1243.01 972.571C1242.07 971.383 1241.27 970.169 1240.5 968.974C1240.31 968.677 1240.13 968.381 1239.94 968.088C1239.38 967.195 1238.82 966.32 1238.22 965.449C1236.87 963.578 1235.41 961.822 1233.38 960.622L1233.38 960.622L1233.37 960.615C1231.4 959.416 1228.95 958.811 1226.42 959.052L1226.42 959.053C1222.54 959.413 1219.39 961.699 1217.29 964.484C1216.52 965.544 1215.88 966.592 1215.22 967.67C1214.83 968.304 1214.43 968.949 1214 969.613L1214 969.613L1213.99 969.623C1212.94 971.203 1211.7 972.741 1210.5 974.236C1209.93 974.944 1209.37 975.641 1208.84 976.329C1207.16 978.518 1205.71 980.686 1204.92 983.075C1204.25 985.147 1204.15 987.217 1204.79 989.135C1205.9 992.497 1209.17 994.944 1212.81 997.403L1212.81 997.403L1212.82 997.408C1215.07 998.963 1217.36 1000.36 1219.88 1001.44L1219.88 1001.44L1219.89 1001.45C1222.01 1002.39 1224.35 1003 1226.72 1003Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment && !tooth73Diagnozis.implant && !tooth73Diagnozis.apex && !tooth73Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth73.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment && !tooth73Diagnozis.implant && !tooth73Diagnozis.shaper && !tooth73Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        <g
                            dataposition="72_4"
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_right && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_right && tooth73Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            />
                            <path className="st54" className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_left && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_left && tooth73Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                    ...
                    <g className="hEmpty hImplant hRoot" style={{visibility: "inherit"}}>
                        ...
                        >
                            <path className={`vinir-fill ${tooth73Diagnozis.vinir_color}`} 
                    ...
                    <g className="crown" style={{
                        visibility: (tooth73Diagnozis.temporary_crown || tooth73Diagnozis.ceramic_crown || tooth73Diagnozis.mceramic_crown || tooth73Diagnozis.metalic_crown || tooth73Diagnozis.zirconia_crown) ? 'inherit' : 'hidden',
                        opacity: (tooth73Diagnozis.temporary_crown || tooth73Diagnozis.ceramic_crown || tooth73Diagnozis.mceramic_crown || tooth73Diagnozis.metalic_crown || tooth73Diagnozis.zirconia_crown)  ? 1 : 0
                    }}>
                        <path className={
                            ...
                            c2.9-3.5,5.6-7.2,7.5-11.3C1271,993,1272.2,984.7,1269.3,976.6z"
                        />
                        <path className={`st3 fissure ${tooth73Diagnozis.fissure ? 'diagnoze' : tooth73Diagnozis.fissure ? 'hidden' : ''}`}  
                    ...
                    <g className="fissures hEmpty hRoot hImplant" style={{visibility: (!tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment && !tooth73Diagnozis.implant && !tooth73Diagnozis.apex && !tooth73Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        <path className={`st3 fissure ${tooth73Diagnozis.fissure ? 'diagnoze' : ''}`}
                            d="M1223.6,981.3c-4.9,0-9.7-0.8-14.4-2.3l0.3-1c5.4,1.7,11,2.5,16.5,2.2c5.3-0.3,10.6-1.5,15.5-3.7l0.4,1
                            c-5,2.2-10.4,3.5-15.9,3.8C1225.3,981.3,1224.5,981.3,1223.6,981.3z"
                        />
                    </g>
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth73Diagnozis.implant && !tooth73Diagnozis.apex && !tooth73Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth73Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth73Diagnozis.channel_class} ${tooth73Diagnozis.channel_class} ${tooth73Diagnozis.pulpit ? 'pulpit' : ''} ${tooth73Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth73Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        />
                        <path style={{fill: tooth73Diagnozis.pin ? '#dbd9d3' : 'none'}} 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth73Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth73Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth73Diagnozis.abutment || tooth73Diagnozis.implant || tooth73Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment && !tooth73Diagnozis.implant && !tooth73Diagnozis.shaper && !tooth73Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                        ...
                        <path className={`st7 ${tooth73Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}  
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth73.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth73Diagnozis.culttab && !tooth73Diagnozis.abutment && !tooth73Diagnozis.implant && !tooth73Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_right && !tooth73Diagnozis.seal_top && !tooth73Diagnozis.seal_center) ||
                                        (tooth73Diagnozis.seal_right && tooth73Diagnozis.seal_top && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_right && tooth73Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_right && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_right && !tooth73Diagnozis.seal_bottom && tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_right && tooth73Diagnozis.seal_bottom && tooth73Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_left && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_left && tooth73Diagnozis.seal_center) ||
                                        (tooth73Diagnozis.seal_right && tooth73Diagnozis.seal_left && !tooth73Diagnozis.seal_center && !tooth73Diagnozis.seal_top) ||
                                        (!tooth73Diagnozis.seal_top && !tooth73Diagnozis.seal_bottom && tooth73Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth73Diagnozis.seal_left && !tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_left && !tooth73Diagnozis.seal_bottom && tooth73Diagnozis.seal_center) ||
                                        (!tooth73Diagnozis.seal_left && tooth73Diagnozis.seal_bottom && tooth73Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
