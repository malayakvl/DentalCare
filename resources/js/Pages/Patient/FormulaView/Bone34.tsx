...
export default function Bone34({
  className = '',
    ...
    return (
        <g id="bone_34" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M1380.1,1260.4c-0.2,0-0.5,0-0.7,0c-7,1-27.3,25.6-59.2,26.3
                        c-31.7,0.8-36.4-12.7-44-12.6" style={{strokeWidth: 2}}/>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M1385.3,1286.4c-0.3,0-0.6,0-0.9,0c-7,1-21.4,27.5-55.3,29.2
                            c-33.4,1.6-43.8-15.2-50.6-15.9" style={{strokeWidth: 2}}/>
            </g>
        </g>
    )
}
