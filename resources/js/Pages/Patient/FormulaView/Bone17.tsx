...
export default function Bone17({
  className = '',
    ...
    return (
        <g id="bone_17" className="df-bone top" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                ...
                c-0.2,0-0.4-0.1-0.6-0.1c0,0-0.1,0-0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-42.7-4.9-62.9,10.9-73.2,9.8c-0.1,0-0.1,0-0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c0,1.4,0.1,2.7,0.1,4.1C478,310.1,478.1,317.3,478,324.8z" style={{strokeWidth: 2}} />
                <path className="st43" d="M477.8,331.8c-8.7-2-16-18.5-61.6-24.4c-53.1-5.7-58.3,11.9-70.9,10.6
                c-0.1,0-0.2,0-0.2,0" style={{strokeWidth: 2}} />
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                c-42.4-0.7-50.3,13-62.3,13.1" style={{strokeWidth: 2}} />
            </g>
        </g>
    )
}
