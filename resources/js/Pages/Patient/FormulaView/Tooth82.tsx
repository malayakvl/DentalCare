...
export default function Tooth82() {
    ...
    const showHideOverlay = (type) => {
        if (type === 'over') {
            if (teethType === 'child' && !teethDiagnozis.tooth82.show && !teethDiagnozis.tooth42.show) {
        ...
        if (type === 'leave') {
            if (teethType === 'child' && !teethDiagnozis.tooth82.show && !teethDiagnozis.tooth25.show) {
                document.getElementById('TH-82').classList.remove('f-tooth-active');
            }
            if (teethType === 'child' && !teethDiagnozis.tooth82.show && teethDiagnozis.tooth42.show) {
                document.getElementById('TH-82').classList.remove('f-tooth-active');
    ...
    const showHideTopCommonView = (type) => {
        if (type === 'over') {
            ...
            if (teethType === 'adult' && teethDiagnozis.tooth82.show) {
                document.getElementById('TH-82').classList.remove('f-tooth-active');
                document.getElementById('TH-42').classList.add('f-tooth-active');
            }
        }
        ...
        <>
            ...
            <g id="TH-82" className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth82.show && !teethDiagnozis.tooth82.absent)  ? 'f-tooth-active' : ''}`}
                onClick={() => {
                    ...
                    dispatch(setSelectedToothNumber(82));
            ...
            >
                <g className={`underlay ${selectedTooth === 82 ? 'selected' : ''}`}  style={{visibility: 'inherit', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}
                    onMouseOver={() => {
                ...
                >
                    <g className="dentin">
                        <g style={{visibility: !tooth82Diagnozis.culttab && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth82Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth82Diagnozis?.apex ? 'apex' : ''}`}  
                        ...
                        <g style={{visibility: tooth82Diagnozis?.apex || tooth82Diagnozis.change_color ? 'inherit' : 'hidden'}}>
                            <path className={`st6 change-color ${tooth82Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth82Diagnozis?.apex ? 'apex' : ''}`}  
                    ...
                    <g className="pulp" style={{visibility: tooth82Diagnozis.apex ? 'inherit' : 'hidden'}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth82Diagnozis.implant || tooth82Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment hEmpty hIntact hRoot" style={{visibility: tooth82Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth82Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* PIN */}
                    <g className="pin" style={{visibility: 'inherit', opacity: tooth82Diagnozis.pin ? 1 : 0}}>
                    ...
                    {/* CULTTAB */}
                    <g className="stump hEmpty hIntact hImplant" style={{visibility: !tooth82Diagnozis.culttab ? 'hidden' : 'inherit', opacity: !tooth82Diagnozis.culttab ? 0 : 1}}>
                        <path className="st47" d="M972.268 983.854L972.268 983.854L972.274 983.863C973.539 985.719 973.563 987.914 972.521 989.922C971.007 992.58 967.92 994.273 964.459 995.56C959.792 997.211 954.81 997.9 949.69 998C943.688 997.999 937.62 997.112 932.264 995.068C929.294 993.88 926.708 992.392 925.488 990.139C924.644 988.441 924.63 986.482 925.59 984.556C926.504 982.825 927.985 981.328 929.584 979.829L929.59 979.824L929.595 979.818C932.725 976.79 935.769 973.444 938.314 969.881L938.319 969.874L938.324 969.866C938.361 969.813 938.398 969.759 938.434 969.706C939.523 968.122 940.601 966.553 941.991 965.507C943.888 964.155 946.238 963.521 948.69 963.794C951.962 964.157 954.761 966.076 957.088 968.402C958.448 969.8 959.654 971.292 960.889 972.818C961.252 973.267 961.617 973.719 961.99 974.172C963.61 976.144 965.339 978.111 967.474 979.78C968.004 980.215 968.615 980.655 969.192 981.07C969.543 981.323 969.882 981.567 970.182 981.796C971.042 982.45 971.761 983.094 972.268 983.854Z"></path>
                        <path className="st47" d="M968.199 983.571L968.198 983.571L968.204 983.58C969.217 985.054 969.241 986.797 968.402 988.406C967.172 990.546 964.652 991.929 961.774 992.991C957.906 994.35 953.774 994.918 949.521 995C944.534 994.999 939.499 994.268 935.06 992.586C932.589 991.604 930.487 990.393 929.501 988.588C928.826 987.238 928.812 985.678 929.587 984.134C930.333 982.731 931.547 981.511 932.879 980.271L932.885 980.266L932.891 980.26C935.503 977.751 938.047 974.975 940.176 972.017L940.181 972.01L940.186 972.002C940.215 971.962 940.243 971.921 940.271 971.88C941.183 970.562 942.067 969.285 943.202 968.437C944.749 967.343 946.667 966.829 948.671 967.05C951.345 967.345 953.644 968.903 955.57 970.814C956.697 971.964 957.695 973.19 958.723 974.451C959.026 974.823 959.332 975.199 959.644 975.576C960.996 977.208 962.446 978.847 964.24 980.239C964.683 980.601 965.202 980.972 965.687 981.319C965.978 981.527 966.257 981.726 966.499 981.909C967.211 982.447 967.792 982.966 968.199 983.571Z"></path>
                    </g>
                    <g className="hRoot hImplant hEmpty" style={{visibility: (!tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.apex && !tooth82Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g className="tartar" style={{opacity: teethDiagnozis.tooth82.tartar ? 1 : 0, visibility: "inherit"}}>
                    ...
                    {/*CARIES/SEAL*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper && !tooth82Diagnozis.apex) ? 'inherit' : 'hidden'}}>
                        <g
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-right
                                    ${'caries-stroke'}
                                    ${teethDiagnozis.tooth82.caries_right ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth82.seal_right ? `seal-fill ${teethDiagnozis.tooth82.seal_right_color}` : ''}
                                `} 
                                d="M960.8,980.3c0,1.9,0.4,3.7,1.4,5.3c1.7,2.5,10.8,10.2,15.3,13.8c1.7-1.5,3.1-3.2,4.1-5.4
                                c1.6-3.6,1.5-7.8-0.4-11.3c-1.6-2.8-4.3-4.7-6.6-6.9c-3.2-3-5.7-6.8-8.3-10.6c-1.2,2.6-3,6.7-4.1,9.1
                                C961.4,976.3,960.8,978.3,960.8,980.3z"
                        ...
                        >
                            ...
                            <path className={
                                    ...
                                    ${teethDiagnozis.tooth82.caries_top ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth82.seal_top ? `seal-fill ${teethDiagnozis.tooth82.seal_top_color}` : ''}
                                `}  
                                d="M931.2,965.4c2.7,4.2,8.4,13.2,8.5,16c6.1,0,15-0.6,21-1.1c0-2,0.6-4,1.4-5.9c1.1-2.5,2.9-6.5,4.1-9.1
                                c-1.7-2.6-3.4-5.1-5.3-7.5c-3.2-3.9-7-7.2-11.7-7.9c-3.5-0.5-6.9,0.5-9.6,3c-2.1,1.9-3.6,4.7-5.1,7.3
                                C933.5,961.9,932.4,963.7,931.2,965.4z" 
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-left
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth82.caries_left ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth82.seal_left ? `seal-fill ${teethDiagnozis.tooth82.seal_left_color}` : ''}
                                `}  
                        ...
                        >
                            ...
                            <path className={
                                    `st8 caries-center
                                    ${['caries', 'seal'].includes(diagnozis) ? 'caries-stroke' : ''}
                                    ${teethDiagnozis.tooth82.caries_center ? 'caries-fill' : ''}
                                    ${teethDiagnozis.tooth82.seal_center ? `seal-fill ${teethDiagnozis.tooth82.seal_center_color}` : ''}
                                `}  
                                d="M922.4,999.3c1.6,1.3,3.4,2.3,5.2,3.2c7.2,3.4,15.2,4.9,23.2,4.9c6.7,0,13.4-1.2,19.6-3.8
                                c2.5-1.1,5-2.4,7-4.2c-4.4-3.7-13.6-11.3-15.3-13.8c-1.1-1.6-1.5-3.4-1.4-5.3c-6.1,0.5-14.9,1.1-21,1.1c0,0.3,0,0.5-0.1,0.6
                                C938.6,983.6,928.4,993.6,922.4,999.3z"
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_left && tooth82Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_top) ||
                                        (!tooth82Diagnozis.seal_left && tooth82Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_center && !tooth82Diagnozis.seal_top) ||
                                        (!tooth82Diagnozis.seal_center && tooth82Diagnozis.seal_top)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_top && !tooth82Diagnozis.seal_right) ||
                                        (!tooth82Diagnozis.seal_top && tooth82Diagnozis.seal_right)
                                    ) ? 5 : 0
                                }}  
                            ...
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_right && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_right && tooth82Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                ...
                >
                    <g className="dentin">
                        <g className="hRoot hImplant hEmpty" style={{visibility: !tooth82Diagnozis.implant && !tooth82Diagnozis.apex && !tooth82Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                            <path className={`st10 change-color ${tooth82Diagnozis.change_color ? 'diagnoze' : ''}`} 
                    ...
                    <g className="pulp">
                        <g>
                            <path className={`st22 target top ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.pulpit ? 'pulpit' : ''} ${tooth82Diagnozis.periodontit ? 'periodontit' : ''}`} 
                        ...
                        <g>
                            <path <path className={`st22 target top ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.pulpit ? 'pulpit' : ''} ${tooth82Diagnozis.periodontit ? 'periodontit' : ''}`} 
                    ...
                    <g className="pin" style={{
                        visibility: 'inherit', opacity: tooth82Diagnozis.pin ? 1 : 0
                    }}>
                        ...
                        />
                        <path className="st57" style={{fill: tooth82Diagnozis.pin ? '#dbd9d3' : 'none'}} 
                    ...
                    {/* ABUTMENT */}
                    <g className="abutment" style={{visibility: tooth82Diagnozis.abutment ? 'inherit' : 'hidden', opacity: tooth82Diagnozis.abutment ? 1 : 0}}>
                    ...
                    {/* IMPLANT/CULTTAB */}
                    <g className="implant hEmpty hIntact hRoot" style={{visibility: tooth82Diagnozis.abutment || tooth82Diagnozis.implant || tooth82Diagnozis.shaper ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="toutline" style={{visibility: !tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper && !tooth82Diagnozis.apex  ? 'inherit' : 'hidden'}}>
                    ...
                    <g className="wedge-shaped" style={{visibility: !tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment ? 'inherit' : 'hidden'}}>
                    ...
                    {/*TARTAR*/}
                    <g style={{visibility: 'inherit', opacity: teethDiagnozis.tooth82.tartar ? 1 : 0}}>
                    ...
                    {/*КАРИЕС*/}
                    <g className="header caries-filling hRoot hImplant hEmpty" style={{visibility: (!tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment && !tooth82Diagnozis.implant && !tooth82Diagnozis.shaper) ? 'inherit' : 'hidden'}}>
                        {/*КАРИЕС RIGHT*/}
                        ...
                        <g className="with">
                            <path className="st54" style={{
                                    stroke: 'rgb(81, 79, 72)',
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_top && !tooth82Diagnozis.seal_center) ||
                                        (tooth82Diagnozis.seal_left && tooth82Diagnozis.seal_top && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_left && tooth82Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_bottom && tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_left && tooth82Diagnozis.seal_bottom && tooth82Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_right && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_right && tooth82Diagnozis.seal_center) ||
                                        (tooth82Diagnozis.seal_right && tooth82Diagnozis.seal_left && !tooth82Diagnozis.seal_center && !tooth82Diagnozis.seal_top) ||
                                        (!tooth82Diagnozis.seal_top && !tooth82Diagnozis.seal_bottom && tooth82Diagnozis.seal_center)
                                    ) ? 5 : 0
                                }} 
                            ...
                            <path className="st54" style={{
                                    ...
                                    strokeWidth: (
                                        (tooth82Diagnozis.seal_right && !tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_right && !tooth82Diagnozis.seal_bottom && tooth82Diagnozis.seal_center) ||
                                        (!tooth82Diagnozis.seal_right && tooth82Diagnozis.seal_bottom && tooth82Diagnozis.seal_center)
                                    )
                                        ? 5 : 0
                                }} 
                    ...
                    <g className="crown" style={{
                        ...
                        <path className={
                                ...
                                ${tooth82Diagnozis.ceramic_crown_color}
                                ${tooth82Diagnozis.mceramic_crown_color}
                                ${tooth82Diagnozis.metalic_crown_color}
                                ${tooth82Diagnozis.zirconia_crown_color}
                            `} 
