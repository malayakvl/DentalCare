...
export default function Bone41({
  className = '',
    ...
    return (
        <g id="bone_41" className="df-bone bottom" opacity="0" style={{opacity: 0, transition: 'opacity'}}>
            <g className="periodontal level" style={{visibility: 'inherit'}}>
                ...
                <path className="st43" d="M984.5,1216.9c0.6-0.2,1.2-0.3,1.9-0.2c2.3,0.1,4.1,1.7,5.7,3.2c7,6.5,15.2,12.6,25.3,13.8
                        c10.2,1.1,20-2.9,26.4-9.8c1.5-1.6,2.9-3.5,4.9-4.7c0.4-0.2,0.8-0.4,1.2-0.6" style={{strokeWidth: 2}}/>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                ...
                <path className="st43" d="M983.4,1246.7c0.5-0.2,0.9-0.3,1.4-0.3c5.7,0,11.8,17.4,33.7,16.6
                            c20.9-0.8,24.4-14.2,31.5-16.3" style={{strokeWidth: 2}}/>
            </g>
            <g className="periodontal level" style={{visibility: 'hidden'}}>
            ...
            <g className="periodontal level" style={{visibility: 'hidden'}}>
                <path className="st0" d="M1049.8,1307.5l-0.5,209c-25.5-0.1-50.9-0.6-76.3-1.5c1.5-38.5,3.2-84.3,4.7-124.5
                            ...
                            C1040.2,1321.6,1043.6,1309.7,1049.8,1307.5z" style={{strokeWidth: 2}}/>
                <path className="st43" d="M981.1,1305.6c0.5-0.3,1-0.4,1.4-0.4c4.9,0.2,10.5,18.5,34.1,17.5
                            c23.6-1.1,26.9-13,33.1-15.1" style={{strokeWidth: 2}}/>
            </g>
        </g>
    )
}
