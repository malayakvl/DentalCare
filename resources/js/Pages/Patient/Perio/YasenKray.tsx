...
import { setPZondChart1828Up, setPKrayChart1828Up, setPBarChart1828Up, setPKrayChart1828Down, setPZondChart1828Down, setPBarChart1828Down, setPerioZ1828VestData, setPerioZ1828OralData, setPerioYK1828VestData, setPerioYK1828OralData } from "../../../Redux/Formula";
...
export default function YasenKray({ type = 'vest', idx = 0 }) {
    ...
    const recalcSlice = (type) => {
        ...
        if (type === 'vest') {
            ...
            // если заполнено только одни значения ясеного краю то столбики не рисуем
            // const sum = arr.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
            console.log(chartNewZond);
