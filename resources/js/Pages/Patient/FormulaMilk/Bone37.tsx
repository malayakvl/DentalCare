...
export default function Bone37({
  className = '',
    ...
    return (
        <g id="bone_37" className="df-bone bottom" data-number="37" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" style={{visibility: "inherit"}}>
                ...
                c-12.2,6.7-26.2,12.4-40.2,15.5c-23.3,5.2-47.5,6.9-70.9,1.9C1640.6,1186.6,1638.1,1186,1635.6,1186.2z" style={{strokeWidth: 2 }}></path>
                <path className="st43" d="M1785.6,1144.6c-1.1-0.2-2.2-0.1-3.3,0.5c-0.9,0.5-1.5,1.3-2.1,2.1c-6.8,9-15.6,16.8-26,22.5
                c-12.2,6.7-26.2,12.4-40.2,15.5c-23.3,5.2-47.5,6.9-70.9,1.9c-2.5-0.5-4.9-1.1-7.4-0.9" style={{strokeWidth: 2 }}></path>
            </g>
            <g className="periodontal level" style={{visibility: "hidden"}}>
                ...
                c-16.2-27.5-30.5-56.1-42.9-85.5c-0.2,0.1-0.5,0.1-0.7,0.2c-11.8,4.3-28.4,37.2-75.1,48C1674.7,1217.8,1650.4,1203.1,1641,1204.3z" style={{strokeWidth: 2 }}></path>
                <path className="st43" d="M1791.8,1160c-0.2,0.1-0.5,0.1-0.7,0.2c-11.8,4.3-28.4,37.2-75.1,48
                c-41.4,9.6-65.7-5.1-75.1-3.8" style={{strokeWidth: 2 }}></path>
            </g>
            <g className="periodontal level" style={{visibility: "hidden"}}>
            ...
            <g className="periodontal level" style={{visibility: "hidden"}}>
                ...
                C1690.7,1258.7,1667.6,1247.3,1657.8,1249.6C1657.9,1249.6,1657.9,1249.6,1657.8,1249.6z" style={{strokeWidth: 2 }}></path>
                <path className="st43" d="M1807.9,1195.3c-0.3,0.1-0.6,0.2-0.8,0.3c-11.6,4.9-19.6,36.9-73.2,51.4
                c-43.1,11.7-66.3,0.3-76,2.6c0,0,0,0-0.1,0" style={{strokeWidth: 2 }}></path>
            </g>
        </g>
    )
}
