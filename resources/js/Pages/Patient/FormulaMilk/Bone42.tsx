...
export default function Bone42({
  className = '',
    ...
    return (
        <g id="bone_42" className="df-bone bottom" data-number="42" opacity="0" style={{opacity: 0, transition: "opacity"}} inflammation="0" data-type="undefined" level="0">
            <g className="periodontal level" data-level="0" style={{visibility: "inherit"}}>
                ...
                c3.8,4.6,8.7,11.6,13.7,14.7c5.3,3.4,11.1,5.9,17.8,5.7c11.6-0.4,19.5-11.9,28.1-18.5C981.7,1218.2,983,1217.3,984.5,1216.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M914.9,1213.9c0.3-0.1,0.7-0.1,1-0.1c2.2,0.2,3.6,1.9,4.9,3.4c3.8,4.6,8.7,11.6,13.7,14.7
                c5.3,3.4,11.1,5.9,17.8,5.7c11.6-0.4,19.5-11.9,28.1-18.5c1.2-1,2.6-1.9,4-2.3" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                ...
                C974.2,1261.5,978.4,1248.8,983.4,1246.7z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M912.3,1244.5c0.1,0,0.1,0,0.2,0c6,0,13.3,18.4,40.7,17.7c21-0.6,25.2-13.3,30.2-15.4" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                ...
                C971.1,1291.1,976.9,1278.6,982.2,1276.6z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M909.5,1277.9c0.2-0.1,0.5-0.1,0.7-0.1c6.2-0.3,12.4,14.7,39.8,13.9
                c21.1-0.6,26.9-13.1,32.2-15.1" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                ...
                C968.6,1322.3,976.2,1308,981.1,1305.6z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M907.4,1304.4c0.2,0,0.4-0.1,0.6-0.1c5.6,0.1,12.4,19.3,39.8,18.5
                c20.9-0.6,28.5-14.9,33.4-17.3" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
