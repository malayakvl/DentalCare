...
export default function Bone33({
  className = '',
    ...
    return (
        <g id="bone_33" className="df-bone bottom" data-number="33" opacity="0" style={{opacity: 0, transition: "opacity"}} inflammation="0" data-type="undefined" level="0">
            <g className="periodontal level" style={{visibility: "inherit"}}>
                ...
                c-4.6-4.3-10.4-17.1-14.8-21.6C1187,1215.3,1185.6,1214.2,1184,1213.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1271,1213.9c-0.3,0-0.6,0-1,0c-3,0-3.8,1.6-5.5,3.8c-7.4,9.3-12.3,19.7-18.5,25.1
                c-5.2,4.6-11.9,5.1-19.5,5.4c-10.1,0.4-16.8-3.8-23.5-10.1c-4.6-4.3-10.4-17.1-14.8-21.6c-1.2-1.2-2.5-2.3-4.1-2.6" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: "hidden"}}>
                ...
                c-5.3,1.6-13.6,31.5-46.2,31.2C1196.2,1271.8,1192.5,1245,1186.6,1244.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1273.4,1240.9c-5.3,1.6-13.6,31.5-46.2,31.2c-31-0.3-34.6-27.1-40.5-27.7" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: "hidden"}}>
                ...
                c-7.7,0.3-12.4,26.8-47.9,25.7C1198.2,1298.9,1195.1,1279.6,1189.3,1277.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1276.3,1274.2h-0.2c-7.7,0.3-12.4,26.8-47.9,25.7c-30-1-33.1-20.2-38.9-22" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" style={{visibility: "hidden"}}>
                ...
                c-0.1,0-0.2,0-0.3,0c-6.8-0.2-7.9,28.9-43.3,30.2C1203.5,1330.9,1197,1306.1,1191.5,1304.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1278.5,1299.7c-0.1,0-0.2,0-0.3,0c-6.8-0.2-7.9,28.9-43.3,30.2
                c-31.4,1.1-37.9-23.8-43.4-25.4" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
