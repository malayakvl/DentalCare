...
export default function MaxilaryLeft({
    className = '',
}) {
    ...
    return (
        <g id="Maxillary_l" className="df-sinus">
            <path id="Maxillary_x5F_1_1_" className="st36" d="M305.1,90.5c-6.7,16-9.6,32.5-8.8,49.1c0.8,16.4,5.3,32.7,9.8,48.9
                ...
                c1.9-22.1,2.4-44.2,1.4-66.4L305.1,90.5z"></path>
        </g>
    )
}
