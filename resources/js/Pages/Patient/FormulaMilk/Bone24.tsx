...
export default function Bone24({
  className = '',
    ...
    return (
        <g id="bone_24" className="df-bone top" data-number="24" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" data-level="0" style={{visibility: "inherit"}}>
                <path className="st0" d="M1414.1,258.3c-1.8,15.7-4.5,39.5-8.5,74c-2.8,23.6-4.8,53.7-6.2,67.5
                ...
                c0.8,2.5,1.9,5.9,3.2,8.5C1406.5,256,1410,258.5,1414.1,258.3z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1398.9,405.2c-1.3-0.2-2.2-1.1-3-2c-0.8-0.8-1.5-1.6-2.3-2.5c-4.9-5-10.3-9.5-16.2-13
            ...
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                <path className="st0" d="M1323.5,386.5c6.9-2.6,11.5-19.8,36.9-21.2c26-1.5,33.1,18.3,40.1,17.5
                ...
                c-4.6-13-6.1-26.9-8.2-40.4c-1.3-8.5-2.6-16.9-3.3-25.4c-0.8-9.3-1.4-18.7-1.7-28l-2.8,0L1323.5,386.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1323.5,386.7c6.9-2.6,11.5-19.8,36.9-21.2c26-1.5,33.1,18.3,40.1,17.5
                c0.1,0,0.2,0,0.3,0" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                <path className="st0" d="M1327,350.8c5,0,8.1-17.2,36.1-18.5c27.2-0.4,31.8,14.2,39.7,13.7
                c0.5,0,0.9-0.1,1.4-0.3c0-0.4,0.1-0.8,0.1-1.2c0.4-4.5,0.8-8.9,1.3-13.1c2.4-20.1,4.3-36.5,5.8-49.9c0.2-1.7,0.4-3.4,0.6-5
                c0.1-0.5,0.1-1,0.2-1.5c0.8-7.5,1.5-13.9,2.1-19.2c-4.2,0.7-8-1.1-10.5-5.7c-1.3-2.5-2.2-6.4-2.2-9.5c-0.1-3.2-0.4-6.5-1.4-9.8
                c-1.1-3.6-4.7-7.1-9.5-8.4c-2.9-0.8-6.1-0.6-8.9,0.2c-2.6,0.7-5.1,1.9-6.6,3.6c-1.4,1.7-2.1,3.9-5,4.2c-3.1,0.4-4.8-1.9-5.6-4.3
                c-4.6-13-6.1-26.9-8.2-40.4c-1.3-8.5-2.6-16.9-3.3-25.4c-0.8-9.3-1.4-18.7-1.7-28l-2.8,0L1327,350.8z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1327,351.1c5,0,8.1-17.2,36.1-18.5c27.2-0.4,31.8,14.2,39.7,13.7
                c0.5,0,0.9-0.1,1.4-0.3" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                <path className="st0" d="M1331,309.9c0.5,0.4,1,0.6,1.5,0.7c6.3,0.5,11.8-18.1,37.4-17.5
                ...
                c-1.3-8.5-2.6-16.9-3.3-25.4c-0.8-9.3-1.4-18.7-1.7-28l-2.8,0L1331,309.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1331,310.1c0.5,0.4,1,0.6,1.5,0.7c6.3,0.5,11.8-18.1,37.4-17.5
                c25.7,0.6,34.2,16.2,37.8,16.1c0.1,0,0.3,0,0.5-0.1" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
