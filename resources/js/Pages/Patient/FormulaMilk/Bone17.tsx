...
export default function Bone17({
  className = '',
    ...
    return (
        <g id="bone_17" className="df-bone top" data-number="17" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" data-level="0" style={{visibility: "inherit"}}>
                <path className="st0" d="M478,324.8c-0.3,22.6-2.2,41.8-4.1,55.1c-0.5,0-0.9-0.1-1.4-0.2c-0.2,0-0.3-0.1-0.4-0.1
                ...
                c0,1,0.1,2.1,0.1,3.1c0,1.4,0.1,2.7,0.1,4.1C478,310.1,478.1,317.3,478,324.8z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M473.9,379.9c-0.5,0-0.9-0.1-1.4-0.2c-0.2,0-0.3-0.1-0.4-0.1c-0.7-0.2-1.3-0.4-1.9-0.7
                ...
                c-0.2,0-0.4-0.1-0.6-0.1c0,0-0.1,0-0.2,0" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                <path className="st0" d="M478,324.8c-0.1,12.5-0.8,24-1.7,33.9c-0.1,0-0.1,0-0.2,0
                ...
                c0,0.6,0.1,1.2,0.1,1.8c0,1,0.1,2.1,0.1,3.1c0,1.4,0.1,2.7,0.1,4.1C478,310.1,478.1,317.3,478,324.8z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M476.3,358.7c-0.1,0-0.1,0-0.2,0c-14.6,0.7-10.6-21.3-62.2-27.1
                c-42.7-4.9-62.9,10.9-73.2,9.8c-0.1,0-0.1,0-0.2,0" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                <path className="st0" d="M478,324.8c0,2.4-0.1,4.8-0.1,7.1c-8.7-2-16-18.5-61.6-24.4
                ...
                c0,1.4,0.1,2.7,0.1,4.1C478,310.1,478.1,317.3,478,324.8z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M477.8,331.8c-8.7-2-16-18.5-61.6-24.4c-53.1-5.7-58.3,11.9-70.9,10.6
                c-0.1,0-0.2,0-0.2,0" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                <path className="st0" d="M477.7,300.3c-0.3,0-0.6,0-0.8,0c-9.3-0.1-17.9-17.8-67.1-18.6
                ...
                c0.9,7.3,2.2,19.5,2.9,35.2c0,0.6,0.1,1.2,0.1,1.8c0,1,0.1,2.1,0.1,3.1C477.7,299.6,477.7,300,477.7,300.3z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M477.7,299.3c0,0.4,0,0.7,0,1.1c-0.3,0-0.6,0-0.8,0c-9.3-0.1-17.9-17.8-67.1-18.6
                c-42.4-0.7-50.3,13-62.3,13.1" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
