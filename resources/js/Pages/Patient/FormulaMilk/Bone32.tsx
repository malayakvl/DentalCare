...
export default function Bone32({
  className = '',
    ...
    return (
        <g id="bone_32" className="df-bone bottom" data-number="32" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" data-level="0" style={{visibility:"inherit"}}>
                ...
                C1117.2,1218.2,1115.9,1217.3,1114.4,1216.9z" style={{strokeWidth:2}}></path>
                <path className="st43" d="M1184,1213.9c-0.3-0.1-0.7-0.1-1-0.1c-2.2,0.2-3.6,1.9-4.9,3.4c-3.8,4.6-8.7,11.6-13.7,14.7
                c-5.3,3.4-11.1,5.9-17.8,5.7c-11.6-0.4-19.5-11.9-28.1-18.5c-1.2-1-2.6-1.9-4-2.3" style={{strokeWidth:2}}></path>
            </g>
            <g className="periodontal level" data-level="1" style={{visibility:"hidden"}}>
                ...
                C1124.7,1261.5,1120.5,1248.8,1115.5,1246.7z" style={{strokeWidth:2}}></path>
                <path className="st43" d="M1186.6,1244.5c-0.1,0-0.1,0-0.2,0c-6,0-13.3,18.4-40.7,17.7
                c-21-0.6-25.2-13.3-30.2-15.4" style={{strokeWidth:2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility:"hidden"}}>
                ...
                C1127.7,1291.1,1122,1278.6,1116.6,1276.6z" style={{strokeWidth:2}}></path>
                <path className="st43" d="M1189.3,1277.9c-0.2-0.1-0.5-0.1-0.7-0.1c-6.2-0.3-12.4,14.7-39.8,13.9
                c-21.1-0.6-26.9-13.1-32.2-15.1" style={{strokeWidth:2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility:"hidden"}}>
                ...
                C1130.3,1322.3,1122.7,1308,1117.7,1305.6z" style={{strokeWidth:2}}></path>
                <path className="st43" d="M1191.5,1304.5c-0.2,0-0.4-0.1-0.6-0.1c-5.6,0.1-12.4,19.3-39.8,18.5
                c-20.9-0.6-28.5-14.9-33.4-17.3" style={{strokeWidth:2}}></path>
            </g>
        </g>
    )
}
