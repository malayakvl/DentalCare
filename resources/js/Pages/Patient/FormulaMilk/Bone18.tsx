...
export default function Bone18({
  className = '',
    ...
    return (
        <g id="bone_18" className="df-bone top" data-number="18" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" data-level="0" style={{visibility: "inherit"}}>
                ...
                C346.3,259.3,348.6,279.3,347.4,295.9z" style={{strokeWidth: 2}}></path>
                ...
                c-4.7-5.9-6.1-12.7-7.8-19.7c-2.1-8.7-4.7-17.6-8-26.1c-4.8-12.2-11.4-23.8-19.6-34.4" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                ...
                c0.1,0.4,0.1,0.6,0.1,0.7c0-0.1,0-0.4-0.1-0.7c0,0,0,0,0,0C346.3,259.3,348.6,279.3,347.4,295.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M340.6,341.4c-9.1-1.2-15.4-22.7-59.5-27.9c-37.8-4.4-53,5.9-62.7,9.7
                c-7.8,3.1-16.8,1.9-22.5-17.6c-5.2-18.2-9.2-40.7-29.5-60.3" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                ...
                c0.1,0.4,0.1,0.6,0.2,0.7c0-0.1-0.1-0.4-0.1-0.7c0,0,0,0,0,0C346.3,259.3,348.6,279.3,347.4,295.9z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M345,318c-10.9-1.3-23.3-19.7-64.8-24.4c-38.5-3.6-53.5,9.8-65.2,12.3
                c-8.1,1.7-14.2-5.9-20.3-26.9c-5.5-18.9-14.2-36.8-28.3-48.3" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                ...
                c0.8,16.4,5.3,32.7,9.8,48.9c2.2,8.2,4.7,16.4,7.2,24.5c2.7,8.6,6.8,17.1,14.4,23.3c4.6,3.8,10.5,6.6,16.5,9.4
                c0.1,0.4,0.1,0.6,0.2,0.7c0-0.1-0.1-0.4-0.1-0.7c0,0,0,0,0,0C346.2,258.9,348.5,278.4,347.5,294.8z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M347.5,294.8c-0.2,0-0.3,0-0.5,0c-8.6-0.3-19-18.9-68.7-19.8
                c-38.6-0.7-48.4,7.2-57.1,11.3c-13.8,6.4-16,2.8-20.6-15.1c-4.7-18-23.6-50.3-34.2-58.4" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
