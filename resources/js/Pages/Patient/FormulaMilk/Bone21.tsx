...
export default function Bone21({
  className = '',
    ...
    return (
        <g id="bone_21" className="df-bone top" data-number="21" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            ...
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                ...
                c-16.7-2.3-33.1-6.1-49.7-8.5c-8.3-1.2-16.7-2.2-25.1-2.7c-8.9-0.6-17.9-0.9-26.9-0.8l0,17.8L1048.9,381.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1049,391.5c11.3-2.6,30.3-22.6,53.2-22.7c30.2-0.1,44.6,20.8,53.4,20.8h0.2" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                ...
                c-16.7-2.3-33.1-6.1-49.7-8.5c-8.3-1.2-16.7-2.2-25.1-2.7c-8.9-0.6-17.9-0.9-26.9-0.8l0,17.8L1049,353.6z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1049,353.9c10.2-2,25.6-24.3,53.8-24.3c36.8,0,45.3,23.1,54.8,23c0.7,0,1.3-0.2,2-0.5" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                ...
                c-16.7-2.3-33.1-6.1-49.7-8.5c-8.3-1.2-16.7-2.2-25.1-2.7c-8.9-0.6-17.9-0.9-26.9-0.8l0,17.8L1049.1,307.3z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1049.1,307.6c9.5-3.4,16.8-19.9,50.4-20.8c42.6-1.2,57.1,21.2,64.1,25.4" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
