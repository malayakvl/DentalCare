...
export default function Bone11({
  className = '',
    ...
    return (
        <g id="bone_11" className="df-bone top" data-number="11" opacity="0" style={{opacity: 0, transition: "opacity"}}>
            <g className="periodontal level" data-level="0" style={{visibility: "inherit"}}>
                ...
                c8.3-1.2,16.7-2.2,25.1-2.7c8.9-0.6,17.9-0.9,26.9-0.8l0,17.8l0.4,189.4l-0.1,32v0L1048.9,419.2z" style={{strokeWidth: 2}}></path>
            ...
            <g className="periodontal level" data-level="1" style={{visibility: "hidden"}}>
                ...
                c16.7-2.3,33.1-6.1,49.7-8.5c8.3-1.2,16.7-2.2,25.1-2.7c8.9-0.6,17.9-0.9,26.9-0.8l0,17.8L1048.9,381.5z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1048.9,391.4c-11.3-2.6-30.3-22.6-53.2-22.7c-30.2-0.1-44.6,20.8-53.4,20.8h-0.2" style={{strokeWidth: 2}}></path>
            </g>
            <g className="periodontal level" data-level="2" style={{visibility: "hidden"}}>
                ...
                c16.7-2.3,33.1-6.1,49.7-8.5c8.3-1.2,16.7-2.2,25.1-2.7c8.9-0.6,17.9-0.9,26.9-0.8l0,17.8L1048.9,353.6z" style={{strokeWidth: 2}}></path>
            ...
            <g className="periodontal level" data-level="3" style={{visibility: "hidden"}}>
                ...
                c16.7-2.3,33.1-6.1,49.7-8.5c8.3-1.2,16.7-2.2,25.1-2.7c8.9-0.6,17.9-0.9,26.9-0.8l0,17.8L1048.8,307.3z" style={{strokeWidth: 2}}></path>
                <path className="st43" d="M1048.8,307.5c-9.5-3.4-16.8-19.9-50.4-20.8c-42.6-1.2-57.1,21.2-64.1,25.4" style={{strokeWidth: 2}}></path>
            </g>
        </g>
    )
}
