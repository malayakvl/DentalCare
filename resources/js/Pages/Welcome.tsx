                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20]">
                    <div className="">
                        <div className="text-center mt-[20px]">
                            <img src="../../images/header/logo.svg"  className="logo logo-main" />
                            <div className="logo-title logo-title-main">DenTal <span className="logo-title-p">Care</span></div>
                            <nav className="float-left w-full text-left mx-auto text-center">
                                {auth.user ? (
                                    <Link
                                        href="/dashboard"
                        ...
                        <main className="mt-36 px-[40px] mb-[50px]">
