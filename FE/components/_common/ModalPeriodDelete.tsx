...
const ModalPeriodDelete: React.FC<Props> = ({
    title = '',
    titleKey,
    children,
    customButton,
    ...
    return (
        <div
            className="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center modal-period-delete"
            {...props}>
...
export default ModalPeriodDelete;
